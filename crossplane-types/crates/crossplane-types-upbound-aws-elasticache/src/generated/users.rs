...
#[kube(group = "elasticache.aws.upbound.io", version = "v1beta2", kind = "User", plural = "users")]
...
pub struct UserForProvider {
    ...
    #[builder(default)]
    pub passwords_secret_ref: Option<Vec<UserForProviderPasswordsSecretRef>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct UserForProviderPasswordsSecretRef {
    /// The key to select.
    pub key: String,
    /// Name of the secret.
    pub name: String,
