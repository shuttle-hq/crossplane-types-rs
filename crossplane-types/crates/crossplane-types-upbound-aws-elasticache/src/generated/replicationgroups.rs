...
#[kube(group = "elasticache.aws.upbound.io", version = "v1beta2", kind = "ReplicationGroup", plural = "replicationgroups")]
...
pub struct ReplicationGroupForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authTokenUpdateStrategy")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoGenerateAuthToken")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalReplicationGroupIdRef")]
    #[builder(default)]
    pub global_replication_group_id_ref: Option<ReplicationGroupForProviderGlobalReplicationGroupIdRef>,
    /// Selector for a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalReplicationGroupIdSelector")]
    #[builder(default)]
    pub global_replication_group_id_selector: Option<ReplicationGroupForProviderGlobalReplicationGroupIdSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDeliveryConfiguration")]
    #[builder(default)]
    pub log_delivery_configuration: Option<Vec<ReplicationGroupForProviderLogDeliveryConfiguration>>,
    ...
    /// 00#.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "numCacheClusters")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetGroupNameRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetGroupNameSelector")]
    #[builder(default)]
...
pub struct ReplicationGroupForProviderGlobalReplicationGroupIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ReplicationGroupForProviderGlobalReplicationGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationGroupInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalReplicationGroupIdRef")]
    #[builder(default)]
    pub global_replication_group_id_ref: Option<ReplicationGroupInitProviderGlobalReplicationGroupIdRef>,
    /// Selector for a GlobalReplicationGroup in elasticache to populate globalReplicationGroupId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalReplicationGroupIdSelector")]
    #[builder(default)]
    pub global_replication_group_id_selector: Option<ReplicationGroupInitProviderGlobalReplicationGroupIdSelector>,
    /// The IP version to advertise in the discovery protocol. Valid values are ipv4 or ipv6.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipDiscovery")]
    #[builder(default)]
    pub ip_discovery: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDeliveryConfiguration")]
    #[builder(default)]
    pub log_delivery_configuration: Option<Vec<ReplicationGroupInitProviderLogDeliveryConfiguration>>,
    /// ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: sun:05:00-sun:09:00
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maintenanceWindow")]
    #[builder(default)]
    pub maintenance_window: Option<String>,
...
pub struct ReplicationGroupInitProviderGlobalReplicationGroupIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ReplicationGroupInitProviderGlobalReplicationGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationGroupStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationEndpointAddress")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDeliveryConfiguration")]
    #[builder(default)]
    pub log_delivery_configuration: Option<Vec<ReplicationGroupStatusAtProviderLogDeliveryConfiguration>>,
    /// ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: sun:05:00-sun:09:00
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maintenanceWindow")]
    #[builder(default)]
    pub maintenance_window: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "primaryEndpointAddress")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readerEndpointAddress")]
    #[builder(default)]
