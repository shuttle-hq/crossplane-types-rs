...
pub struct ConnectAttachmentForProvider {
    ...
    pub transport_attachment_id_selector:
        Option<ConnectAttachmentForProviderTransportAttachmentIdSelector>,
}
...
pub struct ConnectAttachmentForProviderTransportAttachmentIdSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ConnectAttachmentForProviderTransportAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectAttachmentInitProvider {
    ...
    #[builder(default)]
    pub transport_attachment_id_selector:
        Option<ConnectAttachmentInitProviderTransportAttachmentIdSelector>,
}
...
pub struct ConnectAttachmentInitProviderTransportAttachmentIdSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ConnectAttachmentInitProviderTransportAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
