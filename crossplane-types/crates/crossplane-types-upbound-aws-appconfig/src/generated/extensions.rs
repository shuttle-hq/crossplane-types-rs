...
#[kube(group = "appconfig.aws.upbound.io", version = "v1beta1", kind = "Extension", plural = "extensions")]
...
pub struct ExtensionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "actionPoint")]
    #[builder(default)]
