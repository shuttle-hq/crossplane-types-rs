...
pub struct BudgetForProviderCostTypes {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "includeOtherSubscription"
    )]
    #[builder(default)]
...
pub struct BudgetStatusAtProviderAutoAdjustDataHistoricalOptions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "lookbackAvailablePeriods"
    )]
    #[builder(default)]
