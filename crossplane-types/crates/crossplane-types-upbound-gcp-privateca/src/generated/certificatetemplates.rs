...
pub struct CertificateTemplateForProviderPassthroughExtensions {
    ...
    pub additional_extensions:
        Option<Vec<CertificateTemplateForProviderPassthroughExtensionsAdditionalExtensions>>,
    /// Optional. A set of named X.509 extensions. Will be combined with additional_extensions to determine the full set of X.509 extensions.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "knownExtensions"
    )]
    #[builder(default)]
...
pub struct CertificateTemplateForProviderPredefinedValues {
    ...
    #[builder(default)]
    pub additional_extensions:
        Option<Vec<CertificateTemplateForProviderPredefinedValuesAdditionalExtensions>>,
...
pub struct CertificateTemplateForProviderPredefinedValuesAdditionalExtensions {
    ...
    #[builder(default)]
    pub object_id:
        Option<CertificateTemplateForProviderPredefinedValuesAdditionalExtensionsObjectId>,
...
pub struct CertificateTemplateForProviderPredefinedValuesKeyUsage {
    ...
    pub extended_key_usage:
        Option<CertificateTemplateForProviderPredefinedValuesKeyUsageExtendedKeyUsage>,
    ...
    pub unknown_extended_key_usages:
        Option<Vec<CertificateTemplateForProviderPredefinedValuesKeyUsageUnknownExtendedKeyUsages>>,
}
...
pub struct CertificateTemplateInitProviderPassthroughExtensions {
    ...
    #[builder(default)]
    pub additional_extensions:
        Option<Vec<CertificateTemplateInitProviderPassthroughExtensionsAdditionalExtensions>>,
    /// Optional. A set of named X.509 extensions. Will be combined with additional_extensions to determine the full set of X.509 extensions.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct CertificateTemplateInitProviderPredefinedValues {
    ...
    #[builder(default)]
    pub additional_extensions:
        Option<Vec<CertificateTemplateInitProviderPredefinedValuesAdditionalExtensions>>,
    /// Optional. Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the "Authority Information Access" extension in the certificate.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct CertificateTemplateInitProviderPredefinedValuesAdditionalExtensions {
    ...
    #[builder(default)]
    pub object_id:
        Option<CertificateTemplateInitProviderPredefinedValuesAdditionalExtensionsObjectId>,
    /// Required. The value of this X.509 extension.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub value: Option<String>,
...
pub struct CertificateTemplateInitProviderPredefinedValuesKeyUsage {
    ...
    #[builder(default)]
    pub extended_key_usage:
        Option<CertificateTemplateInitProviderPredefinedValuesKeyUsageExtendedKeyUsage>,
    /// Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    pub unknown_extended_key_usages: Option<
        Vec<CertificateTemplateInitProviderPredefinedValuesKeyUsageUnknownExtendedKeyUsages>,
    >,
}
...
pub struct CertificateTemplateStatusAtProviderPassthroughExtensions {
    ...
    #[builder(default)]
    pub additional_extensions:
        Option<Vec<CertificateTemplateStatusAtProviderPassthroughExtensionsAdditionalExtensions>>,
    /// Optional. A set of named X.509 extensions. Will be combined with additional_extensions to determine the full set of X.509 extensions.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct CertificateTemplateStatusAtProviderPredefinedValues {
    ...
    #[builder(default)]
    pub additional_extensions:
        Option<Vec<CertificateTemplateStatusAtProviderPredefinedValuesAdditionalExtensions>>,
    /// Optional. Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the "Authority Information Access" extension in the certificate.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct CertificateTemplateStatusAtProviderPredefinedValuesAdditionalExtensions {
    ...
    #[builder(default)]
    pub object_id:
        Option<CertificateTemplateStatusAtProviderPredefinedValuesAdditionalExtensionsObjectId>,
    /// Required. The value of this X.509 extension.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub value: Option<String>,
...
pub struct CertificateTemplateStatusAtProviderPredefinedValuesKeyUsage {
    ...
    #[builder(default)]
    pub base_key_usage:
        Option<CertificateTemplateStatusAtProviderPredefinedValuesKeyUsageBaseKeyUsage>,
    /// Detailed scenarios in which a key may be used.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub extended_key_usage:
        Option<CertificateTemplateStatusAtProviderPredefinedValuesKeyUsageExtendedKeyUsage>,
    /// Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub unknown_extended_key_usages: Option<
        Vec<CertificateTemplateStatusAtProviderPredefinedValuesKeyUsageUnknownExtendedKeyUsages>,
    >,
}
