...
pub struct DatasetForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deleteContentsOnDestroy"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "externalDatasetReference"
    )]
    #[builder(default)]
...
pub struct DatasetForProviderDefaultEncryptionConfiguration {
    ...
    #[builder(default)]
    pub kms_key_name_selector:
        Option<DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameSelector>,
}
...
pub struct DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<DatasetForProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicyResolve>,
}
...
pub struct DatasetInitProviderAccessDatasetDatasetDatasetIdSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatasetInitProviderAccessDatasetDatasetDatasetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DatasetInitProviderDefaultEncryptionConfiguration {
    ...
    #[builder(default)]
    pub kms_key_name_selector:
        Option<DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameSelector>,
}
...
pub struct DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameRefPolicyResolve>,
}
...
pub struct DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<DatasetInitProviderDefaultEncryptionConfigurationKmsKeyNameSelectorPolicyResolve>,
}
...
pub struct DatasetStatusAtProvider {
    ...
    pub default_encryption_configuration:
        Option<DatasetStatusAtProviderDefaultEncryptionConfiguration>,
    /// The default partition expiration for all partitioned tables in
    /// the dataset, in milliseconds.
    /// Once this property is set, all newly-created partitioned tables in
    /// the dataset will have an expirationMs property in the timePartitioning
