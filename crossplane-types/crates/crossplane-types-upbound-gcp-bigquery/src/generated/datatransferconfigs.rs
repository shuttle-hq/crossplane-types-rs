...
pub struct DataTransferConfigForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationDatasetIdRef"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationDatasetIdSelector"
    )]
    #[builder(default)]
    pub destination_dataset_id_selector:
        Option<DataTransferConfigForProviderDestinationDatasetIdSelector>,
...
pub struct DataTransferConfigForProviderDestinationDatasetIdSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DataTransferConfigForProviderDestinationDatasetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DataTransferConfigForProviderSensitiveParams {
    ...
    pub secret_access_key_secret_ref:
        Option<DataTransferConfigForProviderSensitiveParamsSecretAccessKeySecretRef>,
}
...
pub struct DataTransferConfigInitProvider {
    ...
    #[builder(default)]
    pub destination_dataset_id_selector:
        Option<DataTransferConfigInitProviderDestinationDatasetIdSelector>,
    /// When set to true, no runs are scheduled for a given transfer.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub disabled: Option<bool>,
...
pub struct DataTransferConfigInitProviderDestinationDatasetIdSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DataTransferConfigInitProviderDestinationDatasetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DataTransferConfigInitProviderSensitiveParams {
    ...
    pub secret_access_key_secret_ref:
        DataTransferConfigInitProviderSensitiveParamsSecretAccessKeySecretRef,
}
...
pub struct DataTransferConfigStatusAtProviderSensitiveParams {
    ...
    #[builder(default)]
    pub secret_access_key_secret_ref:
        Option<DataTransferConfigStatusAtProviderSensitiveParamsSecretAccessKeySecretRef>,
}
