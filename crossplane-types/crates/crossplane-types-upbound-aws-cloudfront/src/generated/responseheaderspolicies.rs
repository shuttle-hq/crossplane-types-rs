...
#[kube(group = "cloudfront.aws.upbound.io", version = "v1beta2", kind = "ResponseHeadersPolicy", plural = "responseheaderspolicies")]
...
pub struct ResponseHeadersPolicyForProvider {
    ...
    #[builder(default)]
    pub server_timing_headers_config: Option<ResponseHeadersPolicyForProviderServerTimingHeadersConfig>,
}
...
pub struct ResponseHeadersPolicyForProviderCorsConfig {
    ...
    #[builder(default)]
    pub access_control_allow_headers: Option<ResponseHeadersPolicyForProviderCorsConfigAccessControlAllowHeaders>,
    ...
    #[builder(default)]
    pub access_control_allow_methods: Option<ResponseHeadersPolicyForProviderCorsConfigAccessControlAllowMethods>,
    /// Object that contains an attribute items that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowOrigins")]
    #[builder(default)]
    pub access_control_allow_origins: Option<ResponseHeadersPolicyForProviderCorsConfigAccessControlAllowOrigins>,
    /// Object that contains an attribute items that contains a list of HTTP headers that CloudFront includes as values for the Access-Control-Expose-Headers HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlExposeHeaders")]
    #[builder(default)]
    pub access_control_expose_headers: Option<ResponseHeadersPolicyForProviderCorsConfigAccessControlExposeHeaders>,
...
pub struct ResponseHeadersPolicyForProviderSecurityHeadersConfig {
    ...
    #[builder(default)]
    pub content_security_policy: Option<ResponseHeadersPolicyForProviderSecurityHeadersConfigContentSecurityPolicy>,
    /// Determines whether CloudFront includes the X-Content-Type-Options HTTP response header with its value set to nosniff. See Content Type Options for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "contentTypeOptions")]
    #[builder(default)]
    pub content_type_options: Option<ResponseHeadersPolicyForProviderSecurityHeadersConfigContentTypeOptions>,
    ...
    #[builder(default)]
    pub referrer_policy: Option<ResponseHeadersPolicyForProviderSecurityHeadersConfigReferrerPolicy>,
    /// Determines whether CloudFront includes the Strict-Transport-Security HTTP response header and the header’s value. See Strict Transport Security for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "strictTransportSecurity")]
    #[builder(default)]
    pub strict_transport_security: Option<ResponseHeadersPolicyForProviderSecurityHeadersConfigStrictTransportSecurity>,
...
pub struct ResponseHeadersPolicyInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverTimingHeadersConfig")]
    #[builder(default)]
    pub server_timing_headers_config: Option<ResponseHeadersPolicyInitProviderServerTimingHeadersConfig>,
}
...
pub struct ResponseHeadersPolicyInitProviderCorsConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowHeaders")]
    #[builder(default)]
    pub access_control_allow_headers: Option<ResponseHeadersPolicyInitProviderCorsConfigAccessControlAllowHeaders>,
    /// Object that contains an attribute items that contains a list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header. Valid values: GET | POST | OPTIONS | PUT | DELETE | HEAD | ALL
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowMethods")]
    #[builder(default)]
    pub access_control_allow_methods: Option<ResponseHeadersPolicyInitProviderCorsConfigAccessControlAllowMethods>,
    /// Object that contains an attribute items that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowOrigins")]
    #[builder(default)]
    pub access_control_allow_origins: Option<ResponseHeadersPolicyInitProviderCorsConfigAccessControlAllowOrigins>,
    /// Object that contains an attribute items that contains a list of HTTP headers that CloudFront includes as values for the Access-Control-Expose-Headers HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlExposeHeaders")]
    #[builder(default)]
    pub access_control_expose_headers: Option<ResponseHeadersPolicyInitProviderCorsConfigAccessControlExposeHeaders>,
    /// A number that CloudFront uses as the value for the Access-Control-Max-Age HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlMaxAgeSec")]
    #[builder(default)]
    pub access_control_max_age_sec: Option<f64>,
...
pub struct ResponseHeadersPolicyInitProviderSecurityHeadersConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "contentSecurityPolicy")]
    #[builder(default)]
    pub content_security_policy: Option<ResponseHeadersPolicyInitProviderSecurityHeadersConfigContentSecurityPolicy>,
    /// Determines whether CloudFront includes the X-Content-Type-Options HTTP response header with its value set to nosniff. See Content Type Options for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "contentTypeOptions")]
    #[builder(default)]
    pub content_type_options: Option<ResponseHeadersPolicyInitProviderSecurityHeadersConfigContentTypeOptions>,
    /// Determines whether CloudFront includes the X-Frame-Options HTTP response header and the header’s value. See Frame Options for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameOptions")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "referrerPolicy")]
    #[builder(default)]
    pub referrer_policy: Option<ResponseHeadersPolicyInitProviderSecurityHeadersConfigReferrerPolicy>,
    /// Determines whether CloudFront includes the Strict-Transport-Security HTTP response header and the header’s value. See Strict Transport Security for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "strictTransportSecurity")]
    #[builder(default)]
    pub strict_transport_security: Option<ResponseHeadersPolicyInitProviderSecurityHeadersConfigStrictTransportSecurity>,
    /// Determine whether CloudFront includes the X-XSS-Protection HTTP response header and the header’s value. See XSS Protection for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "xssProtection")]
    #[builder(default)]
...
pub struct ResponseHeadersPolicyPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ResponseHeadersPolicyPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ResponseHeadersPolicyStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverTimingHeadersConfig")]
    #[builder(default)]
    pub server_timing_headers_config: Option<ResponseHeadersPolicyStatusAtProviderServerTimingHeadersConfig>,
}
...
pub struct ResponseHeadersPolicyStatusAtProviderCorsConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowHeaders")]
    #[builder(default)]
    pub access_control_allow_headers: Option<ResponseHeadersPolicyStatusAtProviderCorsConfigAccessControlAllowHeaders>,
    /// Object that contains an attribute items that contains a list of HTTP methods that CloudFront includes as values for the Access-Control-Allow-Methods HTTP response header. Valid values: GET | POST | OPTIONS | PUT | DELETE | HEAD | ALL
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowMethods")]
    #[builder(default)]
    pub access_control_allow_methods: Option<ResponseHeadersPolicyStatusAtProviderCorsConfigAccessControlAllowMethods>,
    /// Object that contains an attribute items that contains a list of origins that CloudFront can use as the value for the Access-Control-Allow-Origin HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlAllowOrigins")]
    #[builder(default)]
    pub access_control_allow_origins: Option<ResponseHeadersPolicyStatusAtProviderCorsConfigAccessControlAllowOrigins>,
    /// Object that contains an attribute items that contains a list of HTTP headers that CloudFront includes as values for the Access-Control-Expose-Headers HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlExposeHeaders")]
    #[builder(default)]
    pub access_control_expose_headers: Option<ResponseHeadersPolicyStatusAtProviderCorsConfigAccessControlExposeHeaders>,
    /// A number that CloudFront uses as the value for the Access-Control-Max-Age HTTP response header.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlMaxAgeSec")]
    #[builder(default)]
    pub access_control_max_age_sec: Option<f64>,
...
pub struct ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "contentSecurityPolicy")]
    #[builder(default)]
    pub content_security_policy: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigContentSecurityPolicy>,
    /// Determines whether CloudFront includes the X-Content-Type-Options HTTP response header with its value set to nosniff. See Content Type Options for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "contentTypeOptions")]
    #[builder(default)]
    pub content_type_options: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigContentTypeOptions>,
    /// Determines whether CloudFront includes the X-Frame-Options HTTP response header and the header’s value. See Frame Options for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameOptions")]
    #[builder(default)]
    pub frame_options: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigFrameOptions>,
    /// Determines whether CloudFront includes the Referrer-Policy HTTP response header and the header’s value. See Referrer Policy for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "referrerPolicy")]
    #[builder(default)]
    pub referrer_policy: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigReferrerPolicy>,
    /// Determines whether CloudFront includes the Strict-Transport-Security HTTP response header and the header’s value. See Strict Transport Security for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "strictTransportSecurity")]
    #[builder(default)]
    pub strict_transport_security: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigStrictTransportSecurity>,
    /// Determine whether CloudFront includes the X-XSS-Protection HTTP response header and the header’s value. See XSS Protection for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "xssProtection")]
    #[builder(default)]
    pub xss_protection: Option<ResponseHeadersPolicyStatusAtProviderSecurityHeadersConfigXssProtection>,
}
