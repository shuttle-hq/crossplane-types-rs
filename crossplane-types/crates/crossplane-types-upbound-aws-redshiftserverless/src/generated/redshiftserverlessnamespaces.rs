...
#[kube(group = "redshiftserverless.aws.upbound.io", version = "v1beta1", kind = "RedshiftServerlessNamespace", plural = "redshiftserverlessnamespaces")]
...
pub struct RedshiftServerlessNamespaceSpec {
    ...
    #[builder(default)]
    pub publish_connection_details_to: Option<RedshiftServerlessNamespacePublishConnectionDetailsTo>,
    ...
    #[builder(default)]
    pub write_connection_secret_to_ref: Option<RedshiftServerlessNamespaceWriteConnectionSecretToRef>,
}
...
pub struct RedshiftServerlessNamespaceForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminPasswordSecretKmsKeyId")]
    #[builder(default)]
    pub admin_password_secret_kms_key_id: Option<String>,
    /// The password of the administrator for the first database created in the namespace.
    /// Conflicts with manage_admin_password.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminUserPasswordSecretRef")]
    #[builder(default)]
    pub admin_user_password_secret_ref: Option<RedshiftServerlessNamespaceForProviderAdminUserPasswordSecretRef>,
    /// The username of the administrator for the first database created in the namespace.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminUsernameSecretRef")]
    #[builder(default)]
    pub admin_username_secret_ref: Option<RedshiftServerlessNamespaceForProviderAdminUsernameSecretRef>,
    ...
    #[builder(default)]
    pub default_iam_role_arn_ref: Option<RedshiftServerlessNamespaceForProviderDefaultIamRoleArnRef>,
    ...
    #[builder(default)]
    pub default_iam_role_arn_selector: Option<RedshiftServerlessNamespaceForProviderDefaultIamRoleArnSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "manageAdminPassword")]
    #[builder(default)]
...
pub struct RedshiftServerlessNamespaceForProviderDefaultIamRoleArnRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RedshiftServerlessNamespaceForProviderDefaultIamRoleArnRefPolicyResolution>,
...
pub struct RedshiftServerlessNamespaceForProviderDefaultIamRoleArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RedshiftServerlessNamespaceForProviderDefaultIamRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<RedshiftServerlessNamespaceForProviderDefaultIamRoleArnSelectorPolicyResolve>,
}
...
pub struct RedshiftServerlessNamespaceInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminUserPasswordSecretRef")]
    #[builder(default)]
    pub admin_user_password_secret_ref: Option<RedshiftServerlessNamespaceInitProviderAdminUserPasswordSecretRef>,
    /// The username of the administrator for the first database created in the namespace.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminUsernameSecretRef")]
    #[builder(default)]
    pub admin_username_secret_ref: Option<RedshiftServerlessNamespaceInitProviderAdminUsernameSecretRef>,
    /// The name of the first database created in the namespace.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbName")]
    #[builder(default)]
    pub db_name: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultIamRoleArnRef")]
    #[builder(default)]
    pub default_iam_role_arn_ref: Option<RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnRef>,
    /// Selector for a Role in iam to populate defaultIamRoleArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultIamRoleArnSelector")]
    #[builder(default)]
    pub default_iam_role_arn_selector: Option<RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnSelector>,
    /// References to Role in iam to populate iamRoles.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "iamRoleRefs")]
    #[builder(default)]
...
pub struct RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<RedshiftServerlessNamespaceInitProviderDefaultIamRoleArnSelectorPolicyResolve>,
}
...
pub struct RedshiftServerlessNamespacePublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RedshiftServerlessNamespacePublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<RedshiftServerlessNamespacePublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct RedshiftServerlessNamespaceStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminPasswordSecretArn")]
    #[builder(default)]
