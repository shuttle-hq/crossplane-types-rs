...
pub struct AppProfileForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataBoostIsolationReadOnly"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multiClusterRoutingClusterIds"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multiClusterRoutingUseAny"
    )]
    #[builder(default)]
...
pub struct AppProfileForProviderSingleClusterRouting {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "allowTransactionalWrites"
    )]
    #[builder(default)]
...
pub struct AppProfileStatusAtProvider {
    ...
    #[builder(default)]
    pub data_boost_isolation_read_only:
        Option<AppProfileStatusAtProviderDataBoostIsolationReadOnly>,
    /// Long form description of the use case for this app profile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub description: Option<String>,
