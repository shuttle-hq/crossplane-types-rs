...
#[kube(group = "s3control.aws.upbound.io", version = "v1beta2", kind = "ObjectLambdaAccessPoint", plural = "objectlambdaaccesspoints")]
...
pub struct ObjectLambdaAccessPointForProviderConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowedFeatures")]
    #[builder(default)]
    pub allowed_features: Option<Vec<String>>,
    /// Whether or not the CloudWatch metrics configuration is enabled.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudWatchMetricsEnabled")]
    #[builder(default)]
    pub cloud_watch_metrics_enabled: Option<bool>,
    /// Standard access point associated with the Object Lambda Access Point.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportingAccessPoint")]
    #[builder(default)]
    pub supporting_access_point: Option<String>,
    /// Reference to a AccessPoint in s3control to populate supportingAccessPoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportingAccessPointRef")]
    #[builder(default)]
    pub supporting_access_point_ref: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRef>,
    /// Selector for a AccessPoint in s3control to populate supportingAccessPoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportingAccessPointSelector")]
    #[builder(default)]
    pub supporting_access_point_selector: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointSelector>,
    /// List of transformation configurations for the Object Lambda Access Point. See Transformation Configuration below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transformationConfiguration")]
    #[builder(default)]
    pub transformation_configuration: Option<Vec<ObjectLambdaAccessPointForProviderConfigurationTransformationConfiguration>>,
}
...
pub struct ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRefPolicy>,
}
...
pub struct ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRefPolicyResolution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointRefPolicyResolve>,
}
...
pub struct ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<ObjectLambdaAccessPointForProviderConfigurationSupportingAccessPointSelectorPolicy>,
}
...
pub struct ObjectLambdaAccessPointInitProviderConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportingAccessPointRef")]
    #[builder(default)]
    pub supporting_access_point_ref: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRef>,
    /// Selector for a AccessPoint in s3control to populate supportingAccessPoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportingAccessPointSelector")]
    #[builder(default)]
    pub supporting_access_point_selector: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointSelector>,
    /// List of transformation configurations for the Object Lambda Access Point. See Transformation Configuration below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transformationConfiguration")]
    #[builder(default)]
    pub transformation_configuration: Option<Vec<ObjectLambdaAccessPointInitProviderConfigurationTransformationConfiguration>>,
}
...
pub struct ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRefPolicy>,
}
...
pub struct ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointRefPolicyResolve>,
}
...
pub struct ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<ObjectLambdaAccessPointInitProviderConfigurationSupportingAccessPointSelectorPolicy>,
}
...
pub struct ObjectLambdaAccessPointPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ObjectLambdaAccessPointPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ObjectLambdaAccessPointStatusAtProviderConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transformationConfiguration")]
    #[builder(default)]
    pub transformation_configuration: Option<Vec<ObjectLambdaAccessPointStatusAtProviderConfigurationTransformationConfiguration>>,
}
