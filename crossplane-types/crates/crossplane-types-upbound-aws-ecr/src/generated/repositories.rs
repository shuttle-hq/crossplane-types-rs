...
#[kube(group = "ecr.aws.upbound.io", version = "v1beta2", kind = "Repository", plural = "repositories")]
...
pub struct RepositoryForProviderEncryptionConfigurationKmsKeySelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RepositoryForProviderEncryptionConfigurationKmsKeySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct RepositoryInitProviderEncryptionConfigurationKmsKeySelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RepositoryInitProviderEncryptionConfigurationKmsKeySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
