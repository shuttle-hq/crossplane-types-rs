...
#[kube(group = "lightsail.aws.upbound.io", version = "v1beta1", kind = "LB", plural = "lbs")]
...
pub struct LBStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicPorts")]
    #[builder(default)]
    pub public_ports: Option<Vec<f64>>,
