...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta1", kind = "VPCEndpointSecurityGroupAssociation", plural = "vpcendpointsecuritygroupassociations")]
...
pub struct VPCEndpointSecurityGroupAssociationSpec {
    ...
    #[builder(default)]
    pub publish_connection_details_to: Option<VPCEndpointSecurityGroupAssociationPublishConnectionDetailsTo>,
    ...
    #[builder(default)]
    pub write_connection_secret_to_ref: Option<VPCEndpointSecurityGroupAssociationWriteConnectionSecretToRef>,
}
...
pub struct VPCEndpointSecurityGroupAssociationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replaceDefaultAssociation")]
    #[builder(default)]
    ...
    #[builder(default)]
    pub security_group_id_ref: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdRef>,
    ...
    #[builder(default)]
    pub security_group_id_selector: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdSelector>,
    ...
    #[builder(default)]
    pub vpc_endpoint_id_selector: Option<VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdSelector>,
}
...
pub struct VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdRefPolicyResolution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdRefPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationForProviderSecurityGroupIdSelectorPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdRefPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationForProviderVpcEndpointIdSelectorPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIdRef")]
    #[builder(default)]
    pub security_group_id_ref: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdRef>,
    /// Selector for a SecurityGroup in ec2 to populate securityGroupId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIdSelector")]
    #[builder(default)]
    pub security_group_id_selector: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelector>,
    /// The ID of the VPC endpoint with which the security group will be associated.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcEndpointId")]
    #[builder(default)]
    pub vpc_endpoint_id: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcEndpointIdRef")]
    #[builder(default)]
    pub vpc_endpoint_id_ref: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdRef>,
    /// Selector for a VPCEndpoint in ec2 to populate vpcEndpointId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcEndpointIdSelector")]
    #[builder(default)]
    pub vpc_endpoint_id_selector: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdSelector>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdRefPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelectorPolicy>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationInitProviderSecurityGroupIdSelectorPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdRefPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationInitProviderVpcEndpointIdSelectorPolicyResolve>,
}
...
pub struct VPCEndpointSecurityGroupAssociationPublishConnectionDetailsToConfigRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<VPCEndpointSecurityGroupAssociationPublishConnectionDetailsToConfigRefPolicy>,
}
...
pub struct VPCEndpointSecurityGroupAssociationPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<VPCEndpointSecurityGroupAssociationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<VPCEndpointSecurityGroupAssociationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
