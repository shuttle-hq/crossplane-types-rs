...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta2", kind = "Instance", plural = "instances")]
...
pub struct InstanceForProvider {
    ...
    #[builder(default)]
    pub capacity_reservation_specification: Option<InstanceForProviderCapacityReservationSpecification>,
...
pub struct InstanceForProviderCapacityReservationSpecification {
    ...
    #[builder(default)]
    pub capacity_reservation_target: Option<InstanceForProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
...
pub struct InstanceForProviderNetworkInterface {
    ...
    #[builder(default)]
    pub network_interface_id_selector: Option<InstanceForProviderNetworkInterfaceNetworkInterfaceIdSelector>,
}
...
pub struct InstanceForProviderNetworkInterfaceNetworkInterfaceIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<InstanceForProviderNetworkInterfaceNetworkInterfaceIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct InstanceForProviderNetworkInterfaceNetworkInterfaceIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<InstanceForProviderNetworkInterfaceNetworkInterfaceIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct InstanceInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationSpecification")]
    #[builder(default)]
    pub capacity_reservation_specification: Option<InstanceInitProviderCapacityReservationSpecification>,
    /// Sets the number of CPU cores for an instance. This option is only supported on creation of instance type that support CPU Options CPU Cores and Threads Per CPU Core Per Instance Type - specifying this option for unsupported instance types will return an error from the EC2 API.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuCoreCount")]
    #[builder(default)]
    pub cpu_core_count: Option<f64>,
...
pub struct InstanceInitProviderCapacityReservationSpecification {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationTarget")]
    #[builder(default)]
    pub capacity_reservation_target: Option<InstanceInitProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
...
pub struct InstanceInitProviderNetworkInterface {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceIdSelector")]
    #[builder(default)]
    pub network_interface_id_selector: Option<InstanceInitProviderNetworkInterfaceNetworkInterfaceIdSelector>,
}
...
pub struct InstanceInitProviderNetworkInterfaceNetworkInterfaceIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<InstanceInitProviderNetworkInterfaceNetworkInterfaceIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct InstanceInitProviderNetworkInterfaceNetworkInterfaceIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<InstanceInitProviderNetworkInterfaceNetworkInterfaceIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<InstanceInitProviderNetworkInterfaceNetworkInterfaceIdSelectorPolicyResolve>,
}
...
pub struct InstanceStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationSpecification")]
    #[builder(default)]
    pub capacity_reservation_specification: Option<InstanceStatusAtProviderCapacityReservationSpecification>,
    /// Sets the number of CPU cores for an instance. This option is only supported on creation of instance type that support CPU Options CPU Cores and Threads Per CPU Core Per Instance Type - specifying this option for unsupported instance types will return an error from the EC2 API.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuCoreCount")]
    #[builder(default)]
    pub cpu_core_count: Option<f64>,
...
pub struct InstanceStatusAtProviderCapacityReservationSpecification {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationTarget")]
    #[builder(default)]
    pub capacity_reservation_target: Option<InstanceStatusAtProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
