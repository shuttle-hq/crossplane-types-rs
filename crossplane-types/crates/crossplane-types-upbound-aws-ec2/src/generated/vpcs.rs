...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta1", kind = "VPC", plural = "vpcs")]
...
pub struct VPCForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4IpamPoolIdRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4IpamPoolIdSelector")]
    #[builder(default)]
