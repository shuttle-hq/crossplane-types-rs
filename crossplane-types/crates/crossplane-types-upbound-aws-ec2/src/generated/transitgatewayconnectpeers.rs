...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta1", kind = "TransitGatewayConnectPeer", plural = "transitgatewayconnectpeers")]
...
pub struct TransitGatewayConnectPeerForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitGatewayAddress")]
    #[builder(default)]
    ...
    #[builder(default)]
    pub transit_gateway_attachment_id_ref: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdRef>,
    ...
    #[builder(default)]
    pub transit_gateway_attachment_id_selector: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelector>,
}
...
pub struct TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdRefPolicyResolution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdRefPolicyResolve>,
}
...
pub struct TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelectorPolicy>,
}
...
pub struct TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<TransitGatewayConnectPeerForProviderTransitGatewayAttachmentIdSelectorPolicyResolve>,
}
...
pub struct TransitGatewayConnectPeerInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitGatewayAttachmentIdRef")]
    #[builder(default)]
    pub transit_gateway_attachment_id_ref: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdRef>,
    /// Selector for a TransitGatewayConnect in ec2 to populate transitGatewayAttachmentId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitGatewayAttachmentIdSelector")]
    #[builder(default)]
    pub transit_gateway_attachment_id_selector: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelector>,
}
...
pub struct TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdRefPolicyResolve>,
}
...
pub struct TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelectorPolicy>,
}
...
pub struct TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<TransitGatewayConnectPeerInitProviderTransitGatewayAttachmentIdSelectorPolicyResolve>,
}
...
pub struct TransitGatewayConnectPeerPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<TransitGatewayConnectPeerPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectPeerStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bgpPeerAddress")]
    #[builder(default)]
    pub bgp_peer_address: Option<String>,
    /// The IP addresses assigned to Transit Gateway, which are used as BGP IP addresses.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bgpTransitGatewayAddresses")]
    #[builder(default)]
