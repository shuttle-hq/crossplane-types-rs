...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta2", kind = "LaunchTemplate", plural = "launchtemplates")]
...
pub struct LaunchTemplateForProvider {
    ...
    #[builder(default)]
    pub capacity_reservation_specification: Option<LaunchTemplateForProviderCapacityReservationSpecification>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "elasticGpuSpecifications")]
    #[builder(default)]
    pub elastic_gpu_specifications: Option<Vec<LaunchTemplateForProviderElasticGpuSpecifications>>,
    /// Configuration block containing an Elastic Inference Accelerator to attach to the instance. See Elastic Inference Accelerator below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "elasticInferenceAccelerator")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "licenseSpecification")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupNameRefs")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupNameSelector")]
    #[builder(default)]
    pub security_group_name_selector: Option<LaunchTemplateForProviderSecurityGroupNameSelector>,
    /// A list of security group names to associate with. If you are creating Instances in a VPC, use
    /// vpc_security_group_ids instead.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupNames")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "updateDefaultVersion")]
    #[builder(default)]
...
pub struct LaunchTemplateForProviderBlockDeviceMappingsEbs {
    ...
    #[builder(default)]
    pub kms_key_id_selector: Option<LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdSelector>,
...
pub struct LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdRefPolicyResolution>,
...
pub struct LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateForProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateForProviderCapacityReservationSpecification {
    ...
    #[builder(default)]
    pub capacity_reservation_target: Option<LaunchTemplateForProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
...
pub struct LaunchTemplateForProviderInstanceRequirements {
    ...
    #[builder(default)]
    pub accelerator_total_memory_mib: Option<LaunchTemplateForProviderInstanceRequirementsAcceleratorTotalMemoryMib>,
    ...
    #[builder(default)]
    pub baseline_ebs_bandwidth_mbps: Option<LaunchTemplateForProviderInstanceRequirementsBaselineEbsBandwidthMbps>,
    ...
    #[builder(default)]
    pub network_bandwidth_gbps: Option<LaunchTemplateForProviderInstanceRequirementsNetworkBandwidthGbps>,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceCount")]
    #[builder(default)]
    pub network_interface_count: Option<LaunchTemplateForProviderInstanceRequirementsNetworkInterfaceCount>,
    ...
    #[builder(default)]
    pub total_local_storage_gb: Option<LaunchTemplateForProviderInstanceRequirementsTotalLocalStorageGb>,
...
pub struct LaunchTemplateForProviderNetworkInterfaces {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4AddressCount")]
    #[builder(default)]
    pub ipv4_address_count: Option<f64>,
    /// One or more private IPv4 addresses to associate. Conflicts with ipv4_address_count
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipv4Addresses")]
    #[builder(default)]
    ...
    #[builder(default)]
    pub network_interface_id_ref: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdRef>,
    ...
    #[builder(default)]
    pub network_interface_id_selector: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdSelector>,
    /// Whether the first IPv6 GUA will be made the primary IPv6 address.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "primaryIpv6")]
    #[builder(default)]
    ...
    #[builder(default)]
    pub security_group_refs: Option<Vec<LaunchTemplateForProviderNetworkInterfacesSecurityGroupRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroups.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupSelector")]
    #[builder(default)]
    pub security_group_selector: Option<LaunchTemplateForProviderNetworkInterfacesSecurityGroupSelector>,
...
pub struct LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdRefPolicyResolve>,
}
...
pub struct LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateForProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateForProviderNetworkInterfacesSecurityGroupRefsPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderNetworkInterfacesSecurityGroupRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateForProviderNetworkInterfacesSecurityGroupSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderNetworkInterfacesSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateForProviderNetworkInterfacesSecurityGroupSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateForProviderNetworkInterfacesSubnetIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateForProviderNetworkInterfacesSubnetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationSpecification")]
    #[builder(default)]
    pub capacity_reservation_specification: Option<LaunchTemplateInitProviderCapacityReservationSpecification>,
    /// The CPU options for the instance. See CPU Options below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuOptions")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "elasticInferenceAccelerator")]
    #[builder(default)]
    pub elastic_inference_accelerator: Option<LaunchTemplateInitProviderElasticInferenceAccelerator>,
    /// Enable Nitro Enclaves on launched instances. See Enclave Options below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enclaveOptions")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSecurityGroupIdSelector")]
    #[builder(default)]
    pub vpc_security_group_id_selector: Option<LaunchTemplateInitProviderVpcSecurityGroupIdSelector>,
    /// A list of security group IDs to associate with. Conflicts with network_interfaces.security_groups
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSecurityGroupIds")]
    #[builder(default)]
    pub vpc_security_group_ids: Option<Vec<String>>,
...
pub struct LaunchTemplateInitProviderBlockDeviceMappingsEbs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyIdSelector")]
    #[builder(default)]
    pub kms_key_id_selector: Option<LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdSelector>,
    /// The Snapshot ID to mount.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snapshotId")]
    #[builder(default)]
    pub snapshot_id: Option<String>,
...
pub struct LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateInitProviderBlockDeviceMappingsEbsKmsKeyIdSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateInitProviderCapacityReservationSpecification {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationTarget")]
    #[builder(default)]
    pub capacity_reservation_target: Option<LaunchTemplateInitProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
...
pub struct LaunchTemplateInitProviderIamInstanceProfileNameSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderIamInstanceProfileNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateInitProviderInstanceRequirements {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorTotalMemoryMib")]
    #[builder(default)]
    pub accelerator_total_memory_mib: Option<LaunchTemplateInitProviderInstanceRequirementsAcceleratorTotalMemoryMib>,
    /// List of accelerator types. Default is any accelerator type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorTypes")]
    #[builder(default)]
    pub accelerator_types: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baselineEbsBandwidthMbps")]
    #[builder(default)]
    pub baseline_ebs_bandwidth_mbps: Option<LaunchTemplateInitProviderInstanceRequirementsBaselineEbsBandwidthMbps>,
    /// Indicate whether burstable performance instance types should be included, excluded, or required. Default is excluded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "burstablePerformance")]
    #[builder(default)]
    pub burstable_performance: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkBandwidthGbps")]
    #[builder(default)]
    pub network_bandwidth_gbps: Option<LaunchTemplateInitProviderInstanceRequirementsNetworkBandwidthGbps>,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceCount")]
    #[builder(default)]
    pub network_interface_count: Option<LaunchTemplateInitProviderInstanceRequirementsNetworkInterfaceCount>,
    /// The price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 20.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDemandMaxPricePercentageOverLowestPrice")]
    #[builder(default)]
    pub on_demand_max_price_percentage_over_lowest_price: Option<f64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "totalLocalStorageGb")]
    #[builder(default)]
    pub total_local_storage_gb: Option<LaunchTemplateInitProviderInstanceRequirementsTotalLocalStorageGb>,
    /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vcpuCount")]
    #[builder(default)]
...
pub struct LaunchTemplateInitProviderNetworkInterfaces {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceIdRef")]
    #[builder(default)]
    pub network_interface_id_ref: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdRef>,
    /// Selector for a NetworkInterface in ec2 to populate networkInterfaceId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceIdSelector")]
    #[builder(default)]
    pub network_interface_id_selector: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdSelector>,
    /// Whether the first IPv6 GUA will be made the primary IPv6 address.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "primaryIpv6")]
    #[builder(default)]
    pub primary_ipv6: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupRefs")]
    #[builder(default)]
    pub security_group_refs: Option<Vec<LaunchTemplateInitProviderNetworkInterfacesSecurityGroupRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroups.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupSelector")]
    #[builder(default)]
    pub security_group_selector: Option<LaunchTemplateInitProviderNetworkInterfacesSecurityGroupSelector>,
    /// A list of security group IDs to associate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    #[builder(default)]
    pub security_groups: Option<Vec<String>>,
...
pub struct LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdRefPolicyResolve>,
}
...
pub struct LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateInitProviderNetworkInterfacesNetworkInterfaceIdSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateInitProviderNetworkInterfacesSecurityGroupRefsPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderNetworkInterfacesSecurityGroupRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateInitProviderNetworkInterfacesSecurityGroupSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderNetworkInterfacesSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LaunchTemplateInitProviderNetworkInterfacesSecurityGroupSelectorPolicyResolve>,
}
...
pub struct LaunchTemplateInitProviderNetworkInterfacesSubnetIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LaunchTemplateInitProviderNetworkInterfacesSubnetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LaunchTemplateStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationSpecification")]
    #[builder(default)]
    pub capacity_reservation_specification: Option<LaunchTemplateStatusAtProviderCapacityReservationSpecification>,
    /// The CPU options for the instance. See CPU Options below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuOptions")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "elasticGpuSpecifications")]
    #[builder(default)]
    pub elastic_gpu_specifications: Option<Vec<LaunchTemplateStatusAtProviderElasticGpuSpecifications>>,
    /// Configuration block containing an Elastic Inference Accelerator to attach to the instance. See Elastic Inference Accelerator below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "elasticInferenceAccelerator")]
    #[builder(default)]
    pub elastic_inference_accelerator: Option<LaunchTemplateStatusAtProviderElasticInferenceAccelerator>,
    /// Enable Nitro Enclaves on launched instances. See Enclave Options below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enclaveOptions")]
    #[builder(default)]
...
pub struct LaunchTemplateStatusAtProviderCapacityReservationSpecification {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityReservationTarget")]
    #[builder(default)]
    pub capacity_reservation_target: Option<LaunchTemplateStatusAtProviderCapacityReservationSpecificationCapacityReservationTarget>,
}
...
pub struct LaunchTemplateStatusAtProviderInstanceRequirements {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorCount")]
    #[builder(default)]
    pub accelerator_count: Option<LaunchTemplateStatusAtProviderInstanceRequirementsAcceleratorCount>,
    /// List of accelerator manufacturer names. Default is any manufacturer.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorManufacturers")]
    #[builder(default)]
    pub accelerator_manufacturers: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorTotalMemoryMib")]
    #[builder(default)]
    pub accelerator_total_memory_mib: Option<LaunchTemplateStatusAtProviderInstanceRequirementsAcceleratorTotalMemoryMib>,
    /// List of accelerator types. Default is any accelerator type.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "acceleratorTypes")]
    #[builder(default)]
    pub accelerator_types: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baselineEbsBandwidthMbps")]
    #[builder(default)]
    pub baseline_ebs_bandwidth_mbps: Option<LaunchTemplateStatusAtProviderInstanceRequirementsBaselineEbsBandwidthMbps>,
    /// Indicate whether burstable performance instance types should be included, excluded, or required. Default is excluded.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "burstablePerformance")]
    #[builder(default)]
    pub burstable_performance: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryGibPerVcpu")]
    #[builder(default)]
    pub memory_gib_per_vcpu: Option<LaunchTemplateStatusAtProviderInstanceRequirementsMemoryGibPerVcpu>,
    /// Block describing the minimum and maximum amount of memory (MiB). Default is no maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryMib")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkBandwidthGbps")]
    #[builder(default)]
    pub network_bandwidth_gbps: Option<LaunchTemplateStatusAtProviderInstanceRequirementsNetworkBandwidthGbps>,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInterfaceCount")]
    #[builder(default)]
    pub network_interface_count: Option<LaunchTemplateStatusAtProviderInstanceRequirementsNetworkInterfaceCount>,
    /// The price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 20.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDemandMaxPricePercentageOverLowestPrice")]
    #[builder(default)]
    pub on_demand_max_price_percentage_over_lowest_price: Option<f64>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "totalLocalStorageGb")]
    #[builder(default)]
    pub total_local_storage_gb: Option<LaunchTemplateStatusAtProviderInstanceRequirementsTotalLocalStorageGb>,
    /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vcpuCount")]
    #[builder(default)]
