...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta1", kind = "VPCIpamPool", plural = "vpcipampools")]
...
pub struct VPCIpamPoolForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocationDefaultNetmaskLength")]
    #[builder(default)]
    pub allocation_default_netmask_length: Option<f64>,
    /// The maximum netmask length that will be required for CIDR allocations in this pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocationMaxNetmaskLength")]
    #[builder(default)]
    pub allocation_max_netmask_length: Option<f64>,
    /// The minimum netmask length that will be required for CIDR allocations in this pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocationMinNetmaskLength")]
    #[builder(default)]
    pub allocation_min_netmask_length: Option<f64>,
    /// Tags that are required for resources that use CIDRs from this IPAM pool. Resources that do not have these tags will not be allowed to allocate space from the pool. If the resources have their tags changed after they have allocated space or if the allocation tagging requirements are changed on the pool, the resource may be marked as noncompliant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allocationResourceTags")]
    #[builder(default)]
    pub allocation_resource_tags: Option<HashMap<String, String>>,
    /// If you include this argument, IPAM automatically imports any VPCs you have in your scope that fall
    /// within the CIDR range in the pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoImport")]
    #[builder(default)]
    pub auto_import: Option<bool>,
    /// Limits which AWS service the pool can be used in. Only useable on public scopes. Valid Values: ec2.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsService")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipamScopeId")]
    #[builder(default)]
    pub ipam_scope_id: Option<String>,
    /// Reference to a VPCIpamScope in ec2 to populate ipamScopeId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipamScopeIdRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ipamScopeIdSelector")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicIpSource")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publiclyAdvertisable")]
    #[builder(default)]
    pub publicly_advertisable: Option<bool>,
    /// Region is the region you'd like your resource to be created in.
    pub region: String,
    /// The ID of the source IPAM pool. Use this argument to create a child pool within an existing pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIpamPoolId")]
    #[builder(default)]
    pub source_ipam_pool_id: Option<String>,
    /// Reference to a VPCIpamPool in ec2 to populate sourceIpamPoolId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIpamPoolIdRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIpamPoolIdSelector")]
    #[builder(default)]
