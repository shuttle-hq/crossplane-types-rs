...
pub struct DatabaseInstanceForProviderReplicaConfiguration {
    ...
    pub password_secret_ref:
        Option<DatabaseInstanceForProviderReplicaConfigurationPasswordSecretRef>,
...
pub struct DatabaseInstanceForProviderSettings {
    ...
    pub advanced_machine_features:
        Option<DatabaseInstanceForProviderSettingsAdvancedMachineFeatures>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "enableDataplexIntegration"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "enableGoogleMlIntegration"
    )]
    #[builder(default)]
    ...
    pub password_validation_policy:
        Option<DatabaseInstanceForProviderSettingsPasswordValidationPolicy>,
...
pub struct DatabaseInstanceForProviderSettingsBackupConfiguration {
    ...
    pub backup_retention_settings:
        Option<DatabaseInstanceForProviderSettingsBackupConfigurationBackupRetentionSettings>,
...
pub struct DatabaseInstanceForProviderSettingsIpConfiguration {
    ...
    pub authorized_networks:
        Option<Vec<DatabaseInstanceForProviderSettingsIpConfigurationAuthorizedNetworks>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "privateNetworkRef"
    )]
    #[builder(default)]
    pub private_network_ref:
        Option<DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkRef>,
    /// Selector for a Network in compute to populate privateNetwork.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "privateNetworkSelector"
    )]
    #[builder(default)]
    pub private_network_selector:
        Option<DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelector>,
...
pub struct DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkRefPolicyResolution>,
    ...
    #[builder(default)]
    pub resolve:
        Option<DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkRefPolicyResolve>,
}
...
pub struct DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelector {
    ...
    #[builder(default)]
    pub policy:
        Option<DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelectorPolicy>,
}
...
pub struct DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelectorPolicy {
    ...
    pub resolution: Option<
        DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default)]
    pub resolve: Option<
        DatabaseInstanceForProviderSettingsIpConfigurationPrivateNetworkSelectorPolicyResolve,
    >,
}
...
pub struct DatabaseInstanceForProviderSettingsIpConfigurationPscConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "allowedConsumerProjects"
    )]
    #[builder(default)]
...
pub struct DatabaseInstanceInitProviderReplicaConfiguration {
    ...
    #[builder(default)]
    pub password_secret_ref:
        Option<DatabaseInstanceInitProviderReplicaConfigurationPasswordSecretRef>,
    /// Permissible ciphers for use in SSL encryption.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslCipher")]
    #[builder(default)]
    pub ssl_cipher: Option<String>,
...
pub struct DatabaseInstanceInitProviderSettings {
    ...
    #[builder(default)]
    pub advanced_machine_features:
        Option<DatabaseInstanceInitProviderSettingsAdvancedMachineFeatures>,
    /// The availability type of the Cloud SQL
    /// instance, high availability (REGIONAL) or single zone (ZONAL).' For all instances, ensure that
    /// settings.backup_configuration.enabled is set to true.
    /// For MySQL instances, ensure that settings.backup_configuration.binary_log_enabled is set to true.
    ...
    #[builder(default)]
    pub password_validation_policy:
        Option<DatabaseInstanceInitProviderSettingsPasswordValidationPolicy>,
    /// Pricing plan for this instance, can only be PER_USE.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DatabaseInstanceInitProviderSettingsBackupConfiguration {
    ...
    #[builder(default)]
    pub backup_retention_settings:
        Option<DatabaseInstanceInitProviderSettingsBackupConfigurationBackupRetentionSettings>,
    /// True if binary logging is enabled.
    /// Can only be used with MySQL.
    #[serde(
        default,
...
pub struct DatabaseInstanceInitProviderSettingsIpConfiguration {
    ...
    #[builder(default)]
    pub authorized_networks:
        Option<Vec<DatabaseInstanceInitProviderSettingsIpConfigurationAuthorizedNetworks>>,
    /// Whether Google Cloud services such as BigQuery are allowed to access data in this Cloud SQL instance over a private IP connection. SQLSERVER database type is not supported.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub private_network_ref:
        Option<DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkRef>,
    /// Selector for a Network in compute to populate privateNetwork.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub private_network_selector:
        Option<DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelector>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pscConfig")]
    #[builder(default)]
...
pub struct DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkRefPolicy {
    ...
    #[builder(default)]
    pub resolution: Option<
        DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default)]
    pub resolve:
        Option<DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkRefPolicyResolve>,
}
...
pub struct DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelector {
    ...
    #[builder(default)]
    pub policy:
        Option<DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelectorPolicy>,
}
...
pub struct DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution: Option<
        DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default)]
    pub resolve: Option<
        DatabaseInstanceInitProviderSettingsIpConfigurationPrivateNetworkSelectorPolicyResolve,
    >,
}
...
pub struct DatabaseInstanceStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "pscServiceAttachmentLink"
    )]
    #[builder(default)]
...
pub struct DatabaseInstanceStatusAtProviderSettings {
    ...
    pub active_directory_config:
        Option<DatabaseInstanceStatusAtProviderSettingsActiveDirectoryConfig>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "advancedMachineFeatures"
    ...
    #[builder(default)]
    pub advanced_machine_features:
        Option<DatabaseInstanceStatusAtProviderSettingsAdvancedMachineFeatures>,
    /// The availability type of the Cloud SQL
    /// instance, high availability (REGIONAL) or single zone (ZONAL).' For all instances, ensure that
    /// settings.backup_configuration.enabled is set to true.
    /// For MySQL instances, ensure that settings.backup_configuration.binary_log_enabled is set to true.
    ...
    #[builder(default)]
    pub deny_maintenance_period:
        Option<DatabaseInstanceStatusAtProviderSettingsDenyMaintenancePeriod>,
    /// Enables auto-resizing of the storage size. Defaults to true. To avoid this, ensure that lifecycle.ignore_changes is applied to disk_size.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub password_validation_policy:
        Option<DatabaseInstanceStatusAtProviderSettingsPasswordValidationPolicy>,
    /// Pricing plan for this instance, can only be PER_USE.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub sql_server_audit_config:
        Option<DatabaseInstanceStatusAtProviderSettingsSqlServerAuditConfig>,
    /// The machine type to use. See tiers
    /// for more details and supported versions. Postgres supports only shared-core machine types,
    /// and custom machine types such as db-custom-2-13312. See the Custom Machine Type Documentation to learn about specifying custom machine types.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct DatabaseInstanceStatusAtProviderSettingsBackupConfiguration {
    ...
    #[builder(default)]
    pub backup_retention_settings:
        Option<DatabaseInstanceStatusAtProviderSettingsBackupConfigurationBackupRetentionSettings>,
    /// True if binary logging is enabled.
    /// Can only be used with MySQL.
    #[serde(
        default,
...
pub struct DatabaseInstanceStatusAtProviderSettingsIpConfiguration {
    ...
    #[builder(default)]
    pub authorized_networks:
        Option<Vec<DatabaseInstanceStatusAtProviderSettingsIpConfigurationAuthorizedNetworks>>,
    /// Whether Google Cloud services such as BigQuery are allowed to access data in this Cloud SQL instance over a private IP connection. SQLSERVER database type is not supported.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
