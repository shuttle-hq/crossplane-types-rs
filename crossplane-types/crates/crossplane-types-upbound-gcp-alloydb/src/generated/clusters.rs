...
pub struct ClusterForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maintenanceUpdatePolicy"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "restoreContinuousBackupSource"
    )]
    #[builder(default)]
...
pub struct ClusterForProviderAutomatedBackupPolicy {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "quantityBasedRetention"
    )]
    #[builder(default)]
    pub quantity_based_retention:
        Option<ClusterForProviderAutomatedBackupPolicyQuantityBasedRetention>,
    /// Time-based Backup retention policy. Conflicts with 'quantity_based_retention', both can't be set together.
    /// Structure is documented below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "timeBasedRetention"
    )]
    #[builder(default)]
...
pub struct ClusterForProviderMaintenanceUpdatePolicy {
    ...
    pub maintenance_windows:
        Option<Vec<ClusterForProviderMaintenanceUpdatePolicyMaintenanceWindows>>,
}
...
pub struct ClusterForProviderRestoreContinuousBackupSourceClusterRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterForProviderRestoreContinuousBackupSourceClusterRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterForProviderRestoreContinuousBackupSourceClusterSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterForProviderRestoreContinuousBackupSourceClusterSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterForProviderRestoreContinuousBackupSourceClusterSelectorPolicyResolve>,
}
...
pub struct ClusterForProviderSecondaryConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "primaryClusterNameSelector"
    )]
    #[builder(default)]
    pub primary_cluster_name_selector:
        Option<ClusterForProviderSecondaryConfigPrimaryClusterNameSelector>,
}
...
pub struct ClusterForProviderSecondaryConfigPrimaryClusterNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterForProviderSecondaryConfigPrimaryClusterNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInitProviderAutomatedBackupPolicy {
    ...
    #[builder(default)]
    pub quantity_based_retention:
        Option<ClusterInitProviderAutomatedBackupPolicyQuantityBasedRetention>,
    /// Time-based Backup retention policy. Conflicts with 'quantity_based_retention', both can't be set together.
    /// Structure is documented below.
    #[serde(
        default,
...
pub struct ClusterInitProviderMaintenanceUpdatePolicy {
    ...
    #[builder(default)]
    pub maintenance_windows:
        Option<Vec<ClusterInitProviderMaintenanceUpdatePolicyMaintenanceWindows>>,
}
...
pub struct ClusterInitProviderRestoreBackupSourceBackupNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInitProviderRestoreBackupSourceBackupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInitProviderRestoreContinuousBackupSourceClusterRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInitProviderRestoreContinuousBackupSourceClusterRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInitProviderRestoreContinuousBackupSourceClusterSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInitProviderRestoreContinuousBackupSourceClusterSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterInitProviderRestoreContinuousBackupSourceClusterSelectorPolicyResolve>,
}
...
pub struct ClusterInitProviderSecondaryConfig {
    ...
    #[builder(default)]
    pub primary_cluster_name_selector:
        Option<ClusterInitProviderSecondaryConfigPrimaryClusterNameSelector>,
}
...
pub struct ClusterInitProviderSecondaryConfigPrimaryClusterNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInitProviderSecondaryConfigPrimaryClusterNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterStatusAtProvider {
    ...
    #[builder(default)]
    pub restore_continuous_backup_source:
        Option<ClusterStatusAtProviderRestoreContinuousBackupSource>,
    /// Configuration of the secondary cluster for Cross Region Replication. This should be set if and only if the cluster is of type SECONDARY.
    /// Structure is documented below.
    #[serde(
        default,
...
pub struct ClusterStatusAtProviderAutomatedBackupPolicy {
    ...
    #[builder(default)]
    pub quantity_based_retention:
        Option<ClusterStatusAtProviderAutomatedBackupPolicyQuantityBasedRetention>,
    /// Time-based Backup retention policy. Conflicts with 'quantity_based_retention', both can't be set together.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub time_based_retention:
        Option<ClusterStatusAtProviderAutomatedBackupPolicyTimeBasedRetention>,
    /// Weekly schedule for the Backup.
    /// Structure is documented below.
    #[serde(
        default,
...
pub struct ClusterStatusAtProviderAutomatedBackupPolicyWeeklySchedule {
    ...
    #[builder(default)]
    pub start_times:
        Option<Vec<ClusterStatusAtProviderAutomatedBackupPolicyWeeklyScheduleStartTimes>>,
}
...
pub struct ClusterStatusAtProviderMaintenanceUpdatePolicy {
    ...
    #[builder(default)]
    pub maintenance_windows:
        Option<Vec<ClusterStatusAtProviderMaintenanceUpdatePolicyMaintenanceWindows>>,
}
...
pub struct ClusterStatusAtProviderMaintenanceUpdatePolicyMaintenanceWindows {
    ...
    #[builder(default)]
    pub start_time:
        Option<ClusterStatusAtProviderMaintenanceUpdatePolicyMaintenanceWindowsStartTime>,
}
