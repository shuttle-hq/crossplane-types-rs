...
#[kube(group = "ecrpublic.aws.upbound.io", version = "v1beta2", kind = "Repository", plural = "repositories")]
...
pub struct RepositoryForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "catalogData")]
    #[builder(default)]
...
pub struct RepositoryForProviderCatalogData {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logoImageBlob")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "operatingSystems")]
    #[builder(default)]
