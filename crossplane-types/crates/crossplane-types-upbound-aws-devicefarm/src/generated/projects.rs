...
#[kube(group = "devicefarm.aws.upbound.io", version = "v1beta1", kind = "Project", plural = "projects")]
...
pub struct ProjectForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultJobTimeoutMinutes")]
    #[builder(default)]
    pub default_job_timeout_minutes: Option<f64>,
