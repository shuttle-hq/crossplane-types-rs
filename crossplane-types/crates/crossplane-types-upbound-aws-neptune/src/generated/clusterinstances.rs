...
pub struct ClusterInstanceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "neptuneParameterGroupName"
    )]
    #[builder(default)]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "neptuneParameterGroupNameRef"
    )]
    #[builder(default)]
    pub neptune_parameter_group_name_ref:
        Option<ClusterInstanceForProviderNeptuneParameterGroupNameRef>,
    /// Selector for a ParameterGroup in neptune to populate neptuneParameterGroupName.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "neptuneParameterGroupNameSelector"
    )]
    #[builder(default)]
    pub neptune_parameter_group_name_selector:
        Option<ClusterInstanceForProviderNeptuneParameterGroupNameSelector>,
    ...
    pub neptune_subnet_group_name_selector:
        Option<ClusterInstanceForProviderNeptuneSubnetGroupNameSelector>,
...
pub struct ClusterInstanceForProviderNeptuneParameterGroupNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInstanceForProviderNeptuneParameterGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceForProviderNeptuneSubnetGroupNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInstanceForProviderNeptuneSubnetGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceInitProvider {
    ...
    #[builder(default)]
    pub neptune_parameter_group_name_ref:
        Option<ClusterInstanceInitProviderNeptuneParameterGroupNameRef>,
    /// Selector for a ParameterGroup in neptune to populate neptuneParameterGroupName.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub neptune_parameter_group_name_selector:
        Option<ClusterInstanceInitProviderNeptuneParameterGroupNameSelector>,
    /// A subnet group to associate with this neptune instance. NOTE: This must match the neptune_subnet_group_name of the attached aws_neptune_cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub neptune_subnet_group_name_selector:
        Option<ClusterInstanceInitProviderNeptuneSubnetGroupNameSelector>,
    /// The port on which the DB accepts connections. Defaults to 8182.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub port: Option<f64>,
...
pub struct ClusterInstanceInitProviderNeptuneParameterGroupNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInstanceInitProviderNeptuneParameterGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceInitProviderNeptuneSubnetGroupNameSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInstanceInitProviderNeptuneSubnetGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
