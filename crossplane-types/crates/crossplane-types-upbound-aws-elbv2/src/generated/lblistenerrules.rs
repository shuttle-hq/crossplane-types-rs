...
#[kube(group = "elbv2.aws.upbound.io", version = "v1beta2", kind = "LBListenerRule", plural = "lblistenerrules")]
...
pub struct LBListenerRuleForProviderActionAuthenticateCognito {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolArnRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolArnSelector")]
    #[builder(default)]
    pub user_pool_arn_selector: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolClientIdRef")]
    #[builder(default)]
    pub user_pool_client_id_ref: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdRef>,
    /// Selector for a UserPoolClient in cognitoidp to populate userPoolClientId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolClientIdSelector")]
    #[builder(default)]
    pub user_pool_client_id_selector: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolDomainRef")]
    #[builder(default)]
    pub user_pool_domain_ref: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainRef>,
    /// Selector for a UserPoolDomain in cognitoidp to populate userPoolDomain.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolDomainSelector")]
    #[builder(default)]
    pub user_pool_domain_selector: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelector>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnRefPolicyResolution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnRefPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolArnSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdRefPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicy>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainRefPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicy>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleForProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleForProviderActionAuthenticateOidc {
    ...
    #[builder(default)]
    pub client_secret_secret_ref: Option<LBListenerRuleForProviderActionAuthenticateOidcClientSecretSecretRef>,
...
pub struct LBListenerRuleForProviderActionForwardTargetGroupArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleForProviderActionForwardTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LBListenerRuleForProviderCondition {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpRequestMethod")]
    #[builder(default)]
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognito {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolArnRef")]
    #[builder(default)]
    pub user_pool_arn_ref: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnRef>,
    /// Selector for a UserPool in cognitoidp to populate userPoolArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolArnSelector")]
    #[builder(default)]
    pub user_pool_arn_selector: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelector>,
    /// The ID of the Cognito user pool client.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolClientId")]
    #[builder(default)]
    pub user_pool_client_id: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolClientIdRef")]
    #[builder(default)]
    pub user_pool_client_id_ref: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRef>,
    /// Selector for a UserPoolClient in cognitoidp to populate userPoolClientId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolClientIdSelector")]
    #[builder(default)]
    pub user_pool_client_id_selector: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelector>,
    /// The domain prefix or fully-qualified domain name of the Cognito user pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolDomain")]
    #[builder(default)]
    pub user_pool_domain: Option<String>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolDomainRef")]
    #[builder(default)]
    pub user_pool_domain_ref: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainRef>,
    /// Selector for a UserPoolDomain in cognitoidp to populate userPoolDomain.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPoolDomainSelector")]
    #[builder(default)]
    pub user_pool_domain_selector: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelector>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnRefPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelectorPolicy>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolArnSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRefPolicy>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdRefPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicy>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolClientIdSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainRefPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicy>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<LBListenerRuleInitProviderActionAuthenticateCognitoUserPoolDomainSelectorPolicyResolve>,
}
...
pub struct LBListenerRuleInitProviderActionAuthenticateOidc {
    ...
    pub client_secret_secret_ref: LBListenerRuleInitProviderActionAuthenticateOidcClientSecretSecretRef,
    /// The OIDC issuer identifier of the IdP.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub issuer: Option<String>,
...
pub struct LBListenerRuleInitProviderActionForwardTargetGroupArnRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionForwardTargetGroupArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LBListenerRuleInitProviderActionForwardTargetGroupArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<LBListenerRuleInitProviderActionForwardTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
