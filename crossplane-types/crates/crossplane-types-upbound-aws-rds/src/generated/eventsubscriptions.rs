...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "EventSubscription", plural = "eventsubscriptions")]
...
pub struct EventSubscriptionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventCategories")]
    #[builder(default)]
    ...
    #[builder(default)]
    pub sns_topic_ref: Option<EventSubscriptionForProviderSnsTopicRef>,
    /// Selector for a Topic in sns to populate snsTopic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsTopicSelector")]
    #[builder(default)]
    pub sns_topic_selector: Option<EventSubscriptionForProviderSnsTopicSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIdsRefs")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIdsSelector")]
    #[builder(default)]
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionForProviderSnsTopicRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<EventSubscriptionForProviderSnsTopicRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionForProviderSnsTopicRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<EventSubscriptionForProviderSnsTopicRefPolicyResolution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<EventSubscriptionForProviderSnsTopicRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionForProviderSnsTopicRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionForProviderSnsTopicRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionForProviderSnsTopicSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<EventSubscriptionForProviderSnsTopicSelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionForProviderSnsTopicSelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<EventSubscriptionForProviderSnsTopicSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<EventSubscriptionForProviderSnsTopicSelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionForProviderSnsTopicSelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionForProviderSnsTopicSelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct EventSubscriptionInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsTopicRef")]
    #[builder(default)]
    pub sns_topic_ref: Option<EventSubscriptionInitProviderSnsTopicRef>,
    /// Selector for a Topic in sns to populate snsTopic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsTopicSelector")]
    #[builder(default)]
    pub sns_topic_selector: Option<EventSubscriptionInitProviderSnsTopicSelector>,
    /// A list of identifiers of the event sources for which events will be returned. If not specified, then all sources are included in the response. If specified, a source_type must also be specified.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceIds")]
    #[builder(default)]
    pub source_ids: Option<Vec<String>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionInitProviderSnsTopicRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<EventSubscriptionInitProviderSnsTopicRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionInitProviderSnsTopicRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<EventSubscriptionInitProviderSnsTopicRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<EventSubscriptionInitProviderSnsTopicRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionInitProviderSnsTopicRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionInitProviderSnsTopicRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionInitProviderSnsTopicSelector {
    /// MatchControllerRef ensures an object with the same controller reference
    /// as the selecting object is selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchControllerRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<EventSubscriptionInitProviderSnsTopicSelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, JsonSchema)]
#[builder(field_defaults(setter(strip_option(ignore_invalid))))]
pub struct EventSubscriptionInitProviderSnsTopicSelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<EventSubscriptionInitProviderSnsTopicSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<EventSubscriptionInitProviderSnsTopicSelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionInitProviderSnsTopicSelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum EventSubscriptionInitProviderSnsTopicSelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct EventSubscriptionStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customerAwsId")]
    #[builder(default)]
