...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "Proxy", plural = "proxies")]
...
pub struct ProxyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "engineFamily")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSubnetIdsRefs")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSubnetIdsSelector")]
    #[builder(default)]
