...
#[kube(group = "dms.aws.upbound.io", version = "v1beta1", kind = "ReplicationTask", plural = "replicationtasks")]
...
pub struct ReplicationTaskForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cdcStartPosition")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cdcStartTime")]
    #[builder(default)]
    pub cdc_start_time: Option<String>,
    /// Migration type. Can be one of full-load | cdc | full-load-and-cdc.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "migrationType")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationInstanceArnRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationInstanceArnSelector")]
    #[builder(default)]
    pub replication_instance_arn_selector: Option<ReplicationTaskForProviderReplicationInstanceArnSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationTaskSettings")]
    #[builder(default)]
    pub replication_task_settings: Option<String>,
    /// A friendly name for the resource identifier at the end of the EndpointArn response parameter that is returned in the created Endpoint object.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceIdentifier")]
    #[builder(default)]
    pub resource_identifier: Option<String>,
    /// ARN that uniquely identifies the source endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceEndpointArn")]
    #[builder(default)]
    pub source_endpoint_arn: Option<String>,
    /// Reference to a Endpoint in dms to populate sourceEndpointArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceEndpointArnRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceEndpointArnSelector")]
    #[builder(default)]
    pub source_endpoint_arn_selector: Option<ReplicationTaskForProviderSourceEndpointArnSelector>,
    /// Whether to run or stop the replication task.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "startReplicationTask")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tableMappings")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetEndpointArn")]
    #[builder(default)]
    pub target_endpoint_arn: Option<String>,
    /// Reference to a Endpoint in dms to populate targetEndpointArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetEndpointArnRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetEndpointArnSelector")]
    #[builder(default)]
...
pub struct ReplicationTaskForProviderReplicationInstanceArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ReplicationTaskForProviderReplicationInstanceArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationTaskInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationInstanceArnSelector")]
    #[builder(default)]
    pub replication_instance_arn_selector: Option<ReplicationTaskInitProviderReplicationInstanceArnSelector>,
    /// Escaped JSON string that contains the task settings. For a complete list of task settings, see Task Settings for AWS Database Migration Service Tasks. Note that Logging.CloudWatchLogGroup and Logging.CloudWatchLogStream are read only and should not be defined, even as null, in the configuration since AWS provides a value for these settings.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationTaskSettings")]
    #[builder(default)]
    pub replication_task_settings: Option<String>,
...
pub struct ReplicationTaskInitProviderReplicationInstanceArnSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ReplicationTaskInitProviderReplicationInstanceArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationTaskStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationTaskArn")]
    #[builder(default)]
