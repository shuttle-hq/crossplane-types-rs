...
pub struct DataCatalogEncryptionSettingsSpec {
    ...
    pub publish_connection_details_to:
        Option<DataCatalogEncryptionSettingsPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref:
        Option<DataCatalogEncryptionSettingsWriteConnectionSecretToRef>,
}
...
pub struct DataCatalogEncryptionSettingsForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataCatalogEncryptionSettings"
    )]
    #[builder(default)]
    pub data_catalog_encryption_settings:
        Option<DataCatalogEncryptionSettingsForProviderDataCatalogEncryptionSettings>,
...
pub struct DataCatalogEncryptionSettingsInitProvider {
    ...
    #[builder(default)]
    pub data_catalog_encryption_settings:
        Option<DataCatalogEncryptionSettingsInitProviderDataCatalogEncryptionSettings>,
}
...
pub struct DataCatalogEncryptionSettingsPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<DataCatalogEncryptionSettingsPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<DataCatalogEncryptionSettingsPublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct DataCatalogEncryptionSettingsStatusAtProvider {
    ...
    #[builder(default)]
    pub data_catalog_encryption_settings:
        Option<DataCatalogEncryptionSettingsStatusAtProviderDataCatalogEncryptionSettings>,
...
pub struct DataCatalogEncryptionSettingsStatusAtProviderDataCatalogEncryptionSettingsConnectionPasswordEncryption
{
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "returnConnectionPasswordEncrypted"
    )]
    #[builder(default)]
    pub return_connection_password_encrypted: Option<bool>,
}
...
pub struct DataCatalogEncryptionSettingsStatusAtProviderDataCatalogEncryptionSettingsEncryptionAtRest
{
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "catalogEncryptionServiceRole"
    )]
    #[builder(default)]
    pub catalog_encryption_service_role: Option<String>,
    /// The ARN of the AWS KMS key to use for encryption at rest.
