...
#[kube(group = "glue.aws.upbound.io", version = "v1beta2", kind = "SecurityConfiguration", plural = "securityconfigurations")]
...
pub struct SecurityConfigurationForProviderEncryptionConfiguration {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudwatchEncryption")]
    #[builder(default)]
    pub cloudwatch_encryption: Option<SecurityConfigurationForProviderEncryptionConfigurationCloudwatchEncryption>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobBookmarksEncryption")]
    #[builder(default)]
    pub job_bookmarks_encryption: Option<SecurityConfigurationForProviderEncryptionConfigurationJobBookmarksEncryption>,
    /// A s3_encryption  block as described below, which contains encryption configuration for S3 data.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3Encryption")]
    #[builder(default)]
...
pub struct SecurityConfigurationForProviderEncryptionConfigurationS3Encryption {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyArnRef")]
    #[builder(default)]
    pub kms_key_arn_ref: Option<SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnRef>,
    /// Selector for a Key in kms to populate kmsKeyArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyArnSelector")]
    #[builder(default)]
    pub kms_key_arn_selector: Option<SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelector>,
    /// Encryption mode to use for S3 data. Valid values: DISABLED, SSE-KMS, SSE-S3. Default value: DISABLED.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3EncryptionMode")]
    #[builder(default)]
...
pub struct SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnRefPolicy>,
}
...
pub struct SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<SecurityConfigurationForProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelectorPolicy>,
}
...
pub struct SecurityConfigurationInitProviderEncryptionConfiguration {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudwatchEncryption")]
    #[builder(default)]
    pub cloudwatch_encryption: Option<SecurityConfigurationInitProviderEncryptionConfigurationCloudwatchEncryption>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobBookmarksEncryption")]
    #[builder(default)]
    pub job_bookmarks_encryption: Option<SecurityConfigurationInitProviderEncryptionConfigurationJobBookmarksEncryption>,
    /// A s3_encryption  block as described below, which contains encryption configuration for S3 data.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3Encryption")]
    #[builder(default)]
...
pub struct SecurityConfigurationInitProviderEncryptionConfigurationS3Encryption {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyArnRef")]
    #[builder(default)]
    pub kms_key_arn_ref: Option<SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnRef>,
    /// Selector for a Key in kms to populate kmsKeyArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyArnSelector")]
    #[builder(default)]
    pub kms_key_arn_selector: Option<SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelector>,
    /// Encryption mode to use for S3 data. Valid values: DISABLED, SSE-KMS, SSE-S3. Default value: DISABLED.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3EncryptionMode")]
    #[builder(default)]
    pub s3_encryption_mode: Option<String>,
...
pub struct SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnRefPolicy>,
}
...
pub struct SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub policy: Option<SecurityConfigurationInitProviderEncryptionConfigurationS3EncryptionKmsKeyArnSelectorPolicy>,
}
...
pub struct SecurityConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<SecurityConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct SecurityConfigurationStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfiguration")]
    #[builder(default)]
    pub encryption_configuration: Option<SecurityConfigurationStatusAtProviderEncryptionConfiguration>,
...
pub struct SecurityConfigurationStatusAtProviderEncryptionConfiguration {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudwatchEncryption")]
    #[builder(default)]
    pub cloudwatch_encryption: Option<SecurityConfigurationStatusAtProviderEncryptionConfigurationCloudwatchEncryption>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobBookmarksEncryption")]
    #[builder(default)]
    pub job_bookmarks_encryption: Option<SecurityConfigurationStatusAtProviderEncryptionConfigurationJobBookmarksEncryption>,
    /// A s3_encryption  block as described below, which contains encryption configuration for S3 data.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3Encryption")]
    #[builder(default)]
    pub s3_encryption: Option<SecurityConfigurationStatusAtProviderEncryptionConfigurationS3Encryption>,
}
