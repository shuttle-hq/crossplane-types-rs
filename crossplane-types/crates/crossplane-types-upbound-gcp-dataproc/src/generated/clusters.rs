...
pub struct ClusterForProviderClusterConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "preemptibleWorkerConfig"
    )]
    #[builder(default)]
...
pub struct ClusterForProviderClusterConfigAuxiliaryNodeGroupsNodeGroup {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "nodeGroupConfig"
    )]
    #[builder(default)]
    pub node_group_config:
        Option<ClusterForProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig>,
...
pub struct ClusterForProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub accelerators: Option<
        Vec<ClusterForProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigAccelerators>,
    >,
    /// Disk Config
    #[serde(
        default,
    ...
    #[builder(default)]
    pub disk_config: Option<
        ClusterForProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigDiskConfig,
    >,
...
pub struct ClusterForProviderClusterConfigGceClusterConfig {
    ...
    #[builder(default)]
    pub node_group_affinity:
        Option<ClusterForProviderClusterConfigGceClusterConfigNodeGroupAffinity>,
    ...
    pub reservation_affinity:
        Option<ClusterForProviderClusterConfigGceClusterConfigReservationAffinity>,
    ...
    pub service_account_ref:
        Option<ClusterForProviderClusterConfigGceClusterConfigServiceAccountRef>,
    ...
    pub service_account_selector:
        Option<ClusterForProviderClusterConfigGceClusterConfigServiceAccountSelector>,
    ...
    pub shielded_instance_config:
        Option<ClusterForProviderClusterConfigGceClusterConfigShieldedInstanceConfig>,
    /// The name or self_link of the Google Compute Engine
...
pub struct ClusterForProviderClusterConfigGceClusterConfigServiceAccountRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterForProviderClusterConfigGceClusterConfigServiceAccountRefPolicyResolution>,
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterForProviderClusterConfigGceClusterConfigServiceAccountRefPolicyResolve>,
}
...
pub struct ClusterForProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicy {
    ...
    pub resolution: Option<
        ClusterForProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterForProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicyResolve>,
}
...
pub struct ClusterForProviderClusterConfigMetastoreConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataprocMetastoreService"
    )]
    #[builder(default)]
...
pub struct ClusterForProviderClusterConfigPreemptibleWorkerConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "instanceFlexibilityPolicy"
    )]
    #[builder(default)]
    pub instance_flexibility_policy:
        Option<ClusterForProviderClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicy>,
...
pub struct ClusterForProviderVirtualClusterConfig {
    ...
    pub auxiliary_services_config:
        Option<ClusterForProviderVirtualClusterConfigAuxiliaryServicesConfig>,
    ...
    pub kubernetes_cluster_config:
        Option<ClusterForProviderVirtualClusterConfigKubernetesClusterConfig>,
    /// The Cloud Storage staging bucket used to stage files,
    /// such as Hadoop jars, between client machines and the cluster.
    /// Note: If you don't explicitly specify a staging_bucket
    /// then GCP will auto create / assign one for you. However, you are not guaranteed
...
pub struct ClusterForProviderVirtualClusterConfigAuxiliaryServicesConfig {
    ...
    #[builder(default)]
    pub metastore_config:
        Option<ClusterForProviderVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfig>,
    ...
    #[builder(default)]
    pub spark_history_server_config: Option<
        ClusterForProviderVirtualClusterConfigAuxiliaryServicesConfigSparkHistoryServerConfig,
    >,
}
...
pub struct ClusterForProviderVirtualClusterConfigKubernetesClusterConfig {
    ...
    #[builder(default)]
    pub gke_cluster_config:
        Option<ClusterForProviderVirtualClusterConfigKubernetesClusterConfigGkeClusterConfig>,
    ...
    #[builder(default)]
    pub kubernetes_software_config: Option<
        ClusterForProviderVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfig,
    >,
}
...
pub struct ClusterInitProviderClusterConfigAuxiliaryNodeGroupsNodeGroup {
    ...
    #[builder(default)]
    pub node_group_config:
        Option<ClusterInitProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig>,
    /// The roles associated with the GKE node pool.
    /// One of "DEFAULT", "CONTROLLER", "SPARK_DRIVER" or "SPARK_EXECUTOR".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
...
pub struct ClusterInitProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig {
    ...
    pub accelerators: Option<
        Vec<
            ClusterInitProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigAccelerators,
        >,
    >,
    /// Disk Config
    #[serde(
    ...
    #[builder(default)]
    pub disk_config: Option<
        ClusterInitProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigDiskConfig,
    >,
    /// The name of a Compute Engine machine type.
    #[serde(
        default,
...
pub struct ClusterInitProviderClusterConfigGceClusterConfig {
    ...
    #[builder(default)]
    pub node_group_affinity:
        Option<ClusterInitProviderClusterConfigGceClusterConfigNodeGroupAffinity>,
    /// Reservation Affinity for consuming zonal reservation.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub reservation_affinity:
        Option<ClusterInitProviderClusterConfigGceClusterConfigReservationAffinity>,
    /// The service account to be used by the Node VMs.
    /// If not specified, the "default" service account is used.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub service_account_ref:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountRef>,
    /// The set of Google API scopes
    /// to be made available on all of the node VMs under the service_account
    /// specified. Both OAuth2 URLs and gcloud
    /// short names are supported. To allow full access to all Cloud APIs, use the
    ...
    #[builder(default)]
    pub service_account_selector:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelector>,
    /// Shielded Instance Config for clusters using Compute Engine Shielded VMs.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub shielded_instance_config:
        Option<ClusterInitProviderClusterConfigGceClusterConfigShieldedInstanceConfig>,
    /// The name or self_link of the Google Compute Engine
    /// subnetwork the cluster will be part of. Conflicts with network.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
...
pub struct ClusterInitProviderClusterConfigGceClusterConfigServiceAccountRefPolicy {
    ...
    #[builder(default)]
    pub resolution:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountRefPolicyResolve>,
}
...
pub struct ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelector {
    ...
    #[builder(default)]
    pub policy:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicy>,
}
...
pub struct ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicy {
    ...
    #[builder(default)]
    pub resolution: Option<
        ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default)]
    pub resolve:
        Option<ClusterInitProviderClusterConfigGceClusterConfigServiceAccountSelectorPolicyResolve>,
}
...
pub struct ClusterInitProviderClusterConfigPreemptibleWorkerConfig {
    ...
    #[builder(default)]
    pub instance_flexibility_policy:
        Option<ClusterInitProviderClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicy>,
    /// Specifies the number of preemptible nodes to create.
    /// Defaults to 0.
    #[serde(
        default,
...
pub struct ClusterInitProviderVirtualClusterConfig {
    ...
    #[builder(default)]
    pub auxiliary_services_config:
        Option<ClusterInitProviderVirtualClusterConfigAuxiliaryServicesConfig>,
    /// The configuration for running the Dataproc cluster on Kubernetes.
    /// Structure defined below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub kubernetes_cluster_config:
        Option<ClusterInitProviderVirtualClusterConfigKubernetesClusterConfig>,
    /// The Cloud Storage staging bucket used to stage files,
    /// such as Hadoop jars, between client machines and the cluster.
    /// Note: If you don't explicitly specify a staging_bucket
    /// then GCP will auto create / assign one for you. However, you are not guaranteed
...
pub struct ClusterInitProviderVirtualClusterConfigAuxiliaryServicesConfig {
    ...
    #[builder(default)]
    pub metastore_config:
        Option<ClusterInitProviderVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfig>,
    /// The Spark History Server configuration for the workload.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub spark_history_server_config: Option<
        ClusterInitProviderVirtualClusterConfigAuxiliaryServicesConfigSparkHistoryServerConfig,
    >,
}
...
pub struct ClusterInitProviderVirtualClusterConfigKubernetesClusterConfig {
    ...
    #[builder(default)]
    pub gke_cluster_config:
        Option<ClusterInitProviderVirtualClusterConfigKubernetesClusterConfigGkeClusterConfig>,
    /// A namespace within the Kubernetes cluster to deploy into.
    /// If this namespace does not exist, it is created.
    /// If it  exists, Dataproc verifies that another Dataproc VirtualCluster is not installed into it.
    /// If not specified, the name of the Dataproc Cluster is used.
    ...
    #[builder(default)]
    pub kubernetes_software_config: Option<
        ClusterInitProviderVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfig,
    >,
}
...
pub struct ClusterStatusAtProviderClusterConfig {
    ...
    #[builder(default)]
    pub initialization_action:
        Option<Vec<ClusterStatusAtProviderClusterConfigInitializationAction>>,
    /// The settings for auto deletion cluster schedule.
    /// Structure defined below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub preemptible_worker_config:
        Option<ClusterStatusAtProviderClusterConfigPreemptibleWorkerConfig>,
    /// Security related configuration. Structure defined below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ClusterStatusAtProviderClusterConfigAuxiliaryNodeGroupsNodeGroup {
    ...
    #[builder(default)]
    pub node_group_config:
        Option<ClusterStatusAtProviderClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig>,
    /// The roles associated with the GKE node pool.
    /// One of "DEFAULT", "CONTROLLER", "SPARK_DRIVER" or "SPARK_EXECUTOR".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
...
pub struct ClusterStatusAtProviderClusterConfigGceClusterConfig {
    ...
    #[builder(default)]
    pub node_group_affinity:
        Option<ClusterStatusAtProviderClusterConfigGceClusterConfigNodeGroupAffinity>,
    /// Reservation Affinity for consuming zonal reservation.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub reservation_affinity:
        Option<ClusterStatusAtProviderClusterConfigGceClusterConfigReservationAffinity>,
    /// The service account to be used by the Node VMs.
    /// If not specified, the "default" service account is used.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub shielded_instance_config:
        Option<ClusterStatusAtProviderClusterConfigGceClusterConfigShieldedInstanceConfig>,
    /// The name or self_link of the Google Compute Engine
    /// subnetwork the cluster will be part of. Conflicts with network.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
...
pub struct ClusterStatusAtProviderClusterConfigPreemptibleWorkerConfig {
    ...
    #[builder(default)]
    pub instance_flexibility_policy: Option<
        ClusterStatusAtProviderClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicy,
    >,
    /// List of worker instance names which have been assigned
    /// to the cluster.
    #[serde(
...
pub struct ClusterStatusAtProviderVirtualClusterConfig {
    ...
    #[builder(default)]
    pub auxiliary_services_config:
        Option<ClusterStatusAtProviderVirtualClusterConfigAuxiliaryServicesConfig>,
    /// The configuration for running the Dataproc cluster on Kubernetes.
    /// Structure defined below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub kubernetes_cluster_config:
        Option<ClusterStatusAtProviderVirtualClusterConfigKubernetesClusterConfig>,
    /// The Cloud Storage staging bucket used to stage files,
    /// such as Hadoop jars, between client machines and the cluster.
    /// Note: If you don't explicitly specify a staging_bucket
    /// then GCP will auto create / assign one for you. However, you are not guaranteed
...
pub struct ClusterStatusAtProviderVirtualClusterConfigAuxiliaryServicesConfig {
    ...
    #[builder(default)]
    pub metastore_config:
        Option<ClusterStatusAtProviderVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfig>,
    /// The Spark History Server configuration for the workload.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default)]
    pub spark_history_server_config: Option<
        ClusterStatusAtProviderVirtualClusterConfigAuxiliaryServicesConfigSparkHistoryServerConfig,
    >,
}
...
pub struct ClusterStatusAtProviderVirtualClusterConfigKubernetesClusterConfig {
    ...
    #[builder(default)]
    pub gke_cluster_config:
        Option<ClusterStatusAtProviderVirtualClusterConfigKubernetesClusterConfigGkeClusterConfig>,
    /// A namespace within the Kubernetes cluster to deploy into.
    /// If this namespace does not exist, it is created.
    /// If it  exists, Dataproc verifies that another Dataproc VirtualCluster is not installed into it.
    /// If not specified, the name of the Dataproc Cluster is used.
    ...
    #[builder(default)]
    pub kubernetes_software_config: Option<
        ClusterStatusAtProviderVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfig,
    >,
}
