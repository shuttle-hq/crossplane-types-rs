...
#[kube(group = "transfer.aws.upbound.io", version = "v1beta2", kind = "Server", plural = "servers")]
...
pub struct ServerForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateRef")]
    #[builder(default)]
    pub certificate_ref: Option<ServerForProviderCertificateRef>,
    /// Selector for a Certificate in acm to populate certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateSelector")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointDetails")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostKeySecretRef")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "identityProviderType")]
    #[builder(default)]
    pub identity_provider_type: Option<String>,
    /// Amazon Resource Name (ARN) of the IAM role used to authenticate the user account with an identity_provider_type of API_GATEWAY.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "invocationRole")]
    #[builder(default)]
    pub invocation_role: Option<String>,
    /// Amazon Resource Name (ARN) of an IAM role that allows the service to write your SFTP users’ activity to your Amazon CloudWatch logs for monitoring and auditing purposes.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loggingRole")]
    #[builder(default)]
    pub logging_role: Option<String>,
    /// Reference to a Role in iam to populate loggingRole.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loggingRoleRef")]
    #[builder(default)]
    pub logging_role_ref: Option<ServerForProviderLoggingRoleRef>,
    /// Selector for a Role in iam to populate loggingRole.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loggingRoleSelector")]
    #[builder(default)]
    pub logging_role_selector: Option<ServerForProviderLoggingRoleSelector>,
    /// Specify a string to display when users connect to a server. This string is displayed after the user authenticates. The SFTP protocol does not support post-authentication display banners.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "postAuthenticationLoginBannerSecretRef")]
    #[builder(default)]
    pub post_authentication_login_banner_secret_ref: Option<ServerForProviderPostAuthenticationLoginBannerSecretRef>,
    /// Specify a string to display when users connect to a server. This string is displayed before the user authenticates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "preAuthenticationLoginBannerSecretRef")]
    #[builder(default)]
    pub pre_authentication_login_banner_secret_ref: Option<ServerForProviderPreAuthenticationLoginBannerSecretRef>,
    /// The protocol settings that are configured for your server. See protocol_details Block below for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "protocolDetails")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3StorageOptions")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityPolicyName")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sftpAuthenticationMethods")]
    #[builder(default)]
    pub sftp_authentication_methods: Option<String>,
    /// A set of ARNs of destinations that will receive structured logs from the transfer server such as CloudWatch Log Group ARNs. If provided this enables the transfer server to emit structured logs to the specified locations.
    /// This is a set of arns of destinations that will receive structured logs from the transfer server
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "structuredLogDestinations")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workflowDetails")]
    #[builder(default)]
...
pub struct ServerForProviderEndpointDetails {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addressAllocationIds")]
    #[builder(default)]
    pub address_allocation_ids: Option<Vec<String>>,
    /// References to EIP in ec2 to populate addressAllocationIds.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addressAllocationIdsRefs")]
    #[builder(default)]
    pub address_allocation_ids_refs: Option<Vec<ServerForProviderEndpointDetailsAddressAllocationIdsRefs>>,
    /// Selector for a list of EIP in ec2 to populate addressAllocationIds.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addressAllocationIdsSelector")]
    #[builder(default)]
    pub address_allocation_ids_selector: Option<ServerForProviderEndpointDetailsAddressAllocationIdsSelector>,
...
pub struct ServerForProviderEndpointDetailsAddressAllocationIdsRefsPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ServerForProviderEndpointDetailsAddressAllocationIdsRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServerForProviderEndpointDetailsAddressAllocationIdsSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ServerForProviderEndpointDetailsAddressAllocationIdsSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServerForProviderProtocolDetails {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "as2Transports")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "setStatOption")]
    #[builder(default)]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tlsSessionResumptionMode")]
    #[builder(default)]
...
pub struct ServerForProviderS3StorageOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "directoryListingOptimization")]
    #[builder(default)]
...
pub struct ServerForProviderWorkflowDetails {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onPartialUpload")]
    #[builder(default)]
...
pub struct ServerInitProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "postAuthenticationLoginBannerSecretRef")]
    #[builder(default)]
    pub post_authentication_login_banner_secret_ref: Option<ServerInitProviderPostAuthenticationLoginBannerSecretRef>,
    /// Specify a string to display when users connect to a server. This string is displayed before the user authenticates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "preAuthenticationLoginBannerSecretRef")]
    #[builder(default)]
    pub pre_authentication_login_banner_secret_ref: Option<ServerInitProviderPreAuthenticationLoginBannerSecretRef>,
    /// The protocol settings that are configured for your server. See protocol_details Block below for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "protocolDetails")]
    #[builder(default)]
...
pub struct ServerInitProviderEndpointDetails {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addressAllocationIdsRefs")]
    #[builder(default)]
    pub address_allocation_ids_refs: Option<Vec<ServerInitProviderEndpointDetailsAddressAllocationIdsRefs>>,
    /// Selector for a list of EIP in ec2 to populate addressAllocationIds.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "addressAllocationIdsSelector")]
    #[builder(default)]
    pub address_allocation_ids_selector: Option<ServerInitProviderEndpointDetailsAddressAllocationIdsSelector>,
    /// A list of security groups IDs that are available to attach to your server's endpoint. If no security groups are specified, the VPC's default security groups are automatically assigned to your endpoint. This property can only be used when endpoint_type is set to VPC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIds")]
    #[builder(default)]
    pub security_group_ids: Option<Vec<String>>,
...
pub struct ServerInitProviderEndpointDetailsAddressAllocationIdsRefsPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ServerInitProviderEndpointDetailsAddressAllocationIdsRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServerInitProviderEndpointDetailsAddressAllocationIdsSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ServerInitProviderEndpointDetailsAddressAllocationIdsSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServerStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostKeyFingerprint")]
    #[builder(default)]
