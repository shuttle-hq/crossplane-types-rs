...
#[kube(group = "ssm.aws.upbound.io", version = "v1beta2", kind = "ResourceDataSync", plural = "resourcedatasyncs")]
...
pub struct ResourceDataSyncForProviderS3Destination {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "syncFormat")]
    #[builder(default)]
...
pub struct ResourceDataSyncForProviderS3DestinationBucketNameSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ResourceDataSyncForProviderS3DestinationBucketNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ResourceDataSyncInitProviderS3DestinationBucketNameSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<ResourceDataSyncInitProviderS3DestinationBucketNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
