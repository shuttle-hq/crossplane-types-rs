...
#[kube(group = "imagebuilder.aws.upbound.io", version = "v1beta2", kind = "ImageRecipe", plural = "imagerecipes")]
...
pub struct ImageRecipeForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "systemsManagerAgent")]
    #[builder(default)]
...
pub struct ImageRecipeForProviderSystemsManagerAgent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "uninstallAfterBuild")]
    #[builder(default)]
