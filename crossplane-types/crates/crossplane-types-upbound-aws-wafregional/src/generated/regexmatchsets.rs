...
#[kube(group = "wafregional.aws.upbound.io", version = "v1beta2", kind = "RegexMatchSet", plural = "regexmatchsets")]
...
pub struct RegexMatchSetForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexMatchTuple")]
    #[builder(default)]
...
pub struct RegexMatchSetForProviderRegexMatchTuple {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexPatternSetId")]
    #[builder(default)]
    pub regex_pattern_set_id: Option<String>,
    /// Reference to a RegexPatternSet in wafregional to populate regexPatternSetId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexPatternSetIdRef")]
    #[builder(default)]
    pub regex_pattern_set_id_ref: Option<RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdRef>,
    /// Selector for a RegexPatternSet in wafregional to populate regexPatternSetId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexPatternSetIdSelector")]
    #[builder(default)]
    pub regex_pattern_set_id_selector: Option<RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdSelector>,
...
pub struct RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdRefPolicyResolution>,
...
pub struct RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<RegexMatchSetForProviderRegexMatchTupleRegexPatternSetIdSelectorPolicyResolve>,
}
...
pub struct RegexMatchSetInitProviderRegexMatchTuple {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexPatternSetIdRef")]
    #[builder(default)]
    pub regex_pattern_set_id_ref: Option<RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdRef>,
    /// Selector for a RegexPatternSet in wafregional to populate regexPatternSetId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "regexPatternSetIdSelector")]
    #[builder(default)]
    pub regex_pattern_set_id_selector: Option<RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdSelector>,
    /// Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF.
    /// e.g., CMD_LINE, HTML_ENTITY_DECODE or NONE.
    /// See docs
    /// for all supported values.
...
pub struct RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdSelectorPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolution: Option<RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub resolve: Option<RegexMatchSetInitProviderRegexMatchTupleRegexPatternSetIdSelectorPolicyResolve>,
}
