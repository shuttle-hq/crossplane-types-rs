...
pub struct DiskForProviderDiskEncryptionKey {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "rsaEncryptedKeySecretRef"
    )]
    #[builder(default)]
    pub rsa_encrypted_key_secret_ref:
        Option<DiskForProviderDiskEncryptionKeyRsaEncryptedKeySecretRef>,
}
...
pub struct DiskInitProviderDiskEncryptionKey {
    ...
    #[builder(default)]
    pub rsa_encrypted_key_secret_ref:
        Option<DiskInitProviderDiskEncryptionKeyRsaEncryptedKeySecretRef>,
}
