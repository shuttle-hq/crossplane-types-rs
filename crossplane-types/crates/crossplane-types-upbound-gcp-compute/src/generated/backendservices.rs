...
pub struct BackendServiceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "connectionDrainingTimeoutSec"
    )]
    #[builder(default)]
...
pub struct BackendServiceForProviderCdnPolicy {
    ...
    pub bypass_cache_on_request_headers:
        Option<Vec<BackendServiceForProviderCdnPolicyBypassCacheOnRequestHeaders>>,
    ...
    pub negative_caching_policy:
        Option<Vec<BackendServiceForProviderCdnPolicyNegativeCachingPolicy>>,
...
pub struct BackendServiceForProviderIap {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "oauth2ClientSecretSecretRef"
    )]
    #[builder(default)]
    pub oauth2_client_secret_secret_ref:
        Option<BackendServiceForProviderIapOauth2ClientSecretSecretRef>,
}
...
pub struct BackendServiceForProviderSecuritySettingsAwsV4Authentication {
    ...
    pub access_key_secret_ref:
        Option<BackendServiceForProviderSecuritySettingsAwsV4AuthenticationAccessKeySecretRef>,
    /// The optional version identifier for the access key. You can use this to keep track of different iterations of your access key.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "accessKeyVersion"
    )]
    #[builder(default)]
...
pub struct BackendServiceInitProviderCdnPolicy {
    ...
    #[builder(default)]
    pub bypass_cache_on_request_headers:
        Option<Vec<BackendServiceInitProviderCdnPolicyBypassCacheOnRequestHeaders>>,
    /// The CacheKeyPolicy for this CdnPolicy.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub negative_caching_policy:
        Option<Vec<BackendServiceInitProviderCdnPolicyNegativeCachingPolicy>>,
    /// Serve existing content from the cache (if available) when revalidating content with the origin, or when an error is encountered when refreshing the cache.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct BackendServiceInitProviderSecuritySettings {
    ...
    pub aws_v4_authentication:
        Option<BackendServiceInitProviderSecuritySettingsAwsV4Authentication>,
    /// ClientTlsPolicy is a resource that specifies how a client should authenticate
    /// connections to backends of a service. This resource itself does not affect
    /// configuration unless it is attached to a backend service resource.
    #[serde(
...
pub struct BackendServiceInitProviderSecuritySettingsAwsV4Authentication {
    ...
    #[builder(default)]
    pub access_key_secret_ref:
        Option<BackendServiceInitProviderSecuritySettingsAwsV4AuthenticationAccessKeySecretRef>,
    /// The optional version identifier for the access key. You can use this to keep track of different iterations of your access key.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct BackendServiceStatusAtProviderCdnPolicy {
    ...
    #[builder(default)]
    pub bypass_cache_on_request_headers:
        Option<Vec<BackendServiceStatusAtProviderCdnPolicyBypassCacheOnRequestHeaders>>,
    /// The CacheKeyPolicy for this CdnPolicy.
    /// Structure is documented below.
    #[serde(
        default,
    ...
    #[builder(default)]
    pub negative_caching_policy:
        Option<Vec<BackendServiceStatusAtProviderCdnPolicyNegativeCachingPolicy>>,
    /// Serve existing content from the cache (if available) when revalidating content with the origin, or when an error is encountered when refreshing the cache.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct BackendServiceStatusAtProviderSecuritySettings {
    ...
    #[builder(default)]
    pub aws_v4_authentication:
        Option<BackendServiceStatusAtProviderSecuritySettingsAwsV4Authentication>,
    /// ClientTlsPolicy is a resource that specifies how a client should authenticate
    /// connections to backends of a service. This resource itself does not affect
    /// configuration unless it is attached to a backend service resource.
    #[serde(
