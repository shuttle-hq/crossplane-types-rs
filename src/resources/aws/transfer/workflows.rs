...
pub struct WorkflowForProviderOnExceptionStepsCopyStepDetails {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationFileLocation"
    )]
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowForProviderOnExceptionStepsCopyStepDetailsDestinationFileLocation>,
...
pub struct WorkflowForProviderOnExceptionStepsCopyStepDetailsDestinationFileLocation {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "efsFileLocation"
    )]
    #[builder(default, setter(strip_option))]
    pub efs_file_location: Option<
        WorkflowForProviderOnExceptionStepsCopyStepDetailsDestinationFileLocationEfsFileLocation,
    >,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "s3FileLocation"
    )]
    #[builder(default, setter(strip_option))]
    pub s3_file_location: Option<
        WorkflowForProviderOnExceptionStepsCopyStepDetailsDestinationFileLocationS3FileLocation,
    >,
}
...
pub struct WorkflowForProviderOnExceptionStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowForProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowForProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location: Option<
        WorkflowForProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation,
    >,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location: Option<
        WorkflowForProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocationS3FileLocation,
    >,
}
...
pub struct WorkflowForProviderStepsCopyStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowForProviderStepsCopyStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowForProviderStepsCopyStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location:
        Option<WorkflowForProviderStepsCopyStepDetailsDestinationFileLocationEfsFileLocation>,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location:
        Option<WorkflowForProviderStepsCopyStepDetailsDestinationFileLocationS3FileLocation>,
}
...
pub struct WorkflowForProviderStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowForProviderStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowForProviderStepsDecryptStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location:
        Option<WorkflowForProviderStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation>,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location:
        Option<WorkflowForProviderStepsDecryptStepDetailsDestinationFileLocationS3FileLocation>,
}
...
pub struct WorkflowInitProviderOnExceptionStepsCopyStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowInitProviderOnExceptionStepsCopyStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowInitProviderOnExceptionStepsCopyStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location: Option<
        WorkflowInitProviderOnExceptionStepsCopyStepDetailsDestinationFileLocationEfsFileLocation,
    >,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location: Option<
        WorkflowInitProviderOnExceptionStepsCopyStepDetailsDestinationFileLocationS3FileLocation,
    >,
}
...
pub struct WorkflowInitProviderOnExceptionStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowInitProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowInitProviderStepsCopyStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowInitProviderStepsCopyStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowInitProviderStepsCopyStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location:
        Option<WorkflowInitProviderStepsCopyStepDetailsDestinationFileLocationEfsFileLocation>,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location:
        Option<WorkflowInitProviderStepsCopyStepDetailsDestinationFileLocationS3FileLocation>,
}
...
pub struct WorkflowInitProviderStepsCustomStepDetailsTargetSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<WorkflowInitProviderStepsCustomStepDetailsTargetSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct WorkflowInitProviderStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowInitProviderStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowInitProviderStepsDecryptStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location:
        Option<WorkflowInitProviderStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation>,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location:
        Option<WorkflowInitProviderStepsDecryptStepDetailsDestinationFileLocationS3FileLocation>,
}
...
pub struct WorkflowStatusAtProviderOnExceptionStepsCopyStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowStatusAtProviderOnExceptionStepsCopyStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowStatusAtProviderOnExceptionStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowStatusAtProviderOnExceptionStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowStatusAtProviderStepsCopyStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowStatusAtProviderStepsCopyStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowStatusAtProviderStepsCopyStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location:
        Option<WorkflowStatusAtProviderStepsCopyStepDetailsDestinationFileLocationEfsFileLocation>,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location:
        Option<WorkflowStatusAtProviderStepsCopyStepDetailsDestinationFileLocationS3FileLocation>,
}
...
pub struct WorkflowStatusAtProviderStepsDecryptStepDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_file_location:
        Option<WorkflowStatusAtProviderStepsDecryptStepDetailsDestinationFileLocation>,
    /// The name of the step, used as an identifier.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct WorkflowStatusAtProviderStepsDecryptStepDetailsDestinationFileLocation {
    ...
    #[builder(default, setter(strip_option))]
    pub efs_file_location: Option<
        WorkflowStatusAtProviderStepsDecryptStepDetailsDestinationFileLocationEfsFileLocation,
    >,
    /// Specifies the details for the S3 file being copied.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_file_location: Option<
        WorkflowStatusAtProviderStepsDecryptStepDetailsDestinationFileLocationS3FileLocation,
    >,
}
