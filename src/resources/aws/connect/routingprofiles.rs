...
pub struct RoutingProfileForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultOutboundQueueIdRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultOutboundQueueIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub default_outbound_queue_id_selector:
        Option<RoutingProfileForProviderDefaultOutboundQueueIdSelector>,
...
pub struct RoutingProfileInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub default_outbound_queue_id_selector:
        Option<RoutingProfileInitProviderDefaultOutboundQueueIdSelector>,
    /// Specifies the description of the Routing Profile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub description: Option<String>,
...
pub struct RoutingProfileInitProviderDefaultOutboundQueueIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<RoutingProfileInitProviderDefaultOutboundQueueIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
