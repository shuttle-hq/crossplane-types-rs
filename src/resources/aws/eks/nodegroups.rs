...
pub struct NodeGroupForProviderRemoteAccess {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceSecurityGroupIdRefs"
    )]
    #[builder(default, setter(strip_option))]
    pub source_security_group_id_refs:
        Option<Vec<NodeGroupForProviderRemoteAccessSourceSecurityGroupIdRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate sourceSecurityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceSecurityGroupIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub source_security_group_id_selector:
        Option<NodeGroupForProviderRemoteAccessSourceSecurityGroupIdSelector>,
    /// Set of EC2 Security Group IDs to allow SSH access (port 22) from on the worker nodes. If you specify ec2_ssh_key, but do not specify this configuration when you create an EKS Node Group, port 22 on the worker nodes is opened to the Internet (0.0.0.0/0).
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceSecurityGroupIds"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct NodeGroupForProviderRemoteAccessSourceSecurityGroupIdRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NodeGroupForProviderRemoteAccessSourceSecurityGroupIdRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NodeGroupForProviderRemoteAccessSourceSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NodeGroupForProviderRemoteAccessSourceSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NodeGroupInitProviderRemoteAccess {
    ...
    #[builder(default, setter(strip_option))]
    pub source_security_group_id_refs:
        Option<Vec<NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate sourceSecurityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub source_security_group_id_selector:
        Option<NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdSelector>,
    /// Set of EC2 Security Group IDs to allow SSH access (port 22) from on the worker nodes. If you specify ec2_ssh_key, but do not specify this configuration when you create an EKS Node Group, port 22 on the worker nodes is opened to the Internet (0.0.0.0/0).
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<NodeGroupInitProviderRemoteAccessSourceSecurityGroupIdSelectorPolicyResolve>,
}
...
pub struct NodeGroupStatusAtProviderResources {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "remoteAccessSecurityGroupId"
    )]
    #[builder(default, setter(strip_option))]
