...
pub struct FargateProfileForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "podExecutionRoleArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub pod_execution_role_arn_selector:
        Option<FargateProfileForProviderPodExecutionRoleArnSelector>,
...
pub struct FargateProfileInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub pod_execution_role_arn_selector:
        Option<FargateProfileInitProviderPodExecutionRoleArnSelector>,
    /// Configuration block(s) for selecting Kubernetes Pods to execute with this EKS Fargate Profile. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
