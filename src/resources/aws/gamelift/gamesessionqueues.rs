...
pub struct GameSessionQueueForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "notificationTargetSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct GameSessionQueueForProviderPlayerLatencyPolicy {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maximumIndividualPlayerLatencyMilliseconds"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct GameSessionQueueInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub notification_target_selector:
        Option<GameSessionQueueInitProviderNotificationTargetSelector>,
    /// One or more policies used to choose fleet based on player latency. See below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
