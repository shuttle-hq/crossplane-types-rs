...
pub struct EventSourceMappingForProvider {
    ...
    pub amazon_managed_kafka_event_source_config:
        Option<EventSourceMappingForProviderAmazonManagedKafkaEventSourceConfig>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "documentDbEventSourceConfig"
    )]
    #[builder(default, setter(strip_option))]
    pub document_db_event_source_config:
        Option<EventSourceMappingForProviderDocumentDbEventSourceConfig>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "provisionedPollerConfig"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub self_managed_kafka_event_source_config:
        Option<EventSourceMappingForProviderSelfManagedKafkaEventSourceConfig>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceAccessConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub source_access_configuration:
        Option<Vec<EventSourceMappingForProviderSourceAccessConfiguration>>,
...
pub struct EventSourceMappingInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub amazon_managed_kafka_event_source_config:
        Option<EventSourceMappingInitProviderAmazonManagedKafkaEventSourceConfig>,
    /// The largest number of records that Lambda will retrieve from your event source at the time of invocation. Defaults to 100 for DynamoDB, Kinesis, MQ and MSK, 10 for SQS.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "batchSize")]
    #[builder(default, setter(strip_option))]
    pub batch_size: Option<f64>,
    ...
    #[builder(default, setter(strip_option))]
    pub document_db_event_source_config:
        Option<EventSourceMappingInitProviderDocumentDbEventSourceConfig>,
    /// Determines if the mapping will be enabled on creation. Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub enabled: Option<bool>,
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_kafka_event_source_config:
        Option<EventSourceMappingInitProviderSelfManagedKafkaEventSourceConfig>,
    /// :  For Self Managed Kafka sources, the access configuration for the source. If set, configuration must also include self_managed_event_source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub source_access_configuration:
        Option<Vec<EventSourceMappingInitProviderSourceAccessConfiguration>>,
    /// The position in the stream where AWS Lambda should start reading. Must be one of AT_TIMESTAMP (Kinesis only), LATEST or TRIM_HORIZON if getting events from Kinesis, DynamoDB, MSK or Self Managed Apache Kafka. Must not be provided if getting events from SQS. More information about these positions can be found in the AWS DynamoDB Streams API Reference and AWS Kinesis API Reference.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct EventSourceMappingStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub amazon_managed_kafka_event_source_config:
        Option<EventSourceMappingStatusAtProviderAmazonManagedKafkaEventSourceConfig>,
    ...
    #[builder(default, setter(strip_option))]
    pub document_db_event_source_config:
        Option<EventSourceMappingStatusAtProviderDocumentDbEventSourceConfig>,
    /// Determines if the mapping will be enabled on creation. Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub enabled: Option<bool>,
    ...
    pub provisioned_poller_config:
        Option<EventSourceMappingStatusAtProviderProvisionedPollerConfig>,
    /// The name of the Amazon MQ broker destination queue to consume. Only available for MQ sources. The list must contain exactly one queue name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub queues: Option<Vec<String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_kafka_event_source_config:
        Option<EventSourceMappingStatusAtProviderSelfManagedKafkaEventSourceConfig>,
    /// :  For Self Managed Kafka sources, the access configuration for the source. If set, configuration must also include self_managed_event_source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub source_access_configuration:
        Option<Vec<EventSourceMappingStatusAtProviderSourceAccessConfiguration>>,
    /// The position in the stream where AWS Lambda should start reading. Must be one of AT_TIMESTAMP (Kinesis only), LATEST or TRIM_HORIZON if getting events from Kinesis, DynamoDB, MSK or Self Managed Apache Kafka. Must not be provided if getting events from SQS. More information about these positions can be found in the AWS DynamoDB Streams API Reference and AWS Kinesis API Reference.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
