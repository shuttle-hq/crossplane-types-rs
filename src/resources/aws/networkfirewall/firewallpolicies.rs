...
pub struct FirewallPolicyForProviderFirewallPolicy {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statefulEngineOptions"
    )]
    #[builder(default, setter(strip_option))]
    pub stateful_engine_options:
        Option<FirewallPolicyForProviderFirewallPolicyStatefulEngineOptions>,
    /// Set of configuration blocks containing references to the stateful rule groups that are used in the policy. See Stateful Rule Group Reference below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statefulRuleGroupReference"
    )]
    #[builder(default, setter(strip_option))]
    pub stateful_rule_group_reference:
        Option<Vec<FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReference>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessCustomAction"
    )]
    #[builder(default, setter(strip_option))]
    pub stateless_custom_action:
        Option<Vec<FirewallPolicyForProviderFirewallPolicyStatelessCustomAction>>,
    /// Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: aws:drop, aws:pass, or aws:forward_to_sfe.
    /// In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify aws:forward_to_sfe.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessDefaultActions"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessFragmentDefaultActions"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statelessRuleGroupReference"
    )]
    #[builder(default, setter(strip_option))]
    pub stateless_rule_group_reference:
        Option<Vec<FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReference>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "tlsInspectionConfigurationArn"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FirewallPolicyForProviderFirewallPolicyPolicyVariables {
    ...
    #[builder(default, setter(strip_option))]
    pub rule_variables:
        Option<Vec<FirewallPolicyForProviderFirewallPolicyPolicyVariablesRuleVariables>>,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatefulEngineOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub flow_timeouts:
        Option<FirewallPolicyForProviderFirewallPolicyStatefulEngineOptionsFlowTimeouts>,
...
pub struct FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReference {
    ...
    #[builder(default, setter(strip_option))]
    pub r#override:
        Option<FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceOverride>,
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_ref:
        Option<FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_selector: Option<
        FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelector,
    >,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRefPolicy,
    >,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyForProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelectorPolicy,
    >,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatelessCustomAction {
    ...
    #[builder(default, setter(strip_option))]
    pub action_definition:
        Option<FirewallPolicyForProviderFirewallPolicyStatelessCustomActionActionDefinition>,
...
pub struct FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReference {
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_ref:
        Option<FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRef>,
    /// Selector for a RuleGroup in networkfirewall to populate resourceArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_selector: Option<
        FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnSelector,
    >,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRefPolicy,
    >,
}
...
pub struct FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyForProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnSelectorPolicy,
    >,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub stateful_engine_options:
        Option<FirewallPolicyInitProviderFirewallPolicyStatefulEngineOptions>,
    /// Set of configuration blocks containing references to the stateful rule groups that are used in the policy. See Stateful Rule Group Reference below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub stateful_rule_group_reference:
        Option<Vec<FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReference>>,
    /// Set of configuration blocks describing the custom action definitions that are available for use in the firewall policy's stateless_default_actions. See Stateless Custom Action below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub stateless_custom_action:
        Option<Vec<FirewallPolicyInitProviderFirewallPolicyStatelessCustomAction>>,
    /// Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: aws:drop, aws:pass, or aws:forward_to_sfe.
    /// In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify aws:forward_to_sfe.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub stateless_rule_group_reference:
        Option<Vec<FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReference>>,
    /// The (ARN) of the TLS Inspection policy to attach to the FW Policy.  This must be added at creation of the resource per AWS documentation. "You can only add a TLS inspection configuration to a new policy, not to an existing policy."  This cannot be removed from a FW Policy.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FirewallPolicyInitProviderFirewallPolicyPolicyVariables {
    ...
    #[builder(default, setter(strip_option))]
    pub rule_variables:
        Option<Vec<FirewallPolicyInitProviderFirewallPolicyPolicyVariablesRuleVariables>>,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatefulEngineOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub flow_timeouts:
        Option<FirewallPolicyInitProviderFirewallPolicyStatefulEngineOptionsFlowTimeouts>,
    /// Indicates how to manage the order of stateful rule evaluation for the policy. Default value: DEFAULT_ACTION_ORDER. Valid values: DEFAULT_ACTION_ORDER, STRICT_ORDER.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ruleOrder")]
    #[builder(default, setter(strip_option))]
    pub rule_order: Option<String>,
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReference {
    ...
    #[builder(default, setter(strip_option))]
    pub r#override:
        Option<FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceOverride>,
    /// An integer setting that indicates the order in which to run the stateless rule groups in a single policy. AWS Network Firewall applies each stateless rule group to a packet starting with the group that has the lowest priority setting.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub priority: Option<f64>,
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_ref:
        Option<FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRef>,
    /// Selector for a RuleGroup in networkfirewall to populate resourceArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_selector: Option<
        FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelector,
    >,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnRefPolicy,
    >,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyInitProviderFirewallPolicyStatefulRuleGroupReferenceResourceArnSelectorPolicy,
    >,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatelessCustomAction {
    ...
    #[builder(default, setter(strip_option))]
    pub action_definition:
        Option<FirewallPolicyInitProviderFirewallPolicyStatelessCustomActionActionDefinition>,
    /// A friendly name of the custom action.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReference {
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_ref:
        Option<FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRef>,
    /// Selector for a RuleGroup in networkfirewall to populate resourceArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub resource_arn_selector: Option<
        FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnSelector,
    >,
}
...
pub struct FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FirewallPolicyInitProviderFirewallPolicyStatelessRuleGroupReferenceResourceArnRefPolicy,
    >,
}
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub stateful_engine_options:
        Option<FirewallPolicyStatusAtProviderFirewallPolicyStatefulEngineOptions>,
    /// Set of configuration blocks containing references to the stateful rule groups that are used in the policy. See Stateful Rule Group Reference below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub stateful_rule_group_reference:
        Option<Vec<FirewallPolicyStatusAtProviderFirewallPolicyStatefulRuleGroupReference>>,
    /// Set of configuration blocks describing the custom action definitions that are available for use in the firewall policy's stateless_default_actions. See Stateless Custom Action below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub stateless_custom_action:
        Option<Vec<FirewallPolicyStatusAtProviderFirewallPolicyStatelessCustomAction>>,
    /// Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: aws:drop, aws:pass, or aws:forward_to_sfe.
    /// In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify aws:forward_to_sfe.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub stateless_rule_group_reference:
        Option<Vec<FirewallPolicyStatusAtProviderFirewallPolicyStatelessRuleGroupReference>>,
    /// The (ARN) of the TLS Inspection policy to attach to the FW Policy.  This must be added at creation of the resource per AWS documentation. "You can only add a TLS inspection configuration to a new policy, not to an existing policy."  This cannot be removed from a FW Policy.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicyPolicyVariables {
    ...
    #[builder(default, setter(strip_option))]
    pub rule_variables:
        Option<Vec<FirewallPolicyStatusAtProviderFirewallPolicyPolicyVariablesRuleVariables>>,
}
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicyPolicyVariablesRuleVariables {
    ...
    #[builder(default, setter(strip_option))]
    pub ip_set:
        Option<FirewallPolicyStatusAtProviderFirewallPolicyPolicyVariablesRuleVariablesIpSet>,
    /// An alphanumeric string to identify the ip_set. Valid values: HOME_NET
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub key: Option<String>,
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicyStatefulEngineOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub flow_timeouts:
        Option<FirewallPolicyStatusAtProviderFirewallPolicyStatefulEngineOptionsFlowTimeouts>,
    /// Indicates how to manage the order of stateful rule evaluation for the policy. Default value: DEFAULT_ACTION_ORDER. Valid values: DEFAULT_ACTION_ORDER, STRICT_ORDER.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ruleOrder")]
    #[builder(default, setter(strip_option))]
    pub rule_order: Option<String>,
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicyStatefulRuleGroupReference {
    ...
    #[builder(default, setter(strip_option))]
    pub r#override:
        Option<FirewallPolicyStatusAtProviderFirewallPolicyStatefulRuleGroupReferenceOverride>,
    /// An integer setting that indicates the order in which to run the stateless rule groups in a single policy. AWS Network Firewall applies each stateless rule group to a packet starting with the group that has the lowest priority setting.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub priority: Option<f64>,
...
pub struct FirewallPolicyStatusAtProviderFirewallPolicyStatelessCustomAction {
    ...
    #[builder(default, setter(strip_option))]
    pub action_definition:
        Option<FirewallPolicyStatusAtProviderFirewallPolicyStatelessCustomActionActionDefinition>,
    /// A friendly name of the custom action.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
