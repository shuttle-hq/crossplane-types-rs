...
pub struct BucketReplicationConfigurationSpec {
    ...
    pub publish_connection_details_to:
        Option<BucketReplicationConfigurationPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref:
        Option<BucketReplicationConfigurationWriteConnectionSecretToRef>,
}
...
pub struct BucketReplicationConfigurationForProviderRule {
    ...
    #[builder(default, setter(strip_option))]
    pub delete_marker_replication:
        Option<BucketReplicationConfigurationForProviderRuleDeleteMarkerReplication>,
    ...
    #[builder(default, setter(strip_option))]
    pub existing_object_replication:
        Option<BucketReplicationConfigurationForProviderRuleExistingObjectReplication>,
    ...
    #[builder(default, setter(strip_option))]
    pub source_selection_criteria:
        Option<BucketReplicationConfigurationForProviderRuleSourceSelectionCriteria>,
...
pub struct BucketReplicationConfigurationForProviderRuleDestination {
    ...
    pub access_control_translation:
        Option<BucketReplicationConfigurationForProviderRuleDestinationAccessControlTranslation>,
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_selector:
        Option<BucketReplicationConfigurationForProviderRuleDestinationBucketSelector>,
    ...
    pub encryption_configuration:
        Option<BucketReplicationConfigurationForProviderRuleDestinationEncryptionConfiguration>,
    ...
    pub replication_time:
        Option<BucketReplicationConfigurationForProviderRuleDestinationReplicationTime>,
...
pub struct BucketReplicationConfigurationForProviderRuleDestinationBucketRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<BucketReplicationConfigurationForProviderRuleDestinationBucketRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<BucketReplicationConfigurationForProviderRuleDestinationBucketRefPolicyResolve>,
}
...
pub struct BucketReplicationConfigurationForProviderRuleDestinationBucketSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<BucketReplicationConfigurationForProviderRuleDestinationBucketSelectorPolicy>,
}
...
pub struct BucketReplicationConfigurationForProviderRuleDestinationBucketSelectorPolicy {
    ...
    pub resolution: Option<
        BucketReplicationConfigurationForProviderRuleDestinationBucketSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<BucketReplicationConfigurationForProviderRuleDestinationBucketSelectorPolicyResolve>,
}
...
pub struct BucketReplicationConfigurationForProviderRuleDestinationMetrics {
    ...
    #[builder(default, setter(strip_option))]
    pub event_threshold:
        Option<BucketReplicationConfigurationForProviderRuleDestinationMetricsEventThreshold>,
...
pub struct BucketReplicationConfigurationForProviderRuleSourceSelectionCriteria {
    ...
    pub replica_modifications: Option<
        BucketReplicationConfigurationForProviderRuleSourceSelectionCriteriaReplicaModifications,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub sse_kms_encrypted_objects: Option<
        BucketReplicationConfigurationForProviderRuleSourceSelectionCriteriaSseKmsEncryptedObjects,
    >,
}
...
pub struct BucketReplicationConfigurationInitProviderBucketSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<BucketReplicationConfigurationInitProviderBucketSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct BucketReplicationConfigurationInitProviderRule {
    ...
    #[builder(default, setter(strip_option))]
    pub delete_marker_replication:
        Option<BucketReplicationConfigurationInitProviderRuleDeleteMarkerReplication>,
    /// Specifies the destination for the rule. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub existing_object_replication:
        Option<BucketReplicationConfigurationInitProviderRuleExistingObjectReplication>,
    /// Filter that identifies subset of objects to which the replication rule applies. See below. If not specified, the rule will default to using prefix.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub source_selection_criteria:
        Option<BucketReplicationConfigurationInitProviderRuleSourceSelectionCriteria>,
    /// Status of the rule. Either "Enabled" or "Disabled". The rule is ignored if status is not "Enabled".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub status: Option<String>,
...
pub struct BucketReplicationConfigurationInitProviderRuleDestination {
    ...
    #[builder(default, setter(strip_option))]
    pub access_control_translation:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationAccessControlTranslation>,
    /// Account ID to specify the replica ownership. Must be used in conjunction with access_control_translation override configuration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub account: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_selector:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationBucketSelector>,
    /// Configuration block that provides information about encryption. See below. If source_selection_criteria is specified, you must specify this element.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub encryption_configuration:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationEncryptionConfiguration>,
    /// Configuration block that specifies replication metrics-related settings enabling replication metrics and events. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub replication_time:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationReplicationTime>,
    /// The storage class used to store the object. By default, Amazon S3 uses the storage class of the source object to create the object replica.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct BucketReplicationConfigurationInitProviderRuleDestinationBucketRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationBucketRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationBucketRefPolicyResolve>,
}
...
pub struct BucketReplicationConfigurationInitProviderRuleDestinationBucketSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationBucketSelectorPolicy>,
}
...
pub struct BucketReplicationConfigurationInitProviderRuleDestinationBucketSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        BucketReplicationConfigurationInitProviderRuleDestinationBucketSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        BucketReplicationConfigurationInitProviderRuleDestinationBucketSelectorPolicyResolve,
    >,
}
...
pub struct BucketReplicationConfigurationInitProviderRuleDestinationMetrics {
    ...
    #[builder(default, setter(strip_option))]
    pub event_threshold:
        Option<BucketReplicationConfigurationInitProviderRuleDestinationMetricsEventThreshold>,
    /// Whether the existing objects should be replicated. Either "Enabled" or "Disabled".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub status: Option<String>,
...
pub struct BucketReplicationConfigurationInitProviderRuleSourceSelectionCriteria {
    ...
    #[builder(default, setter(strip_option))]
    pub replica_modifications: Option<
        BucketReplicationConfigurationInitProviderRuleSourceSelectionCriteriaReplicaModifications,
    >,
    /// Configuration block for filter information for the selection of Amazon S3 objects encrypted with AWS KMS. If specified, replica_kms_key_id in destination encryption_configuration must be specified as well.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub sse_kms_encrypted_objects: Option<
        BucketReplicationConfigurationInitProviderRuleSourceSelectionCriteriaSseKmsEncryptedObjects,
    >,
}
...
pub struct BucketReplicationConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<BucketReplicationConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<BucketReplicationConfigurationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct BucketReplicationConfigurationStatusAtProviderRule {
    ...
    #[builder(default, setter(strip_option))]
    pub delete_marker_replication:
        Option<BucketReplicationConfigurationStatusAtProviderRuleDeleteMarkerReplication>,
    /// Specifies the destination for the rule. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub existing_object_replication:
        Option<BucketReplicationConfigurationStatusAtProviderRuleExistingObjectReplication>,
    /// Filter that identifies subset of objects to which the replication rule applies. See below. If not specified, the rule will default to using prefix.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub source_selection_criteria:
        Option<BucketReplicationConfigurationStatusAtProviderRuleSourceSelectionCriteria>,
    /// Status of the rule. Either "Enabled" or "Disabled". The rule is ignored if status is not "Enabled".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub status: Option<String>,
...
pub struct BucketReplicationConfigurationStatusAtProviderRuleDestination {
    ...
    pub access_control_translation: Option<
        BucketReplicationConfigurationStatusAtProviderRuleDestinationAccessControlTranslation,
    >,
    /// Account ID to specify the replica ownership. Must be used in conjunction with access_control_translation override configuration.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    pub encryption_configuration: Option<
        BucketReplicationConfigurationStatusAtProviderRuleDestinationEncryptionConfiguration,
    >,
    /// Configuration block that specifies replication metrics-related settings enabling replication metrics and events. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub replication_time:
        Option<BucketReplicationConfigurationStatusAtProviderRuleDestinationReplicationTime>,
    /// The storage class used to store the object. By default, Amazon S3 uses the storage class of the source object to create the object replica.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct BucketReplicationConfigurationStatusAtProviderRuleDestinationMetrics {
    ...
    #[builder(default, setter(strip_option))]
    pub event_threshold:
        Option<BucketReplicationConfigurationStatusAtProviderRuleDestinationMetricsEventThreshold>,
    /// Whether the existing objects should be replicated. Either "Enabled" or "Disabled".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub status: Option<String>,
...
pub struct BucketReplicationConfigurationStatusAtProviderRuleDestinationReplicationTime {
    ...
    #[builder(default, setter(strip_option))]
    pub time:
        Option<BucketReplicationConfigurationStatusAtProviderRuleDestinationReplicationTimeTime>,
}
