...
pub struct BucketStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "bucketRegionalDomainName"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "objectLockConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub server_side_encryption_configuration:
        Option<BucketStatusAtProviderServerSideEncryptionConfiguration>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
...
pub struct BucketStatusAtProviderLifecycleRule {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "abortIncompleteMultipartUploadDays"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub noncurrent_version_expiration:
        Option<BucketStatusAtProviderLifecycleRuleNoncurrentVersionExpiration>,
    ...
    pub noncurrent_version_transition:
        Option<Vec<BucketStatusAtProviderLifecycleRuleNoncurrentVersionTransition>>,
...
pub struct BucketStatusAtProviderObjectLockConfigurationRule {
    ...
    pub default_retention:
        Option<BucketStatusAtProviderObjectLockConfigurationRuleDefaultRetention>,
}
...
pub struct BucketStatusAtProviderReplicationConfigurationRules {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deleteMarkerReplicationStatus"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub source_selection_criteria:
        Option<BucketStatusAtProviderReplicationConfigurationRulesSourceSelectionCriteria>,
...
pub struct BucketStatusAtProviderReplicationConfigurationRulesDestination {
    ...
    pub access_control_translation: Option<
        BucketStatusAtProviderReplicationConfigurationRulesDestinationAccessControlTranslation,
    >,
    ...
    pub replication_time:
        Option<BucketStatusAtProviderReplicationConfigurationRulesDestinationReplicationTime>,
    /// Specifies the Amazon S3 storage class to which you want the object to transition.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
