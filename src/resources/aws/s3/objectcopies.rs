...
pub struct ObjectCopyForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "expectedSourceBucketOwner"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "kmsEncryptionContextSecretRef"
    )]
    #[builder(default, setter(strip_option))]
    pub kms_encryption_context_secret_ref:
        Option<ObjectCopyForProviderKmsEncryptionContextSecretRef>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceCustomerAlgorithm"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceCustomerKeySecretRef"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ObjectCopyInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub kms_encryption_context_secret_ref:
        Option<ObjectCopyInitProviderKmsEncryptionContextSecretRef>,
    /// Specifies the AWS KMS Key ARN to use for object encryption. This value is a fully qualified ARN of the KMS Key. If using aws_kms_key, use the exported arn attribute: kms_key_id = aws_kms_key.foo.arn
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
