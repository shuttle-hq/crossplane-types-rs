...
pub struct PoolRolesAttachmentForProviderRoleMapping {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ambiguousRoleResolution"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PoolRolesAttachmentForProviderRoleMappingMappingRule {
    ...
    pub role_arn_selector:
        Option<PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnSelector>,
...
pub struct PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnRefPolicyResolve>,
}
...
pub struct PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<PoolRolesAttachmentForProviderRoleMappingMappingRuleRoleArnSelectorPolicyResolve>,
}
...
pub struct PoolRolesAttachmentInitProviderRoleMappingMappingRule {
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnSelector>,
    /// A brief string that the claim must match, for example, "paid" or "yes".
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub value: Option<String>,
...
pub struct PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnRefPolicyResolve>,
}
...
pub struct PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnSelectorPolicy {
    ...
    pub resolution: Option<
        PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<PoolRolesAttachmentInitProviderRoleMappingMappingRuleRoleArnSelectorPolicyResolve>,
}
