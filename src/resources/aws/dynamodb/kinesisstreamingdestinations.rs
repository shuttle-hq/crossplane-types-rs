...
pub struct KinesisStreamingDestinationSpec {
    ...
    pub publish_connection_details_to:
        Option<KinesisStreamingDestinationPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref:
        Option<KinesisStreamingDestinationWriteConnectionSecretToRef>,
}
...
pub struct KinesisStreamingDestinationForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "approximateCreationDateTimePrecision"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct KinesisStreamingDestinationInitProviderStreamArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<KinesisStreamingDestinationInitProviderStreamArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct KinesisStreamingDestinationInitProviderTableNameSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<KinesisStreamingDestinationInitProviderTableNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct KinesisStreamingDestinationPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<KinesisStreamingDestinationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<KinesisStreamingDestinationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
