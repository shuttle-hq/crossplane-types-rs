...
pub struct OrganizationForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "awsServiceAccessPrincipals"
    )]
    #[builder(default, setter(strip_option))]
