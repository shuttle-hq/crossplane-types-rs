...
pub struct GatewayAssociationProposalSpec {
    ...
    pub write_connection_secret_to_ref:
        Option<GatewayAssociationProposalWriteConnectionSecretToRef>,
}
...
pub struct GatewayAssociationProposalForProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub associated_gateway_id_ref:
        Option<GatewayAssociationProposalForProviderAssociatedGatewayIdRef>,
    ...
    pub associated_gateway_id_selector:
        Option<GatewayAssociationProposalForProviderAssociatedGatewayIdSelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dxGatewayOwnerAccountIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub dx_gateway_owner_account_id_ref:
        Option<GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdRef>,
    /// Selector for a Gateway in directconnect to populate dxGatewayOwnerAccountId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dxGatewayOwnerAccountIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub dx_gateway_owner_account_id_selector:
        Option<GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdSelector>,
...
pub struct GatewayAssociationProposalForProviderAssociatedGatewayIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalForProviderAssociatedGatewayIdRefPolicyResolution>,
...
pub struct GatewayAssociationProposalForProviderAssociatedGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalForProviderAssociatedGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalForProviderAssociatedGatewayIdSelectorPolicyResolve>,
}
...
pub struct GatewayAssociationProposalForProviderDxGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalForProviderDxGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdRefPolicyResolve>,
}
...
pub struct GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdSelectorPolicy {
    ...
    pub resolution: Option<
        GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalForProviderDxGatewayOwnerAccountIdSelectorPolicyResolve>,
}
...
pub struct GatewayAssociationProposalInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub associated_gateway_id_ref:
        Option<GatewayAssociationProposalInitProviderAssociatedGatewayIdRef>,
    /// Selector for a VPNGateway in ec2 to populate associatedGatewayId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub associated_gateway_id_selector:
        Option<GatewayAssociationProposalInitProviderAssociatedGatewayIdSelector>,
    /// Direct Connect Gateway identifier.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub dx_gateway_owner_account_id_ref:
        Option<GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdRef>,
    /// Selector for a Gateway in directconnect to populate dxGatewayOwnerAccountId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub dx_gateway_owner_account_id_selector:
        Option<GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdSelector>,
}
...
pub struct GatewayAssociationProposalInitProviderAssociatedGatewayIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalInitProviderAssociatedGatewayIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct GatewayAssociationProposalInitProviderAssociatedGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalInitProviderAssociatedGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalInitProviderAssociatedGatewayIdSelectorPolicyResolve>,
}
...
pub struct GatewayAssociationProposalInitProviderDxGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalInitProviderDxGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdRefPolicyResolve>,
}
...
pub struct GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GatewayAssociationProposalInitProviderDxGatewayOwnerAccountIdSelectorPolicyResolve>,
}
...
pub struct GatewayAssociationProposalPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GatewayAssociationProposalPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
