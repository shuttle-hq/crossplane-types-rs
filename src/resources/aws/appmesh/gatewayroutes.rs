...
pub struct GatewayRouteForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "virtualGatewayNameSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct GatewayRouteForProviderSpecHttpRouteActionTargetVirtualService {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "virtualServiceNameRef"
    )]
    #[builder(default, setter(strip_option))]
    pub virtual_service_name_ref:
        Option<GatewayRouteForProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRef>,
    /// Selector for a VirtualService in appmesh to populate virtualServiceName.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "virtualServiceNameSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub virtual_service_name_selector: Option<
        GatewayRouteForProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameSelector,
    >,
}
...
pub struct GatewayRouteForProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        GatewayRouteForProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRefPolicy,
    >,
}
...
pub struct GatewayRouteInitProviderSpecHttpRouteActionTargetVirtualService {
    ...
    #[builder(default, setter(strip_option))]
    pub virtual_service_name_ref: Option<
        GatewayRouteInitProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRef,
    >,
    /// Selector for a VirtualService in appmesh to populate virtualServiceName.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub virtual_service_name_selector: Option<
        GatewayRouteInitProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameSelector,
    >,
}
...
pub struct GatewayRouteInitProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        GatewayRouteInitProviderSpecHttpRouteActionTargetVirtualServiceVirtualServiceNameRefPolicy,
    >,
}
...
pub struct GatewayRouteStatusAtProviderSpecGrpcRouteActionTarget {
    ...
    #[builder(default, setter(strip_option))]
    pub virtual_service:
        Option<GatewayRouteStatusAtProviderSpecGrpcRouteActionTargetVirtualService>,
}
...
pub struct GatewayRouteStatusAtProviderSpecHttp2RouteActionTarget {
    ...
    #[builder(default, setter(strip_option))]
    pub virtual_service:
        Option<GatewayRouteStatusAtProviderSpecHttp2RouteActionTargetVirtualService>,
}
...
pub struct GatewayRouteStatusAtProviderSpecHttpRouteActionTarget {
    ...
    #[builder(default, setter(strip_option))]
    pub virtual_service:
        Option<GatewayRouteStatusAtProviderSpecHttpRouteActionTargetVirtualService>,
}
