...
pub struct ReplicationInstanceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationInstanceClass"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationSubnetGroupId"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationSubnetGroupIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub replication_subnet_group_id_ref:
        Option<ReplicationInstanceForProviderReplicationSubnetGroupIdRef>,
    /// Selector for a ReplicationSubnetGroup in dms to populate replicationSubnetGroupId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationSubnetGroupIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub replication_subnet_group_id_selector:
        Option<ReplicationInstanceForProviderReplicationSubnetGroupIdSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_security_group_id_refs:
        Option<Vec<ReplicationInstanceForProviderVpcSecurityGroupIdRefs>>,
    ...
    pub vpc_security_group_id_selector:
        Option<ReplicationInstanceForProviderVpcSecurityGroupIdSelector>,
...
pub struct ReplicationInstanceForProviderReplicationSubnetGroupIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceForProviderReplicationSubnetGroupIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationInstanceForProviderReplicationSubnetGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceForProviderReplicationSubnetGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<ReplicationInstanceForProviderReplicationSubnetGroupIdSelectorPolicyResolve>,
}
...
pub struct ReplicationInstanceForProviderVpcSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceForProviderVpcSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationInstanceInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub replication_subnet_group_id_ref:
        Option<ReplicationInstanceInitProviderReplicationSubnetGroupIdRef>,
    /// Selector for a ReplicationSubnetGroup in dms to populate replicationSubnetGroupId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub replication_subnet_group_id_selector:
        Option<ReplicationInstanceInitProviderReplicationSubnetGroupIdSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_security_group_id_refs:
        Option<Vec<ReplicationInstanceInitProviderVpcSecurityGroupIdRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate vpcSecurityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_security_group_id_selector:
        Option<ReplicationInstanceInitProviderVpcSecurityGroupIdSelector>,
    /// A list of VPC security group IDs to be used with the replication instance. The VPC security groups must work with the VPC containing the replication instance.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ReplicationInstanceInitProviderReplicationSubnetGroupIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceInitProviderReplicationSubnetGroupIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationInstanceInitProviderReplicationSubnetGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceInitProviderReplicationSubnetGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<ReplicationInstanceInitProviderReplicationSubnetGroupIdSelectorPolicyResolve>,
}
...
pub struct ReplicationInstanceInitProviderVpcSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ReplicationInstanceInitProviderVpcSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ReplicationInstanceStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationInstancePrivateIps"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicationInstancePublicIps"
    )]
    #[builder(default, setter(strip_option))]
