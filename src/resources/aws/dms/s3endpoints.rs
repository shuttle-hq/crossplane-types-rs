...
pub struct S3EndpointForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "addTrailingPaddingCharacter"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "detachTargetOnLobLookupFailureParquet"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serverSideEncryptionKmsKeyIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_kms_key_id_ref:
        Option<S3EndpointForProviderServerSideEncryptionKmsKeyIdRef>,
    /// Selector for a Key in kms to populate serverSideEncryptionKmsKeyId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serverSideEncryptionKmsKeyIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_kms_key_id_selector:
        Option<S3EndpointForProviderServerSideEncryptionKmsKeyIdSelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceAccessRoleArnRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceAccessRoleArnSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct S3EndpointForProviderServerSideEncryptionKmsKeyIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<S3EndpointForProviderServerSideEncryptionKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct S3EndpointInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_kms_key_id_ref:
        Option<S3EndpointInitProviderServerSideEncryptionKmsKeyIdRef>,
    /// Selector for a Key in kms to populate serverSideEncryptionKmsKeyId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_kms_key_id_selector:
        Option<S3EndpointInitProviderServerSideEncryptionKmsKeyIdSelector>,
    /// ARN of the IAM role with permissions to the S3 Bucket.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub service_access_role_arn_selector:
        Option<S3EndpointInitProviderServiceAccessRoleArnSelector>,
    /// SSL mode to use for the connection. Valid values are none, require, verify-ca, verify-full. (AWS default is none.)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslMode")]
    #[builder(default, setter(strip_option))]
    pub ssl_mode: Option<String>,
...
pub struct S3EndpointInitProviderServerSideEncryptionKmsKeyIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<S3EndpointInitProviderServerSideEncryptionKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
