...
pub struct PipelineForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contentConfigPermissions"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "thumbnailConfigPermissions"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PipelineStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub thumbnail_config_permissions:
        Option<Vec<PipelineStatusAtProviderThumbnailConfigPermissions>>,
}
