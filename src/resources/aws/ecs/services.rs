...
pub struct ServiceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "availabilityZoneRebalancing"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deploymentCircuitBreaker"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deploymentMaximumPercent"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deploymentMinimumHealthyPercent"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "healthCheckGracePeriodSeconds"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serviceConnectConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpcLatticeConfigurations"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ServiceForProviderNetworkConfiguration {
    ...
    pub security_group_selector:
        Option<ServiceForProviderNetworkConfigurationSecurityGroupSelector>,
...
pub struct ServiceForProviderNetworkConfigurationSecurityGroupSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ServiceForProviderNetworkConfigurationSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServiceForProviderServiceConnectConfigurationLogConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub secret_option:
        Option<Vec<ServiceForProviderServiceConnectConfigurationLogConfigurationSecretOption>>,
}
...
pub struct ServiceForProviderServiceConnectConfigurationServiceTimeout {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "perRequestTimeoutSeconds"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ServiceForProviderServiceConnectConfigurationServiceTls {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "issuerCertAuthority"
    )]
    #[builder(default, setter(strip_option))]
    pub issuer_cert_authority:
        Option<ServiceForProviderServiceConnectConfigurationServiceTlsIssuerCertAuthority>,
...
pub struct ServiceForProviderVolumeConfigurationManagedEbsVolume {
    ...
    pub tag_specifications:
        Option<Vec<ServiceForProviderVolumeConfigurationManagedEbsVolumeTagSpecifications>>,
...
pub struct ServiceInitProviderNetworkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub security_group_selector:
        Option<ServiceInitProviderNetworkConfigurationSecurityGroupSelector>,
    /// Security groups associated with the task or service. If you do not specify a security group, the default security group for the VPC is used.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ServiceInitProviderNetworkConfigurationSecurityGroupRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ServiceInitProviderNetworkConfigurationSecurityGroupRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServiceInitProviderNetworkConfigurationSecurityGroupSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ServiceInitProviderNetworkConfigurationSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ServiceInitProviderServiceConnectConfigurationLogConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub secret_option:
        Option<Vec<ServiceInitProviderServiceConnectConfigurationLogConfigurationSecretOption>>,
}
...
pub struct ServiceInitProviderServiceConnectConfigurationServiceTls {
    ...
    #[builder(default, setter(strip_option))]
    pub issuer_cert_authority:
        Option<ServiceInitProviderServiceConnectConfigurationServiceTlsIssuerCertAuthority>,
    /// KMS key used to encrypt the private key in Secrets Manager.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKey")]
    #[builder(default, setter(strip_option))]
    pub kms_key: Option<String>,
...
pub struct ServiceInitProviderVolumeConfigurationManagedEbsVolume {
    ...
    #[builder(default, setter(strip_option))]
    pub tag_specifications:
        Option<Vec<ServiceInitProviderVolumeConfigurationManagedEbsVolumeTagSpecifications>>,
    /// Throughput to provision for a volume, in MiB/s, with a maximum of 1,000 MiB/s.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub throughput: Option<f64>,
...
pub struct ServiceStatusAtProviderServiceConnectConfiguration {
    ...
    pub log_configuration:
        Option<ServiceStatusAtProviderServiceConnectConfigurationLogConfiguration>,
    /// Namespace name or ARN of the aws_service_discovery_http_namespace for use with Service Connect.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub namespace: Option<String>,
...
pub struct ServiceStatusAtProviderServiceConnectConfigurationLogConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub secret_option:
        Option<Vec<ServiceStatusAtProviderServiceConnectConfigurationLogConfigurationSecretOption>>,
}
...
pub struct ServiceStatusAtProviderServiceConnectConfigurationServiceTls {
    ...
    #[builder(default, setter(strip_option))]
    pub issuer_cert_authority:
        Option<ServiceStatusAtProviderServiceConnectConfigurationServiceTlsIssuerCertAuthority>,
    /// KMS key used to encrypt the private key in Secrets Manager.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKey")]
    #[builder(default, setter(strip_option))]
    pub kms_key: Option<String>,
...
pub struct ServiceStatusAtProviderVolumeConfigurationManagedEbsVolume {
    ...
    #[builder(default, setter(strip_option))]
    pub tag_specifications:
        Option<Vec<ServiceStatusAtProviderVolumeConfigurationManagedEbsVolumeTagSpecifications>>,
    /// Throughput to provision for a volume, in MiB/s, with a maximum of 1,000 MiB/s.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub throughput: Option<f64>,
