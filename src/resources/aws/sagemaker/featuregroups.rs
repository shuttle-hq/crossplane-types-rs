...
pub struct FeatureGroupForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "recordIdentifierFeatureName"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FeatureGroupInitProviderFeatureDefinitionCollectionConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub vector_config:
        Option<FeatureGroupInitProviderFeatureDefinitionCollectionConfigVectorConfig>,
}
...
pub struct FeatureGroupStatusAtProviderFeatureDefinitionCollectionConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub vector_config:
        Option<FeatureGroupStatusAtProviderFeatureDefinitionCollectionConfigVectorConfig>,
}
...
pub struct FeatureGroupStatusAtProviderOfflineStoreConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub data_catalog_config:
        Option<FeatureGroupStatusAtProviderOfflineStoreConfigDataCatalogConfig>,
    /// Set to true to turn Online Store On.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
