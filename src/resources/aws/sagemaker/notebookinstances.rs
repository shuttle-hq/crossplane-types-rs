...
pub struct NotebookInstanceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultCodeRepositoryRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultCodeRepositorySelector"
    )]
    #[builder(default, setter(strip_option))]
    pub default_code_repository_selector:
        Option<NotebookInstanceForProviderDefaultCodeRepositorySelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "instanceMetadataServiceConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub instance_metadata_service_configuration:
        Option<NotebookInstanceForProviderInstanceMetadataServiceConfiguration>,
...
pub struct NotebookInstanceForProviderDefaultCodeRepositorySelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NotebookInstanceForProviderDefaultCodeRepositorySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NotebookInstanceForProviderInstanceMetadataServiceConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "minimumInstanceMetadataServiceVersion"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct NotebookInstanceInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub default_code_repository_selector:
        Option<NotebookInstanceInitProviderDefaultCodeRepositorySelector>,
    /// Set to Disabled to disable internet access to notebook. Requires security_groups and subnet_id to be set. Supported values: Enabled (Default) or Disabled. If set to Disabled, the notebook instance will be able to access resources only in your VPC, and will not be able to connect to Amazon SageMaker training and endpoint services unless your configure a NAT Gateway in your VPC.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub instance_metadata_service_configuration:
        Option<NotebookInstanceInitProviderInstanceMetadataServiceConfiguration>,
    /// The name of ML compute instance type.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct NotebookInstanceInitProviderDefaultCodeRepositorySelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NotebookInstanceInitProviderDefaultCodeRepositorySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NotebookInstanceStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub instance_metadata_service_configuration:
        Option<NotebookInstanceStatusAtProviderInstanceMetadataServiceConfiguration>,
    /// The name of ML compute instance type.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
