...
pub struct WorkteamForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "notificationConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "workerAccessConfiguration"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct WorkteamForProviderMemberDefinition {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cognitoMemberDefinition"
    )]
    #[builder(default, setter(strip_option))]
    pub cognito_member_definition:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinition>,
    /// A list user groups that exist in your OIDC Identity Provider (IdP). One to ten groups can be used to create a single private work team. See Cognito Member Definition details below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "oidcMemberDefinition"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinition {
    ...
    #[builder(default, setter(strip_option))]
    pub client_id_ref:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub client_id_selector:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_group_ref:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRef>,
    /// Selector for a UserGroup in cognitoidp to populate userGroup.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userGroupSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub user_group_selector:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_pool_ref:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolRef>,
    /// Selector for a UserPoolDomain in cognitoidp to populate userPool.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userPoolSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub user_pool_selector:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelector>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicy {
    ...
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicyResolution,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicyResolve>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicy>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicyResolve,
    >,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicy>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicyResolve>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelectorPolicy>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelectorPolicyResolve,
    >,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicyResolve>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicy>,
}
...
pub struct WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamForProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicyResolve,
    >,
}
...
pub struct WorkteamForProviderWorkerAccessConfigurationS3Presign {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "iamPolicyConstraints"
    )]
    #[builder(default, setter(strip_option))]
    pub iam_policy_constraints:
        Option<WorkteamForProviderWorkerAccessConfigurationS3PresignIamPolicyConstraints>,
}
...
pub struct WorkteamInitProviderMemberDefinition {
    ...
    #[builder(default, setter(strip_option))]
    pub cognito_member_definition:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinition>,
    /// A list user groups that exist in your OIDC Identity Provider (IdP). One to ten groups can be used to create a single private work team. See Cognito Member Definition details below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinition {
    ...
    #[builder(default, setter(strip_option))]
    pub client_id_ref:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRef>,
    /// Selector for a UserPoolClient in cognitoidp to populate clientId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub client_id_selector:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelector>,
    /// An identifier for a user group.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userGroup")]
    #[builder(default, setter(strip_option))]
    pub user_group: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_group_ref:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRef>,
    /// Selector for a UserGroup in cognitoidp to populate userGroup.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_group_selector:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelector>,
    /// An identifier for a user pool. The user pool must be in the same region as the service that you are calling.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPool")]
    #[builder(default, setter(strip_option))]
    pub user_pool: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_pool_ref:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRef>,
    /// Selector for a UserPoolDomain in cognitoidp to populate userPool.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_pool_selector:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelector>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdRefPolicyResolve>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionClientIdSelectorPolicyResolve,
    >,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupRefPolicyResolve,
    >,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserGroupSelectorPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolRefPolicyResolve>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicy>,
}
...
pub struct WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        WorkteamInitProviderMemberDefinitionCognitoMemberDefinitionUserPoolSelectorPolicyResolve,
    >,
}
...
pub struct WorkteamInitProviderWorkerAccessConfigurationS3Presign {
    ...
    #[builder(default, setter(strip_option))]
    pub iam_policy_constraints:
        Option<WorkteamInitProviderWorkerAccessConfigurationS3PresignIamPolicyConstraints>,
}
...
pub struct WorkteamStatusAtProviderMemberDefinition {
    ...
    #[builder(default, setter(strip_option))]
    pub cognito_member_definition:
        Option<WorkteamStatusAtProviderMemberDefinitionCognitoMemberDefinition>,
    /// A list user groups that exist in your OIDC Identity Provider (IdP). One to ten groups can be used to create a single private work team. See Cognito Member Definition details below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub oidc_member_definition:
        Option<WorkteamStatusAtProviderMemberDefinitionOidcMemberDefinition>,
}
...
pub struct WorkteamStatusAtProviderWorkerAccessConfigurationS3Presign {
    ...
    #[builder(default, setter(strip_option))]
    pub iam_policy_constraints:
        Option<WorkteamStatusAtProviderWorkerAccessConfigurationS3PresignIamPolicyConstraints>,
}
