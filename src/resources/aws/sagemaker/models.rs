...
pub struct ModelForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "inferenceExecutionConfig"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ModelForProviderContainer {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "inferenceSpecificationName"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ModelForProviderContainerImageConfigRepositoryAuthConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "repositoryCredentialsProviderArn"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ModelForProviderContainerModelDataSourceS3DataSource {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "modelAccessConfig"
    )]
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelForProviderContainerModelDataSourceS3DataSourceModelAccessConfig>,
...
pub struct ModelForProviderPrimaryContainerImageConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub repository_auth_config:
        Option<ModelForProviderPrimaryContainerImageConfigRepositoryAuthConfig>,
}
...
pub struct ModelForProviderPrimaryContainerModelDataSourceS3DataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelForProviderPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig>,
    /// The type of model data to deploy. Allowed values are: S3Object and S3Prefix.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ModelInitProviderContainerModelDataSourceS3DataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelInitProviderContainerModelDataSourceS3DataSourceModelAccessConfig>,
    /// The type of model data to deploy. Allowed values are: S3Object and S3Prefix.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ModelInitProviderPrimaryContainerImageConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub repository_auth_config:
        Option<ModelInitProviderPrimaryContainerImageConfigRepositoryAuthConfig>,
}
...
pub struct ModelInitProviderPrimaryContainerModelDataSourceS3DataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelInitProviderPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig>,
    /// The type of model data to deploy. Allowed values are: S3Object and S3Prefix.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ModelStatusAtProviderContainerImageConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub repository_auth_config:
        Option<ModelStatusAtProviderContainerImageConfigRepositoryAuthConfig>,
}
...
pub struct ModelStatusAtProviderContainerModelDataSourceS3DataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelStatusAtProviderContainerModelDataSourceS3DataSourceModelAccessConfig>,
    /// The type of model data to deploy. Allowed values are: S3Object and S3Prefix.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ModelStatusAtProviderPrimaryContainerImageConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub repository_auth_config:
        Option<ModelStatusAtProviderPrimaryContainerImageConfigRepositoryAuthConfig>,
}
...
pub struct ModelStatusAtProviderPrimaryContainerModelDataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub s3_data_source:
        Option<Vec<ModelStatusAtProviderPrimaryContainerModelDataSourceS3DataSource>>,
}
...
pub struct ModelStatusAtProviderPrimaryContainerModelDataSourceS3DataSource {
    ...
    #[builder(default, setter(strip_option))]
    pub model_access_config:
        Option<ModelStatusAtProviderPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig>,
    /// The type of model data to deploy. Allowed values are: S3Object and S3Prefix.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
