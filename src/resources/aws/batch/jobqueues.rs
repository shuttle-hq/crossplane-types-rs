...
pub struct JobQueueForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "computeEnvironmentOrder"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "jobStateTimeLimitAction"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "schedulingPolicyArnSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct JobQueueForProviderComputeEnvironmentOrder {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "computeEnvironmentRef"
    )]
    #[builder(default, setter(strip_option))]
    pub compute_environment_ref:
        Option<JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentRef>,
    /// Selector for a ComputeEnvironment in batch to populate computeEnvironment.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "computeEnvironmentSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub compute_environment_selector:
        Option<JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentSelector>,
...
pub struct JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentRefPolicyResolution>,
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentRefPolicyResolve>,
}
...
pub struct JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicy {
    ...
    pub resolution: Option<
        JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<JobQueueForProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicyResolve>,
}
...
pub struct JobQueueInitProviderComputeEnvironmentOrder {
    ...
    #[builder(default, setter(strip_option))]
    pub compute_environment_ref:
        Option<JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentRef>,
    /// Selector for a ComputeEnvironment in batch to populate computeEnvironment.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub compute_environment_selector:
        Option<JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentSelector>,
    /// The order of the compute environment. Compute environments are tried in ascending order. For example, if two compute environments are associated with a job queue, the compute environment with a lower order integer value is tried for job placement first.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub order: Option<f64>,
...
pub struct JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentRefPolicyResolve>,
}
...
pub struct JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<JobQueueInitProviderComputeEnvironmentOrderComputeEnvironmentSelectorPolicyResolve>,
}
