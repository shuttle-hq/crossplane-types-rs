...
pub struct UserForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "temporaryPasswordSecretRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "validationData"
    )]
    #[builder(default, setter(strip_option))]
    pub validation_data: Option<BTreeMap<String, String>>,
}
