...
pub struct RiskConfigurationForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "accountTakeoverRiskConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub account_takeover_risk_configuration:
        Option<RiskConfigurationForProviderAccountTakeoverRiskConfiguration>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "compromisedCredentialsRiskConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub compromised_credentials_risk_configuration:
        Option<RiskConfigurationForProviderCompromisedCredentialsRiskConfiguration>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "riskExceptionConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub risk_exception_configuration:
        Option<RiskConfigurationForProviderRiskExceptionConfiguration>,
    /// The user pool ID.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct RiskConfigurationForProviderAccountTakeoverRiskConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "notifyConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub notify_configuration:
        Option<RiskConfigurationForProviderAccountTakeoverRiskConfigurationNotifyConfiguration>,
}
...
pub struct RiskConfigurationForProviderAccountTakeoverRiskConfigurationActions {
    ...
    #[builder(default, setter(strip_option))]
    pub high_action:
        Option<RiskConfigurationForProviderAccountTakeoverRiskConfigurationActionsHighAction>,
    /// Action to take for a low risk. See action block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lowAction")]
    #[builder(default, setter(strip_option))]
    pub low_action:
        Option<RiskConfigurationForProviderAccountTakeoverRiskConfigurationActionsLowAction>,
    ...
    #[builder(default, setter(strip_option))]
    pub medium_action:
        Option<RiskConfigurationForProviderAccountTakeoverRiskConfigurationActionsMediumAction>,
}
...
pub struct RiskConfigurationInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub account_takeover_risk_configuration:
        Option<RiskConfigurationInitProviderAccountTakeoverRiskConfiguration>,
    /// The app client ID. When the client ID is not provided, the same risk configuration is applied to all the clients in the User Pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientId")]
    #[builder(default, setter(strip_option))]
    pub client_id: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub compromised_credentials_risk_configuration:
        Option<RiskConfigurationInitProviderCompromisedCredentialsRiskConfiguration>,
    /// The configuration to override the risk decision. See details below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub risk_exception_configuration:
        Option<RiskConfigurationInitProviderRiskExceptionConfiguration>,
    /// The user pool ID.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct RiskConfigurationInitProviderAccountTakeoverRiskConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub notify_configuration:
        Option<RiskConfigurationInitProviderAccountTakeoverRiskConfigurationNotifyConfiguration>,
}
...
pub struct RiskConfigurationInitProviderAccountTakeoverRiskConfigurationActions {
    ...
    #[builder(default, setter(strip_option))]
    pub high_action:
        Option<RiskConfigurationInitProviderAccountTakeoverRiskConfigurationActionsHighAction>,
    /// Action to take for a low risk. See action block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lowAction")]
    #[builder(default, setter(strip_option))]
    pub low_action:
        Option<RiskConfigurationInitProviderAccountTakeoverRiskConfigurationActionsLowAction>,
    /// Action to take for a medium risk. See action block below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub medium_action:
        Option<RiskConfigurationInitProviderAccountTakeoverRiskConfigurationActionsMediumAction>,
}
...
pub struct RiskConfigurationInitProviderCompromisedCredentialsRiskConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub actions:
        Option<RiskConfigurationInitProviderCompromisedCredentialsRiskConfigurationActions>,
    /// Perform the action for these events. The default is to perform all events if no event filter is specified. Valid values are SIGN_IN, PASSWORD_CHANGE, and SIGN_UP.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct RiskConfigurationStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub account_takeover_risk_configuration:
        Option<RiskConfigurationStatusAtProviderAccountTakeoverRiskConfiguration>,
    /// The app client ID. When the client ID is not provided, the same risk configuration is applied to all the clients in the User Pool.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientId")]
    #[builder(default, setter(strip_option))]
    pub client_id: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub compromised_credentials_risk_configuration:
        Option<RiskConfigurationStatusAtProviderCompromisedCredentialsRiskConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub risk_exception_configuration:
        Option<RiskConfigurationStatusAtProviderRiskExceptionConfiguration>,
    /// The user pool ID.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct RiskConfigurationStatusAtProviderAccountTakeoverRiskConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub notify_configuration: Option<
        RiskConfigurationStatusAtProviderAccountTakeoverRiskConfigurationNotifyConfiguration,
    >,
}
...
pub struct RiskConfigurationStatusAtProviderAccountTakeoverRiskConfigurationActions {
    ...
    #[builder(default, setter(strip_option))]
    pub high_action:
        Option<RiskConfigurationStatusAtProviderAccountTakeoverRiskConfigurationActionsHighAction>,
    /// Action to take for a low risk. See action block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lowAction")]
    #[builder(default, setter(strip_option))]
    pub low_action:
        Option<RiskConfigurationStatusAtProviderAccountTakeoverRiskConfigurationActionsLowAction>,
    /// Action to take for a medium risk. See action block below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub medium_action: Option<
        RiskConfigurationStatusAtProviderAccountTakeoverRiskConfigurationActionsMediumAction,
    >,
}
...
pub struct RiskConfigurationStatusAtProviderCompromisedCredentialsRiskConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub actions:
        Option<RiskConfigurationStatusAtProviderCompromisedCredentialsRiskConfigurationActions>,
    /// Perform the action for these events. The default is to perform all events if no event filter is specified. Valid values are SIGN_IN, PASSWORD_CHANGE, and SIGN_UP.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
