...
pub struct RestAPIForProviderEndpointConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpcEndpointIdsRefs"
    )]
    #[builder(default, setter(strip_option))]
    pub vpc_endpoint_ids_refs:
        Option<Vec<RestAPIForProviderEndpointConfigurationVpcEndpointIdsRefs>>,
    /// Selector for a list of VPCEndpoint in ec2 to populate vpcEndpointIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpcEndpointIdsSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub vpc_endpoint_ids_selector:
        Option<RestAPIForProviderEndpointConfigurationVpcEndpointIdsSelector>,
}
...
pub struct RestAPIForProviderEndpointConfigurationVpcEndpointIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<RestAPIForProviderEndpointConfigurationVpcEndpointIdsRefsPolicyResolution>,
...
pub struct RestAPIForProviderEndpointConfigurationVpcEndpointIdsSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<RestAPIForProviderEndpointConfigurationVpcEndpointIdsSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct RestAPIInitProviderEndpointConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_endpoint_ids_refs:
        Option<Vec<RestAPIInitProviderEndpointConfigurationVpcEndpointIdsRefs>>,
    /// Selector for a list of VPCEndpoint in ec2 to populate vpcEndpointIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_endpoint_ids_selector:
        Option<RestAPIInitProviderEndpointConfigurationVpcEndpointIdsSelector>,
}
...
pub struct RestAPIInitProviderEndpointConfigurationVpcEndpointIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<RestAPIInitProviderEndpointConfigurationVpcEndpointIdsRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct RestAPIInitProviderEndpointConfigurationVpcEndpointIdsSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<RestAPIInitProviderEndpointConfigurationVpcEndpointIdsSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<RestAPIInitProviderEndpointConfigurationVpcEndpointIdsSelectorPolicyResolve>,
}
