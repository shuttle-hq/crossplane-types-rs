...
pub struct DomainNameForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "certificatePrivateKeySecretRef"
    )]
    #[builder(default, setter(strip_option))]
    pub certificate_private_key_secret_ref:
        Option<DomainNameForProviderCertificatePrivateKeySecretRef>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "regionalCertificateArnRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "regionalCertificateArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub regional_certificate_arn_selector:
        Option<DomainNameForProviderRegionalCertificateArnSelector>,
    /// User-friendly name of the certificate that will be used by regional endpoint for this domain name. Conflicts with certificate_arn, certificate_name, certificate_body, certificate_chain, and certificate_private_key.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "regionalCertificateName"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DomainNameInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub certificate_private_key_secret_ref:
        Option<DomainNameInitProviderCertificatePrivateKeySecretRef>,
    /// Fully-qualified domain name to register.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub regional_certificate_arn_selector:
        Option<DomainNameInitProviderRegionalCertificateArnSelector>,
    /// User-friendly name of the certificate that will be used by regional endpoint for this domain name. Conflicts with certificate_arn, certificate_name, certificate_body, certificate_chain, and certificate_private_key.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
