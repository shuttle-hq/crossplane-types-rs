...
pub struct StageForProviderCanarySettings {
    ...
    #[builder(default, setter(strip_option))]
    pub stage_variable_overrides: Option<BTreeMap<String, String>>,
