...
pub struct StackSetInstanceForProviderOperationPreferences {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "failureTolerancePercentage"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maxConcurrentPercentage"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct StackSetInstanceStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "stackInstanceSummaries"
    )]
    #[builder(default, setter(strip_option))]
    pub stack_instance_summaries:
        Option<Vec<StackSetInstanceStatusAtProviderStackInstanceSummaries>>,
    /// Name of the StackSet.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
