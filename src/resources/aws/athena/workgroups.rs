...
pub struct WorkgroupForProviderConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "bytesScannedCutoffPerQuery"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "enforceWorkgroupConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "publishCloudwatchMetricsEnabled"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct WorkgroupForProviderConfigurationResultConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "aclConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub acl_configuration:
        Option<WorkgroupForProviderConfigurationResultConfigurationAclConfiguration>,
    ...
    pub encryption_configuration:
        Option<WorkgroupForProviderConfigurationResultConfigurationEncryptionConfiguration>,
...
pub struct WorkgroupInitProviderConfigurationResultConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub acl_configuration:
        Option<WorkgroupInitProviderConfigurationResultConfigurationAclConfiguration>,
    /// Configuration block with encryption settings. See Encryption Configuration below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub encryption_configuration:
        Option<WorkgroupInitProviderConfigurationResultConfigurationEncryptionConfiguration>,
    /// AWS account ID that you expect to be the owner of the Amazon S3 bucket.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct WorkgroupStatusAtProviderConfigurationResultConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub acl_configuration:
        Option<WorkgroupStatusAtProviderConfigurationResultConfigurationAclConfiguration>,
    /// Configuration block with encryption settings. See Encryption Configuration below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub encryption_configuration:
        Option<WorkgroupStatusAtProviderConfigurationResultConfigurationEncryptionConfiguration>,
    /// AWS account ID that you expect to be the owner of the Amazon S3 bucket.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
