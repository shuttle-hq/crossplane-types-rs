...
pub struct CustomActionTypeForProviderSettings {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "thirdPartyConfigurationUrl"
    )]
    #[builder(default, setter(strip_option))]
