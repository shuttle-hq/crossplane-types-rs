...
pub struct OntapStorageVirtualMachineSpec {
    ...
    pub write_connection_secret_to_ref:
        Option<OntapStorageVirtualMachineWriteConnectionSecretToRef>,
}
...
pub struct OntapStorageVirtualMachineForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "activeDirectoryConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub active_directory_configuration:
        Option<OntapStorageVirtualMachineForProviderActiveDirectoryConfiguration>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "rootVolumeSecurityStyle"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "svmAdminPasswordSecretRef"
    )]
    #[builder(default, setter(strip_option))]
    pub svm_admin_password_secret_ref:
        Option<OntapStorageVirtualMachineForProviderSvmAdminPasswordSecretRef>,
...
pub struct OntapStorageVirtualMachineForProviderFileSystemIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<OntapStorageVirtualMachineForProviderFileSystemIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct OntapStorageVirtualMachineInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub active_directory_configuration:
        Option<OntapStorageVirtualMachineInitProviderActiveDirectoryConfiguration>,
    /// The ID of the Amazon FSx ONTAP File System that this SVM will be created on.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub svm_admin_password_secret_ref:
        Option<OntapStorageVirtualMachineInitProviderSvmAdminPasswordSecretRef>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
...
pub struct OntapStorageVirtualMachineInitProviderFileSystemIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<OntapStorageVirtualMachineInitProviderFileSystemIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct OntapStorageVirtualMachinePublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<OntapStorageVirtualMachinePublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct OntapStorageVirtualMachineStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub active_directory_configuration:
        Option<OntapStorageVirtualMachineStatusAtProviderActiveDirectoryConfiguration>,
