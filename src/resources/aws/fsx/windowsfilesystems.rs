...
pub struct WindowsFileSystemForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "activeDirectoryIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "finalBackupTags"
    )]
    #[builder(default, setter(strip_option))]
    pub final_backup_tags: Option<BTreeMap<String, String>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "selfManagedActiveDirectory"
    )]
    #[builder(default, setter(strip_option))]
    pub self_managed_active_directory:
        Option<WindowsFileSystemForProviderSelfManagedActiveDirectory>,
...
pub struct WindowsFileSystemForProviderAuditLogConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "fileAccessAuditLogLevel"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "fileShareAccessAuditLogLevel"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct WindowsFileSystemForProviderSelfManagedActiveDirectory {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "fileSystemAdministratorsGroup"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub password_secret_ref:
        Option<WindowsFileSystemForProviderSelfManagedActiveDirectoryPasswordSecretRef>,
...
pub struct WindowsFileSystemInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub active_directory_id_selector:
        Option<WindowsFileSystemInitProviderActiveDirectoryIdSelector>,
    /// An array DNS alias names that you want to associate with the Amazon FSx file system.  For more information, see Working with DNS Aliases
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub aliases: Option<Vec<String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_active_directory:
        Option<WindowsFileSystemInitProviderSelfManagedActiveDirectory>,
    /// When enabled, will skip the default final backup taken when the file system is deleted. This configuration must be applied separately before attempting to delete the resource to have the desired behavior. Defaults to false.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct WindowsFileSystemInitProviderSelfManagedActiveDirectory {
    ...
    pub password_secret_ref:
        WindowsFileSystemInitProviderSelfManagedActiveDirectoryPasswordSecretRef,
    /// The user name for the service account on your self-managed AD domain that Amazon FSx will use to join to your AD domain.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub username: Option<String>,
...
pub struct WindowsFileSystemStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "remoteAdministrationEndpoint"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_active_directory:
        Option<WindowsFileSystemStatusAtProviderSelfManagedActiveDirectory>,
    /// When enabled, will skip the default final backup taken when the file system is deleted. This configuration must be applied separately before attempting to delete the resource to have the desired behavior. Defaults to false.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
