...
pub struct LBTargetGroupForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "lambdaMultiValueHeadersEnabled"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancingAlgorithmType"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancingAnomalyMitigation"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancingCrossZoneEnabled"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct LBTargetGroupForProviderTargetGroupHealth {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unhealthyStateRouting"
    )]
    #[builder(default, setter(strip_option))]
    pub unhealthy_state_routing:
        Option<LBTargetGroupForProviderTargetGroupHealthUnhealthyStateRouting>,
}
...
pub struct LBTargetGroupForProviderTargetGroupHealthDnsFailover {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "minimumHealthyTargetsCount"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "minimumHealthyTargetsPercentage"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct LBTargetGroupForProviderTargetHealthState {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "enableUnhealthyConnectionTermination"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unhealthyDrainingInterval"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct LBTargetGroupInitProviderTargetGroupHealth {
    ...
    #[builder(default, setter(strip_option))]
    pub unhealthy_state_routing:
        Option<LBTargetGroupInitProviderTargetGroupHealthUnhealthyStateRouting>,
}
...
pub struct LBTargetGroupStatusAtProviderTargetGroupHealth {
    ...
    #[builder(default, setter(strip_option))]
    pub unhealthy_state_routing:
        Option<LBTargetGroupStatusAtProviderTargetGroupHealthUnhealthyStateRouting>,
}
