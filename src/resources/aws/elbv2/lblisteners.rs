...
pub struct LBListenerForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancerArnSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct LBListenerForProviderDefaultActionAuthenticateOidc {
    ...
    pub client_secret_secret_ref:
        Option<LBListenerForProviderDefaultActionAuthenticateOidcClientSecretSecretRef>,
...
pub struct LBListenerForProviderDefaultActionForwardTargetGroupArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerForProviderDefaultActionForwardTargetGroupArnRefPolicyResolution>,
...
pub struct LBListenerForProviderDefaultActionForwardTargetGroupArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerForProviderDefaultActionForwardTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<LBListenerForProviderDefaultActionForwardTargetGroupArnSelectorPolicyResolve>,
}
...
pub struct LBListenerForProviderDefaultActionTargetGroupArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerForProviderDefaultActionTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LBListenerForProviderMutualAuthentication {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "advertiseTrustStoreCaNames"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ignoreClientCertificateExpiry"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct LBListenerInitProviderDefaultAction {
    ...
    pub target_group_arn_selector:
        Option<LBListenerInitProviderDefaultActionTargetGroupArnSelector>,
    /// Type of routing action. Valid values are forward, redirect, fixed-response, authenticate-cognito and authenticate-oidc.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    #[builder(default, setter(strip_option))]
    pub r#type: Option<String>,
...
pub struct LBListenerInitProviderDefaultActionAuthenticateOidc {
    ...
    pub client_secret_secret_ref:
        LBListenerInitProviderDefaultActionAuthenticateOidcClientSecretSecretRef,
    /// OIDC issuer identifier of the IdP.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub issuer: Option<String>,
...
pub struct LBListenerInitProviderDefaultActionForwardTargetGroupArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerInitProviderDefaultActionForwardTargetGroupArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct LBListenerInitProviderDefaultActionForwardTargetGroupArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerInitProviderDefaultActionForwardTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<LBListenerInitProviderDefaultActionForwardTargetGroupArnSelectorPolicyResolve>,
}
...
pub struct LBListenerInitProviderDefaultActionTargetGroupArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<LBListenerInitProviderDefaultActionTargetGroupArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
