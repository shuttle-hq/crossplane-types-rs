...
pub struct TopicSubscriptionForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "confirmationTimeoutInMinutes"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "subscriptionRoleArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub subscription_role_arn_selector:
        Option<TopicSubscriptionForProviderSubscriptionRoleArnSelector>,
...
pub struct TopicSubscriptionInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub subscription_role_arn_selector:
        Option<TopicSubscriptionInitProviderSubscriptionRoleArnSelector>,
    /// ARN of the SNS topic to subscribe to.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "topicArn")]
    #[builder(default, setter(strip_option))]
    pub topic_arn: Option<String>,
...
pub struct TopicSubscriptionInitProviderSubscriptionRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TopicSubscriptionInitProviderSubscriptionRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
