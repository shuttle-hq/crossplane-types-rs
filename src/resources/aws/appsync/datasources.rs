...
pub struct DatasourceForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "opensearchserviceConfig"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "relationalDatabaseConfig"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DatasourceForProviderRelationalDatabaseConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "httpEndpointConfig"
    )]
    #[builder(default, setter(strip_option))]
    pub http_endpoint_config:
        Option<DatasourceForProviderRelationalDatabaseConfigHttpEndpointConfig>,
...
pub struct DatasourceInitProviderRelationalDatabaseConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub http_endpoint_config:
        Option<DatasourceInitProviderRelationalDatabaseConfigHttpEndpointConfig>,
    /// Source type for the relational database. Valid values: RDS_HTTP_ENDPOINT.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DatasourceStatusAtProviderRelationalDatabaseConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub http_endpoint_config:
        Option<DatasourceStatusAtProviderRelationalDatabaseConfigHttpEndpointConfig>,
    /// Source type for the relational database. Valid values: RDS_HTTP_ENDPOINT.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
