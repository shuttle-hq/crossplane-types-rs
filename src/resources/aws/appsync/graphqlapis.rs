...
pub struct GraphQLAPIForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "additionalAuthenticationProvider"
    )]
    #[builder(default, setter(strip_option))]
    pub additional_authentication_provider:
        Option<Vec<GraphQLAPIForProviderAdditionalAuthenticationProvider>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "mergedApiExecutionRoleArn"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "mergedApiExecutionRoleArnRef"
    )]
    #[builder(default, setter(strip_option))]
    pub merged_api_execution_role_arn_ref:
        Option<GraphQLAPIForProviderMergedApiExecutionRoleArnRef>,
    /// Selector for a Role in iam to populate mergedApiExecutionRoleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "mergedApiExecutionRoleArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub merged_api_execution_role_arn_selector:
        Option<GraphQLAPIForProviderMergedApiExecutionRoleArnSelector>,
...
pub struct GraphQLAPIForProviderAdditionalAuthenticationProvider {
    ...
    pub lambda_authorizer_config:
        Option<GraphQLAPIForProviderAdditionalAuthenticationProviderLambdaAuthorizerConfig>,
    /// Nested argument containing OpenID Connect configuration. See openid_connect_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub openid_connect_config:
        Option<GraphQLAPIForProviderAdditionalAuthenticationProviderOpenidConnectConfig>,
    /// Amazon Cognito User Pool configuration. See user_pool_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub user_pool_config:
        Option<GraphQLAPIForProviderAdditionalAuthenticationProviderUserPoolConfig>,
}
...
pub struct GraphQLAPIForProviderEnhancedMetricsConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataSourceLevelMetricsBehavior"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "operationLevelMetricsConfig"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "resolverLevelMetricsBehavior"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct GraphQLAPIForProviderLogConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_role_arn_ref:
        Option<GraphQLAPIForProviderLogConfigCloudwatchLogsRoleArnRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_role_arn_selector:
        Option<GraphQLAPIForProviderLogConfigCloudwatchLogsRoleArnSelector>,
    /// Set to TRUE to exclude sections that contain information such as headers, context, and evaluated mapping templates, regardless of logging  level. Valid values: true, false. Default value: false
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "excludeVerboseContent"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct GraphQLAPIForProviderLogConfigCloudwatchLogsRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GraphQLAPIForProviderLogConfigCloudwatchLogsRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct GraphQLAPIInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub additional_authentication_provider:
        Option<Vec<GraphQLAPIInitProviderAdditionalAuthenticationProvider>>,
    /// API type. Valid values are GRAPHQL or MERGED. A MERGED type requires merged_api_execution_role_arn to be set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiType")]
    #[builder(default, setter(strip_option))]
    pub api_type: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub merged_api_execution_role_arn_ref:
        Option<GraphQLAPIInitProviderMergedApiExecutionRoleArnRef>,
    /// Selector for a Role in iam to populate mergedApiExecutionRoleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub merged_api_execution_role_arn_selector:
        Option<GraphQLAPIInitProviderMergedApiExecutionRoleArnSelector>,
    /// User-supplied name for the GraphQL API.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct GraphQLAPIInitProviderAdditionalAuthenticationProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub lambda_authorizer_config:
        Option<GraphQLAPIInitProviderAdditionalAuthenticationProviderLambdaAuthorizerConfig>,
    /// Nested argument containing OpenID Connect configuration. See openid_connect_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub openid_connect_config:
        Option<GraphQLAPIInitProviderAdditionalAuthenticationProviderOpenidConnectConfig>,
    /// Amazon Cognito User Pool configuration. See user_pool_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_pool_config:
        Option<GraphQLAPIInitProviderAdditionalAuthenticationProviderUserPoolConfig>,
}
...
pub struct GraphQLAPIInitProviderLogConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_role_arn_ref:
        Option<GraphQLAPIInitProviderLogConfigCloudwatchLogsRoleArnRef>,
    /// Selector for a Role in iam to populate cloudwatchLogsRoleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_role_arn_selector:
        Option<GraphQLAPIInitProviderLogConfigCloudwatchLogsRoleArnSelector>,
    /// Set to TRUE to exclude sections that contain information such as headers, context, and evaluated mapping templates, regardless of logging  level. Valid values: true, false. Default value: false
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct GraphQLAPIInitProviderLogConfigCloudwatchLogsRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GraphQLAPIInitProviderLogConfigCloudwatchLogsRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct GraphQLAPIStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub additional_authentication_provider:
        Option<Vec<GraphQLAPIStatusAtProviderAdditionalAuthenticationProvider>>,
    /// API type. Valid values are GRAPHQL or MERGED. A MERGED type requires merged_api_execution_role_arn to be set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiType")]
    #[builder(default, setter(strip_option))]
    pub api_type: Option<String>,
...
pub struct GraphQLAPIStatusAtProviderAdditionalAuthenticationProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub lambda_authorizer_config:
        Option<GraphQLAPIStatusAtProviderAdditionalAuthenticationProviderLambdaAuthorizerConfig>,
    /// Nested argument containing OpenID Connect configuration. See openid_connect_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub openid_connect_config:
        Option<GraphQLAPIStatusAtProviderAdditionalAuthenticationProviderOpenidConnectConfig>,
    /// Amazon Cognito User Pool configuration. See user_pool_config Block for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_pool_config:
        Option<GraphQLAPIStatusAtProviderAdditionalAuthenticationProviderUserPoolConfig>,
}
