...
pub struct MetricStreamForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "includeLinkedAccountsMetrics"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "statisticsConfiguration"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct MetricStreamStatusAtProviderStatisticsConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub include_metric:
        Option<Vec<MetricStreamStatusAtProviderStatisticsConfigurationIncludeMetric>>,
}
