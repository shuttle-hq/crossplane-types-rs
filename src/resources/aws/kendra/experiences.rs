...
pub struct ExperienceForProviderConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contentSourceConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub content_source_configuration:
        Option<ExperienceForProviderConfigurationContentSourceConfiguration>,
    /// The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userIdentityConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub user_identity_configuration:
        Option<ExperienceForProviderConfigurationUserIdentityConfiguration>,
}
...
pub struct ExperienceInitProviderConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub content_source_configuration:
        Option<ExperienceInitProviderConfigurationContentSourceConfiguration>,
    /// The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_identity_configuration:
        Option<ExperienceInitProviderConfigurationUserIdentityConfiguration>,
}
...
pub struct ExperienceStatusAtProviderConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub content_source_configuration:
        Option<ExperienceStatusAtProviderConfigurationContentSourceConfiguration>,
    /// The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub user_identity_configuration:
        Option<ExperienceStatusAtProviderConfigurationUserIdentityConfiguration>,
}
