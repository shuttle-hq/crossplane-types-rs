...
pub struct IndexForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "documentMetadataConfigurationUpdates"
    )]
    #[builder(default, setter(strip_option))]
    pub document_metadata_configuration_updates:
        Option<Vec<IndexForProviderDocumentMetadataConfigurationUpdates>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "serverSideEncryptionConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_configuration:
        Option<IndexForProviderServerSideEncryptionConfiguration>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userGroupResolutionConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub user_group_resolution_configuration:
        Option<IndexForProviderUserGroupResolutionConfiguration>,
    /// A block that specifies the user token configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userTokenConfigurations"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct IndexForProviderDocumentMetadataConfigurationUpdatesRelevance {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "valuesImportanceMap"
    )]
    #[builder(default, setter(strip_option))]
    pub values_importance_map: Option<BTreeMap<String, Number>>,
}
...
pub struct IndexForProviderUserGroupResolutionConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "userGroupResolutionMode"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct IndexForProviderUserTokenConfigurations {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "jsonTokenTypeConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub json_token_type_configuration:
        Option<IndexForProviderUserTokenConfigurationsJsonTokenTypeConfiguration>,
    /// A block that specifies the information about the JWT token type configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "jwtTokenTypeConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub jwt_token_type_configuration:
        Option<IndexForProviderUserTokenConfigurationsJwtTokenTypeConfiguration>,
}
...
pub struct IndexInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub document_metadata_configuration_updates:
        Option<Vec<IndexInitProviderDocumentMetadataConfigurationUpdates>>,
    /// The Amazon Kendra edition to use for the index. Choose DEVELOPER_EDITION for indexes intended for development, testing, or proof of concept. Use ENTERPRISE_EDITION for your production databases. Once you set the edition for an index, it can't be changed. Defaults to ENTERPRISE_EDITION
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub edition: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_configuration:
        Option<IndexInitProviderServerSideEncryptionConfiguration>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_group_resolution_configuration:
        Option<IndexInitProviderUserGroupResolutionConfiguration>,
    /// A block that specifies the user token configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct IndexInitProviderUserTokenConfigurations {
    ...
    #[builder(default, setter(strip_option))]
    pub json_token_type_configuration:
        Option<IndexInitProviderUserTokenConfigurationsJsonTokenTypeConfiguration>,
    /// A block that specifies the information about the JWT token type configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub jwt_token_type_configuration:
        Option<IndexInitProviderUserTokenConfigurationsJwtTokenTypeConfiguration>,
}
...
pub struct IndexStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub document_metadata_configuration_updates:
        Option<Vec<IndexStatusAtProviderDocumentMetadataConfigurationUpdates>>,
    /// The Amazon Kendra edition to use for the index. Choose DEVELOPER_EDITION for indexes intended for development, testing, or proof of concept. Use ENTERPRISE_EDITION for your production databases. Once you set the edition for an index, it can't be changed. Defaults to ENTERPRISE_EDITION
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub edition: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub server_side_encryption_configuration:
        Option<IndexStatusAtProviderServerSideEncryptionConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub user_group_resolution_configuration:
        Option<IndexStatusAtProviderUserGroupResolutionConfiguration>,
    /// A block that specifies the user token configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct IndexStatusAtProviderIndexStatistics {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "textDocumentStatistics"
    )]
    #[builder(default, setter(strip_option))]
    pub text_document_statistics:
        Option<Vec<IndexStatusAtProviderIndexStatisticsTextDocumentStatistics>>,
}
...
pub struct IndexStatusAtProviderIndexStatisticsFaqStatistics {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "indexedQuestionAnswersCount"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct IndexStatusAtProviderIndexStatisticsTextDocumentStatistics {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "indexedTextDocumentsCount"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct IndexStatusAtProviderUserTokenConfigurations {
    ...
    #[builder(default, setter(strip_option))]
    pub json_token_type_configuration:
        Option<IndexStatusAtProviderUserTokenConfigurationsJsonTokenTypeConfiguration>,
    /// A block that specifies the information about the JWT token type configuration. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub jwt_token_type_configuration:
        Option<IndexStatusAtProviderUserTokenConfigurationsJwtTokenTypeConfiguration>,
}
