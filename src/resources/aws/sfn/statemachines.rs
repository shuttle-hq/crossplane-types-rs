...
pub struct StateMachineForProviderEncryptionConfigurationKmsKeyIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<StateMachineForProviderEncryptionConfigurationKmsKeyIdRefPolicyResolution>,
...
pub struct StateMachineForProviderEncryptionConfigurationKmsKeyIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<StateMachineForProviderEncryptionConfigurationKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<StateMachineForProviderEncryptionConfigurationKmsKeyIdSelectorPolicyResolve>,
}
...
pub struct StateMachineInitProviderEncryptionConfiguration {
    ...
    pub kms_key_id_selector:
        Option<StateMachineInitProviderEncryptionConfigurationKmsKeyIdSelector>,
    /// The encryption option specified for the state machine. Valid values: AWS_OWNED_KEY, CUSTOMER_MANAGED_KMS_KEY
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
    #[builder(default, setter(strip_option))]
    pub r#type: Option<String>,
...
pub struct StateMachineInitProviderEncryptionConfigurationKmsKeyIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<StateMachineInitProviderEncryptionConfigurationKmsKeyIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct StateMachineInitProviderEncryptionConfigurationKmsKeyIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<StateMachineInitProviderEncryptionConfigurationKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<StateMachineInitProviderEncryptionConfigurationKmsKeyIdSelectorPolicyResolve>,
}
