...
pub struct ConfigurationProfileForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "retrievalRoleArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub retrieval_role_arn_selector:
        Option<ConfigurationProfileForProviderRetrievalRoleArnSelector>,
...
pub struct ConfigurationProfileInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub retrieval_role_arn_selector:
        Option<ConfigurationProfileInitProviderRetrievalRoleArnSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
...
pub struct ConfigurationProfileInitProviderRetrievalRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ConfigurationProfileInitProviderRetrievalRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
