...
pub struct TriggerForProviderPredicateConditionsCrawlerNameSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TriggerForProviderPredicateConditionsCrawlerNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TriggerInitProviderPredicateConditionsCrawlerNameSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TriggerInitProviderPredicateConditionsCrawlerNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
