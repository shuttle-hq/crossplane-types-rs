...
pub struct JobForProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub default_arguments: Option<BTreeMap<String, String>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "nonOverridableArguments"
    )]
    #[builder(default, setter(strip_option))]
    pub non_overridable_arguments: Option<BTreeMap<String, String>>,
