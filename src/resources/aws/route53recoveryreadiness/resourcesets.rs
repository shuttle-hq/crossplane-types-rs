...
pub struct ResourceSetForProviderResourcesDnsTargetResourceTargetResource {
    ...
    #[builder(default, setter(strip_option))]
    pub nlb_resource:
        Option<ResourceSetForProviderResourcesDnsTargetResourceTargetResourceNlbResource>,
    ...
    #[builder(default, setter(strip_option))]
    pub r53_resource:
        Option<ResourceSetForProviderResourcesDnsTargetResourceTargetResourceR53Resource>,
}
...
pub struct ResourceSetInitProviderResourcesDnsTargetResourceTargetResource {
    ...
    #[builder(default, setter(strip_option))]
    pub nlb_resource:
        Option<ResourceSetInitProviderResourcesDnsTargetResourceTargetResourceNlbResource>,
    /// Route53 resource a DNS Target Resource record points to.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub r53_resource:
        Option<ResourceSetInitProviderResourcesDnsTargetResourceTargetResourceR53Resource>,
}
...
pub struct ResourceSetStatusAtProviderResourcesDnsTargetResource {
    ...
    #[builder(default, setter(strip_option))]
    pub target_resource:
        Option<ResourceSetStatusAtProviderResourcesDnsTargetResourceTargetResource>,
}
...
pub struct ResourceSetStatusAtProviderResourcesDnsTargetResourceTargetResource {
    ...
    #[builder(default, setter(strip_option))]
    pub nlb_resource:
        Option<ResourceSetStatusAtProviderResourcesDnsTargetResourceTargetResourceNlbResource>,
    /// Route53 resource a DNS Target Resource record points to.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub r53_resource:
        Option<ResourceSetStatusAtProviderResourcesDnsTargetResourceTargetResourceR53Resource>,
}
