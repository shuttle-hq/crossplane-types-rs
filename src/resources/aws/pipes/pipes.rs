...
pub struct PipeForProviderLogConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cloudwatchLogsLogDestination"
    )]
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_log_destination:
        Option<PipeForProviderLogConfigurationCloudwatchLogsLogDestination>,
    /// Amazon Kinesis Data Firehose logging configuration settings for the pipe. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "firehoseLogDestination"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PipeForProviderLogConfigurationCloudwatchLogsLogDestination {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "logGroupArnRef"
    )]
    #[builder(default, setter(strip_option))]
    pub log_group_arn_ref:
        Option<PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRef>,
    /// Selector for a Group in cloudwatchlogs to populate logGroupArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "logGroupArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub log_group_arn_selector:
        Option<PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelector>,
}
...
pub struct PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicy>,
}
...
pub struct PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicy {
    ...
    pub resolution: Option<
        PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicyResolve,
    >,
}
...
pub struct PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        PipeForProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelectorPolicy,
    >,
}
...
pub struct PipeForProviderSourceParameters {
    ...
    pub managed_streaming_kafka_parameters:
        Option<PipeForProviderSourceParametersManagedStreamingKafkaParameters>,
    ...
    pub self_managed_kafka_parameters:
        Option<PipeForProviderSourceParametersSelfManagedKafkaParameters>,
...
pub struct PipeForProviderSourceParametersDynamodbStreamParameters {
    ...
    pub dead_letter_config:
        Option<PipeForProviderSourceParametersDynamodbStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeForProviderSourceParametersKinesisStreamParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub dead_letter_config:
        Option<PipeForProviderSourceParametersKinesisStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeForProviderSourceParametersManagedStreamingKafkaParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeForProviderSourceParametersManagedStreamingKafkaParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeForProviderTargetParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub eventbridge_event_bus_parameters:
        Option<PipeForProviderTargetParametersEventbridgeEventBusParameters>,
    ...
    pub sagemaker_pipeline_parameters:
        Option<PipeForProviderTargetParametersSagemakerPipelineParameters>,
    ...
    pub step_function_state_machine_parameters:
        Option<PipeForProviderTargetParametersStepFunctionStateMachineParameters>,
}
...
pub struct PipeForProviderTargetParametersBatchJobParameters {
    ...
    pub container_overrides:
        Option<PipeForProviderTargetParametersBatchJobParametersContainerOverrides>,
...
pub struct PipeForProviderTargetParametersBatchJobParametersContainerOverrides {
    ...
    #[builder(default, setter(strip_option))]
    pub environment:
        Option<Vec<PipeForProviderTargetParametersBatchJobParametersContainerOverridesEnvironment>>,
    ...
    #[builder(default, setter(strip_option))]
    pub resource_requirement: Option<
        Vec<PipeForProviderTargetParametersBatchJobParametersContainerOverridesResourceRequirement>,
    >,
}
...
pub struct PipeForProviderTargetParametersEcsTaskParameters {
    ...
    pub capacity_provider_strategy:
        Option<Vec<PipeForProviderTargetParametersEcsTaskParametersCapacityProviderStrategy>>,
    ...
    pub network_configuration:
        Option<PipeForProviderTargetParametersEcsTaskParametersNetworkConfiguration>,
    ...
    pub placement_constraint:
        Option<Vec<PipeForProviderTargetParametersEcsTaskParametersPlacementConstraint>>,
    ...
    pub placement_strategy:
        Option<Vec<PipeForProviderTargetParametersEcsTaskParametersPlacementStrategy>>,
...
pub struct PipeForProviderTargetParametersEcsTaskParametersNetworkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub aws_vpc_configuration: Option<
        PipeForProviderTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfiguration,
    >,
}
...
pub struct PipeForProviderTargetParametersEcsTaskParametersOverrides {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "containerOverride"
    )]
    #[builder(default, setter(strip_option))]
    pub container_override:
        Option<Vec<PipeForProviderTargetParametersEcsTaskParametersOverridesContainerOverride>>,
    ...
    pub ephemeral_storage:
        Option<PipeForProviderTargetParametersEcsTaskParametersOverridesEphemeralStorage>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "inferenceAcceleratorOverride"
    )]
    #[builder(default, setter(strip_option))]
    pub inference_accelerator_override: Option<
        Vec<PipeForProviderTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverride>,
    >,
...
pub struct PipeForProviderTargetParametersSagemakerPipelineParameters {
    ...
    pub pipeline_parameter:
        Option<Vec<PipeForProviderTargetParametersSagemakerPipelineParametersPipelineParameter>>,
}
...
pub struct PipeInitProviderLogConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_log_destination:
        Option<PipeInitProviderLogConfigurationCloudwatchLogsLogDestination>,
    /// Amazon Kinesis Data Firehose logging configuration settings for the pipe. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderLogConfigurationCloudwatchLogsLogDestination {
    ...
    #[builder(default, setter(strip_option))]
    pub log_group_arn_ref:
        Option<PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRef>,
    /// Selector for a Group in cloudwatchlogs to populate logGroupArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub log_group_arn_selector:
        Option<PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelector>,
}
...
pub struct PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicy>,
}
...
pub struct PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnRefPolicyResolve,
    >,
}
...
pub struct PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        PipeInitProviderLogConfigurationCloudwatchLogsLogDestinationLogGroupArnSelectorPolicy,
    >,
}
...
pub struct PipeInitProviderSourceParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub activemq_broker_parameters:
        Option<PipeInitProviderSourceParametersActivemqBrokerParameters>,
    /// The parameters for using a DynamoDB stream as a source.  Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub dynamodb_stream_parameters:
        Option<PipeInitProviderSourceParametersDynamodbStreamParameters>,
    /// The collection of event patterns used to filter events. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub managed_streaming_kafka_parameters:
        Option<PipeInitProviderSourceParametersManagedStreamingKafkaParameters>,
    /// The parameters for using a Rabbit MQ broker as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub rabbitmq_broker_parameters:
        Option<PipeInitProviderSourceParametersRabbitmqBrokerParameters>,
    /// The parameters for using a self-managed Apache Kafka stream as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_kafka_parameters:
        Option<PipeInitProviderSourceParametersSelfManagedKafkaParameters>,
    /// The parameters for using a Amazon SQS stream as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderSourceParametersDynamodbStreamParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub dead_letter_config:
        Option<PipeInitProviderSourceParametersDynamodbStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderSourceParametersKinesisStreamParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub dead_letter_config:
        Option<PipeInitProviderSourceParametersKinesisStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderSourceParametersManagedStreamingKafkaParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeInitProviderSourceParametersManagedStreamingKafkaParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderTargetParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_parameters:
        Option<PipeInitProviderTargetParametersCloudwatchLogsParameters>,
    /// The parameters for using an Amazon ECS task as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub eventbridge_event_bus_parameters:
        Option<PipeInitProviderTargetParametersEventbridgeEventBusParameters>,
    /// These are custom parameter to be used when the target is an API Gateway REST APIs or EventBridge ApiDestinations. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub lambda_function_parameters:
        Option<PipeInitProviderTargetParametersLambdaFunctionParameters>,
    /// These are custom parameters to be used when the target is a Amazon Redshift cluster to invoke the Amazon Redshift Data API BatchExecuteStatement. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub sagemaker_pipeline_parameters:
        Option<PipeInitProviderTargetParametersSagemakerPipelineParameters>,
    /// The parameters for using a Amazon SQS stream as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub step_function_state_machine_parameters:
        Option<PipeInitProviderTargetParametersStepFunctionStateMachineParameters>,
}
...
pub struct PipeInitProviderTargetParametersBatchJobParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub container_overrides:
        Option<PipeInitProviderTargetParametersBatchJobParametersContainerOverrides>,
    /// A list of dependencies for the job. A job can depend upon a maximum of 20 jobs. You can specify a SEQUENTIAL type dependency without specifying a job ID for array jobs so that each child array job completes sequentially, starting at index 0. You can also specify an N_TO_N type dependency with a job ID for array jobs. In that case, each index child of this job must wait for the corresponding index child of each dependency to complete before it can begin. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dependsOn")]
    #[builder(default, setter(strip_option))]
...
pub struct PipeInitProviderTargetParametersBatchJobParametersContainerOverrides {
    ...
    pub environment: Option<
        Vec<PipeInitProviderTargetParametersBatchJobParametersContainerOverridesEnvironment>,
    >,
    /// The instance type to use for a multi-node parallel job. This parameter isn't applicable to single-node container jobs or jobs that run on Fargate resources, and shouldn't be provided.
    #[serde(
        default,
    ...
    pub resource_requirement: Option<
        Vec<
            PipeInitProviderTargetParametersBatchJobParametersContainerOverridesResourceRequirement,
        >,
    >,
}
...
pub struct PipeInitProviderTargetParametersEcsTaskParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_provider_strategy:
        Option<Vec<PipeInitProviderTargetParametersEcsTaskParametersCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task. Valid values: true, false.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub network_configuration:
        Option<PipeInitProviderTargetParametersEcsTaskParametersNetworkConfiguration>,
    /// The overrides that are associated with a task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub placement_constraint:
        Option<Vec<PipeInitProviderTargetParametersEcsTaskParametersPlacementConstraint>>,
    /// The placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub placement_strategy:
        Option<Vec<PipeInitProviderTargetParametersEcsTaskParametersPlacementStrategy>>,
    /// Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as 1.1.0. This structure is used only if LaunchType is FARGATE.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeInitProviderTargetParametersEcsTaskParametersNetworkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub aws_vpc_configuration: Option<
        PipeInitProviderTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfiguration,
    >,
}
...
pub struct PipeInitProviderTargetParametersEcsTaskParametersOverrides {
    ...
    #[builder(default, setter(strip_option))]
    pub container_override:
        Option<Vec<PipeInitProviderTargetParametersEcsTaskParametersOverridesContainerOverride>>,
    /// The cpu override for the task.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub cpu: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub ephemeral_storage:
        Option<PipeInitProviderTargetParametersEcsTaskParametersOverridesEphemeralStorage>,
    /// The Amazon Resource Name (ARN) of the task execution IAM role override for the task.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub inference_accelerator_override: Option<
        Vec<PipeInitProviderTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverride>,
    >,
    /// The memory override for the task.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
pub struct PipeInitProviderTargetParametersSagemakerPipelineParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub pipeline_parameter:
        Option<Vec<PipeInitProviderTargetParametersSagemakerPipelineParametersPipelineParameter>>,
}
...
pub struct PipeStatusAtProviderLogConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_log_destination:
        Option<PipeStatusAtProviderLogConfigurationCloudwatchLogsLogDestination>,
    /// Amazon Kinesis Data Firehose logging configuration settings for the pipe. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub firehose_log_destination:
        Option<PipeStatusAtProviderLogConfigurationFirehoseLogDestination>,
    /// String list that specifies whether the execution data (specifically, the payload, awsRequest, and awsResponse fields) is included in the log messages for this pipe. This applies to all log destinations for the pipe. Valid values ALL.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub activemq_broker_parameters:
        Option<PipeStatusAtProviderSourceParametersActivemqBrokerParameters>,
    /// The parameters for using a DynamoDB stream as a source.  Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub dynamodb_stream_parameters:
        Option<PipeStatusAtProviderSourceParametersDynamodbStreamParameters>,
    /// The collection of event patterns used to filter events. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub kinesis_stream_parameters:
        Option<PipeStatusAtProviderSourceParametersKinesisStreamParameters>,
    /// The parameters for using an MSK stream as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub managed_streaming_kafka_parameters:
        Option<PipeStatusAtProviderSourceParametersManagedStreamingKafkaParameters>,
    /// The parameters for using a Rabbit MQ broker as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub rabbitmq_broker_parameters:
        Option<PipeStatusAtProviderSourceParametersRabbitmqBrokerParameters>,
    /// The parameters for using a self-managed Apache Kafka stream as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub self_managed_kafka_parameters:
        Option<PipeStatusAtProviderSourceParametersSelfManagedKafkaParameters>,
    /// The parameters for using a Amazon SQS stream as a source. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersActivemqBrokerParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeStatusAtProviderSourceParametersActivemqBrokerParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersDynamodbStreamParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub dead_letter_config:
        Option<PipeStatusAtProviderSourceParametersDynamodbStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersKinesisStreamParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub dead_letter_config:
        Option<PipeStatusAtProviderSourceParametersKinesisStreamParametersDeadLetterConfig>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersManagedStreamingKafkaParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeStatusAtProviderSourceParametersManagedStreamingKafkaParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersRabbitmqBrokerParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeStatusAtProviderSourceParametersRabbitmqBrokerParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderSourceParametersSelfManagedKafkaParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub credentials:
        Option<PipeStatusAtProviderSourceParametersSelfManagedKafkaParametersCredentials>,
    /// The maximum length of a time to wait for events. Maximum value of 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderTargetParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logs_parameters:
        Option<PipeStatusAtProviderTargetParametersCloudwatchLogsParameters>,
    /// The parameters for using an Amazon ECS task as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub eventbridge_event_bus_parameters:
        Option<PipeStatusAtProviderTargetParametersEventbridgeEventBusParameters>,
    /// These are custom parameter to be used when the target is an API Gateway REST APIs or EventBridge ApiDestinations. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub kinesis_stream_parameters:
        Option<PipeStatusAtProviderTargetParametersKinesisStreamParameters>,
    /// The parameters for using a Lambda function as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub lambda_function_parameters:
        Option<PipeStatusAtProviderTargetParametersLambdaFunctionParameters>,
    /// These are custom parameters to be used when the target is a Amazon Redshift cluster to invoke the Amazon Redshift Data API BatchExecuteStatement. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub redshift_data_parameters:
        Option<PipeStatusAtProviderTargetParametersRedshiftDataParameters>,
    /// The parameters for using a SageMaker pipeline as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub sagemaker_pipeline_parameters:
        Option<PipeStatusAtProviderTargetParametersSagemakerPipelineParameters>,
    /// The parameters for using a Amazon SQS stream as a target. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub step_function_state_machine_parameters:
        Option<PipeStatusAtProviderTargetParametersStepFunctionStateMachineParameters>,
}
...
pub struct PipeStatusAtProviderTargetParametersBatchJobParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub array_properties:
        Option<PipeStatusAtProviderTargetParametersBatchJobParametersArrayProperties>,
    /// The overrides that are sent to a container. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub container_overrides:
        Option<PipeStatusAtProviderTargetParametersBatchJobParametersContainerOverrides>,
    /// A list of dependencies for the job. A job can depend upon a maximum of 20 jobs. You can specify a SEQUENTIAL type dependency without specifying a job ID for array jobs so that each child array job completes sequentially, starting at index 0. You can also specify an N_TO_N type dependency with a job ID for array jobs. In that case, each index child of this job must wait for the corresponding index child of each dependency to complete before it can begin. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dependsOn")]
    #[builder(default, setter(strip_option))]
...
pub struct PipeStatusAtProviderTargetParametersEcsTaskParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_provider_strategy:
        Option<Vec<PipeStatusAtProviderTargetParametersEcsTaskParametersCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task. Valid values: true, false.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub network_configuration:
        Option<PipeStatusAtProviderTargetParametersEcsTaskParametersNetworkConfiguration>,
    /// The overrides that are associated with a task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub placement_constraint:
        Option<Vec<PipeStatusAtProviderTargetParametersEcsTaskParametersPlacementConstraint>>,
    /// The placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task. Detailed below.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub placement_strategy:
        Option<Vec<PipeStatusAtProviderTargetParametersEcsTaskParametersPlacementStrategy>>,
    /// Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as 1.1.0. This structure is used only if LaunchType is FARGATE.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipeStatusAtProviderTargetParametersSagemakerPipelineParameters {
    ...
    #[builder(default, setter(strip_option))]
    pub pipeline_parameter: Option<
        Vec<PipeStatusAtProviderTargetParametersSagemakerPipelineParametersPipelineParameter>,
    >,
}
