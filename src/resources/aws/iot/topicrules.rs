...
pub struct TopicRuleForProviderErrorActionKafka {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "clientProperties"
    )]
    #[builder(default, setter(strip_option))]
    pub client_properties: Option<BTreeMap<String, String>>,
