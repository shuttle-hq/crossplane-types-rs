...
pub struct LifecyclePolicyForProviderPolicyDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub target_tags: Option<BTreeMap<String, String>>,
}
...
pub struct LifecyclePolicyForProviderPolicyDetailsAction {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "crossRegionCopy"
    )]
    #[builder(default, setter(strip_option))]
    pub cross_region_copy:
        Option<Vec<LifecyclePolicyForProviderPolicyDetailsActionCrossRegionCopy>>,
...
pub struct LifecyclePolicyForProviderPolicyDetailsActionCrossRegionCopy {
    ...
    pub encryption_configuration:
        Option<LifecyclePolicyForProviderPolicyDetailsActionCrossRegionCopyEncryptionConfiguration>,
...
pub struct LifecyclePolicyForProviderPolicyDetailsSchedule {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "crossRegionCopyRule"
    )]
    #[builder(default, setter(strip_option))]
    pub cross_region_copy_rule:
        Option<Vec<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRule>>,
    /// See the deprecate_rule block. Max of 1 per schedule.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "deprecateRule"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub tags_to_add: Option<BTreeMap<String, String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub variable_tags: Option<BTreeMap<String, String>>,
}
...
pub struct LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRule {
    ...
    #[builder(default, setter(strip_option))]
    pub cmk_arn_ref:
        Option<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRef>,
    /// Selector for a Key in kms to populate cmkArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cmkArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub cmk_arn_selector:
        Option<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelector>,
    /// Copy all user-defined tags on a source volume to snapshots of the volume created by this policy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "copyTags")]
    #[builder(default, setter(strip_option))]
    pub copy_tags: Option<bool>,
    ...
    #[builder(default, setter(strip_option))]
    pub deprecate_rule:
        Option<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRule>,
    /// To encrypt a copy of an unencrypted snapshot when encryption by default is not enabled, enable encryption using this parameter. Copies of encrypted snapshots are encrypted, even if this parameter is false or when encryption by default is not enabled.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub encrypted: Option<bool>,
    ...
    #[builder(default, setter(strip_option))]
    pub retain_rule:
        Option<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleRetainRule>,
    /// The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub target: Option<String>,
...
pub struct LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRefPolicy>,
}
...
pub struct LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRefPolicy {
    ...
    pub resolution: Option<
        LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRefPolicyResolve,
    >,
}
...
pub struct LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        LifecyclePolicyForProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelectorPolicy,
    >,
}
...
pub struct LifecyclePolicyInitProviderPolicyDetailsAction {
    ...
    #[builder(default, setter(strip_option))]
    pub cross_region_copy:
        Option<Vec<LifecyclePolicyInitProviderPolicyDetailsActionCrossRegionCopy>>,
    /// A descriptive name for the action.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct LifecyclePolicyInitProviderPolicyDetailsActionCrossRegionCopy {
    ...
    pub encryption_configuration: Option<
        LifecyclePolicyInitProviderPolicyDetailsActionCrossRegionCopyEncryptionConfiguration,
    >,
    /// Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub retain_rule:
        Option<LifecyclePolicyInitProviderPolicyDetailsActionCrossRegionCopyRetainRule>,
    /// The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub target: Option<String>,
...
pub struct LifecyclePolicyInitProviderPolicyDetailsSchedule {
    ...
    #[builder(default, setter(strip_option))]
    pub cross_region_copy_rule:
        Option<Vec<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRule>>,
    /// See the deprecate_rule block. Max of 1 per schedule.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRule {
    ...
    #[builder(default, setter(strip_option))]
    pub cmk_arn_ref:
        Option<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRef>,
    /// Selector for a Key in kms to populate cmkArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cmk_arn_selector:
        Option<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelector>,
    /// Copy all user-defined tags on a source volume to snapshots of the volume created by this policy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "copyTags")]
    #[builder(default, setter(strip_option))]
    pub copy_tags: Option<bool>,
    ...
    #[builder(default, setter(strip_option))]
    pub deprecate_rule:
        Option<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRule>,
    /// To encrypt a copy of an unencrypted snapshot when encryption by default is not enabled, enable encryption using this parameter. Copies of encrypted snapshots are encrypted, even if this parameter is false or when encryption by default is not enabled.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub encrypted: Option<bool>,
    ...
    #[builder(default, setter(strip_option))]
    pub retain_rule:
        Option<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleRetainRule>,
    /// The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub target: Option<String>,
...
pub struct LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnRefPolicy>,
}
...
pub struct LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        LifecyclePolicyInitProviderPolicyDetailsScheduleCrossRegionCopyRuleCmkArnSelectorPolicy,
    >,
}
...
pub struct LifecyclePolicyStatusAtProviderPolicyDetailsAction {
    ...
    #[builder(default, setter(strip_option))]
    pub cross_region_copy:
        Option<Vec<LifecyclePolicyStatusAtProviderPolicyDetailsActionCrossRegionCopy>>,
    /// A descriptive name for the action.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct LifecyclePolicyStatusAtProviderPolicyDetailsActionCrossRegionCopy {
    ...
    #[builder(default, setter(strip_option))]
    pub encryption_configuration: Option<
        LifecyclePolicyStatusAtProviderPolicyDetailsActionCrossRegionCopyEncryptionConfiguration,
    >,
    /// Specifies the retention rule for cross-Region snapshot copies. See the retain_rule block. Max of 1 per action.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub retain_rule:
        Option<LifecyclePolicyStatusAtProviderPolicyDetailsActionCrossRegionCopyRetainRule>,
    /// The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub target: Option<String>,
...
pub struct LifecyclePolicyStatusAtProviderPolicyDetailsSchedule {
    ...
    #[builder(default, setter(strip_option))]
    pub cross_region_copy_rule:
        Option<Vec<LifecyclePolicyStatusAtProviderPolicyDetailsScheduleCrossRegionCopyRule>>,
    /// See the deprecate_rule block. Max of 1 per schedule.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub fast_restore_rule:
        Option<LifecyclePolicyStatusAtProviderPolicyDetailsScheduleFastRestoreRule>,
    /// A descriptive name for the action.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
...
pub struct LifecyclePolicyStatusAtProviderPolicyDetailsScheduleCrossRegionCopyRule {
    ...
    #[builder(default, setter(strip_option))]
    pub deprecate_rule: Option<
        LifecyclePolicyStatusAtProviderPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRule,
    >,
    /// To encrypt a copy of an unencrypted snapshot when encryption by default is not enabled, enable encryption using this parameter. Copies of encrypted snapshots are encrypted, even if this parameter is false or when encryption by default is not enabled.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub retain_rule:
        Option<LifecyclePolicyStatusAtProviderPolicyDetailsScheduleCrossRegionCopyRuleRetainRule>,
    /// The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub target: Option<String>,
