...
pub struct DeliveryStreamForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "elasticsearchConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "extendedS3Configuration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "httpEndpointConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "kinesisSourceConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "opensearchConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "opensearchserverlessConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub opensearchserverless_configuration:
        Option<DeliveryStreamForProviderOpensearchserverlessConfiguration>,
...
pub struct DeliveryStreamForProviderElasticsearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderElasticsearchConfigurationCloudwatchLoggingOptions>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "domainArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub domain_arn_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationDomainArnSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderElasticsearchConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Amazon Elasticsearch, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "retryDuration"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub role_arn_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationRoleArnSelector>,
    ...
    pub s3_configuration:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3Configuration>,
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationDomainArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderElasticsearchConfigurationDomainArnRefPolicyResolution>,
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderElasticsearchConfigurationDomainArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationDomainArnSelectorPolicy {
    ...
    pub resolution: Option<
        DeliveryStreamForProviderElasticsearchConfigurationDomainArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderElasticsearchConfigurationDomainArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationProcessingConfiguration {
    ...
    pub processors: Option<
        Vec<DeliveryStreamForProviderElasticsearchConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderElasticsearchConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderElasticsearchConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderElasticsearchConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderElasticsearchConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelector>,
    ...
    pub security_group_ids_refs: Option<
        Vec<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefs>,
    >,
    ...
    pub security_group_ids_selector: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelector,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_refs:
        Option<Vec<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefs>>,
    ...
    pub subnet_ids_selector:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsSelector>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefsPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicy>,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderElasticsearchConfigurationVpcConfigSubnetIdsSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderExtendedS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationCloudwatchLoggingOptions>,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dataFormatConversionConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub data_format_conversion_configuration:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationDataFormatConversionConfiguration>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "dynamicPartitioningConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub dynamic_partitioning_configuration:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationDynamicPartitioningConfiguration>,
    /// Prefix added to failed records before writing them to S3. Not currently supported for redshift destination. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see Custom Prefixes for Amazon S3 Objects.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationProcessingConfiguration>,
    /// The ARN of the IAM role to be assumed by Firehose for calling the Amazon EC2 configuration API and for creating network interfaces. Make sure role has necessary IAM permissions
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "roleArn")]
    #[builder(default, setter(strip_option))]
    pub role_arn: Option<String>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "s3BackupConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationS3BackupConfiguration>,
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationBucketArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationBucketArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationBucketArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationBucketArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfigurationDeserializerOpenXJsonSerDe
{
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "columnToJsonKeyMappings"
    )]
    #[builder(default, setter(strip_option))]
    pub column_to_json_key_mappings: Option<BTreeMap<String, String>>,
    /// When set to true, specifies that the names of the keys include dots and that you want Kinesis Data Firehose to replace them with underscores. This is useful because Apache Hive does not allow dots in column names. For example, if the JSON contains a key whose name is "a.b", you can define the column name to be "a_b" when using this option. Defaults to false.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "convertDotsInJsonKeysToUnderscores"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe
{
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "bloomFilterFalsePositiveProbability"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerParquetSerDe
{
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "enableDictionaryCompression"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamForProviderExtendedS3ConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderExtendedS3ConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderExtendedS3ConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfiguration {
    ...
    pub access_key_secret_ref:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationAccessKeySecretRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationCloudwatchLoggingOptions>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationProcessingConfiguration>,
    /// The request configuration.  See request_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "requestConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub request_configuration:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationRequestConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationRoleArnSelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "secretsManagerConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationSecretsManagerConfiguration>,
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamForProviderHttpEndpointConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationRequestConfiguration {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "commonAttributes"
    )]
    #[builder(default, setter(strip_option))]
    pub common_attributes: Option<
        Vec<DeliveryStreamForProviderHttpEndpointConfigurationRequestConfigurationCommonAttributes>,
    >,
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderIcebergConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderIcebergConfigurationCloudwatchLoggingOptions>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationTableConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub destination_table_configuration:
        Option<Vec<DeliveryStreamForProviderIcebergConfigurationDestinationTableConfiguration>>,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderIcebergConfigurationProcessingConfiguration>,
...
pub struct DeliveryStreamForProviderIcebergConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors:
        Option<Vec<DeliveryStreamForProviderIcebergConfigurationProcessingConfigurationProcessors>>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderIcebergConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationBucketArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderIcebergConfigurationS3ConfigurationRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderMskSourceConfiguration {
    ...
    pub authentication_configuration:
        Option<DeliveryStreamForProviderMskSourceConfigurationAuthenticationConfiguration>,
...
pub struct DeliveryStreamForProviderOpensearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderOpensearchConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the cluster. Conflicts with domain_arn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "documentIdOptions"
    )]
    #[builder(default, setter(strip_option))]
    pub document_id_options:
        Option<DeliveryStreamForProviderOpensearchConfigurationDocumentIdOptions>,
    /// The ARN of the Amazon ES domain.  The pattern needs to be arn:.*.  Conflicts with cluster_endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainArn")]
    #[builder(default, setter(strip_option))]
    pub domain_arn: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub domain_arn_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationDomainArnSelector>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderOpensearchConfigurationProcessingConfiguration>,
...
pub struct DeliveryStreamForProviderOpensearchConfigurationDocumentIdOptions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultDocumentIdFormat"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct DeliveryStreamForProviderOpensearchConfigurationDomainArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderOpensearchConfigurationDomainArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderOpensearchConfigurationDomainArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderOpensearchConfigurationDomainArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderOpensearchConfigurationDomainArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamForProviderOpensearchConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderOpensearchConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderOpensearchConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderOpensearchConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderOpensearchConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelector>,
    /// A list of security group IDs to associate with Kinesis Firehose.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub security_group_ids_refs:
        Option<Vec<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    pub security_group_ids_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelector>,
    /// A list of subnet IDs to associate with Kinesis Firehose.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetIds")]
    #[builder(default, setter(strip_option))]
    pub subnet_ids: Option<Vec<String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_refs:
        Option<Vec<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefs>>,
    /// Selector for a list of Subnet in ec2 to populate subnetIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_selector:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelector>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefsPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationCloudwatchLoggingOptions>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "collectionEndpointRef"
    )]
    #[builder(default, setter(strip_option))]
    pub collection_endpoint_ref:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointRef>,
    /// Selector for a Collection in opensearchserverless to populate collectionEndpoint.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "collectionEndpointSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub collection_endpoint_selector: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointSelector,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationProcessingConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelector>,
    /// Defines how documents should be delivered to Amazon S3.  Valid values are FailedDocumentsOnly and AllDocuments.  Default value is FailedDocumentsOnly.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationS3Configuration>,
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointRefPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationCollectionEndpointSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationS3ConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderOpensearchserverlessConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderOpensearchserverlessConfigurationS3ConfigurationRoleArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderRedshiftConfigurationCloudwatchLoggingOptions>,
    /// The jdbcurl of the redshift cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "clusterJdbcurl"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub password_secret_ref:
        Option<DeliveryStreamForProviderRedshiftConfigurationPasswordSecretRef>,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderRedshiftConfigurationProcessingConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3BackupConfiguration>,
    /// The Amazon S3 backup mode.  Valid values are Disabled and Enabled.  Default value is Disabled.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamForProviderRedshiftConfigurationSecretsManagerConfiguration>,
...
pub struct DeliveryStreamForProviderRedshiftConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamForProviderRedshiftConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderRedshiftConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderRedshiftConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderRedshiftConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3BackupConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnSelector,
    >,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3BackupConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderRedshiftConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderSnowflakeConfigurationCloudwatchLoggingOptions>,
    /// The name of the content column.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "contentColumnName"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "keyPassphraseSecretRef"
    )]
    #[builder(default, setter(strip_option))]
    pub key_passphrase_secret_ref:
        Option<DeliveryStreamForProviderSnowflakeConfigurationKeyPassphraseSecretRef>,
    /// The name of the metadata column.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "metadataColumnName"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub private_key_secret_ref:
        Option<DeliveryStreamForProviderSnowflakeConfigurationPrivateKeySecretRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderSnowflakeConfigurationProcessingConfiguration>,
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamForProviderSnowflakeConfigurationSecretsManagerConfiguration>,
    /// The configuration for Snowflake role.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "snowflakeRoleConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub snowflake_role_configuration:
        Option<DeliveryStreamForProviderSnowflakeConfigurationSnowflakeRoleConfiguration>,
    /// The VPC configuration for Snowflake.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "snowflakeVpcConfiguration"
    )]
    #[builder(default, setter(strip_option))]
    pub snowflake_vpc_configuration:
        Option<DeliveryStreamForProviderSnowflakeConfigurationSnowflakeVpcConfiguration>,
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamForProviderSnowflakeConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderSnowflakeConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamForProviderSnowflakeConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderSnowflakeConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSnowflakeConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderSplunkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderSplunkConfigurationCloudwatchLoggingOptions>,
    /// The amount of time, in seconds between 180 and 600, that Kinesis Firehose waits to receive an acknowledgment from Splunk after it sends it data.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "hecAcknowledgmentTimeout"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamForProviderSplunkConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Splunk, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamForProviderSplunkConfigurationSecretsManagerConfiguration>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors:
        Option<Vec<DeliveryStreamForProviderSplunkConfigurationProcessingConfigurationProcessors>>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationProcessingConfigurationProcessors {
    ...
    pub parameters: Option<
        Vec<
            DeliveryStreamForProviderSplunkConfigurationProcessingConfigurationProcessorsParameters,
        >,
    >,
    /// The type of processor. Valid Values: RecordDeAggregation, Lambda, MetadataExtraction, AppendDelimiterToRecord, Decompression, CloudWatchLogProcessing. Validation is done against AWS SDK constants; so values not explicitly listed may also work.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions>,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationBucketArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamForProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub opensearchserverless_configuration:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfiguration>,
    /// Configuration options when destination is redshift. Requires the user to also specify an s3_configuration block. See redshift_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamInitProviderElasticsearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the cluster. Conflicts with domain_arn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub domain_arn_selector:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationDomainArnSelector>,
    /// The Elasticsearch index name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "indexName")]
    #[builder(default, setter(strip_option))]
    pub index_name: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Amazon Elasticsearch, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationRoleArnSelector>,
    /// Defines how documents should be delivered to Amazon S3.  Valid values are FailedDocumentsOnly and AllDocuments.  Default value is FailedDocumentsOnly.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationS3Configuration>,
    /// The Elasticsearch type name with maximum length of 100 characters.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "typeName")]
    #[builder(default, setter(strip_option))]
    pub type_name: Option<String>,
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationDomainArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationDomainArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationDomainArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationDomainArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationDomainArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationDomainArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderElasticsearchConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnSelector,
    >,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnSelector>,
    /// A list of security group IDs to associate with Kinesis Firehose.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub security_group_ids_refs: Option<
        Vec<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefs>,
    >,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroupIds.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub security_group_ids_selector: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelector,
    >,
    /// A list of subnet IDs to associate with Kinesis Firehose.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetIds")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_refs:
        Option<Vec<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefs>>,
    /// Selector for a list of Subnet in ec2 to populate subnetIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_selector:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsSelector>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsRefsPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSecurityGroupIdsSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicy>,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsRefsPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderElasticsearchConfigurationVpcConfigSubnetIdsSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderExtendedS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationCloudwatchLoggingOptions>,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub data_format_conversion_configuration:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationDataFormatConversionConfiguration>,
    /// The configuration for dynamic partitioning. Required when using dynamic partitioning. See dynamic_partitioning_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub dynamic_partitioning_configuration:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationDynamicPartitioningConfiguration>,
    /// Prefix added to failed records before writing them to S3. Not currently supported for redshift destination. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see Custom Prefixes for Amazon S3 Objects.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationProcessingConfiguration>,
    /// The ARN of the IAM role to be assumed by Firehose for calling the Amazon EC2 configuration API and for creating network interfaces. Make sure role has necessary IAM permissions
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "roleArn")]
    #[builder(default, setter(strip_option))]
    pub role_arn: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationS3BackupConfiguration>,
    /// The Amazon S3 backup mode.  Valid values are Disabled and Enabled.  Default value is Disabled.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationBucketArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderExtendedS3ConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderExtendedS3ConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderExtendedS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderExtendedS3ConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderExtendedS3ConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub access_key_secret_ref:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationAccessKeySecretRef>,
    /// Buffer incoming data for the specified period of time, in seconds, before delivering it to the destination. The default value is 300 (5 minutes).
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationCloudwatchLoggingOptions>,
    /// The HTTP endpoint name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationProcessingConfiguration>,
    /// The request configuration.  See request_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub request_configuration:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationRequestConfiguration>,
    /// Total amount of seconds Firehose spends on retries. This duration starts after the initial attempt fails, It does not include the time periods during which Firehose waits for acknowledgment from the specified destination after each attempt. Valid values between 0 and 7200. Default is 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnSelector>,
    /// Defines how documents should be delivered to Amazon S3.  Valid values are FailedDataOnly and AllData.  Default value is FailedDataOnly.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3Configuration>,
    /// The Secret Manager Configuration. See secrets_manager_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationSecretsManagerConfiguration>,
    /// The HTTP endpoint URL to which Kinesis Firehose sends your data.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub url: Option<String>,
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderHttpEndpointConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationRequestConfiguration {
    ...
    pub common_attributes: Option<
        Vec<
            DeliveryStreamInitProviderHttpEndpointConfigurationRequestConfigurationCommonAttributes,
        >,
    >,
    /// Kinesis Data Firehose uses the content encoding to compress the body of a request before sending the request to the destination. Valid values are NONE and GZIP.  Default value is NONE.
    #[serde(
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderHttpEndpointConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderIcebergConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderIcebergConfigurationCloudwatchLoggingOptions>,
    /// Destination table configurations which Firehose uses to deliver data to Apache Iceberg Tables. Firehose will write data with insert if table specific configuration is not provided. See destination_table_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub destination_table_configuration:
        Option<Vec<DeliveryStreamInitProviderIcebergConfigurationDestinationTableConfiguration>>,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderIcebergConfigurationProcessingConfiguration>,
    /// The period of time, in seconds between 0 to 7200, during which Firehose retries to deliver data to the specified destination.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamInitProviderIcebergConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderIcebergConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderIcebergConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderIcebergConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderIcebergConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderIcebergConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderMskSourceConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub authentication_configuration:
        Option<DeliveryStreamInitProviderMskSourceConfigurationAuthenticationConfiguration>,
    /// The ARN of the Amazon MSK cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamInitProviderOpensearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderOpensearchConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the cluster. Conflicts with domain_arn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub document_id_options:
        Option<DeliveryStreamInitProviderOpensearchConfigurationDocumentIdOptions>,
    /// The ARN of the Amazon ES domain.  The pattern needs to be arn:.*.  Conflicts with cluster_endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainArn")]
    #[builder(default, setter(strip_option))]
    pub domain_arn: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub domain_arn_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationDomainArnSelector>,
    /// The OpenSearch index name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "indexName")]
    #[builder(default, setter(strip_option))]
    pub index_name: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderOpensearchConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Amazon OpenSearch, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationDomainArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderOpensearchConfigurationDomainArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationDomainArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderOpensearchConfigurationDomainArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderOpensearchConfigurationDomainArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderOpensearchConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderOpensearchConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderOpensearchConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderOpensearchConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelector>,
    /// A list of security group IDs to associate with Kinesis Firehose.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub security_group_ids_refs:
        Option<Vec<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub security_group_ids_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelector>,
    /// A list of subnet IDs to associate with Kinesis Firehose.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetIds")]
    #[builder(default, setter(strip_option))]
    pub subnet_ids: Option<Vec<String>>,
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_refs:
        Option<Vec<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefs>>,
    /// Selector for a list of Subnet in ec2 to populate subnetIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub subnet_ids_selector:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelector>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsRefsPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSecurityGroupIdsSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefs {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsRefsPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderOpensearchConfigurationVpcConfigSubnetIdsSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the collection in the Serverless offering for Amazon OpenSearch Service.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub collection_endpoint_ref:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointRef>,
    /// Selector for a Collection in opensearchserverless to populate collectionEndpoint.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub collection_endpoint_selector: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointSelector,
    >,
    /// The Serverless offering for Amazon OpenSearch Service index name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "indexName")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to the Serverless offering for Amazon OpenSearch Service, the total amount of time, in seconds between 0 to 7200, during which Kinesis Data Firehose retries delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelector>,
    /// Defines how documents should be delivered to Amazon S3.  Valid values are FailedDocumentsOnly and AllDocuments.  Default value is FailedDocumentsOnly.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationS3Configuration>,
    /// The VPC configuration for the delivery stream to connect to OpenSearch Serverless associated with the VPC. See vpc_config block below for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcConfig")]
    #[builder(default, setter(strip_option))]
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationCollectionEndpointSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderOpensearchserverlessConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderOpensearchserverlessConfigurationS3ConfigurationRoleArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderRedshiftConfigurationCloudwatchLoggingOptions>,
    /// The jdbcurl of the redshift cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub password_secret_ref:
        Option<DeliveryStreamInitProviderRedshiftConfigurationPasswordSecretRef>,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderRedshiftConfigurationProcessingConfiguration>,
    /// The length of time during which Firehose retries delivery after a failure, starting from the initial request and including the first attempt. The default value is 3600 seconds (60 minutes). Firehose does not retry if the value of DurationInSeconds is 0 (zero) or if the first delivery attempt takes longer than the current value.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfiguration>,
    /// The Amazon S3 backup mode.  Valid values are Disabled and Enabled.  Default value is Disabled.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamInitProviderRedshiftConfigurationSecretsManagerConfiguration>,
    /// The username that the firehose delivery stream will assume. It is strongly recommended that the username and password provided is used exclusively for Amazon Kinesis Firehose purposes, and that the permissions for the account are restricted for Amazon Redshift INSERT permissions. This value is required if secrets_manager_configuration is not provided.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub username: Option<String>,
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderRedshiftConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderRedshiftConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderRedshiftConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderRedshiftConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationBucketArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationRoleArnRefPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3BackupConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderRedshiftConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationCloudwatchLoggingOptions>,
    /// The name of the content column.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub key_passphrase_secret_ref:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationKeyPassphraseSecretRef>,
    /// The name of the metadata column.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub private_key_secret_ref:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationPrivateKeySecretRef>,
    /// The processing configuration. See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Snowflake, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 60s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationSecretsManagerConfiguration>,
    /// The configuration for Snowflake role.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub snowflake_role_configuration:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationSnowflakeRoleConfiguration>,
    /// The VPC configuration for Snowflake.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub snowflake_vpc_configuration:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationSnowflakeVpcConfiguration>,
    /// The Snowflake table name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub table: Option<String>,
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamInitProviderSnowflakeConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationRoleArnSelectorPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationBucketArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        DeliveryStreamInitProviderSnowflakeConfigurationS3ConfigurationRoleArnSelectorPolicy,
    >,
}
...
pub struct DeliveryStreamInitProviderSplunkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamInitProviderSplunkConfigurationCloudwatchLoggingOptions>,
    /// The amount of time, in seconds between 180 and 600, that Kinesis Firehose waits to receive an acknowledgment from Splunk after it sends it data.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub hec_token_secret_ref:
        Option<DeliveryStreamInitProviderSplunkConfigurationHecTokenSecretRef>,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamInitProviderSplunkConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Splunk, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamInitProviderSplunkConfigurationSecretsManagerConfiguration>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors:
        Option<Vec<DeliveryStreamInitProviderSplunkConfigurationProcessingConfigurationProcessors>>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_ref:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRef>,
    /// Selector for a Bucket in s3 to populate bucketArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub bucket_arn_selector:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnSelector>,
    /// Buffer incoming data for the specified period of time, in seconds between 0 to 60, before delivering it to the destination.  The default value is 60s.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_ref:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRef>,
    /// Selector for a Role in iam to populate roleArn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub role_arn_selector:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelector>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnRefPolicyResolve,
    >,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationBucketArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicy>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnRefPolicyResolve>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicy>,
}
...
pub struct DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        DeliveryStreamInitProviderSplunkConfigurationS3ConfigurationRoleArnSelectorPolicyResolve,
    >,
}
...
pub struct DeliveryStreamStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub elasticsearch_configuration:
        Option<DeliveryStreamStatusAtProviderElasticsearchConfiguration>,
    /// Enhanced configuration options for the s3 destination. See extended_s3_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub http_endpoint_configuration:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfiguration>,
    /// Configuration options when destination is iceberg. See iceberg_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub kinesis_source_configuration:
        Option<DeliveryStreamStatusAtProviderKinesisSourceConfiguration>,
    /// The configuration for the Amazon MSK cluster to be used as the source for a delivery stream. See msk_source_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub opensearchserverless_configuration:
        Option<DeliveryStreamStatusAtProviderOpensearchserverlessConfiguration>,
    /// Configuration options when destination is redshift. Requires the user to also specify an s3_configuration block. See redshift_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamStatusAtProviderElasticsearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderElasticsearchConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the cluster. Conflicts with domain_arn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderElasticsearchConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Amazon Elasticsearch, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderElasticsearchConfigurationS3Configuration>,
    /// The Elasticsearch type name with maximum length of 100 characters.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "typeName")]
    #[builder(default, setter(strip_option))]
    pub type_name: Option<String>,
...
pub struct DeliveryStreamStatusAtProviderExtendedS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderExtendedS3ConfigurationCloudwatchLoggingOptions>,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub data_format_conversion_configuration: Option<
        DeliveryStreamStatusAtProviderExtendedS3ConfigurationDataFormatConversionConfiguration,
    >,
    /// The configuration for dynamic partitioning. Required when using dynamic partitioning. See dynamic_partitioning_configuration block below for details.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub dynamic_partitioning_configuration: Option<
        DeliveryStreamStatusAtProviderExtendedS3ConfigurationDynamicPartitioningConfiguration,
    >,
    /// Prefix added to failed records before writing them to S3. Not currently supported for redshift destination. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see Custom Prefixes for Amazon S3 Objects.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderExtendedS3ConfigurationProcessingConfiguration>,
    /// The ARN of the IAM role to be assumed by Firehose for calling the Amazon EC2 configuration API and for creating network interfaces. Make sure role has necessary IAM permissions
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "roleArn")]
    #[builder(default, setter(strip_option))]
    pub role_arn: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamStatusAtProviderExtendedS3ConfigurationS3BackupConfiguration>,
    /// The Amazon S3 backup mode.  Valid values are Disabled and Enabled.  Default value is Disabled.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamStatusAtProviderExtendedS3ConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderExtendedS3ConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderHttpEndpointConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfigurationCloudwatchLoggingOptions>,
    /// The HTTP endpoint name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub name: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfigurationProcessingConfiguration>,
    /// The request configuration.  See request_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub request_configuration:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfigurationRequestConfiguration>,
    /// Total amount of seconds Firehose spends on retries. This duration starts after the initial attempt fails, It does not include the time periods during which Firehose waits for acknowledgment from the specified destination after each attempt. Valid values between 0 and 7200. Default is 300.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfigurationS3Configuration>,
    /// The Secret Manager Configuration. See secrets_manager_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamStatusAtProviderHttpEndpointConfigurationSecretsManagerConfiguration>,
    /// The HTTP endpoint URL to which Kinesis Firehose sends your data.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub url: Option<String>,
...
pub struct DeliveryStreamStatusAtProviderIcebergConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderIcebergConfigurationCloudwatchLoggingOptions>,
    /// Destination table configurations which Firehose uses to deliver data to Apache Iceberg Tables. Firehose will write data with insert if table specific configuration is not provided. See destination_table_configuration block below for details.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub destination_table_configuration: Option<
        Vec<DeliveryStreamStatusAtProviderIcebergConfigurationDestinationTableConfiguration>,
    >,
    /// The data processing configuration.  See processing_configuration block below for details.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderIcebergConfigurationProcessingConfiguration>,
    /// The period of time, in seconds between 0 to 7200, during which Firehose retries to deliver data to the specified destination.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamStatusAtProviderIcebergConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderIcebergConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderIcebergConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamStatusAtProviderIcebergConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
...
pub struct DeliveryStreamStatusAtProviderMskSourceConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub authentication_configuration:
        Option<DeliveryStreamStatusAtProviderMskSourceConfigurationAuthenticationConfiguration>,
    /// The ARN of the Amazon MSK cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DeliveryStreamStatusAtProviderOpensearchConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderOpensearchConfigurationCloudwatchLoggingOptions>,
    /// The endpoint to use when communicating with the cluster. Conflicts with domain_arn.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub document_id_options:
        Option<DeliveryStreamStatusAtProviderOpensearchConfigurationDocumentIdOptions>,
    /// The ARN of the Amazon ES domain.  The pattern needs to be arn:.*.  Conflicts with cluster_endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainArn")]
    #[builder(default, setter(strip_option))]
    pub domain_arn: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderOpensearchConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Amazon OpenSearch, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderOpensearchConfigurationS3Configuration>,
    /// The Elasticsearch type name with maximum length of 100 characters. Types are deprecated in OpenSearch_1.1. TypeName must be empty.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "typeName")]
    #[builder(default, setter(strip_option))]
    pub type_name: Option<String>,
...
pub struct DeliveryStreamStatusAtProviderOpensearchConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderOpensearchConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderOpensearchserverlessConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamStatusAtProviderOpensearchserverlessConfigurationCloudwatchLoggingOptions,
    >,
    /// The endpoint to use when communicating with the collection in the Serverless offering for Amazon OpenSearch Service.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration: Option<
        DeliveryStreamStatusAtProviderOpensearchserverlessConfigurationProcessingConfiguration,
    >,
    /// After an initial failure to deliver to the Serverless offering for Amazon OpenSearch Service, the total amount of time, in seconds between 0 to 7200, during which Kinesis Data Firehose retries delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderOpensearchserverlessConfigurationS3Configuration>,
    /// The VPC configuration for the delivery stream to connect to OpenSearch Serverless associated with the VPC. See vpc_config block below for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcConfig")]
    #[builder(default, setter(strip_option))]
    pub vpc_config:
        Option<DeliveryStreamStatusAtProviderOpensearchserverlessConfigurationVpcConfig>,
}
...
pub struct DeliveryStreamStatusAtProviderRedshiftConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderRedshiftConfigurationCloudwatchLoggingOptions>,
    /// The jdbcurl of the redshift cluster.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderRedshiftConfigurationProcessingConfiguration>,
    /// The length of time during which Firehose retries delivery after a failure, starting from the initial request and including the first attempt. The default value is 3600 seconds (60 minutes). Firehose does not retry if the value of DurationInSeconds is 0 (zero) or if the first delivery attempt takes longer than the current value.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_backup_configuration:
        Option<DeliveryStreamStatusAtProviderRedshiftConfigurationS3BackupConfiguration>,
    /// The Amazon S3 backup mode.  Valid values are Disabled and Enabled.  Default value is Disabled.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderRedshiftConfigurationS3Configuration>,
    /// The Secrets Manager configuration. See secrets_manager_configuration block below for details. This value is required if user and private_key are not provided.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamStatusAtProviderRedshiftConfigurationSecretsManagerConfiguration>,
    /// The username that the firehose delivery stream will assume. It is strongly recommended that the username and password provided is used exclusively for Amazon Kinesis Firehose purposes, and that the permissions for the account are restricted for Amazon Redshift INSERT permissions. This value is required if secrets_manager_configuration is not provided.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub username: Option<String>,
...
pub struct DeliveryStreamStatusAtProviderRedshiftConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderRedshiftConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderRedshiftConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamStatusAtProviderRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
...
pub struct DeliveryStreamStatusAtProviderSnowflakeConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationCloudwatchLoggingOptions>,
    /// The name of the content column.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Snowflake, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 60s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub s3_configuration:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationS3Configuration>,
    /// The Snowflake schema name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub schema: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationSecretsManagerConfiguration>,
    /// The configuration for Snowflake role.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub snowflake_role_configuration:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationSnowflakeRoleConfiguration>,
    /// The VPC configuration for Snowflake.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub snowflake_vpc_configuration:
        Option<DeliveryStreamStatusAtProviderSnowflakeConfigurationSnowflakeVpcConfiguration>,
    /// The Snowflake table name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub table: Option<String>,
...
pub struct DeliveryStreamStatusAtProviderSnowflakeConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderSnowflakeConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderSnowflakeConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamStatusAtProviderSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
...
pub struct DeliveryStreamStatusAtProviderSplunkConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options:
        Option<DeliveryStreamStatusAtProviderSplunkConfigurationCloudwatchLoggingOptions>,
    /// The amount of time, in seconds between 180 and 600, that Kinesis Firehose waits to receive an acknowledgment from Splunk after it sends it data.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub processing_configuration:
        Option<DeliveryStreamStatusAtProviderSplunkConfigurationProcessingConfiguration>,
    /// After an initial failure to deliver to Splunk, the total amount of time, in seconds between 0 to 7200, during which Firehose re-attempts delivery (including the first attempt).  After this time has elapsed, the failed documents are written to Amazon S3.  The default value is 300s.  There will be no retry if the value is 0.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secrets_manager_configuration:
        Option<DeliveryStreamStatusAtProviderSplunkConfigurationSecretsManagerConfiguration>,
}
...
pub struct DeliveryStreamStatusAtProviderSplunkConfigurationProcessingConfiguration {
    ...
    #[builder(default, setter(strip_option))]
    pub processors: Option<
        Vec<DeliveryStreamStatusAtProviderSplunkConfigurationProcessingConfigurationProcessors>,
    >,
}
...
pub struct DeliveryStreamStatusAtProviderSplunkConfigurationS3Configuration {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_logging_options: Option<
        DeliveryStreamStatusAtProviderSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions,
    >,
    /// The compression format. If no value is specified, the default is UNCOMPRESSED. Other supported values are GZIP, ZIP, Snappy, & HADOOP_SNAPPY.
    #[serde(
        default,
