...
pub struct PipelineForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "pipelineConfigurationBody"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PipelineForProviderBufferOptions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "persistentBufferEnabled"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PipelineForProviderLogPublishingOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_log_destination:
        Option<Vec<PipelineForProviderLogPublishingOptionsCloudwatchLogDestination>>,
    /// Whether logs should be published.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "isLoggingEnabled"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct PipelineInitProviderLogPublishingOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_log_destination:
        Option<Vec<PipelineInitProviderLogPublishingOptionsCloudwatchLogDestination>>,
    /// Whether logs should be published.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct PipelineStatusAtProviderLogPublishingOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub cloudwatch_log_destination:
        Option<Vec<PipelineStatusAtProviderLogPublishingOptionsCloudwatchLogDestination>>,
    /// Whether logs should be published.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
