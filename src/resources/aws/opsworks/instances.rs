...
pub struct InstanceStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sshHostDsaKeyFingerprint"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sshHostRsaKeyFingerprint"
    )]
    #[builder(default, setter(strip_option))]
