...
pub struct StackForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "configurationManagerName"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "configurationManagerVersion"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultAvailabilityZone"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultInstanceProfileArn"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultInstanceProfileArnRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultInstanceProfileArnSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub default_instance_profile_arn_selector:
        Option<StackForProviderDefaultInstanceProfileArnSelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultSubnetIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "useOpsworksSecurityGroups"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct StackInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub default_instance_profile_arn_selector:
        Option<StackInitProviderDefaultInstanceProfileArnSelector>,
    /// Name of OS that will be installed on instances by default.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultOs")]
    #[builder(default, setter(strip_option))]
    pub default_os: Option<String>,
