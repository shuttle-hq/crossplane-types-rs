...
pub struct CustomLayerForProvider {
    ...
    pub custom_security_group_id_selector:
        Option<CustomLayerForProviderCustomSecurityGroupIdSelector>,
...
pub struct CustomLayerInitProvider {
    ...
    pub custom_security_group_id_refs:
        Option<Vec<CustomLayerInitProviderCustomSecurityGroupIdRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate customSecurityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub custom_security_group_id_selector:
        Option<CustomLayerInitProviderCustomSecurityGroupIdSelector>,
    /// Ids for a set of security groups to apply to the layer's instances.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
