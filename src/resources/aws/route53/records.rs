...
pub struct RecordForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "geolocationRoutingPolicy"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "geoproximityRoutingPolicy"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "multivalueAnswerRoutingPolicy"
    )]
    #[builder(default, setter(strip_option))]
