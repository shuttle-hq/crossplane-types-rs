...
pub struct HealthCheckForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "childHealthchecksSelector"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cloudwatchAlarmNameSelector"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "insufficientDataHealthStatus"
    )]
    #[builder(default, setter(strip_option))]
