...
pub struct IntegrationStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "integrationResponseSelectionExpression"
    )]
    #[builder(default, setter(strip_option))]
