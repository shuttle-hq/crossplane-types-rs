...
pub struct GlobalReplicationGroupForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "globalReplicationGroupDescription"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "globalReplicationGroupIdSuffix"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "primaryReplicationGroupId"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "primaryReplicationGroupIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub primary_replication_group_id_ref:
        Option<GlobalReplicationGroupForProviderPrimaryReplicationGroupIdRef>,
    /// Selector for a ReplicationGroup in elasticache to populate primaryReplicationGroupId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "primaryReplicationGroupIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub primary_replication_group_id_selector:
        Option<GlobalReplicationGroupForProviderPrimaryReplicationGroupIdSelector>,
...
pub struct GlobalReplicationGroupForProviderPrimaryReplicationGroupIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GlobalReplicationGroupForProviderPrimaryReplicationGroupIdRefPolicyResolution>,
...
pub struct GlobalReplicationGroupForProviderPrimaryReplicationGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GlobalReplicationGroupForProviderPrimaryReplicationGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GlobalReplicationGroupForProviderPrimaryReplicationGroupIdSelectorPolicyResolve>,
}
...
pub struct GlobalReplicationGroupInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub primary_replication_group_id_ref:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdRef>,
    /// Selector for a ReplicationGroup in elasticache to populate primaryReplicationGroupId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub primary_replication_group_id_selector:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdSelector>,
}
...
pub struct GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdRefPolicyResolve>,
}
...
pub struct GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<GlobalReplicationGroupInitProviderPrimaryReplicationGroupIdSelectorPolicyResolve>,
}
...
pub struct GlobalReplicationGroupPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<GlobalReplicationGroupPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
