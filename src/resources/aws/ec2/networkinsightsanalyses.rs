...
pub struct NetworkInsightsAnalysisForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "networkInsightsPathIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub network_insights_path_id_ref:
        Option<NetworkInsightsAnalysisForProviderNetworkInsightsPathIdRef>,
    /// Selector for a NetworkInsightsPath in ec2 to populate networkInsightsPathId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "networkInsightsPathIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub network_insights_path_id_selector:
        Option<NetworkInsightsAnalysisForProviderNetworkInsightsPathIdSelector>,
...
pub struct NetworkInsightsAnalysisForProviderNetworkInsightsPathIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NetworkInsightsAnalysisForProviderNetworkInsightsPathIdRefPolicyResolution>,
...
pub struct NetworkInsightsAnalysisForProviderNetworkInsightsPathIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NetworkInsightsAnalysisForProviderNetworkInsightsPathIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<NetworkInsightsAnalysisForProviderNetworkInsightsPathIdSelectorPolicyResolve>,
}
...
pub struct NetworkInsightsAnalysisInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub network_insights_path_id_ref:
        Option<NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdRef>,
    /// Selector for a NetworkInsightsPath in ec2 to populate networkInsightsPathId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub network_insights_path_id_selector:
        Option<NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub tags: Option<BTreeMap<String, String>>,
...
pub struct NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<NetworkInsightsAnalysisInitProviderNetworkInsightsPathIdSelectorPolicyResolve>,
}
...
pub struct NetworkInsightsAnalysisPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<NetworkInsightsAnalysisPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct NetworkInsightsAnalysisStatusAtProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "alternatePathHints"
    )]
    #[builder(default, setter(strip_option))]
    pub alternate_path_hints:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderAlternatePathHints>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "forwardPathComponents"
    )]
    #[builder(default, setter(strip_option))]
    pub forward_path_components:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderForwardPathComponents>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "returnPathComponents"
    )]
    #[builder(default, setter(strip_option))]
    pub return_path_components:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderReturnPathComponents>>,
...
pub struct NetworkInsightsAnalysisStatusAtProviderExplanations {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "classicLoadBalancerListener"
    )]
    #[builder(default, setter(strip_option))]
    pub classic_load_balancer_listener:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsClassicLoadBalancerListener>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "customerGateway"
    )]
    #[builder(default, setter(strip_option))]
    pub customer_gateway:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsCustomerGateway>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationVpc"
    )]
    #[builder(default, setter(strip_option))]
    pub destination_vpc:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsDestinationVpc>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "elasticLoadBalancerListener"
    )]
    #[builder(default, setter(strip_option))]
    pub elastic_load_balancer_listener:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsElasticLoadBalancerListener>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "explanationCode"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "ingressRouteTable"
    )]
    #[builder(default, setter(strip_option))]
    pub ingress_route_table:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsIngressRouteTable>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "internetGateway"
    )]
    #[builder(default, setter(strip_option))]
    pub internet_gateway:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsInternetGateway>>,
    /// ARN of the Network Insights Analysis.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancerListenerPort"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancerTargetGroup"
    )]
    #[builder(default, setter(strip_option))]
    pub load_balancer_target_group:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsLoadBalancerTargetGroup>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancerTargetGroups"
    )]
    #[builder(default, setter(strip_option))]
    pub load_balancer_target_groups:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsLoadBalancerTargetGroups>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "loadBalancerTargetPort"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub network_interface:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsNetworkInterface>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "packetField"
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "routeTableRoute"
    )]
    #[builder(default, setter(strip_option))]
    pub route_table_route:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsRouteTableRoute>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub security_group:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsSecurityGroup>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "securityGroupRule"
    )]
    #[builder(default, setter(strip_option))]
    pub security_group_rule:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsSecurityGroupRule>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub security_groups:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsSecurityGroups>>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "subnetRouteTable"
    )]
    #[builder(default, setter(strip_option))]
    pub subnet_route_table:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsSubnetRouteTable>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub transit_gateway:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsTransitGateway>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transitGatewayAttachment"
    )]
    #[builder(default, setter(strip_option))]
    pub transit_gateway_attachment:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsTransitGatewayAttachment>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transitGatewayRouteTable"
    )]
    #[builder(default, setter(strip_option))]
    pub transit_gateway_route_table:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsTransitGatewayRouteTable>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transitGatewayRouteTableRoute"
    )]
    #[builder(default, setter(strip_option))]
    pub transit_gateway_route_table_route: Option<
        Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsTransitGatewayRouteTableRoute>,
    >,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpcPeeringConnection"
    )]
    #[builder(default, setter(strip_option))]
    pub vpc_peering_connection:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsVpcPeeringConnection>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub vpn_connection:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsVpnConnection>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpnGateway"
...
pub struct NetworkInsightsAnalysisStatusAtProviderExplanationsAclRule {
    ...
    #[builder(default, setter(strip_option))]
    pub port_range:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsAclRulePortRange>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
pub struct NetworkInsightsAnalysisStatusAtProviderExplanationsSecurityGroupRule {
    ...
    #[builder(default, setter(strip_option))]
    pub port_range:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderExplanationsSecurityGroupRulePortRange>>,
    /// ID of the Network Insights Analysis.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsAclRule {
    ...
    #[builder(default, setter(strip_option))]
    pub port_range:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsAclRulePortRange>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub protocol: Option<String>,
    #[serde(
...
pub struct NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsAdditionalDetails {
    ...
    pub component: Option<
        Vec<NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsAdditionalDetailsComponent>,
    >,
}
...
pub struct NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsSecurityGroupRule {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "portRange")]
    #[builder(default, setter(strip_option))]
    pub port_range: Option<
        Vec<NetworkInsightsAnalysisStatusAtProviderForwardPathComponentsSecurityGroupRulePortRange>,
    >,
    /// ID of the Network Insights Analysis.
    #[serde(
        default,
...
pub struct NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsAclRule {
    ...
    #[builder(default, setter(strip_option))]
    pub port_range:
        Option<Vec<NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsAclRulePortRange>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub protocol: Option<String>,
    #[serde(
...
pub struct NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsAdditionalDetails {
    ...
    #[builder(default, setter(strip_option))]
    pub component: Option<
        Vec<NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsAdditionalDetailsComponent>,
    >,
}
...
pub struct NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsSecurityGroupRule {
    ...
    #[builder(default, setter(strip_option))]
    pub port_range: Option<
        Vec<NetworkInsightsAnalysisStatusAtProviderReturnPathComponentsSecurityGroupRulePortRange>,
    >,
    /// ID of the Network Insights Analysis.
    #[serde(
        default,
