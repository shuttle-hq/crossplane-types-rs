...
pub struct NATGatewayForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "secondaryAllocationIdsRefs"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "secondaryAllocationIdsSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub secondary_allocation_ids_selector:
        Option<NATGatewayForProviderSecondaryAllocationIdsSelector>,
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "secondaryPrivateIpAddresses"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct NATGatewayInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub secondary_allocation_ids_refs:
        Option<Vec<NATGatewayInitProviderSecondaryAllocationIdsRefs>>,
    /// Selector for a list of EIP in ec2 to populate secondaryAllocationIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub secondary_allocation_ids_selector:
        Option<NATGatewayInitProviderSecondaryAllocationIdsSelector>,
    /// [Private NAT Gateway only] The number of secondary private IPv4 addresses you want to assign to the NAT Gateway.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
