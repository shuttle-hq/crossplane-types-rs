...
pub struct SpotInstanceRequestForProvider {
    ...
    pub capacity_reservation_specification:
        Option<SpotInstanceRequestForProviderCapacityReservationSpecification>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cpuCoreCount"
    ...
    pub vpc_security_group_id_refs:
        Option<Vec<SpotInstanceRequestForProviderVpcSecurityGroupIdRefs>>,
    ...
    pub vpc_security_group_id_selector:
        Option<SpotInstanceRequestForProviderVpcSecurityGroupIdSelector>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct SpotInstanceRequestForProviderCapacityReservationSpecification {
    ...
    pub capacity_reservation_target: Option<
        SpotInstanceRequestForProviderCapacityReservationSpecificationCapacityReservationTarget,
    >,
}
...
pub struct SpotInstanceRequestForProviderVpcSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<SpotInstanceRequestForProviderVpcSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct SpotInstanceRequestInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_specification:
        Option<SpotInstanceRequestInitProviderCapacityReservationSpecification>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cpuCoreCount"
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_security_group_id_refs:
        Option<Vec<SpotInstanceRequestInitProviderVpcSecurityGroupIdRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate vpcSecurityGroupIds.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub vpc_security_group_id_selector:
        Option<SpotInstanceRequestInitProviderVpcSecurityGroupIdSelector>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "vpcSecurityGroupIds"
...
pub struct SpotInstanceRequestInitProviderCapacityReservationSpecification {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_target: Option<
        SpotInstanceRequestInitProviderCapacityReservationSpecificationCapacityReservationTarget,
    >,
}
...
pub struct SpotInstanceRequestInitProviderVpcSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<SpotInstanceRequestInitProviderVpcSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct SpotInstanceRequestStatusAtProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_specification:
        Option<SpotInstanceRequestStatusAtProviderCapacityReservationSpecification>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "cpuCoreCount"
    ...
    pub ephemeral_block_device:
        Option<Vec<SpotInstanceRequestStatusAtProviderEphemeralBlockDevice>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "getPasswordData"
