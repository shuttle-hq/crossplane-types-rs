...
pub struct TransitGatewayConnectForProvider {
    ...
    pub transit_gateway_id_selector:
        Option<TransitGatewayConnectForProviderTransitGatewayIdSelector>,
    /// The underlaying VPC attachment
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transportAttachmentId"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transportAttachmentIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub transport_attachment_id_ref:
        Option<TransitGatewayConnectForProviderTransportAttachmentIdRef>,
    /// Selector for a TransitGatewayVPCAttachment in ec2 to populate transportAttachmentId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "transportAttachmentIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub transport_attachment_id_selector:
        Option<TransitGatewayConnectForProviderTransportAttachmentIdSelector>,
}
...
pub struct TransitGatewayConnectForProviderTransitGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectForProviderTransitGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectForProviderTransportAttachmentIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectForProviderTransportAttachmentIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectForProviderTransportAttachmentIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectForProviderTransportAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub transit_gateway_id_selector:
        Option<TransitGatewayConnectInitProviderTransitGatewayIdSelector>,
    /// The underlaying VPC attachment
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub transport_attachment_id_ref:
        Option<TransitGatewayConnectInitProviderTransportAttachmentIdRef>,
    /// Selector for a TransitGatewayVPCAttachment in ec2 to populate transportAttachmentId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub transport_attachment_id_selector:
        Option<TransitGatewayConnectInitProviderTransportAttachmentIdSelector>,
}
...
pub struct TransitGatewayConnectInitProviderTransitGatewayIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectInitProviderTransitGatewayIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectInitProviderTransportAttachmentIdRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectInitProviderTransportAttachmentIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct TransitGatewayConnectInitProviderTransportAttachmentIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectInitProviderTransportAttachmentIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    ...
    #[builder(default, setter(strip_option))]
    pub resolve:
        Option<TransitGatewayConnectInitProviderTransportAttachmentIdSelectorPolicyResolve>,
}
...
pub struct TransitGatewayConnectPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<TransitGatewayConnectPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
