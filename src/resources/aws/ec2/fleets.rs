...
pub struct FleetForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "excessCapacityTerminationPolicy"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "fulfilledOnDemandCapacity"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replaceUnhealthyInstances"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "targetCapacitySpecification"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "terminateInstancesWithExpiration"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FleetForProviderLaunchTemplateConfig {
    ...
    pub launch_template_specification:
        Option<FleetForProviderLaunchTemplateConfigLaunchTemplateSpecification>,
...
pub struct FleetForProviderLaunchTemplateConfigLaunchTemplateSpecification {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "launchTemplateIdRef"
    )]
    #[builder(default, setter(strip_option))]
    pub launch_template_id_ref:
        Option<FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRef>,
    /// Selector for a LaunchTemplate in ec2 to populate launchTemplateId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "launchTemplateIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub launch_template_id_selector: Option<
        FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdSelector,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub version_ref:
        Option<FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRef>,
    ...
    #[builder(default, setter(strip_option))]
    pub version_selector:
        Option<FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelector>,
}
...
pub struct FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRefPolicy,
    >,
}
...
pub struct FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicy>,
}
...
pub struct FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicy {
    ...
    pub resolution: Option<
        FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicyResolve,
    >,
}
...
pub struct FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FleetForProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelectorPolicy,
    >,
}
...
pub struct FleetForProviderLaunchTemplateConfigOverride {
    ...
    #[builder(default, setter(strip_option))]
    pub instance_requirements:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirements>,
    /// Instance type.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FleetForProviderLaunchTemplateConfigOverrideInstanceRequirements {
    ...
    pub accelerator_count:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount>,
    ...
    #[builder(default, setter(strip_option))]
    pub accelerator_total_memory_mib: Option<
        FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub baseline_ebs_bandwidth_mbps: Option<
        FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps,
    >,
    ...
    pub memory_gib_per_vcpu:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu>,
    ...
    #[builder(default, setter(strip_option))]
    pub memory_mib:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib>,
    ...
    #[builder(default, setter(strip_option))]
    pub network_bandwidth_gbps: Option<
        FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps,
    >,
    ...
    #[builder(default, setter(strip_option))]
    pub network_interface_count: Option<
        FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount,
    >,
    ...
    pub total_local_storage_gb:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb>,
    /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vcpuCount")]
    #[builder(default, setter(strip_option))]
    pub vcpu_count:
        Option<FleetForProviderLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount>,
}
...
pub struct FleetForProviderOnDemandOptions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "capacityReservationOptions"
    )]
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_options:
        Option<FleetForProviderOnDemandOptionsCapacityReservationOptions>,
    /// The maximum amount per hour for On-Demand Instances that you're willing to pay.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maxTotalPrice"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FleetForProviderSpotOptions {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "instancePoolsToUseCount"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FleetForProviderSpotOptionsMaintenanceStrategies {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_rebalance:
        Option<FleetForProviderSpotOptionsMaintenanceStrategiesCapacityRebalance>,
}
...
pub struct FleetForProviderTargetCapacitySpecification {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "defaultTargetCapacityType"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct FleetInitProviderLaunchTemplateConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub launch_template_specification:
        Option<FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecification>,
    /// Nested argument(s) containing parameters to override the same parameters in the Launch Template. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "override")]
    #[builder(default, setter(strip_option))]
...
pub struct FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecification {
    ...
    #[builder(default, setter(strip_option))]
    pub launch_template_id_ref:
        Option<FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRef>,
    /// Selector for a LaunchTemplate in ec2 to populate launchTemplateId.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub launch_template_id_selector: Option<
        FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdSelector,
    >,
    /// The name of the launch template.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub version_ref:
        Option<FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRef>,
    /// Selector for a LaunchTemplate in ec2 to populate version.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub version_selector:
        Option<FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelector>,
}
...
pub struct FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationLaunchTemplateIdRefPolicy,
    >,
}
...
pub struct FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRef {
    ...
    #[builder(default, setter(strip_option))]
    pub policy:
        Option<FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicy>,
}
...
pub struct FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution: Option<
        FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicyResolution,
    >,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    ...
    #[builder(default, setter(strip_option))]
    pub resolve: Option<
        FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionRefPolicyResolve,
    >,
}
...
pub struct FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelector {
    ...
    #[builder(default, setter(strip_option))]
    pub policy: Option<
        FleetInitProviderLaunchTemplateConfigLaunchTemplateSpecificationVersionSelectorPolicy,
    >,
}
...
pub struct FleetInitProviderLaunchTemplateConfigOverride {
    ...
    #[builder(default, setter(strip_option))]
    pub instance_requirements:
        Option<FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirements>,
    /// Instance type.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirements {
    ...
    #[builder(default, setter(strip_option))]
    pub accelerator_count:
        Option<FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount>,
    /// List of accelerator manufacturer names. Default is any manufacturer.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub accelerator_total_memory_mib: Option<
        FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib,
    >,
    /// The accelerator types that must be on the instance type. Default is any accelerator type.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub baseline_ebs_bandwidth_mbps: Option<
        FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps,
    >,
    /// Indicates whether burstable performance T instance types are included, excluded, or required. Default is excluded.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub memory_gib_per_vcpu:
        Option<FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu>,
    /// The minimum and maximum amount of memory per vCPU, in GiB. Default is no minimum or maximum limits.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryMib")]
    #[builder(default, setter(strip_option))]
    pub memory_mib:
        Option<FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib>,
    /// The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is No minimum or maximum.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
    ...
    #[builder(default, setter(strip_option))]
    pub network_bandwidth_gbps: Option<
        FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps,
    >,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub network_interface_count: Option<
        FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount,
    >,
    /// The price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 20.
    #[serde(
        default,
    ...
    #[builder(default, setter(strip_option))]
    pub total_local_storage_gb: Option<
        FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb,
    >,
    /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vcpuCount")]
    #[builder(default, setter(strip_option))]
    pub vcpu_count:
        Option<FleetInitProviderLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount>,
}
...
pub struct FleetInitProviderOnDemandOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_options:
        Option<FleetInitProviderOnDemandOptionsCapacityReservationOptions>,
    /// The maximum amount per hour for On-Demand Instances that you're willing to pay.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FleetInitProviderSpotOptionsMaintenanceStrategies {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_rebalance:
        Option<FleetInitProviderSpotOptionsMaintenanceStrategiesCapacityRebalance>,
}
...
pub struct FleetStatusAtProviderLaunchTemplateConfig {
    ...
    #[builder(default, setter(strip_option))]
    pub launch_template_specification:
        Option<FleetStatusAtProviderLaunchTemplateConfigLaunchTemplateSpecification>,
    /// Nested argument(s) containing parameters to override the same parameters in the Launch Template. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "override")]
    #[builder(default, setter(strip_option))]
...
pub struct FleetStatusAtProviderLaunchTemplateConfigOverride {
    ...
    #[builder(default, setter(strip_option))]
    pub instance_requirements:
        Option<FleetStatusAtProviderLaunchTemplateConfigOverrideInstanceRequirements>,
    /// Instance type.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FleetStatusAtProviderOnDemandOptions {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_reservation_options:
        Option<FleetStatusAtProviderOnDemandOptionsCapacityReservationOptions>,
    /// The maximum amount per hour for On-Demand Instances that you're willing to pay.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct FleetStatusAtProviderSpotOptionsMaintenanceStrategies {
    ...
    #[builder(default, setter(strip_option))]
    pub capacity_rebalance:
        Option<FleetStatusAtProviderSpotOptionsMaintenanceStrategiesCapacityRebalance>,
}
