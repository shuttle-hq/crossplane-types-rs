...
pub struct RouteForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationPrefixListIdRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "destinationPrefixListIdSelector"
    )]
    #[builder(default, setter(strip_option))]
    pub destination_prefix_list_id_selector:
        Option<RouteForProviderDestinationPrefixListIdSelector>,
...
pub struct RouteInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub destination_prefix_list_id_selector:
        Option<RouteInitProviderDestinationPrefixListIdSelector>,
    /// Identifier of a VPC Egress Only Internet Gateway.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
