...
pub struct SecurityGroupRuleForProvider {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceSecurityGroupIdRef"
    )]
    #[builder(default, setter(strip_option))]
    ...
    pub source_security_group_id_selector:
        Option<SecurityGroupRuleForProviderSourceSecurityGroupIdSelector>,
...
pub struct SecurityGroupRuleForProviderSourceSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<SecurityGroupRuleForProviderSourceSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct SecurityGroupRuleInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub source_security_group_id_selector:
        Option<SecurityGroupRuleInitProviderSourceSecurityGroupIdSelector>,
    /// End port (or ICMP code if protocol is "icmp").
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "toPort")]
    #[builder(default, setter(strip_option))]
    pub to_port: Option<f64>,
...
pub struct SecurityGroupRuleInitProviderSourceSecurityGroupIdSelectorPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<SecurityGroupRuleInitProviderSourceSecurityGroupIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
