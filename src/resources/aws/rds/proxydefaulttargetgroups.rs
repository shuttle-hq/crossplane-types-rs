...
pub struct ProxyDefaultTargetGroupForProviderConnectionPoolConfig {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "connectionBorrowTimeout"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maxIdleConnectionsPercent"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct ProxyDefaultTargetGroupPublishConnectionDetailsToConfigRefPolicy {
    ...
    #[builder(default, setter(strip_option))]
    pub resolution:
        Option<ProxyDefaultTargetGroupPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
