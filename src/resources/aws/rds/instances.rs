...
pub struct InstanceForProvider {
    ...
    pub master_user_secret_kms_key_id_selector:
        Option<InstanceForProviderMasterUserSecretKmsKeyIdSelector>,
    /// When configured, the upper limit to which Amazon RDS can automatically scale the storage of the DB instance. Configuring this will automatically ignore differences to allocated_storage. Must be greater than or equal to allocated_storage or 0 to disable Storage Autoscaling.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "maxAllocatedStorage"
    )]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "replicateSourceDbSelector"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct InstanceForProviderRestoreToPointInTime {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "sourceDbInstanceAutomatedBackupsArn"
    )]
    #[builder(default, setter(strip_option))]
...
pub struct InstanceInitProvider {
    ...
    #[builder(default, setter(strip_option))]
    pub master_user_secret_kms_key_id_selector:
        Option<InstanceInitProviderMasterUserSecretKmsKeyIdSelector>,
    /// When configured, the upper limit to which Amazon RDS can automatically scale the storage of the DB instance. Configuring this will automatically ignore differences to allocated_storage. Must be greater than or equal to allocated_storage or 0 to disable Storage Autoscaling.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
