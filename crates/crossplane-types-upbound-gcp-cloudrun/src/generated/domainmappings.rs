...
#[kube(group = "cloudrun.gcp.upbound.io", version = "v1beta2", kind = "DomainMapping", plural = "domainmappings")]
...
pub struct DomainMappingForProviderSpec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceOverride")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routeNameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routeNameSelector")]
...
pub struct DomainMappingStatusAtProviderStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mappedRouteName")]
