...
#[kube(group = "containeraws.gcp.upbound.io", version = "v1beta2", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProviderControlPlane {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsServicesAuthentication")]
    pub aws_services_authentication: Option<ClusterForProviderControlPlaneAwsServicesAuthentication>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mainVolume")]
...
pub struct ClusterForProviderNetworking {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "perNodePoolSgRulesDisabled")]
    pub per_node_pool_sg_rules_disabled: Option<bool>,
    /// All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges. Only a single range is supported. This field cannot be changed after creation.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "podAddressCidrBlocks")]
    pub pod_address_cidr_blocks: Option<Vec<String>>,
    /// All services in the cluster are assigned an RFC1918 IPv4 address from these ranges. Only a single range is supported. This field cannot be changed after creation.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceAddressCidrBlocks")]
...
pub struct ClusterInitProviderControlPlane {
    /// Authentication configuration for management of AWS resources.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsServicesAuthentication")]
    pub aws_services_authentication: Option<ClusterInitProviderControlPlaneAwsServicesAuthentication>,
    /// The ARN of the AWS KMS key used to encrypt cluster configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configEncryption")]
...
pub struct ClusterStatusAtProviderControlPlane {
    /// Authentication configuration for management of AWS resources.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsServicesAuthentication")]
    pub aws_services_authentication: Option<ClusterStatusAtProviderControlPlaneAwsServicesAuthentication>,
    /// The ARN of the AWS KMS key used to encrypt cluster configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configEncryption")]
