...
#[kube(group = "organizations.aws.upbound.io", version = "v1beta1", kind = "Organization", plural = "organizations")]
...
pub struct OrganizationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsServiceAccessPrincipals")]
    pub aws_service_access_principals: Option<Vec<String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enabledPolicyTypes")]
    pub enabled_policy_types: Option<Vec<String>>,
...
pub struct OrganizationStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub accounts: Option<Vec<OrganizationStatusAtProviderAccounts>>,
    /// ARN of the account
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "masterAccountArn")]
    pub master_account_arn: Option<String>,
    /// Email address of the master account
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "masterAccountEmail")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "masterAccountName")]
    pub master_account_name: Option<String>,
    /// List of organization accounts excluding the master account. For a list including the master account, see the accounts attribute. All elements have these attributes:
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nonMasterAccounts")]
    pub non_master_accounts: Option<Vec<OrganizationStatusAtProviderNonMasterAccounts>>,
    /// List of organization roots. All elements have these attributes:
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub roots: Option<Vec<OrganizationStatusAtProviderRoots>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct OrganizationStatusAtProviderAccounts {
    /// ARN of the account
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arn: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct OrganizationStatusAtProviderNonMasterAccounts {
    /// ARN of the account
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arn: Option<String>,
    /// Email of the account
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct OrganizationStatusAtProviderRoots {
    /// ARN of the account
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arn: Option<String>,
    /// Identifier of the account
    ...
    pub policy_types: Option<Vec<OrganizationStatusAtProviderRootsPolicyTypes>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct OrganizationStatusAtProviderRootsPolicyTypes {
    /// Current status of the account
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "type")]
