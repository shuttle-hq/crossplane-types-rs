...
#[kube(group = "macie2.aws.upbound.io", version = "v1beta2", kind = "ClassificationJob", plural = "classificationjobs")]
...
pub struct ClassificationJobForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customDataIdentifierIds")]
    pub custom_data_identifier_ids: Option<Vec<String>>,
    /// A custom description of the job. The description can contain as many as 200 characters.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    /// Specifies whether to analyze all existing, eligible objects immediately after the job is created.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initialRun")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3JobDefinition")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scheduleFrequency")]
...
pub struct ClassificationJobForProviderS3JobDefinition {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketCriteria")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketDefinitions")]
    pub bucket_definitions: Option<Vec<ClassificationJobForProviderS3JobDefinitionBucketDefinitions>>,
...
pub struct ClassificationJobForProviderS3JobDefinitionBucketCriteriaExcludesAnd {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobForProviderS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobForProviderS3JobDefinitionBucketCriteriaExcludesAndTagCriterion>,
}
...
pub struct ClassificationJobForProviderS3JobDefinitionBucketCriteriaIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobForProviderS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobForProviderS3JobDefinitionBucketCriteriaIncludesAndTagCriterion>,
}
...
pub struct ClassificationJobForProviderS3JobDefinitionScopingExcludesAnd {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobForProviderS3JobDefinitionScopingExcludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobForProviderS3JobDefinitionScopingExcludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobForProviderS3JobDefinitionScopingExcludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobForProviderS3JobDefinitionScopingExcludesAndTagScopeTermTagValues>>,
...
pub struct ClassificationJobForProviderS3JobDefinitionScopingIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobForProviderS3JobDefinitionScopingIncludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobForProviderS3JobDefinitionScopingIncludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobForProviderS3JobDefinitionScopingIncludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobForProviderS3JobDefinitionScopingIncludesAndTagScopeTermTagValues>>,
    /// The type of object to apply the condition to. The only valid value is S3_OBJECT.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
}
...
pub struct ClassificationJobForProviderScheduleFrequency {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "monthlySchedule")]
...
pub struct ClassificationJobInitProviderS3JobDefinition {
    ...
    /// An array of objects, one for each AWS account that owns buckets to analyze. Each object specifies the account ID for an account and one or more buckets to analyze for the account. Conflicts with bucket_criteria. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketDefinitions")]
    pub bucket_definitions: Option<Vec<ClassificationJobInitProviderS3JobDefinitionBucketDefinitions>>,
    /// The property- and tag-based conditions that determine which objects to include or exclude from the analysis. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ClassificationJobInitProviderS3JobDefinitionBucketCriteriaExcludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobInitProviderS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobInitProviderS3JobDefinitionBucketCriteriaExcludesAndTagCriterion>,
}
...
pub struct ClassificationJobInitProviderS3JobDefinitionBucketCriteriaIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobInitProviderS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobInitProviderS3JobDefinitionBucketCriteriaIncludesAndTagCriterion>,
}
...
pub struct ClassificationJobInitProviderS3JobDefinitionScopingExcludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobInitProviderS3JobDefinitionScopingExcludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobInitProviderS3JobDefinitionScopingExcludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobInitProviderS3JobDefinitionScopingExcludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobInitProviderS3JobDefinitionScopingExcludesAndTagScopeTermTagValues>>,
    /// The type of object to apply the condition to. The only valid value is S3_OBJECT.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
}
...
pub struct ClassificationJobInitProviderS3JobDefinitionScopingIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobInitProviderS3JobDefinitionScopingIncludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobInitProviderS3JobDefinitionScopingIncludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobInitProviderS3JobDefinitionScopingIncludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobInitProviderS3JobDefinitionScopingIncludesAndTagScopeTermTagValues>>,
    /// The type of object to apply the condition to. The only valid value is S3_OBJECT.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
}
...
pub struct ClassificationJobStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userPausedDetails")]
...
pub struct ClassificationJobStatusAtProviderS3JobDefinition {
    ...
    /// An array of objects, one for each AWS account that owns buckets to analyze. Each object specifies the account ID for an account and one or more buckets to analyze for the account. Conflicts with bucket_criteria. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketDefinitions")]
    pub bucket_definitions: Option<Vec<ClassificationJobStatusAtProviderS3JobDefinitionBucketDefinitions>>,
    /// The property- and tag-based conditions that determine which objects to include or exclude from the analysis. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaExcludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaExcludesAndTagCriterion>,
}
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleCriterion")]
    pub simple_criterion: Option<ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an S3 buckets from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagCriterion")]
    pub tag_criterion: Option<ClassificationJobStatusAtProviderS3JobDefinitionBucketCriteriaIncludesAndTagCriterion>,
}
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionScopingExcludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobStatusAtProviderS3JobDefinitionScopingExcludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobStatusAtProviderS3JobDefinitionScopingExcludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionScopingExcludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobStatusAtProviderS3JobDefinitionScopingExcludesAndTagScopeTermTagValues>>,
    /// The type of object to apply the condition to. The only valid value is S3_OBJECT.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
}
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionScopingIncludesAnd {
    /// A property-based condition that defines a property, operator, and one or more values for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "simpleScopeTerm")]
    pub simple_scope_term: Option<ClassificationJobStatusAtProviderS3JobDefinitionScopingIncludesAndSimpleScopeTerm>,
    /// A tag-based condition that defines the operator and tag keys or tag key and value pairs for including or excluding an object from the job. (documented below)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagScopeTerm")]
    pub tag_scope_term: Option<ClassificationJobStatusAtProviderS3JobDefinitionScopingIncludesAndTagScopeTerm>,
}
...
pub struct ClassificationJobStatusAtProviderS3JobDefinitionScopingIncludesAndTagScopeTerm {
    ...
    /// The tag keys or tag key and value pairs to use in the condition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagValues")]
    pub tag_values: Option<Vec<ClassificationJobStatusAtProviderS3JobDefinitionScopingIncludesAndTagScopeTermTagValues>>,
    /// The type of object to apply the condition to. The only valid value is S3_OBJECT.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub target: Option<String>,
}
...
pub struct ClassificationJobStatusAtProviderUserPausedDetails {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobExpiresAt")]
    pub job_expires_at: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobImminentExpirationHealthEventArn")]
    pub job_imminent_expiration_health_event_arn: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobPausedAt")]
