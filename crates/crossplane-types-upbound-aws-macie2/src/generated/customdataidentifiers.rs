...
#[kube(group = "macie2.aws.upbound.io", version = "v1beta1", kind = "CustomDataIdentifier", plural = "customdataidentifiers")]
...
pub struct CustomDataIdentifierForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreWords")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maximumMatchDistance")]
