...
#[kube(group = "dialogflowcx.gcp.upbound.io", version = "v1beta1", kind = "EntityType", plural = "entitytypes")]
...
pub struct EntityTypeForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoExpansionMode")]
    pub auto_expansion_mode: Option<String>,
    /// The human-readable name of the entity type, unique within the agent.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "displayName")]
    pub display_name: Option<String>,
    /// Enables fuzzy entity extraction during classification.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableFuzzyExtraction")]
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludedPhrases")]
