...
#[kube(group = "acmpca.aws.upbound.io", version = "v1beta2", kind = "CertificateAuthority", plural = "certificateauthorities")]
...
pub struct CertificateAuthorityForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateAuthorityConfiguration")]
    pub certificate_authority_configuration: Option<CertificateAuthorityForProviderCertificateAuthorityConfiguration>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "permanentDeletionTimeInDays")]
...
pub struct CertificateAuthorityForProviderRevocationConfiguration {
    ...
    pub crl_configuration: Option<CertificateAuthorityForProviderRevocationConfigurationCrlConfiguration>,
    ...
    pub ocsp_configuration: Option<CertificateAuthorityForProviderRevocationConfigurationOcspConfiguration>,
}
...
pub struct CertificateAuthorityInitProvider {
    /// Nested argument containing algorithms and certificate subject information. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateAuthorityConfiguration")]
    pub certificate_authority_configuration: Option<CertificateAuthorityInitProviderCertificateAuthorityConfiguration>,
    /// Whether the certificate authority is enabled or disabled. Defaults to true. Can only be disabled if the CA is in an ACTIVE state.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Cryptographic key management compliance standard used for handling CA keys. Defaults to FIPS_140_2_LEVEL_3_OR_HIGHER. Valid values: FIPS_140_2_LEVEL_3_OR_HIGHER and FIPS_140_2_LEVEL_2_OR_HIGHER. Supported standard for each region can be found in the Storage and security compliance of AWS Private CA private keys Documentation.
...
pub struct CertificateAuthorityInitProviderRevocationConfiguration {
    /// Nested argument containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "crlConfiguration")]
    pub crl_configuration: Option<CertificateAuthorityInitProviderRevocationConfigurationCrlConfiguration>,
    /// Nested argument containing configuration of
    /// the custom OCSP responder endpoint. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ocspConfiguration")]
    pub ocsp_configuration: Option<CertificateAuthorityInitProviderRevocationConfigurationOcspConfiguration>,
}
...
pub struct CertificateAuthorityStatusAtProvider {
    ...
    /// Nested argument containing algorithms and certificate subject information. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateAuthorityConfiguration")]
    pub certificate_authority_configuration: Option<CertificateAuthorityStatusAtProviderCertificateAuthorityConfiguration>,
    ...
    /// Nested argument containing revocation configuration. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "revocationConfiguration")]
    pub revocation_configuration: Option<CertificateAuthorityStatusAtProviderRevocationConfiguration>,
...
pub struct CertificateAuthorityStatusAtProviderCertificateAuthorityConfiguration {
    ...
    /// Nested argument that contains X.500 distinguished name information. At least one nested attribute must be specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subject: Option<CertificateAuthorityStatusAtProviderCertificateAuthorityConfigurationSubject>,
}
...
pub struct CertificateAuthorityStatusAtProviderRevocationConfiguration {
    /// Nested argument containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "crlConfiguration")]
    pub crl_configuration: Option<CertificateAuthorityStatusAtProviderRevocationConfigurationCrlConfiguration>,
    /// Nested argument containing configuration of
    /// the custom OCSP responder endpoint. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ocspConfiguration")]
    pub ocsp_configuration: Option<CertificateAuthorityStatusAtProviderRevocationConfigurationOcspConfiguration>,
}
