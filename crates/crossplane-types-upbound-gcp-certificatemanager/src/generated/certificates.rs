...
#[kube(group = "certificatemanager.gcp.upbound.io", version = "v1beta2", kind = "Certificate", plural = "certificates")]
...
pub struct CertificateForProviderManaged {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsAuthorizations")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsAuthorizationsRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsAuthorizationsSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainsRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainsSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "issuanceConfig")]
...
pub struct CertificateForProviderSelfManaged {
    ...
    pub certificate_pem_secret_ref: Option<CertificateForProviderSelfManagedCertificatePemSecretRef>,
    /// The certificate chain in PEM-encoded form.
    /// Leaf certificate comes first, followed by intermediate ones if any.
    ...
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pemPrivateKeySecretRef")]
    pub pem_private_key_secret_ref: Option<CertificateForProviderSelfManagedPemPrivateKeySecretRef>,
    /// The private key of the leaf certificate in PEM-encoded form.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateKeyPemSecretRef")]
...
pub struct CertificateInitProviderManaged {
    ...
    /// Selector for a list of DNSAuthorization in certificatemanager to populate dnsAuthorizations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsAuthorizationsSelector")]
    pub dns_authorizations_selector: Option<CertificateInitProviderManagedDnsAuthorizationsSelector>,
    /// The domains for which a managed SSL certificate will be generated.
    /// Wildcard domains are only supported with DNS challenge resolution
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub domains: Option<Vec<String>>,
...
pub struct CertificateInitProviderSelfManaged {
    ...
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificatePemSecretRef")]
    pub certificate_pem_secret_ref: Option<CertificateInitProviderSelfManagedCertificatePemSecretRef>,
    /// The certificate chain in PEM-encoded form.
    /// Leaf certificate comes first, followed by intermediate ones if any.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pemCertificate")]
    pub pem_certificate: Option<String>,
    ...
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pemPrivateKeySecretRef")]
    pub pem_private_key_secret_ref: Option<CertificateInitProviderSelfManagedPemPrivateKeySecretRef>,
    /// The private key of the leaf certificate in PEM-encoded form.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateKeyPemSecretRef")]
    pub private_key_pem_secret_ref: Option<CertificateInitProviderSelfManagedPrivateKeyPemSecretRef>,
}
...
pub struct CertificateStatusAtProviderManaged {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizationAttemptInfo")]
    pub authorization_attempt_info: Option<Vec<CertificateStatusAtProviderManagedAuthorizationAttemptInfo>>,
    /// Authorizations that will be used for performing domain authorization. Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dnsAuthorizations")]
    pub dns_authorizations: Option<Vec<String>>,
    /// The domains for which a managed SSL certificate will be generated.
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "provisioningIssue")]
