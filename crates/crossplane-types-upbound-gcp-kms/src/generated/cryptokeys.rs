...
#[kube(group = "kms.gcp.upbound.io", version = "v1beta2", kind = "CryptoKey", plural = "cryptokeys")]
...
pub struct CryptoKeyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cryptoKeyBackend")]
    pub crypto_key_backend: Option<String>,
    /// The period of time that versions of this key spend in the DESTROY_SCHEDULED state before transitioning to DESTROYED.
    /// If not specified at creation time, the default duration is 30 days.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destroyScheduledDuration")]
    pub destroy_scheduled_duration: Option<String>,
    /// Whether this key may contain imported versions only.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "importOnly")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipInitialVersionCreation")]
    pub skip_initial_version_creation: Option<bool>,
    /// A template describing settings for new crypto key versions.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "versionTemplate")]
