...
#[kube(group = "cloudwatchevents.aws.upbound.io", version = "v1beta2", kind = "Target", plural = "targets")]
...
pub struct TargetForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appsyncTarget")]
    pub appsync_target: Option<TargetForProviderAppsyncTarget>,
    /// The Amazon Resource Name (ARN) of the target.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub arn: Option<String>,
    /// Parameters used when you are using the rule to invoke an Amazon Batch Job. Documented below. A maximum of 1 are allowed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "batchTarget")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputTransformer")]
    pub input_transformer: Option<TargetForProviderInputTransformer>,
    /// Parameters used when you are using the rule to invoke an Amazon Kinesis Stream. Documented below. A maximum of 1 are allowed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisTarget")]
    pub kinesis_target: Option<TargetForProviderKinesisTarget>,
    /// Parameters used when you are using the rule to invoke an Amazon Redshift Statement. Documented below. A maximum of 1 are allowed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "redshiftTarget")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runCommandTargets")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sagemakerPipelineTarget")]
...
pub struct TargetForProviderAppsyncTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "graphqlOperation")]
...
pub struct TargetForProviderBatchTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobAttempts")]
...
pub struct TargetForProviderEcsTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "taskDefinitionArnRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "taskDefinitionArnSelector")]
...
pub struct TargetForProviderInputTransformer {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputPaths")]
    pub input_paths: Option<HashMap<String, String>>,
...
pub struct TargetForProviderKinesisTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "partitionKeyPath")]
...
pub struct TargetForProviderSagemakerPipelineTarget {
    ...
    pub pipeline_parameter_list: Option<Vec<TargetForProviderSagemakerPipelineTargetPipelineParameterList>>,
}
...
pub struct TargetInitProviderEcsTarget {
    /// The capacity provider strategy to use for the task. If a capacity_provider_strategy specified, the launch_type parameter must be omitted. If no capacity_provider_strategy or launch_type is specified, the default capacity provider strategy for the cluster is used. Can be one or more. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityProviderStrategy")]
    pub capacity_provider_strategy: Option<Vec<TargetInitProviderEcsTargetCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableEcsManagedTags")]
    pub enable_ecs_managed_tags: Option<bool>,
    /// Whether or not to enable the execute command functionality for the containers in this task. If true, this enables execute command functionality on all containers in the task.
    ...
    /// An array of placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "orderedPlacementStrategy")]
    pub ordered_placement_strategy: Option<Vec<TargetInitProviderEcsTargetOrderedPlacementStrategy>>,
    /// An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime). See Below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementConstraint")]
...
pub struct TargetInitProviderSagemakerPipelineTarget {
    /// List of Parameter names and values for SageMaker Model Building Pipeline execution.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pipelineParameterList")]
    pub pipeline_parameter_list: Option<Vec<TargetInitProviderSagemakerPipelineTargetPipelineParameterList>>,
}
...
pub struct TargetStatusAtProviderEcsTarget {
    /// The capacity provider strategy to use for the task. If a capacity_provider_strategy specified, the launch_type parameter must be omitted. If no capacity_provider_strategy or launch_type is specified, the default capacity provider strategy for the cluster is used. Can be one or more. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityProviderStrategy")]
    pub capacity_provider_strategy: Option<Vec<TargetStatusAtProviderEcsTargetCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableEcsManagedTags")]
    pub enable_ecs_managed_tags: Option<bool>,
    /// Whether or not to enable the execute command functionality for the containers in this task. If true, this enables execute command functionality on all containers in the task.
    ...
    /// An array of placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "orderedPlacementStrategy")]
    pub ordered_placement_strategy: Option<Vec<TargetStatusAtProviderEcsTargetOrderedPlacementStrategy>>,
    /// An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime). See Below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementConstraint")]
...
pub struct TargetStatusAtProviderSagemakerPipelineTarget {
    /// List of Parameter names and values for SageMaker Model Building Pipeline execution.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pipelineParameterList")]
    pub pipeline_parameter_list: Option<Vec<TargetStatusAtProviderSagemakerPipelineTargetPipelineParameterList>>,
}
