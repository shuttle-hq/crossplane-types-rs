...
#[kube(group = "compute.gcp.upbound.io", version = "v1beta2", kind = "HealthCheck", plural = "healthchecks")]
...
pub struct HealthCheckForProvider {
    ...
    pub grpc_health_check: Option<HealthCheckForProviderGrpcHealthCheck>,
    ...
    pub http2_health_check: Option<HealthCheckForProviderHttp2HealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpHealthCheck")]
    pub http_health_check: Option<HealthCheckForProviderHttpHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpsHealthCheck")]
    pub https_health_check: Option<HealthCheckForProviderHttpsHealthCheck>,
    /// Configure logging on this health check.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logConfig")]
    pub log_config: Option<HealthCheckForProviderLogConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceRegions")]
    pub source_regions: Option<Vec<String>>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslHealthCheck")]
    pub ssl_health_check: Option<HealthCheckForProviderSslHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tcpHealthCheck")]
    pub tcp_health_check: Option<HealthCheckForProviderTcpHealthCheck>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderGrpcHealthCheck {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderHttp2HealthCheck {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderHttpHealthCheck {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderHttpsHealthCheck {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderLogConfig {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderSslHealthCheck {
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckForProviderTcpHealthCheck {
...
pub struct HealthCheckInitProvider {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcHealthCheck")]
    pub grpc_health_check: Option<HealthCheckInitProviderGrpcHealthCheck>,
    /// A so-far unhealthy instance will be marked healthy after this many
    /// consecutive successes. The default value is 2.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "healthyThreshold")]
    pub healthy_threshold: Option<f64>,
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2HealthCheck")]
    pub http2_health_check: Option<HealthCheckInitProviderHttp2HealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpHealthCheck")]
    pub http_health_check: Option<HealthCheckInitProviderHttpHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpsHealthCheck")]
    pub https_health_check: Option<HealthCheckInitProviderHttpsHealthCheck>,
    /// Configure logging on this health check.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logConfig")]
    pub log_config: Option<HealthCheckInitProviderLogConfig>,
    /// The ID of the project in which the resource belongs.
    /// If it is not provided, the provider project is used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub project: Option<String>,
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslHealthCheck")]
    pub ssl_health_check: Option<HealthCheckInitProviderSslHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tcpHealthCheck")]
    pub tcp_health_check: Option<HealthCheckInitProviderTcpHealthCheck>,
    /// How long (in seconds) to wait before claiming failure.
    /// The default value is 5 seconds.  It is invalid for timeoutSec to have
    /// greater value than checkIntervalSec.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeoutSec")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderGrpcHealthCheck {
    /// The gRPC service name for the health check.
    /// The value of grpcServiceName has the following meanings by convention:
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcServiceName")]
    pub grpc_service_name: Option<String>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderHttp2HealthCheck {
    /// The value of the host header in the HTTP2 health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderHttpHealthCheck {
    /// The value of the host header in the HTTP health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderHttpsHealthCheck {
    /// The value of the host header in the HTTPS health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderLogConfig {
    /// Indicates whether or not to export logs. This is false by default,
    /// which means no health check logging will be done.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enable: Option<bool>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderSslHealthCheck {
    /// The TCP port number for the SSL health check request.
    /// The default value is 443.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckInitProviderTcpHealthCheck {
    /// The TCP port number for the TCP health check request.
    /// The default value is 443.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
...
pub struct HealthCheckStatusAtProvider {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcHealthCheck")]
    pub grpc_health_check: Option<HealthCheckStatusAtProviderGrpcHealthCheck>,
    /// A so-far unhealthy instance will be marked healthy after this many
    /// consecutive successes. The default value is 2.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "healthyThreshold")]
    pub healthy_threshold: Option<f64>,
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "http2HealthCheck")]
    pub http2_health_check: Option<HealthCheckStatusAtProviderHttp2HealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpHealthCheck")]
    pub http_health_check: Option<HealthCheckStatusAtProviderHttpHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpsHealthCheck")]
    pub https_health_check: Option<HealthCheckStatusAtProviderHttpsHealthCheck>,
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logConfig")]
    pub log_config: Option<HealthCheckStatusAtProviderLogConfig>,
    /// The ID of the project in which the resource belongs.
    /// If it is not provided, the provider project is used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub project: Option<String>,
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sslHealthCheck")]
    pub ssl_health_check: Option<HealthCheckStatusAtProviderSslHealthCheck>,
    /// A nested object resource
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tcpHealthCheck")]
    pub tcp_health_check: Option<HealthCheckStatusAtProviderTcpHealthCheck>,
    /// How long (in seconds) to wait before claiming failure.
    /// The default value is 5 seconds.  It is invalid for timeoutSec to have
    /// greater value than checkIntervalSec.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeoutSec")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderGrpcHealthCheck {
    /// The gRPC service name for the health check.
    /// The value of grpcServiceName has the following meanings by convention:
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grpcServiceName")]
    pub grpc_service_name: Option<String>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderHttp2HealthCheck {
    /// The value of the host header in the HTTP2 health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderHttpHealthCheck {
    /// The value of the host header in the HTTP health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderHttpsHealthCheck {
    /// The value of the host header in the HTTPS health check request.
    /// If left empty (default value), the public IP on behalf of which this health
    /// check is performed will be used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderLogConfig {
    /// Indicates whether or not to export logs. This is false by default,
    /// which means no health check logging will be done.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enable: Option<bool>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderSslHealthCheck {
    /// The TCP port number for the SSL health check request.
    /// The default value is 443.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct HealthCheckStatusAtProviderTcpHealthCheck {
    /// The TCP port number for the TCP health check request.
    /// The default value is 443.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
