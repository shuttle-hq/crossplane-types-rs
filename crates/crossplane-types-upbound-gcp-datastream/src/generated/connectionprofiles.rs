...
#[kube(group = "datastream.gcp.upbound.io", version = "v1beta2", kind = "ConnectionProfile", plural = "connectionprofiles")]
...
pub struct ConnectionProfileForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bigqueryProfile")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forwardSshConnectivity")]
    pub forward_ssh_connectivity: Option<ConnectionProfileForProviderForwardSshConnectivity>,
    /// Cloud Storage bucket profile.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gcsProfile")]
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mysqlProfile")]
    pub mysql_profile: Option<ConnectionProfileForProviderMysqlProfile>,
    /// Oracle database profile.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "oracleProfile")]
    pub oracle_profile: Option<ConnectionProfileForProviderOracleProfile>,
    /// PostgreSQL database profile.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "postgresqlProfile")]
    pub postgresql_profile: Option<ConnectionProfileForProviderPostgresqlProfile>,
    /// Private connectivity.
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnectivity")]
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sqlServerProfile")]
...
pub struct ConnectionProfileForProviderForwardSshConnectivity {
    ...
    pub password_secret_ref: Option<ConnectionProfileForProviderForwardSshConnectivityPasswordSecretRef>,
    ...
    pub private_key_secret_ref: Option<ConnectionProfileForProviderForwardSshConnectivityPrivateKeySecretRef>,
...
pub struct ConnectionProfileForProviderMysqlProfileSslConfig {
    ...
    pub ca_certificate_secret_ref: Option<ConnectionProfileForProviderMysqlProfileSslConfigCaCertificateSecretRef>,
    ...
    pub client_certificate_secret_ref: Option<ConnectionProfileForProviderMysqlProfileSslConfigClientCertificateSecretRef>,
    /// PEM-encoded private key associated with the Client Certificate.
    /// If this field is used then the 'client_certificate' and the
    /// 'ca_certificate' fields are mandatory.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientKeySecretRef")]
    pub client_key_secret_ref: Option<ConnectionProfileForProviderMysqlProfileSslConfigClientKeySecretRef>,
}
...
pub struct ConnectionProfileForProviderOracleProfile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionAttributes")]
    pub connection_attributes: Option<HashMap<String, String>>,
    /// Database for the Oracle connection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "databaseService")]
...
pub struct ConnectionProfileForProviderPostgresqlProfile {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostnameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostnameSelector")]
...
pub struct ConnectionProfileForProviderPostgresqlProfileDatabaseRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileDatabaseRefPolicyResolution>,
...
pub struct ConnectionProfileForProviderPostgresqlProfileDatabaseSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileDatabaseSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderPostgresqlProfileHostnameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileHostnameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderPostgresqlProfileHostnameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileHostnameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderPostgresqlProfileUsernameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileUsernameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderPostgresqlProfileUsernameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPostgresqlProfileUsernameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderPrivateConnectivity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnection")]
    pub private_connection: Option<String>,
    /// Reference to a PrivateConnection in datastream to populate privateConnection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnectionRef")]
    pub private_connection_ref: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionRef>,
    /// Selector for a PrivateConnection in datastream to populate privateConnection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnectionSelector")]
    pub private_connection_selector: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelector>,
}
...
pub struct ConnectionProfileForProviderPrivateConnectivityPrivateConnectionRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionRefPolicyResolve>,
}
...
pub struct ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelectorPolicy>,
}
...
pub struct ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileForProviderPrivateConnectivityPrivateConnectionSelectorPolicyResolve>,
}
...
pub struct ConnectionProfileForProviderSqlServerProfileDatabaseSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderSqlServerProfileDatabaseSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderSqlServerProfileHostnameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderSqlServerProfileHostnameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileForProviderSqlServerProfileUsernameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileForProviderSqlServerProfileUsernameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderForwardSshConnectivity {
    ...
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passwordSecretRef")]
    pub password_secret_ref: Option<ConnectionProfileInitProviderForwardSshConnectivityPasswordSecretRef>,
    /// Port for the SSH tunnel.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
    /// SSH private key.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateKeySecretRef")]
    pub private_key_secret_ref: Option<ConnectionProfileInitProviderForwardSshConnectivityPrivateKeySecretRef>,
    /// Username for the SSH tunnel.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub username: Option<String>,
}
...
pub struct ConnectionProfileInitProviderMysqlProfileSslConfig {
    ...
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCertificateSecretRef")]
    pub ca_certificate_secret_ref: Option<ConnectionProfileInitProviderMysqlProfileSslConfigCaCertificateSecretRef>,
    /// PEM-encoded certificate that will be used by the replica to
    /// authenticate against the source database server. If this field
    /// is used then the 'clientKey' and the 'caCertificate' fields are
    /// mandatory.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientCertificateSecretRef")]
    pub client_certificate_secret_ref: Option<ConnectionProfileInitProviderMysqlProfileSslConfigClientCertificateSecretRef>,
    /// PEM-encoded private key associated with the Client Certificate.
    /// If this field is used then the 'client_certificate' and the
    /// 'ca_certificate' fields are mandatory.
    /// Note: This property is sensitive and will not be displayed in the plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientKeySecretRef")]
    pub client_key_secret_ref: Option<ConnectionProfileInitProviderMysqlProfileSslConfigClientKeySecretRef>,
}
...
pub struct ConnectionProfileInitProviderPostgresqlProfileDatabaseRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileDatabaseRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderPostgresqlProfileDatabaseSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileDatabaseSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileInitProviderPostgresqlProfileDatabaseSelectorPolicyResolve>,
}
...
pub struct ConnectionProfileInitProviderPostgresqlProfileHostnameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileHostnameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderPostgresqlProfileHostnameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileHostnameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileInitProviderPostgresqlProfileHostnameSelectorPolicyResolve>,
}
...
pub struct ConnectionProfileInitProviderPostgresqlProfileUsernameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileUsernameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderPostgresqlProfileUsernameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPostgresqlProfileUsernameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileInitProviderPostgresqlProfileUsernameSelectorPolicyResolve>,
}
...
pub struct ConnectionProfileInitProviderPrivateConnectivity {
    ...
    /// Reference to a PrivateConnection in datastream to populate privateConnection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnectionRef")]
    pub private_connection_ref: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionRef>,
    /// Selector for a PrivateConnection in datastream to populate privateConnection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateConnectionSelector")]
    pub private_connection_selector: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelector>,
}
...
pub struct ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionRefPolicyResolve>,
}
...
pub struct ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelectorPolicy>,
}
...
pub struct ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectionProfileInitProviderPrivateConnectivityPrivateConnectionSelectorPolicyResolve>,
}
...
pub struct ConnectionProfileInitProviderSqlServerProfileDatabaseRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileDatabaseRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderSqlServerProfileDatabaseSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileDatabaseSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderSqlServerProfileHostnameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileHostnameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderSqlServerProfileHostnameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileHostnameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderSqlServerProfileUsernameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileUsernameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileInitProviderSqlServerProfileUsernameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectionProfileInitProviderSqlServerProfileUsernameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectionProfileStatusAtProviderMysqlProfileSslConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCertificateSet")]
    pub ca_certificate_set: Option<bool>,
    /// (Output)
    /// Indicates whether the clientCertificate field is set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientCertificateSet")]
    pub client_certificate_set: Option<bool>,
    /// (Output)
    /// Indicates whether the clientKey field is set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientKeySet")]
