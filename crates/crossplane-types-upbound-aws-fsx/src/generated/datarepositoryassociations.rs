...
#[kube(group = "fsx.aws.upbound.io", version = "v1beta2", kind = "DataRepositoryAssociation", plural = "datarepositoryassociations")]
...
pub struct DataRepositoryAssociationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "batchImportMetaDataOnCreate")]
    pub batch_import_meta_data_on_create: Option<bool>,
    /// The path to the Amazon S3 data repository that will be linked to the file system. The path must be an S3 bucket s3://myBucket/myPrefix/. This path specifies where in the S3 data repository files will be imported from or exported to. The same S3 bucket cannot be linked more than once to the same file system.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataRepositoryPath")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deleteDataInFilesystem")]
...
pub struct DataRepositoryAssociationForProviderFileSystemIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DataRepositoryAssociationForProviderFileSystemIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DataRepositoryAssociationForProviderS3 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoExportPolicy")]
...
pub struct DataRepositoryAssociationInitProviderFileSystemIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DataRepositoryAssociationInitProviderFileSystemIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DataRepositoryAssociationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DataRepositoryAssociationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
