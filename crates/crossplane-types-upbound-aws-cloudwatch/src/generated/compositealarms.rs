...
#[kube(group = "cloudwatch.aws.upbound.io", version = "v1beta2", kind = "CompositeAlarm", plural = "compositealarms")]
...
pub struct CompositeAlarmForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "actionsSuppressor")]
...
pub struct CompositeAlarmForProviderActionsSuppressor {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "extensionPeriod")]
    pub extension_period: Option<f64>,
    /// The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the ALARM state. After this time, the composite alarm performs its actions.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "waitPeriod")]
