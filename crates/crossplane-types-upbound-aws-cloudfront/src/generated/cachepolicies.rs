...
#[kube(group = "cloudfront.aws.upbound.io", version = "v1beta2", kind = "CachePolicy", plural = "cachepolicies")]
...
pub struct CachePolicyForProvider {
    ...
    pub parameters_in_cache_key_and_forwarded_to_origin: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOrigin>,
...
pub struct CachePolicyForProviderParametersInCacheKeyAndForwardedToOrigin {
    ...
    pub cookies_config: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig>,
    ...
    pub headers_config: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig>,
    ...
    pub query_strings_config: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginQueryStringsConfig>,
}
...
pub struct CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cookies: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginCookiesConfigCookies>,
}
...
pub struct CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<CachePolicyForProviderParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaders>,
}
...
pub struct CachePolicyInitProvider {
    ...
    /// Configuration for including HTTP headers, cookies, and URL query strings in the cache key. For more information, refer to the Parameters In Cache Key And Forwarded To Origin section.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "parametersInCacheKeyAndForwardedToOrigin")]
    pub parameters_in_cache_key_and_forwarded_to_origin: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOrigin>,
}
...
pub struct CachePolicyInitProviderParametersInCacheKeyAndForwardedToOrigin {
    /// Whether any cookies in viewer requests are included in the cache key and automatically included in requests that CloudFront sends to the origin. See Cookies Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cookiesConfig")]
    pub cookies_config: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig>,
    /// Flag determines whether the Accept-Encoding HTTP header is included in the cache key and in requests that CloudFront sends to the origin.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableAcceptEncodingBrotli")]
    pub enable_accept_encoding_brotli: Option<bool>,
    /// Whether the Accept-Encoding HTTP header is included in the cache key and in requests sent to the origin by CloudFront.
    ...
    /// Whether any HTTP headers are included in the cache key and automatically included in requests that CloudFront sends to the origin. See Headers Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "headersConfig")]
    pub headers_config: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig>,
    /// Whether any URL query strings in viewer requests are included in the cache key. It also automatically includes these query strings in requests that CloudFront sends to the origin. Please refer to the Query String Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "queryStringsConfig")]
    pub query_strings_config: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginQueryStringsConfig>,
}
...
pub struct CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig {
    ...
    /// Object that contains a list of cookie names. See Items for more information.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cookies: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginCookiesConfigCookies>,
}
...
pub struct CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig {
    ...
    /// Object contains a list of header names. See Items for more information.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<CachePolicyInitProviderParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaders>,
}
...
pub struct CachePolicyStatusAtProvider {
    ...
    /// Configuration for including HTTP headers, cookies, and URL query strings in the cache key. For more information, refer to the Parameters In Cache Key And Forwarded To Origin section.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "parametersInCacheKeyAndForwardedToOrigin")]
    pub parameters_in_cache_key_and_forwarded_to_origin: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOrigin>,
}
...
pub struct CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOrigin {
    /// Whether any cookies in viewer requests are included in the cache key and automatically included in requests that CloudFront sends to the origin. See Cookies Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cookiesConfig")]
    pub cookies_config: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig>,
    /// Flag determines whether the Accept-Encoding HTTP header is included in the cache key and in requests that CloudFront sends to the origin.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableAcceptEncodingBrotli")]
    pub enable_accept_encoding_brotli: Option<bool>,
    /// Whether the Accept-Encoding HTTP header is included in the cache key and in requests sent to the origin by CloudFront.
    ...
    /// Whether any HTTP headers are included in the cache key and automatically included in requests that CloudFront sends to the origin. See Headers Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "headersConfig")]
    pub headers_config: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig>,
    /// Whether any URL query strings in viewer requests are included in the cache key. It also automatically includes these query strings in requests that CloudFront sends to the origin. Please refer to the Query String Config for more information.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "queryStringsConfig")]
    pub query_strings_config: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginQueryStringsConfig>,
}
...
pub struct CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginCookiesConfig {
    ...
    /// Object that contains a list of cookie names. See Items for more information.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cookies: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginCookiesConfigCookies>,
}
...
pub struct CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginHeadersConfig {
    ...
    /// Object contains a list of header names. See Items for more information.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub headers: Option<CachePolicyStatusAtProviderParametersInCacheKeyAndForwardedToOriginHeadersConfigHeaders>,
}
