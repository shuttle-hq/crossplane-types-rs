...
#[kube(group = "signer.aws.upbound.io", version = "v1beta2", kind = "SigningJob", plural = "signingjobs")]
...
pub struct SigningJobForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreSigningJobFailure")]
...
pub struct SigningJobStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jobInvoker")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "signatureExpiresAt")]
    pub signature_expires_at: Option<String>,
    /// Name of the S3 bucket where the signed code image is saved by code signing.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "signedObject")]
