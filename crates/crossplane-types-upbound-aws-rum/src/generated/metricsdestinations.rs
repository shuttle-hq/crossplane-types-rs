...
#[kube(group = "rum.aws.upbound.io", version = "v1beta1", kind = "MetricsDestination", plural = "metricsdestinations")]
...
pub struct MetricsDestinationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appMonitorName")]
    pub app_monitor_name: Option<String>,
    /// Reference to a AppMonitor in rum to populate appMonitorName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appMonitorNameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appMonitorNameSelector")]
