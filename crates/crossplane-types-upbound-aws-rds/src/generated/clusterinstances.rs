...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "ClusterInstance", plural = "clusterinstances")]
...
pub struct ClusterInstanceForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbParameterGroupNameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbParameterGroupNameSelector")]
    pub db_parameter_group_name_selector: Option<ClusterInstanceForProviderDbParameterGroupNameSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "performanceInsightsKmsKeyIdRef")]
    pub performance_insights_kms_key_id_ref: Option<ClusterInstanceForProviderPerformanceInsightsKmsKeyIdRef>,
    /// Selector for a Key in kms to populate performanceInsightsKmsKeyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "performanceInsightsKmsKeyIdSelector")]
    pub performance_insights_kms_key_id_selector: Option<ClusterInstanceForProviderPerformanceInsightsKmsKeyIdSelector>,
...
pub struct ClusterInstanceForProviderPerformanceInsightsKmsKeyIdRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInstanceForProviderPerformanceInsightsKmsKeyIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceForProviderPerformanceInsightsKmsKeyIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInstanceForProviderPerformanceInsightsKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceInitProvider {
    ...
    /// Selector for a ParameterGroup in rds to populate dbParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbParameterGroupNameSelector")]
    pub db_parameter_group_name_selector: Option<ClusterInstanceInitProviderDbParameterGroupNameSelector>,
    /// Specifies the DB subnet group to associate with this DB instance. The default behavior varies depending on whether db_subnet_group_name is specified. Please refer to official AWS documentation to understand how db_subnet_group_name and publicly_accessible parameters affect DB instance behaviour. NOTE: This must match the db_subnet_group_name of the attached aws_rds_cluster.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbSubnetGroupName")]
    pub db_subnet_group_name: Option<String>,
    /// Reference to a SubnetGroup in rds to populate dbSubnetGroupName.
    ...
    /// Reference to a Key in kms to populate performanceInsightsKmsKeyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "performanceInsightsKmsKeyIdRef")]
    pub performance_insights_kms_key_id_ref: Option<ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdRef>,
    /// Selector for a Key in kms to populate performanceInsightsKmsKeyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "performanceInsightsKmsKeyIdSelector")]
    pub performance_insights_kms_key_id_selector: Option<ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdSelector>,
    /// Amount of time in days to retain Performance Insights data. Valid values are 7, 731 (2 years) or a multiple of 31. When specifying performance_insights_retention_period, performance_insights_enabled needs to be set to true. Defaults to '7'.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "performanceInsightsRetentionPeriod")]
    pub performance_insights_retention_period: Option<f64>,
    /// Daily time range during which automated backups are created if automated backups are enabled. Eg: "04:00-09:00". NOTE: If preferred_backup_window is set at the cluster level, this argument must be omitted.
...
pub struct ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ClusterInstanceInitProviderPerformanceInsightsKmsKeyIdSelectorPolicyResolve>,
}
