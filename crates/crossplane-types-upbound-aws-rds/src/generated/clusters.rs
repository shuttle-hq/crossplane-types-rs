...
#[kube(group = "rds.aws.upbound.io", version = "v1beta2", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterMembers")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbClusterParameterGroupNameRef")]
    pub db_cluster_parameter_group_name_ref: Option<ClusterForProviderDbClusterParameterGroupNameRef>,
    /// Selector for a ClusterParameterGroup in rds to populate dbClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbClusterParameterGroupNameSelector")]
    pub db_cluster_parameter_group_name_selector: Option<ClusterForProviderDbClusterParameterGroupNameSelector>,
    /// Instance parameter group to associate with all instances of the DB cluster. The db_instance_parameter_group_name parameter is only valid in combination with the allow_major_version_upgrade parameter.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupNameRef")]
    pub db_instance_parameter_group_name_ref: Option<ClusterForProviderDbInstanceParameterGroupNameRef>,
    /// Selector for a ParameterGroup in rds to populate dbInstanceParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupNameSelector")]
    pub db_instance_parameter_group_name_selector: Option<ClusterForProviderDbInstanceParameterGroupNameSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableLocalWriteForwarding")]
    ...
    pub master_user_secret_kms_key_id_selector: Option<ClusterForProviderMasterUserSecretKmsKeyIdSelector>,
    ...
    pub serverlessv2_scaling_configuration: Option<ClusterForProviderServerlessv2ScalingConfiguration>,
...
pub struct ClusterForProviderRestoreToPointInTime {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterIdentifier")]
    pub source_cluster_identifier: Option<String>,
    /// Reference to a Cluster in rds to populate sourceClusterIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterIdentifierRef")]
    pub source_cluster_identifier_ref: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierRef>,
    /// Selector for a Cluster in rds to populate sourceClusterIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterIdentifierSelector")]
    pub source_cluster_identifier_selector: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterResourceId")]
...
pub struct ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicyResolve>,
}
...
pub struct ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ClusterForProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicyResolve>,
}
...
pub struct ClusterInitProvider {
    ...
    /// Reference to a ClusterParameterGroup in rds to populate dbClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbClusterParameterGroupNameRef")]
    pub db_cluster_parameter_group_name_ref: Option<ClusterInitProviderDbClusterParameterGroupNameRef>,
    /// Selector for a ClusterParameterGroup in rds to populate dbClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbClusterParameterGroupNameSelector")]
    pub db_cluster_parameter_group_name_selector: Option<ClusterInitProviderDbClusterParameterGroupNameSelector>,
    /// Instance parameter group to associate with all instances of the DB cluster. The db_instance_parameter_group_name parameter is only valid in combination with the allow_major_version_upgrade parameter.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupName")]
    pub db_instance_parameter_group_name: Option<String>,
    /// Reference to a ParameterGroup in rds to populate dbInstanceParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupNameRef")]
    pub db_instance_parameter_group_name_ref: Option<ClusterInitProviderDbInstanceParameterGroupNameRef>,
    /// Selector for a ParameterGroup in rds to populate dbInstanceParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbInstanceParameterGroupNameSelector")]
    pub db_instance_parameter_group_name_selector: Option<ClusterInitProviderDbInstanceParameterGroupNameSelector>,
    /// DB subnet group to associate with this DB cluster.
    /// NOTE: This must match the db_subnet_group_name specified on every aws_rds_cluster_instance in the cluster.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dbSubnetGroupName")]
    pub db_subnet_group_name: Option<String>,
    ...
    /// Selector for a Key in kms to populate masterUserSecretKmsKeyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "masterUserSecretKmsKeyIdSelector")]
    pub master_user_secret_kms_key_id_selector: Option<ClusterInitProviderMasterUserSecretKmsKeyIdSelector>,
    /// Username for the master DB user. Please refer to the RDS Naming Constraints. This argument does not support in-place updates and cannot be changed during a restore from snapshot.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "masterUsername")]
    pub master_username: Option<String>,
    /// Network type of the cluster. Valid values: IPV4, DUAL.
    ...
    /// Nested attribute with scaling properties for ServerlessV2. Only valid when engine_mode is set to provisioned. More details below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessv2ScalingConfiguration")]
    pub serverlessv2_scaling_configuration: Option<ClusterInitProviderServerlessv2ScalingConfiguration>,
    /// Determines whether a final DB snapshot is created before the DB cluster is deleted. If true is specified, no DB snapshot is created. If false is specified, a DB snapshot is created before the DB cluster is deleted, using the value from final_snapshot_identifier. Default is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipFinalSnapshot")]
    pub skip_final_snapshot: Option<bool>,
    /// Specifies whether or not to create this cluster from a snapshot. You can use either the name or ARN when specifying a DB cluster snapshot, or the ARN when specifying a DB snapshot. Conflicts with global_cluster_identifier. Clusters cannot be restored from snapshot and joined to an existing global cluster in a single operation. See the AWS documentation or the Global Cluster Restored From Snapshot example for instructions on building a global cluster starting with a snapshot.
...
pub struct ClusterInitProviderRestoreToPointInTime {
    ...
    /// Reference to a Cluster in rds to populate sourceClusterIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterIdentifierRef")]
    pub source_cluster_identifier_ref: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierRef>,
    /// Selector for a Cluster in rds to populate sourceClusterIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterIdentifierSelector")]
    pub source_cluster_identifier_selector: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelector>,
    /// Cluster resource ID of the source database cluster from which to restore. To be used for restoring a deleted cluster in the same account which still has a retained automatic backup available.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceClusterResourceId")]
    pub source_cluster_resource_id: Option<String>,
    /// Set to true to restore the database cluster to the latest restorable backup time. Defaults to false. Conflicts with restore_to_time.
...
pub struct ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierRefPolicyResolve>,
}
...
pub struct ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicy>,
}
...
pub struct ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ClusterInitProviderRestoreToPointInTimeSourceClusterIdentifierSelectorPolicyResolve>,
}
...
pub struct ClusterStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "caCertificateValidTill")]
    pub ca_certificate_valid_till: Option<String>,
    /// – List of RDS Instances that are a part of this cluster
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterMembers")]
    pub cluster_members: Option<Vec<String>>,
    /// RDS Cluster Resource ID
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterResourceId")]
    ...
    /// Nested attribute with scaling properties for ServerlessV2. Only valid when engine_mode is set to provisioned. More details below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessv2ScalingConfiguration")]
    pub serverlessv2_scaling_configuration: Option<ClusterStatusAtProviderServerlessv2ScalingConfiguration>,
    /// Determines whether a final DB snapshot is created before the DB cluster is deleted. If true is specified, no DB snapshot is created. If false is specified, a DB snapshot is created before the DB cluster is deleted, using the value from final_snapshot_identifier. Default is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipFinalSnapshot")]
    pub skip_final_snapshot: Option<bool>,
    /// Specifies whether or not to create this cluster from a snapshot. You can use either the name or ARN when specifying a DB cluster snapshot, or the ARN when specifying a DB snapshot. Conflicts with global_cluster_identifier. Clusters cannot be restored from snapshot and joined to an existing global cluster in a single operation. See the AWS documentation or the Global Cluster Restored From Snapshot example for instructions on building a global cluster starting with a snapshot.
