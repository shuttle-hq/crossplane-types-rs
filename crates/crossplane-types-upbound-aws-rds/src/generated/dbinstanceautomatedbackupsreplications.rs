...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "DBInstanceAutomatedBackupsReplication", plural = "dbinstanceautomatedbackupsreplications")]
...
pub struct DBInstanceAutomatedBackupsReplicationSpec {
    ...
    pub publish_connection_details_to: Option<DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref: Option<DBInstanceAutomatedBackupsReplicationWriteConnectionSecretToRef>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProvider {
    ...
    pub kms_key_id_selector: Option<DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbInstanceArn")]
    pub source_db_instance_arn: Option<String>,
    /// Reference to a Instance in rds to populate sourceDbInstanceArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbInstanceArnRef")]
    pub source_db_instance_arn_ref: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRef>,
    /// Selector for a Instance in rds to populate sourceDbInstanceArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbInstanceArnSelector")]
    pub source_db_instance_arn_selector: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelector>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdRefPolicyResolution>,
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationForProviderKmsKeyIdSelectorPolicyResolve>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRefPolicy>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnRefPolicyResolve>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelectorPolicy>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationForProviderSourceDbInstanceArnSelectorPolicyResolve>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationInitProvider {
    ...
    /// Selector for a Key in kms to populate kmsKeyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyIdSelector")]
    pub kms_key_id_selector: Option<DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdSelector>,
    /// A URL that contains a Signature Version 4 signed request for the StartDBInstanceAutomatedBackupsReplication action to be called in the AWS Region of the source DB instance.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "preSignedUrl")]
    pub pre_signed_url: Option<String>,
    /// The retention period for the replicated automated backups, defaults to 7.
    ...
    /// Reference to a Instance in rds to populate sourceDbInstanceArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbInstanceArnRef")]
    pub source_db_instance_arn_ref: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRef>,
    /// Selector for a Instance in rds to populate sourceDbInstanceArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbInstanceArnSelector")]
    pub source_db_instance_arn_selector: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnSelector>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationInitProviderKmsKeyIdSelectorPolicyResolve>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRefPolicy>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnRefPolicyResolve>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DBInstanceAutomatedBackupsReplicationInitProviderSourceDbInstanceArnSelectorPolicy>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsTo {
    ...
    pub config_ref: Option<DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRef>,
...
pub struct DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRefPolicy>,
}
...
pub struct DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DBInstanceAutomatedBackupsReplicationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
