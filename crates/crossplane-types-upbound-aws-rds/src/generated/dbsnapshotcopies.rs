...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "DBSnapshotCopy", plural = "dbsnapshotcopies")]
...
pub struct DBSnapshotCopyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbSnapshotIdentifierRef")]
    pub source_db_snapshot_identifier_ref: Option<DBSnapshotCopyForProviderSourceDbSnapshotIdentifierRef>,
    /// Selector for a Snapshot in rds to populate sourceDbSnapshotIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbSnapshotIdentifierSelector")]
    pub source_db_snapshot_identifier_selector: Option<DBSnapshotCopyForProviderSourceDbSnapshotIdentifierSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
    /// The external custom Availability Zone.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetCustomAvailabilityZone")]
    pub target_custom_availability_zone: Option<String>,
    /// The Identifier for the snapshot.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetDbSnapshotIdentifier")]
...
pub struct DBSnapshotCopyForProviderSourceDbSnapshotIdentifierSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBSnapshotCopyForProviderSourceDbSnapshotIdentifierSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DBSnapshotCopyInitProvider {
    ...
    /// Reference to a Snapshot in rds to populate sourceDbSnapshotIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbSnapshotIdentifierRef")]
    pub source_db_snapshot_identifier_ref: Option<DBSnapshotCopyInitProviderSourceDbSnapshotIdentifierRef>,
    /// Selector for a Snapshot in rds to populate sourceDbSnapshotIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceDbSnapshotIdentifierSelector")]
    pub source_db_snapshot_identifier_selector: Option<DBSnapshotCopyInitProviderSourceDbSnapshotIdentifierSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
    /// The external custom Availability Zone.
...
pub struct DBSnapshotCopyInitProviderSourceDbSnapshotIdentifierSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DBSnapshotCopyInitProviderSourceDbSnapshotIdentifierSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
