...
#[kube(group = "rds.aws.upbound.io", version = "v1beta1", kind = "ClusterEndpoint", plural = "clusterendpoints")]
...
pub struct ClusterEndpointForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customEndpointType")]
    pub custom_endpoint_type: Option<String>,
    /// List of DB instance identifiers that aren't part of the custom endpoint group. All other eligible instances are reachable through the custom endpoint. Only relevant if the list of static members is empty. Conflicts with static_members.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludedMembers")]
    pub excluded_members: Option<Vec<String>>,
    /// References to ClusterInstance in rds to populate excludedMembers.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludedMembersRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludedMembersSelector")]
    pub excluded_members_selector: Option<ClusterEndpointForProviderExcludedMembersSelector>,
    /// Region is the region you'd like your resource to be created in.
    pub region: String,
    /// List of DB instance identifiers that are part of the custom endpoint group. Conflicts with excluded_members.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "staticMembers")]
    pub static_members: Option<Vec<String>>,
    /// References to ClusterInstance in rds to populate staticMembers.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "staticMembersRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "staticMembersSelector")]
