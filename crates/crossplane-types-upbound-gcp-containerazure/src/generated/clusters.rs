...
#[kube(group = "containerazure.gcp.upbound.io", version = "v1beta2", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "azureRegion")]
    pub azure_region: Option<String>,
    /// Azure authentication configuration for management of Azure resources
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "azureServicesAuthentication")]
...
pub struct ClusterForProviderControlPlane {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicaPlacements")]
...
pub struct ClusterForProviderNetworking {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "virtualNetworkId")]
