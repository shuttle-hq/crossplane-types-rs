...
#[kube(group = "mediapackage.aws.upbound.io", version = "v1beta1", kind = "Channel", plural = "channels")]
...
pub struct ChannelStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsIngest")]
    pub hls_ingest: Option<Vec<ChannelStatusAtProviderHlsIngest>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct ChannelStatusAtProviderHlsIngest {
    /// A list of the ingest endpoints
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ingestEndpoints")]
    pub ingest_endpoints: Option<Vec<ChannelStatusAtProviderHlsIngestIngestEndpoints>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct ChannelStatusAtProviderHlsIngestIngestEndpoints {
    /// The password
    #[serde(default, skip_serializing_if = "Option::is_none")]
