...
#[kube(group = "ivs.aws.upbound.io", version = "v1beta1", kind = "Channel", plural = "channels")]
...
pub struct ChannelForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "latencyMode")]
    pub latency_mode: Option<String>,
    /// Channel name.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Recording configuration ARN.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingConfigurationArn")]
...
pub struct ChannelStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ingestEndpoint")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "playbackUrl")]
