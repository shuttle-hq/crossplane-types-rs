...
#[kube(group = "apigateway.aws.upbound.io", version = "v1beta1", kind = "Authorizer", plural = "authorizers")]
...
pub struct AuthorizerForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizerCredentials")]
    pub authorizer_credentials: Option<String>,
    /// Reference to a Role in iam to populate authorizerCredentials.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizerCredentialsRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizerCredentialsSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "identitySource")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "providerArns")]
...
pub struct AuthorizerInitProvider {
    ...
    /// Selector for a Role in iam to populate authorizerCredentials.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizerCredentialsSelector")]
    pub authorizer_credentials_selector: Option<AuthorizerInitProviderAuthorizerCredentialsSelector>,
    /// TTL of cached authorizer results in seconds. Defaults to 300.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizerResultTtlInSeconds")]
    pub authorizer_result_ttl_in_seconds: Option<f64>,
    /// Authorizer's Uniform Resource Identifier (URI). This must be a well-formed Lambda function URI in the form of arn:aws:apigateway:{region}:lambda:path/{service_api},
