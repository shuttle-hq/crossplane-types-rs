...
#[kube(group = "apigateway.aws.upbound.io", version = "v1beta2", kind = "Integration", plural = "integrations")]
...
pub struct IntegrationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cacheKeyParameters")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "integrationHttpMethod")]
...
pub struct IntegrationForProviderTlsConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "insecureSkipVerification")]
