...
#[kube(group = "scheduler.aws.upbound.io", version = "v1beta2", kind = "Schedule", plural = "schedules")]
...
pub struct ScheduleForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "flexibleTimeWindow")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scheduleExpressionTimezone")]
...
pub struct ScheduleForProviderFlexibleTimeWindow {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maximumWindowInMinutes")]
...
pub struct ScheduleForProviderTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ecsParameters")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventbridgeParameters")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisParameters")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sqsParameters")]
...
pub struct ScheduleForProviderTargetEcsParameters {
    ...
    pub capacity_provider_strategy: Option<Vec<ScheduleForProviderTargetEcsParametersCapacityProviderStrategy>>,
    ...
    pub placement_constraints: Option<Vec<ScheduleForProviderTargetEcsParametersPlacementConstraints>>,
...
pub struct ScheduleForProviderTargetSagemakerPipelineParameters {
    ...
    pub pipeline_parameter: Option<Vec<ScheduleForProviderTargetSagemakerPipelineParametersPipelineParameter>>,
}
...
pub struct ScheduleInitProviderTarget {
    ...
    /// Templated target type for the Amazon SageMaker StartPipelineExecution API operation. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sagemakerPipelineParameters")]
    pub sagemaker_pipeline_parameters: Option<ScheduleInitProviderTargetSagemakerPipelineParameters>,
    /// The templated target type for the Amazon SQS SendMessage API operation. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sqsParameters")]
...
pub struct ScheduleInitProviderTargetEcsParameters {
    /// Up to 6 capacity provider strategies to use for the task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityProviderStrategy")]
    pub capacity_provider_strategy: Option<Vec<ScheduleInitProviderTargetEcsParametersCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task. For more information, see Tagging Your Amazon ECS Resources in the Amazon ECS Developer Guide.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableEcsManagedTags")]
    pub enable_ecs_managed_tags: Option<bool>,
    /// Specifies whether to enable the execute command functionality for the containers in this task.
    ...
    /// A set of up to 10 placement constraints to use for the task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementConstraints")]
    pub placement_constraints: Option<Vec<ScheduleInitProviderTargetEcsParametersPlacementConstraints>>,
    /// A set of up to 5 placement strategies. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementStrategy")]
...
pub struct ScheduleInitProviderTargetSagemakerPipelineParameters {
    /// Set of up to 200 parameter names and values to use when executing the SageMaker Model Building Pipeline. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pipelineParameter")]
    pub pipeline_parameter: Option<Vec<ScheduleInitProviderTargetSagemakerPipelineParametersPipelineParameter>>,
}
...
pub struct ScheduleStatusAtProviderTarget {
    ...
    /// Templated target type for the Amazon SageMaker StartPipelineExecution API operation. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sagemakerPipelineParameters")]
    pub sagemaker_pipeline_parameters: Option<ScheduleStatusAtProviderTargetSagemakerPipelineParameters>,
    /// The templated target type for the Amazon SQS SendMessage API operation. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sqsParameters")]
...
pub struct ScheduleStatusAtProviderTargetEcsParameters {
    /// Up to 6 capacity provider strategies to use for the task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityProviderStrategy")]
    pub capacity_provider_strategy: Option<Vec<ScheduleStatusAtProviderTargetEcsParametersCapacityProviderStrategy>>,
    /// Specifies whether to enable Amazon ECS managed tags for the task. For more information, see Tagging Your Amazon ECS Resources in the Amazon ECS Developer Guide.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableEcsManagedTags")]
    pub enable_ecs_managed_tags: Option<bool>,
    /// Specifies whether to enable the execute command functionality for the containers in this task.
    ...
    /// Configures the networking associated with the task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkConfiguration")]
    pub network_configuration: Option<ScheduleStatusAtProviderTargetEcsParametersNetworkConfiguration>,
    /// A set of up to 10 placement constraints to use for the task. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementConstraints")]
    pub placement_constraints: Option<Vec<ScheduleStatusAtProviderTargetEcsParametersPlacementConstraints>>,
    /// A set of up to 5 placement strategies. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "placementStrategy")]
    pub placement_strategy: Option<Vec<ScheduleStatusAtProviderTargetEcsParametersPlacementStrategy>>,
    /// Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as 1.1.0.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "platformVersion")]
    pub platform_version: Option<String>,
    /// Specifies whether to propagate the tags from the task definition to the task. One of: TASK_DEFINITION.
...
pub struct ScheduleStatusAtProviderTargetSagemakerPipelineParameters {
    /// Set of up to 200 parameter names and values to use when executing the SageMaker Model Building Pipeline. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pipelineParameter")]
    pub pipeline_parameter: Option<Vec<ScheduleStatusAtProviderTargetSagemakerPipelineParametersPipelineParameter>>,
}
