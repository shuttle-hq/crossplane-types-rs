...
#[kube(group = "ecr.aws.upbound.io", version = "v1beta1", kind = "LifecyclePolicy", plural = "lifecyclepolicies")]
...
pub struct LifecyclePolicyForProvider {
    ...
    pub repository_ref: Option<LifecyclePolicyForProviderRepositoryRef>,
    ...
    pub repository_selector: Option<LifecyclePolicyForProviderRepositorySelector>,
}

/// Reference to a Repository in ecr to populate repository.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyForProviderRepositoryRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<LifecyclePolicyForProviderRepositoryRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyForProviderRepositoryRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<LifecyclePolicyForProviderRepositoryRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<LifecyclePolicyForProviderRepositoryRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyForProviderRepositoryRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyForProviderRepositoryRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
/// Selector for a Repository in ecr to populate repository.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyForProviderRepositorySelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<LifecyclePolicyForProviderRepositorySelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyForProviderRepositorySelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<LifecyclePolicyForProviderRepositorySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<LifecyclePolicyForProviderRepositorySelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyForProviderRepositorySelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyForProviderRepositorySelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct LifecyclePolicyInitProvider {
    ...
    /// Reference to a Repository in ecr to populate repository.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "repositoryRef")]
    pub repository_ref: Option<LifecyclePolicyInitProviderRepositoryRef>,
    /// Selector for a Repository in ecr to populate repository.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "repositorySelector")]
    pub repository_selector: Option<LifecyclePolicyInitProviderRepositorySelector>,
}

/// Reference to a Repository in ecr to populate repository.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyInitProviderRepositoryRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<LifecyclePolicyInitProviderRepositoryRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyInitProviderRepositoryRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<LifecyclePolicyInitProviderRepositoryRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<LifecyclePolicyInitProviderRepositoryRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyInitProviderRepositoryRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyInitProviderRepositoryRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
/// Selector for a Repository in ecr to populate repository.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyInitProviderRepositorySelector {
    /// MatchControllerRef ensures an object with the same controller reference
    /// as the selecting object is selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchControllerRef")]
    pub match_controller_ref: Option<bool>,
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<LifecyclePolicyInitProviderRepositorySelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct LifecyclePolicyInitProviderRepositorySelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<LifecyclePolicyInitProviderRepositorySelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<LifecyclePolicyInitProviderRepositorySelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyInitProviderRepositorySelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum LifecyclePolicyInitProviderRepositorySelectorPolicyResolve {
    Always,
    IfNotPresent,
}
