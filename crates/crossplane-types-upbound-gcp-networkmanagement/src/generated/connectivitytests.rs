...
#[kube(group = "networkmanagement.gcp.upbound.io", version = "v1beta2", kind = "ConnectivityTest", plural = "connectivitytests")]
...
pub struct ConnectivityTestForProvider {
    ...
    /// boundaries.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "relatedProjects")]
...
pub struct ConnectivityTestInitProviderDestinationIpAddressSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectivityTestInitProviderDestinationIpAddressSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectivityTestInitProviderDestinationProjectIdSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectivityTestInitProviderDestinationProjectIdSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
