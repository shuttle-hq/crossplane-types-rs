...
#[kube(group = "configservice.aws.upbound.io", version = "v1beta1", kind = "ConformancePack", plural = "conformancepacks")]
...
pub struct ConformancePackForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliveryS3Bucket")]
    pub delivery_s3_bucket: Option<String>,
    /// The prefix for the Amazon S3 bucket. Maximum length of 1024.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliveryS3KeyPrefix")]
    pub delivery_s3_key_prefix: Option<String>,
    /// Set of configuration blocks describing input parameters passed to the conformance pack template. Documented below. When configured, the parameters must also be included in the template_body or in the template stored in Amazon S3 if using template_s3_uri.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputParameter")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "templateS3Uri")]
