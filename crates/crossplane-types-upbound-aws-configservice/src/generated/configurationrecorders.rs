...
#[kube(group = "configservice.aws.upbound.io", version = "v1beta2", kind = "ConfigurationRecorder", plural = "configurationrecorders")]
...
pub struct ConfigurationRecorderForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingGroup")]
...
pub struct ConfigurationRecorderForProviderRecordingGroup {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allSupported")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exclusionByResourceTypes")]
    pub exclusion_by_resource_types: Option<Vec<ConfigurationRecorderForProviderRecordingGroupExclusionByResourceTypes>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeGlobalResourceTypes")]
    pub include_global_resource_types: Option<bool>,
    /// Recording Strategy. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingStrategy")]
    pub recording_strategy: Option<Vec<ConfigurationRecorderForProviderRecordingGroupRecordingStrategy>>,
...
pub struct ConfigurationRecorderForProviderRecordingMode {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingFrequency")]
    pub recording_frequency: Option<String>,
    /// Recording mode overrides. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingModeOverride")]
    pub recording_mode_override: Option<ConfigurationRecorderForProviderRecordingModeRecordingModeOverride>,
}
...
pub struct ConfigurationRecorderInitProviderRecordingGroup {
    ...
    /// An object that specifies how AWS Config excludes resource types from being recorded by the configuration recorder.To use this option, you must set the useOnly field of RecordingStrategy to EXCLUSION_BY_RESOURCE_TYPES Requires all_supported = false. Conflicts with resource_types.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exclusionByResourceTypes")]
    pub exclusion_by_resource_types: Option<Vec<ConfigurationRecorderInitProviderRecordingGroupExclusionByResourceTypes>>,
    /// Specifies whether AWS Config includes all supported types of global resources with the resources that it records. Requires all_supported = true. Conflicts with resource_types.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeGlobalResourceTypes")]
    pub include_global_resource_types: Option<bool>,
    /// Recording Strategy. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingStrategy")]
    pub recording_strategy: Option<Vec<ConfigurationRecorderInitProviderRecordingGroupRecordingStrategy>>,
    /// A list that specifies the types of AWS resources for which AWS Config records configuration changes (for example, AWS::EC2::Instance or AWS::CloudTrail::Trail). See relevant part of AWS Docs for available types. In order to use this attribute, all_supported must be set to false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceTypes")]
    pub resource_types: Option<Vec<String>>,
}
...
pub struct ConfigurationRecorderInitProviderRecordingMode {
    ...
    /// Recording mode overrides. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingModeOverride")]
    pub recording_mode_override: Option<ConfigurationRecorderInitProviderRecordingModeRecordingModeOverride>,
}
...
pub struct ConfigurationRecorderPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationRecorderPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConfigurationRecorderStatusAtProviderRecordingGroup {
    ...
    /// An object that specifies how AWS Config excludes resource types from being recorded by the configuration recorder.To use this option, you must set the useOnly field of RecordingStrategy to EXCLUSION_BY_RESOURCE_TYPES Requires all_supported = false. Conflicts with resource_types.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "exclusionByResourceTypes")]
    pub exclusion_by_resource_types: Option<Vec<ConfigurationRecorderStatusAtProviderRecordingGroupExclusionByResourceTypes>>,
    /// Specifies whether AWS Config includes all supported types of global resources with the resources that it records. Requires all_supported = true. Conflicts with resource_types.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeGlobalResourceTypes")]
    pub include_global_resource_types: Option<bool>,
    /// Recording Strategy. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingStrategy")]
    pub recording_strategy: Option<Vec<ConfigurationRecorderStatusAtProviderRecordingGroupRecordingStrategy>>,
    /// A list that specifies the types of AWS resources for which AWS Config records configuration changes (for example, AWS::EC2::Instance or AWS::CloudTrail::Trail). See relevant part of AWS Docs for available types. In order to use this attribute, all_supported must be set to false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceTypes")]
    pub resource_types: Option<Vec<String>>,
}
...
pub struct ConfigurationRecorderStatusAtProviderRecordingMode {
    ...
    /// Recording mode overrides. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recordingModeOverride")]
    pub recording_mode_override: Option<ConfigurationRecorderStatusAtProviderRecordingModeRecordingModeOverride>,
}
