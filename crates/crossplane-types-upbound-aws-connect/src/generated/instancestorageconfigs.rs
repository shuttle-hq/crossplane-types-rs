...
#[kube(group = "connect.aws.upbound.io", version = "v1beta2", kind = "InstanceStorageConfig", plural = "instancestorageconfigs")]
...
pub struct InstanceStorageConfigForProviderStorageConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseConfig")]
    pub kinesis_firehose_config: Option<InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfig>,
    /// A block that specifies the configuration of the Kinesis data stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisStreamConfig")]
    pub kinesis_stream_config: Option<InstanceStorageConfigForProviderStorageConfigKinesisStreamConfig>,
    /// A block that specifies the configuration of the Kinesis video stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisVideoStreamConfig")]
    pub kinesis_video_stream_config: Option<InstanceStorageConfigForProviderStorageConfigKinesisVideoStreamConfig>,
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfig {
    ...
    pub firehose_arn_ref: Option<InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnRef>,
    ...
    pub firehose_arn_selector: Option<InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnSelector>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnRefPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigKinesisFirehoseConfigFirehoseArnSelectorPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisStreamConfig {
    ...
    pub stream_arn_ref: Option<InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnRef>,
    ...
    pub stream_arn_selector: Option<InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnSelector>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnRefPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigKinesisStreamConfigStreamArnSelectorPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigKinesisVideoStreamConfig {
    ...
    pub encryption_config: Option<InstanceStorageConfigForProviderStorageConfigKinesisVideoStreamConfigEncryptionConfig>,
...
pub struct InstanceStorageConfigForProviderStorageConfigS3Config {
    ...
    pub bucket_name_selector: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelector>,
    /// The S3 bucket prefix.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketPrefix")]
    pub bucket_prefix: Option<String>,
    /// The encryption configuration. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfig>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameRefPolicyResolve>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelectorPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigBucketNameSelectorPolicyResolve>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfig {
    ...
    /// Reference to a Key in kms to populate keyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "keyIdRef")]
    pub key_id_ref: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdRef>,
    /// Selector for a Key in kms to populate keyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "keyIdSelector")]
    pub key_id_selector: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelector>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdRefPolicy>,
}
...
pub struct InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigForProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelectorPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfig {
    /// A block that specifies the configuration of the Kinesis Firehose delivery stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseConfig")]
    pub kinesis_firehose_config: Option<InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfig>,
    /// A block that specifies the configuration of the Kinesis data stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisStreamConfig")]
    pub kinesis_stream_config: Option<InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfig>,
    /// A block that specifies the configuration of the Kinesis video stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisVideoStreamConfig")]
    pub kinesis_video_stream_config: Option<InstanceStorageConfigInitProviderStorageConfigKinesisVideoStreamConfig>,
    /// A block that specifies the configuration of S3 Bucket. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3Config")]
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfig {
    ...
    /// Reference to a DeliveryStream in firehose to populate firehoseArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "firehoseArnRef")]
    pub firehose_arn_ref: Option<InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfigFirehoseArnRef>,
    /// Selector for a DeliveryStream in firehose to populate firehoseArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "firehoseArnSelector")]
    pub firehose_arn_selector: Option<InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfigFirehoseArnSelector>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfigFirehoseArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigKinesisFirehoseConfigFirehoseArnRefPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfig {
    ...
    /// Reference to a Stream in kinesis to populate streamArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "streamArnRef")]
    pub stream_arn_ref: Option<InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnRef>,
    /// Selector for a Stream in kinesis to populate streamArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "streamArnSelector")]
    pub stream_arn_selector: Option<InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnSelector>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnRefPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigKinesisStreamConfigStreamArnSelectorPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigKinesisVideoStreamConfig {
    /// The encryption configuration. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<InstanceStorageConfigInitProviderStorageConfigKinesisVideoStreamConfigEncryptionConfig>,
    /// The prefix of the video stream. Minimum length of 1. Maximum length of 128. When read from the state, the value returned is <prefix>-connect-<connect_instance_alias>-contact- since the API appends additional details to the prefix.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prefix: Option<String>,
    /// The number of hours data is retained in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream. Minimum value of 0. Maximum value of 87600. A value of 0, indicates that the stream does not persist data.
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3Config {
    ...
    /// Reference to a Bucket in s3 to populate bucketName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketNameRef")]
    pub bucket_name_ref: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameRef>,
    /// Selector for a Bucket in s3 to populate bucketName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketNameSelector")]
    pub bucket_name_selector: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelector>,
    /// The S3 bucket prefix.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bucketPrefix")]
    pub bucket_prefix: Option<String>,
    /// The encryption configuration. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfig>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameRefPolicyResolve>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelectorPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigBucketNameSelectorPolicyResolve>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfig {
    ...
    /// Reference to a Key in kms to populate keyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "keyIdRef")]
    pub key_id_ref: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdRef>,
    /// Selector for a Key in kms to populate keyId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "keyIdSelector")]
    pub key_id_selector: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelector>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdRefPolicy>,
}
...
pub struct InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<InstanceStorageConfigInitProviderStorageConfigS3ConfigEncryptionConfigKeyIdSelectorPolicy>,
}
...
pub struct InstanceStorageConfigPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<InstanceStorageConfigPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct InstanceStorageConfigStatusAtProviderStorageConfig {
    /// A block that specifies the configuration of the Kinesis Firehose delivery stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseConfig")]
    pub kinesis_firehose_config: Option<InstanceStorageConfigStatusAtProviderStorageConfigKinesisFirehoseConfig>,
    /// A block that specifies the configuration of the Kinesis data stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisStreamConfig")]
    pub kinesis_stream_config: Option<InstanceStorageConfigStatusAtProviderStorageConfigKinesisStreamConfig>,
    /// A block that specifies the configuration of the Kinesis video stream. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisVideoStreamConfig")]
    pub kinesis_video_stream_config: Option<InstanceStorageConfigStatusAtProviderStorageConfigKinesisVideoStreamConfig>,
    /// A block that specifies the configuration of S3 Bucket. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3Config")]
...
pub struct InstanceStorageConfigStatusAtProviderStorageConfigKinesisVideoStreamConfig {
    /// The encryption configuration. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<InstanceStorageConfigStatusAtProviderStorageConfigKinesisVideoStreamConfigEncryptionConfig>,
    /// The prefix of the video stream. Minimum length of 1. Maximum length of 128. When read from the state, the value returned is <prefix>-connect-<connect_instance_alias>-contact- since the API appends additional details to the prefix.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prefix: Option<String>,
    /// The number of hours data is retained in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream. Minimum value of 0. Maximum value of 87600. A value of 0, indicates that the stream does not persist data.
...
pub struct InstanceStorageConfigStatusAtProviderStorageConfigS3Config {
    ...
    /// The encryption configuration. Documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<InstanceStorageConfigStatusAtProviderStorageConfigS3ConfigEncryptionConfig>,
}
