...
#[kube(group = "apigee.gcp.upbound.io", version = "v1beta2", kind = "Environment", plural = "environments")]
...
pub struct EnvironmentForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiProxyType")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forwardProxyUri")]
...
pub struct EnvironmentStatusAtProviderNodeConfig {
    ...
    /// all instances.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "currentAggregateNodeCount")]
