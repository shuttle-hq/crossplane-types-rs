...
#[kube(group = "redshiftserverless.aws.upbound.io", version = "v1beta1", kind = "Workgroup", plural = "workgroups")]
...
pub struct WorkgroupForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "baseCapacity")]
    pub base_capacity: Option<f64>,
    /// An array of parameters to set for more control over a serverless database. See Config Parameter below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configParameter")]
...
pub struct WorkgroupForProviderConfigParameter {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "parameterKey")]
...
pub struct WorkgroupStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workgroupId")]
...
pub struct WorkgroupStatusAtProviderEndpointVpcEndpoint {
    ...
    pub network_interface: Option<Vec<WorkgroupStatusAtProviderEndpointVpcEndpointNetworkInterface>>,
    /// The DNS address of the VPC endpoint.
