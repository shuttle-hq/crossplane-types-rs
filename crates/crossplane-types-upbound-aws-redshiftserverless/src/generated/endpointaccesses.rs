...
#[kube(group = "redshiftserverless.aws.upbound.io", version = "v1beta1", kind = "EndpointAccess", plural = "endpointaccesses")]
...
pub struct EndpointAccessForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workgroupName")]
...
pub struct EndpointAccessInitProvider {
    ...
    /// Selector for a list of SecurityGroup in ec2 to populate vpcSecurityGroupIds.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSecurityGroupIdSelector")]
    pub vpc_security_group_id_selector: Option<EndpointAccessInitProviderVpcSecurityGroupIdSelector>,
    /// An array of security group IDs to associate with the workgroup.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcSecurityGroupIds")]
    pub vpc_security_group_ids: Option<Vec<String>>,
    /// The name of the workgroup.
