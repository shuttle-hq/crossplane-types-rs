...
#[kube(group = "vertexai.gcp.upbound.io", version = "v1beta2", kind = "Dataset", plural = "datasets")]
...
pub struct DatasetForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metadataSchemaUri")]
