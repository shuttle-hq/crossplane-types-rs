...
#[kube(group = "autoscaling.aws.upbound.io", version = "v1beta3", kind = "AutoscalingGroup", plural = "autoscalinggroups")]
...
pub struct AutoscalingGroupForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZoneDistribution")]
    pub availability_zone_distribution: Option<AutoscalingGroupForProviderAvailabilityZoneDistribution>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultCooldown")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultInstanceWarmup")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredCapacityType")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enabledMetrics")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "forceDeleteWarmPool")]
    pub force_delete_warm_pool: Option<bool>,
    /// Time (in seconds) after instance comes into service before checking health.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "healthCheckGracePeriod")]
    pub health_check_grace_period: Option<f64>,
    /// "EC2" or "ELB". Controls how health checking is done.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "healthCheckType")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreFailedScalingActivities")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initialLifecycleHook")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceMaintenancePolicy")]
    pub instance_maintenance_policy: Option<AutoscalingGroupForProviderInstanceMaintenancePolicy>,
    /// If this block is configured, start an
    /// Instance Refresh
    /// when this Auto Scaling Group is updated. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceRefresh")]
    pub instance_refresh: Option<AutoscalingGroupForProviderInstanceRefresh>,
    /// Name of the launch configuration to use.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchConfiguration")]
    pub launch_configuration: Option<String>,
    /// Reference to a LaunchConfiguration in autoscaling to populate launchConfiguration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchConfigurationRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchConfigurationSelector")]
    pub launch_configuration_selector: Option<AutoscalingGroupForProviderLaunchConfigurationSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxInstanceLifetime")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metricsGranularity")]
    pub metrics_granularity: Option<String>,
    /// Updates will not wait on ELB instance number changes.
    /// (See also Waiting for Capacity below.)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "minElbCapacity")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mixedInstancesPolicy")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "protectFromScaleIn")]
    pub protect_from_scale_in: Option<bool>,
    /// Region is the region you'd like your resource to be created in.
    pub region: String,
    /// ARN of the service-linked role that the ASG will use to call other AWS services
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceLinkedRoleArn")]
    pub service_linked_role_arn: Option<String>,
    /// Reference to a Role in iam to populate serviceLinkedRoleArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceLinkedRoleArnRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceLinkedRoleArnSelector")]
    pub service_linked_role_arn_selector: Option<AutoscalingGroupForProviderServiceLinkedRoleArnSelector>,
    /// List of processes to suspend for the Auto Scaling Group. The allowed values are Launch, Terminate, HealthCheck, ReplaceUnhealthy, AZRebalance, AlarmNotification, ScheduledActions, AddToLoadBalancer, InstanceRefresh.
    /// Note that if you suspend either the Launch or Terminate process types, it can prevent your Auto Scaling Group from functioning properly.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "suspendedProcesses")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "terminationPolicies")]
    pub termination_policies: Option<Vec<String>>,
    /// Attaches one or more traffic sources to the specified Auto Scaling group.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trafficSource")]
    pub traffic_source: Option<Vec<AutoscalingGroupForProviderTrafficSource>>,
    /// List of subnet IDs to launch resources in. Subnets automatically determine which availability zones the group will reside. Conflicts with availability_zones.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcZoneIdentifier")]
    pub vpc_zone_identifier: Option<Vec<String>>,
    /// References to Subnet in ec2 to populate vpcZoneIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcZoneIdentifierRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vpcZoneIdentifierSelector")]
    pub vpc_zone_identifier_selector: Option<AutoscalingGroupForProviderVpcZoneIdentifierSelector>,
    /// (See also Waiting
    /// for Capacity below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "waitForCapacityTimeout")]
    pub wait_for_capacity_timeout: Option<String>,
    /// (Takes
    /// precedence over min_elb_capacity behavior.)
    /// (See also Waiting for Capacity below.)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "waitForElbCapacity")]
...
pub struct AutoscalingGroupForProviderAvailabilityZoneDistribution {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "capacityDistributionStrategy")]
...
pub struct AutoscalingGroupForProviderInstanceMaintenancePolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxHealthyPercentage")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "minHealthyPercentage")]
...
pub struct AutoscalingGroupForProviderInstanceRefreshPreferences {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "alarmSpecification")]
    pub alarm_specification: Option<AutoscalingGroupForProviderInstanceRefreshPreferencesAlarmSpecification>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoRollback")]
    pub auto_rollback: Option<bool>,
    /// Number of seconds to wait after a checkpoint. Defaults to 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checkpointDelay")]
    pub checkpoint_delay: Option<String>,
    /// List of percentages for each checkpoint. Values must be unique and in ascending order. To replace all instances, the final number must be 100.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checkpointPercentages")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceWarmup")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleInProtectedInstances")]
    pub scale_in_protected_instances: Option<String>,
    /// Replace instances that already have your desired configuration. Defaults to false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipMatching")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "standbyInstances")]
...
pub struct AutoscalingGroupForProviderMixedInstancesPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instancesDistribution")]
    pub instances_distribution: Option<AutoscalingGroupForProviderMixedInstancesPolicyInstancesDistribution>,
...
pub struct AutoscalingGroupForProviderMixedInstancesPolicyInstancesDistribution {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDemandBaseCapacity")]
    pub on_demand_base_capacity: Option<f64>,
    /// Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: 100.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onDemandPercentageAboveBaseCapacity")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spotAllocationStrategy")]
    pub spot_allocation_strategy: Option<String>,
    /// Number of Spot pools per availability zone to allocate capacity. EC2 Auto Scaling selects the cheapest Spot pools and evenly allocates Spot capacity across the number of Spot pools that you specify. Only available with spot_allocation_strategy set to lowest-price. Otherwise it must be set to 0, if it has been defined before. Default: 2.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spotInstancePools")]
    pub spot_instance_pools: Option<f64>,
    /// Maximum price per unit hour that the user is willing to pay for the Spot instances. Default: an empty string which means the on-demand price.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spotMaxPrice")]
...
pub struct AutoscalingGroupForProviderMixedInstancesPolicyLaunchTemplate {
    ...
    pub launch_template_specification: Option<AutoscalingGroupForProviderMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification>,
    ...
    pub r#override: Option<Vec<AutoscalingGroupForProviderMixedInstancesPolicyLaunchTemplateOverride>>,
}
...
pub struct AutoscalingGroupForProviderWarmPool {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceReusePolicy")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxGroupPreparedCapacity")]
...
pub struct AutoscalingGroupForProviderWarmPoolInstanceReusePolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reuseOnScaleIn")]
...
pub struct AutoscalingGroupInitProvider {
    /// The instance capacity distribution across Availability Zones. See Availability Zone Distribution below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZoneDistribution")]
    pub availability_zone_distribution: Option<AutoscalingGroupInitProviderAvailabilityZoneDistribution>,
    /// A list of Availability Zones where instances in the Auto Scaling group can be created. Used for launching into the default VPC subnet in each Availability Zone when not using the vpc_zone_identifier attribute, or for attaching a network interface when an existing network interface ID is specified in a launch template. Conflicts with vpc_zone_identifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZones")]
    pub availability_zones: Option<Vec<String>>,
    /// Whether capacity rebalance is enabled. Otherwise, capacity rebalance is disabled.
    ...
    /// Selector for a LaunchConfiguration in autoscaling to populate launchConfiguration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchConfigurationSelector")]
    pub launch_configuration_selector: Option<AutoscalingGroupInitProviderLaunchConfigurationSelector>,
    /// Nested argument with Launch template specification to use to launch instances. See Launch Template below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplate")]
    ...
    /// Selector for a Role in iam to populate serviceLinkedRoleArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceLinkedRoleArnSelector")]
    pub service_linked_role_arn_selector: Option<AutoscalingGroupInitProviderServiceLinkedRoleArnSelector>,
    /// List of processes to suspend for the Auto Scaling Group. The allowed values are Launch, Terminate, HealthCheck, ReplaceUnhealthy, AZRebalance, AlarmNotification, ScheduledActions, AddToLoadBalancer, InstanceRefresh.
    /// Note that if you suspend either the Launch or Terminate process types, it can prevent your Auto Scaling Group from functioning properly.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "suspendedProcesses")]
    pub suspended_processes: Option<Vec<String>>,
...
pub struct AutoscalingGroupInitProviderInstanceRefreshPreferences {
    /// Alarm Specification for Instance Refresh.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "alarmSpecification")]
    pub alarm_specification: Option<AutoscalingGroupInitProviderInstanceRefreshPreferencesAlarmSpecification>,
    /// Automatically rollback if instance refresh fails. Defaults to false. This option may only be set to true when specifying a launch_template or mixed_instances_policy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoRollback")]
    pub auto_rollback: Option<bool>,
    /// Number of seconds to wait after a checkpoint. Defaults to 3600.
...
pub struct AutoscalingGroupInitProviderMixedInstancesPolicy {
    /// Nested argument containing settings on how to mix on-demand and Spot instances in the Auto Scaling group. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instancesDistribution")]
    pub instances_distribution: Option<AutoscalingGroupInitProviderMixedInstancesPolicyInstancesDistribution>,
    /// Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplate")]
...
pub struct AutoscalingGroupInitProviderMixedInstancesPolicyLaunchTemplate {
    /// Nested argument defines the Launch Template. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplateSpecification")]
    pub launch_template_specification: Option<AutoscalingGroupInitProviderMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification>,
    /// List of nested arguments provides the ability to specify multiple instance types. This will override the same parameter in the launch template. For on-demand instances, Auto Scaling considers the order of preference of instance types to launch based on the order specified in the overrides list. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "override")]
    pub r#override: Option<Vec<AutoscalingGroupInitProviderMixedInstancesPolicyLaunchTemplateOverride>>,
}
...
pub struct AutoscalingGroupInitProviderServiceLinkedRoleArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<AutoscalingGroupInitProviderServiceLinkedRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct AutoscalingGroupStatusAtProvider {
    ...
    /// The instance capacity distribution across Availability Zones. See Availability Zone Distribution below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZoneDistribution")]
    pub availability_zone_distribution: Option<AutoscalingGroupStatusAtProviderAvailabilityZoneDistribution>,
    /// A list of Availability Zones where instances in the Auto Scaling group can be created. Used for launching into the default VPC subnet in each Availability Zone when not using the vpc_zone_identifier attribute, or for attaching a network interface when an existing network interface ID is specified in a launch template. Conflicts with vpc_zone_identifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availabilityZones")]
    pub availability_zones: Option<Vec<String>>,
    /// Whether capacity rebalance is enabled. Otherwise, capacity rebalance is disabled.
    ...
    /// If this block is configured, add a instance maintenance policy to the specified Auto Scaling group. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceMaintenancePolicy")]
    pub instance_maintenance_policy: Option<AutoscalingGroupStatusAtProviderInstanceMaintenancePolicy>,
    /// If this block is configured, start an
    /// Instance Refresh
    /// when this Auto Scaling Group is updated. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceRefresh")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "predictedCapacity")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "warmPoolSize")]
...
pub struct AutoscalingGroupStatusAtProviderInstanceRefreshPreferences {
    /// Alarm Specification for Instance Refresh.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "alarmSpecification")]
    pub alarm_specification: Option<AutoscalingGroupStatusAtProviderInstanceRefreshPreferencesAlarmSpecification>,
    /// Automatically rollback if instance refresh fails. Defaults to false. This option may only be set to true when specifying a launch_template or mixed_instances_policy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoRollback")]
    pub auto_rollback: Option<bool>,
    /// Number of seconds to wait after a checkpoint. Defaults to 3600.
...
pub struct AutoscalingGroupStatusAtProviderMixedInstancesPolicy {
    /// Nested argument containing settings on how to mix on-demand and Spot instances in the Auto Scaling group. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instancesDistribution")]
    pub instances_distribution: Option<AutoscalingGroupStatusAtProviderMixedInstancesPolicyInstancesDistribution>,
    /// Nested argument containing launch template settings along with the overrides to specify multiple instance types and weights. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplate")]
