...
#[kube(group = "neptune.aws.upbound.io", version = "v1beta2", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneClusterParameterGroupName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneClusterParameterGroupNameRef")]
    pub neptune_cluster_parameter_group_name_ref: Option<ClusterForProviderNeptuneClusterParameterGroupNameRef>,
    /// Selector for a ClusterParameterGroup in neptune to populate neptuneClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneClusterParameterGroupNameSelector")]
    pub neptune_cluster_parameter_group_name_selector: Option<ClusterForProviderNeptuneClusterParameterGroupNameSelector>,
    /// The name of the DB parameter group to apply to all instances of the DB cluster.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneInstanceParameterGroupName")]
    ...
    pub neptune_subnet_group_name_selector: Option<ClusterForProviderNeptuneSubnetGroupNameSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationSourceIdentifierRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationSourceIdentifierSelector")]
    pub replication_source_identifier_selector: Option<ClusterForProviderReplicationSourceIdentifierSelector>,
    /// If set, create the Neptune cluster as a serverless one. See Serverless for example block attributes.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessV2ScalingConfiguration")]
    pub serverless_v2_scaling_configuration: Option<ClusterForProviderServerlessV2ScalingConfiguration>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snapshotIdentifierRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snapshotIdentifierSelector")]
...
pub struct ClusterForProviderNeptuneClusterParameterGroupNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterForProviderNeptuneClusterParameterGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterInitProvider {
    ...
    /// Reference to a ClusterParameterGroup in neptune to populate neptuneClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneClusterParameterGroupNameRef")]
    pub neptune_cluster_parameter_group_name_ref: Option<ClusterInitProviderNeptuneClusterParameterGroupNameRef>,
    /// Selector for a ClusterParameterGroup in neptune to populate neptuneClusterParameterGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneClusterParameterGroupNameSelector")]
    pub neptune_cluster_parameter_group_name_selector: Option<ClusterInitProviderNeptuneClusterParameterGroupNameSelector>,
    /// The name of the DB parameter group to apply to all instances of the DB cluster.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneInstanceParameterGroupName")]
    pub neptune_instance_parameter_group_name: Option<String>,
    /// A Neptune subnet group to associate with this Neptune instance.
    ...
    /// Selector for a SubnetGroup in neptune to populate neptuneSubnetGroupName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "neptuneSubnetGroupNameSelector")]
    pub neptune_subnet_group_name_selector: Option<ClusterInitProviderNeptuneSubnetGroupNameSelector>,
    /// The port on which the Neptune accepts connections. Default is 8182.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub port: Option<f64>,
    /// The daily time range during which automated backups are created if automated backups are enabled using the BackupRetentionPeriod parameter. Time in UTC. Default: A 30-minute window selected at random from an 8-hour block of time per regionE.g., 04:00-09:00
    ...
    /// Reference to a Cluster in neptune to populate replicationSourceIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationSourceIdentifierRef")]
    pub replication_source_identifier_ref: Option<ClusterInitProviderReplicationSourceIdentifierRef>,
    /// Selector for a Cluster in neptune to populate replicationSourceIdentifier.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "replicationSourceIdentifierSelector")]
    pub replication_source_identifier_selector: Option<ClusterInitProviderReplicationSourceIdentifierSelector>,
    /// If set, create the Neptune cluster as a serverless one. See Serverless for example block attributes.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessV2ScalingConfiguration")]
    pub serverless_v2_scaling_configuration: Option<ClusterInitProviderServerlessV2ScalingConfiguration>,
    /// Determines whether a final Neptune snapshot is created before the Neptune cluster is deleted. If true is specified, no Neptune snapshot is created. If false is specified, a Neptune snapshot is created before the Neptune cluster is deleted, using the value from final_snapshot_identifier. Default is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipFinalSnapshot")]
    pub skip_final_snapshot: Option<bool>,
    /// Specifies whether or not to create this cluster from a snapshot. You can use either the name or ARN when specifying a Neptune cluster snapshot, or the ARN when specifying a Neptune snapshot. Automated snapshots should not be used for this attribute, unless from a different cluster. Automated snapshots are deleted as part of cluster destruction when the resource is replaced.
...
pub struct ClusterInitProviderNeptuneClusterParameterGroupNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ClusterInitProviderNeptuneClusterParameterGroupNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ClusterStatusAtProvider {
    ...
    /// If set, create the Neptune cluster as a serverless one. See Serverless for example block attributes.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessV2ScalingConfiguration")]
    pub serverless_v2_scaling_configuration: Option<ClusterStatusAtProviderServerlessV2ScalingConfiguration>,
    /// Determines whether a final Neptune snapshot is created before the Neptune cluster is deleted. If true is specified, no Neptune snapshot is created. If false is specified, a Neptune snapshot is created before the Neptune cluster is deleted, using the value from final_snapshot_identifier. Default is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "skipFinalSnapshot")]
    pub skip_final_snapshot: Option<bool>,
    /// Specifies whether or not to create this cluster from a snapshot. You can use either the name or ARN when specifying a Neptune cluster snapshot, or the ARN when specifying a Neptune snapshot. Automated snapshots should not be used for this attribute, unless from a different cluster. Automated snapshots are deleted as part of cluster destruction when the resource is replaced.
