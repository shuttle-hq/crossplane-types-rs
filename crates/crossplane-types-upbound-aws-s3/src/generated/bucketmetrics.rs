...
#[kube(group = "s3.aws.upbound.io", version = "v1beta2", kind = "BucketMetric", plural = "bucketmetrics")]
...
pub struct BucketMetricForProviderFilter {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessPoint")]
    pub access_point: Option<String>,
    /// Reference to a AccessPoint in s3control to populate accessPoint.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessPointRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessPointSelector")]
