...
#[kube(group = "s3.aws.upbound.io", version = "v1beta2", kind = "BucketWebsiteConfiguration", plural = "bucketwebsiteconfigurations")]
...
pub struct BucketWebsiteConfigurationSpec {
    ...
    pub write_connection_secret_to_ref: Option<BucketWebsiteConfigurationWriteConnectionSecretToRef>,
}
...
pub struct BucketWebsiteConfigurationForProvider {
    ...
    pub redirect_all_requests_to: Option<BucketWebsiteConfigurationForProviderRedirectAllRequestsTo>,
...
pub struct BucketWebsiteConfigurationInitProvider {
    ...
    /// Redirect behavior for every request to this bucket's website endpoint. See below. Conflicts with error_document, index_document, and routing_rule.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "redirectAllRequestsTo")]
    pub redirect_all_requests_to: Option<BucketWebsiteConfigurationInitProviderRedirectAllRequestsTo>,
    /// List of rules that define when a redirect is applied and the redirect behavior. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingRule")]
...
pub struct BucketWebsiteConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<BucketWebsiteConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct BucketWebsiteConfigurationStatusAtProvider {
    ...
    /// Redirect behavior for every request to this bucket's website endpoint. See below. Conflicts with error_document, index_document, and routing_rule.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "redirectAllRequestsTo")]
    pub redirect_all_requests_to: Option<BucketWebsiteConfigurationStatusAtProviderRedirectAllRequestsTo>,
    /// List of rules that define when a redirect is applied and the redirect behavior. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingRule")]
