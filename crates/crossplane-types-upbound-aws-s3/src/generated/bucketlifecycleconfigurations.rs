...
#[kube(group = "s3.aws.upbound.io", version = "v1beta2", kind = "BucketLifecycleConfiguration", plural = "bucketlifecycleconfigurations")]
...
pub struct BucketLifecycleConfigurationSpec {
    ...
    pub publish_connection_details_to: Option<BucketLifecycleConfigurationPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref: Option<BucketLifecycleConfigurationWriteConnectionSecretToRef>,
}
...
pub struct BucketLifecycleConfigurationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitionDefaultMinimumObjectSize")]
...
pub struct BucketLifecycleConfigurationForProviderRule {
    ...
    pub abort_incomplete_multipart_upload: Option<BucketLifecycleConfigurationForProviderRuleAbortIncompleteMultipartUpload>,
    ...
    pub noncurrent_version_expiration: Option<BucketLifecycleConfigurationForProviderRuleNoncurrentVersionExpiration>,
    /// Set of configuration blocks that specify the transition rule for the lifecycle rule that describes when noncurrent objects transition to a specific storage class. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noncurrentVersionTransition")]
    pub noncurrent_version_transition: Option<Vec<BucketLifecycleConfigurationForProviderRuleNoncurrentVersionTransition>>,
...
pub struct BucketLifecycleConfigurationInitProviderRule {
    /// Configuration block that specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "abortIncompleteMultipartUpload")]
    pub abort_incomplete_multipart_upload: Option<BucketLifecycleConfigurationInitProviderRuleAbortIncompleteMultipartUpload>,
    /// Configuration block that specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Configuration block that specifies when noncurrent object versions expire. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noncurrentVersionExpiration")]
    pub noncurrent_version_expiration: Option<BucketLifecycleConfigurationInitProviderRuleNoncurrentVersionExpiration>,
    /// Set of configuration blocks that specify the transition rule for the lifecycle rule that describes when noncurrent objects transition to a specific storage class. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noncurrentVersionTransition")]
    pub noncurrent_version_transition: Option<Vec<BucketLifecycleConfigurationInitProviderRuleNoncurrentVersionTransition>>,
    /// DEPRECATED Use filter instead. This has been deprecated by Amazon S3. Prefix identifying one or more objects to which the rule applies. Defaults to an empty string ("") if filter is not specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prefix: Option<String>,
    /// Whether the rule is currently being applied. Valid values: Enabled or Disabled.
...
pub struct BucketLifecycleConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<BucketLifecycleConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<BucketLifecycleConfigurationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct BucketLifecycleConfigurationStatusAtProviderRule {
    /// Configuration block that specifies the days since the initiation of an incomplete multipart upload that Amazon S3 will wait before permanently removing all parts of the upload. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "abortIncompleteMultipartUpload")]
    pub abort_incomplete_multipart_upload: Option<BucketLifecycleConfigurationStatusAtProviderRuleAbortIncompleteMultipartUpload>,
    /// Configuration block that specifies the expiration for the lifecycle of the object in the form of date, days and, whether the object has a delete marker. See below.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Configuration block that specifies when noncurrent object versions expire. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noncurrentVersionExpiration")]
    pub noncurrent_version_expiration: Option<BucketLifecycleConfigurationStatusAtProviderRuleNoncurrentVersionExpiration>,
    /// Set of configuration blocks that specify the transition rule for the lifecycle rule that describes when noncurrent objects transition to a specific storage class. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noncurrentVersionTransition")]
    pub noncurrent_version_transition: Option<Vec<BucketLifecycleConfigurationStatusAtProviderRuleNoncurrentVersionTransition>>,
    /// DEPRECATED Use filter instead. This has been deprecated by Amazon S3. Prefix identifying one or more objects to which the rule applies. Defaults to an empty string ("") if filter is not specified.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prefix: Option<String>,
    /// Whether the rule is currently being applied. Valid values: Enabled or Disabled.
