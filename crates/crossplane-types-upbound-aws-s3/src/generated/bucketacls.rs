...
#[kube(group = "s3.aws.upbound.io", version = "v1beta2", kind = "BucketACL", plural = "bucketacls")]
...
pub struct BucketACLForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessControlPolicy")]
