...
#[kube(group = "glacier.aws.upbound.io", version = "v1beta1", kind = "VaultLock", plural = "vaultlocks")]
...
pub struct VaultLockForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "completeLock")]
    pub complete_lock: Option<bool>,
    /// This should only be used in conjunction with complete_lock being set to true.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignoreDeletionError")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vaultNameRef")]
    pub vault_name_ref: Option<VaultLockForProviderVaultNameRef>,
    /// Selector for a Vault in glacier to populate vaultName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vaultNameSelector")]
