...
#[kube(group = "route53recoverycontrolconfig.aws.upbound.io", version = "v1beta1", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clusterEndpoints")]
    pub cluster_endpoints: Option<Vec<ClusterStatusAtProviderClusterEndpoints>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct ClusterStatusAtProviderClusterEndpoints {
    /// Cluster endpoint.
    #[serde(default, skip_serializing_if = "Option::is_none")]
