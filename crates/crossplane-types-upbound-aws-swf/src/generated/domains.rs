...
#[kube(group = "swf.aws.upbound.io", version = "v1beta1", kind = "Domain", plural = "domains")]
...
pub struct DomainForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workflowExecutionRetentionPeriodInDays")]
