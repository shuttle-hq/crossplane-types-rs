...
#[kube(group = "ec2.aws.upbound.io", version = "v1beta2", kind = "FlowLog", plural = "flowlogs")]
...
pub struct FlowLogForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliverCrossAccountRole")]
    pub deliver_cross_account_role: Option<String>,
    /// Describes the destination options for a flow log. More details below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationOptions")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxAggregationInterval")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trafficType")]
...
pub struct FlowLogForProviderDestinationOptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileFormat")]
    pub file_format: Option<String>,
    /// Indicates whether to use Hive-compatible prefixes for flow logs stored in Amazon S3. Default value: false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hiveCompatiblePartitions")]
    pub hive_compatible_partitions: Option<bool>,
    /// Indicates whether to partition the flow log per hour. This reduces the cost and response time for queries. Default value: false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "perHourPartition")]
