...
#[kube(group = "servicenetworking.gcp.upbound.io", version = "v1beta1", kind = "Connection", plural = "connections")]
...
pub struct ConnectionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedPeeringRanges")]
    pub reserved_peering_ranges: Option<Vec<String>>,
    /// References to GlobalAddress in compute to populate reservedPeeringRanges.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedPeeringRangesRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedPeeringRangesSelector")]
    pub reserved_peering_ranges_selector: Option<ConnectionForProviderReservedPeeringRangesSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "updateOnCreationFail")]
...
pub struct ConnectionInitProvider {
    ...
    /// Selector for a list of GlobalAddress in compute to populate reservedPeeringRanges.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "reservedPeeringRangesSelector")]
    pub reserved_peering_ranges_selector: Option<ConnectionInitProviderReservedPeeringRangesSelector>,
    /// Provider peering service that is managing peering connectivity for a
    /// service provider organization. For Google services that support this functionality it is
    /// 'servicenetworking.googleapis.com'.
    #[serde(default, skip_serializing_if = "Option::is_none")]
