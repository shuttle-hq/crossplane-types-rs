...
#[kube(group = "ssoadmin.aws.upbound.io", version = "v1beta2", kind = "CustomerManagedPolicyAttachment", plural = "customermanagedpolicyattachments")]
...
pub struct CustomerManagedPolicyAttachmentSpec {
    ...
    pub publish_connection_details_to: Option<CustomerManagedPolicyAttachmentPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref: Option<CustomerManagedPolicyAttachmentWriteConnectionSecretToRef>,
}
...
pub struct CustomerManagedPolicyAttachmentForProvider {
    ...
    pub customer_managed_policy_reference: Option<CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReference>,
    ...
    pub permission_set_arn_ref: Option<CustomerManagedPolicyAttachmentForProviderPermissionSetArnRef>,
    ...
    pub permission_set_arn_selector: Option<CustomerManagedPolicyAttachmentForProviderPermissionSetArnSelector>,
...
pub struct CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReference {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "policyNameRef")]
    pub policy_name_ref: Option<CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReferencePolicyNameRef>,
    /// Selector for a Policy in iam to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "policyNameSelector")]
    pub policy_name_selector: Option<CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReferencePolicyNameSelector>,
}
...
pub struct CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReferencePolicyNameRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<CustomerManagedPolicyAttachmentForProviderCustomerManagedPolicyReferencePolicyNameRefPolicy>,
}
...
pub struct CustomerManagedPolicyAttachmentForProviderPermissionSetArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<CustomerManagedPolicyAttachmentForProviderPermissionSetArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct CustomerManagedPolicyAttachmentForProviderPermissionSetArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<CustomerManagedPolicyAttachmentForProviderPermissionSetArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<CustomerManagedPolicyAttachmentForProviderPermissionSetArnSelectorPolicyResolve>,
}
...
pub struct CustomerManagedPolicyAttachmentInitProvider {
    /// Specifies the name and path of a customer managed policy. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customerManagedPolicyReference")]
    pub customer_managed_policy_reference: Option<CustomerManagedPolicyAttachmentInitProviderCustomerManagedPolicyReference>,
}
...
pub struct CustomerManagedPolicyAttachmentInitProviderCustomerManagedPolicyReference {
    ...
    /// Reference to a Policy in iam to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "policyNameRef")]
    pub policy_name_ref: Option<CustomerManagedPolicyAttachmentInitProviderCustomerManagedPolicyReferencePolicyNameRef>,
    /// Selector for a Policy in iam to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "policyNameSelector")]
    pub policy_name_selector: Option<CustomerManagedPolicyAttachmentInitProviderCustomerManagedPolicyReferencePolicyNameSelector>,
}
...
pub struct CustomerManagedPolicyAttachmentPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<CustomerManagedPolicyAttachmentPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<CustomerManagedPolicyAttachmentPublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct CustomerManagedPolicyAttachmentStatusAtProvider {
    /// Specifies the name and path of a customer managed policy. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customerManagedPolicyReference")]
    pub customer_managed_policy_reference: Option<CustomerManagedPolicyAttachmentStatusAtProviderCustomerManagedPolicyReference>,
