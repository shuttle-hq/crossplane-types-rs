...
#[kube(group = "imagebuilder.aws.upbound.io", version = "v1beta2", kind = "DistributionConfiguration", plural = "distributionconfigurations")]
...
pub struct DistributionConfigurationForProviderDistribution {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "amiDistributionConfiguration")]
    pub ami_distribution_configuration: Option<DistributionConfigurationForProviderDistributionAmiDistributionConfiguration>,
    /// Configuration block with container distribution settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerDistributionConfiguration")]
    pub container_distribution_configuration: Option<DistributionConfigurationForProviderDistributionContainerDistributionConfiguration>,
    /// Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fastLaunchConfiguration")]
    pub fast_launch_configuration: Option<Vec<DistributionConfigurationForProviderDistributionFastLaunchConfiguration>>,
    /// Set of launch template configuration settings that apply to image distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplateConfiguration")]
    pub launch_template_configuration: Option<Vec<DistributionConfigurationForProviderDistributionLaunchTemplateConfiguration>>,
    /// Set of Amazon Resource Names (ARNs) of License Manager License Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "licenseConfigurationArns")]
    pub license_configuration_arns: Option<Vec<String>>,
    /// AWS Region for the distribution.
    pub region: String,
    /// Configuration block with S3 export settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3ExportConfiguration")]
    pub s3_export_configuration: Option<DistributionConfigurationForProviderDistributionS3ExportConfiguration>,
}
...
pub struct DistributionConfigurationForProviderDistributionAmiDistributionConfigurationLaunchPermission {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "organizationArns")]
    pub organization_arns: Option<Vec<String>>,
    /// Set of AWS Organizational Unit ARNs to assign.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "organizationalUnitArns")]
...
pub struct DistributionConfigurationForProviderDistributionFastLaunchConfigurationLaunchTemplate {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplateVersion")]
...
pub struct DistributionConfigurationForProviderDistributionFastLaunchConfigurationSnapshotConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetResourceCount")]
...
pub struct DistributionConfigurationForProviderDistributionS3ExportConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "diskImageFormat")]
...
pub struct DistributionConfigurationInitProviderDistribution {
    /// Configuration block with Amazon Machine Image (AMI) distribution settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "amiDistributionConfiguration")]
    pub ami_distribution_configuration: Option<DistributionConfigurationInitProviderDistributionAmiDistributionConfiguration>,
    /// Configuration block with container distribution settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerDistributionConfiguration")]
    pub container_distribution_configuration: Option<DistributionConfigurationInitProviderDistributionContainerDistributionConfiguration>,
    /// Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fastLaunchConfiguration")]
    pub fast_launch_configuration: Option<Vec<DistributionConfigurationInitProviderDistributionFastLaunchConfiguration>>,
    /// Set of launch template configuration settings that apply to image distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplateConfiguration")]
    pub launch_template_configuration: Option<Vec<DistributionConfigurationInitProviderDistributionLaunchTemplateConfiguration>>,
    /// Set of Amazon Resource Names (ARNs) of License Manager License Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "licenseConfigurationArns")]
    pub license_configuration_arns: Option<Vec<String>>,
    /// Configuration block with S3 export settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3ExportConfiguration")]
    pub s3_export_configuration: Option<DistributionConfigurationInitProviderDistributionS3ExportConfiguration>,
}
...
pub struct DistributionConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DistributionConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DistributionConfigurationStatusAtProviderDistribution {
    /// Configuration block with Amazon Machine Image (AMI) distribution settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "amiDistributionConfiguration")]
    pub ami_distribution_configuration: Option<DistributionConfigurationStatusAtProviderDistributionAmiDistributionConfiguration>,
    /// Configuration block with container distribution settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerDistributionConfiguration")]
    pub container_distribution_configuration: Option<DistributionConfigurationStatusAtProviderDistributionContainerDistributionConfiguration>,
    /// Set of Windows faster-launching configurations to use for AMI distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fastLaunchConfiguration")]
    pub fast_launch_configuration: Option<Vec<DistributionConfigurationStatusAtProviderDistributionFastLaunchConfiguration>>,
    /// Set of launch template configuration settings that apply to image distribution. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchTemplateConfiguration")]
    pub launch_template_configuration: Option<Vec<DistributionConfigurationStatusAtProviderDistributionLaunchTemplateConfiguration>>,
    /// Set of Amazon Resource Names (ARNs) of License Manager License Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "licenseConfigurationArns")]
    pub license_configuration_arns: Option<Vec<String>>,
    /// AWS Region for the distribution.
    ...
    /// Configuration block with S3 export settings. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3ExportConfiguration")]
    pub s3_export_configuration: Option<DistributionConfigurationStatusAtProviderDistributionS3ExportConfiguration>,
}
