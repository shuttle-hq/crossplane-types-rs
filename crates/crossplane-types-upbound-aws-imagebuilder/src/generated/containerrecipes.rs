...
#[kube(group = "imagebuilder.aws.upbound.io", version = "v1beta2", kind = "ContainerRecipe", plural = "containerrecipes")]
...
pub struct ContainerRecipeForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dockerfileTemplateData")]
    pub dockerfile_template_data: Option<String>,
    /// The Amazon S3 URI for the Dockerfile that will be used to build the container image.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dockerfileTemplateUri")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "parentImage")]
    pub parent_image: Option<String>,
    /// Specifies the operating system platform when you use a custom base image.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "platformOverride")]
...
pub struct ContainerRecipeForProviderComponent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "componentArnRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "componentArnSelector")]
...
pub struct ContainerRecipeForProviderInstanceConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blockDeviceMapping")]
    pub block_device_mapping: Option<Vec<ContainerRecipeForProviderInstanceConfigurationBlockDeviceMapping>>,
...
pub struct ContainerRecipeForProviderTargetRepository {
    ...
    pub repository_name_selector: Option<ContainerRecipeForProviderTargetRepositoryRepositoryNameSelector>,
...
pub struct ContainerRecipeForProviderTargetRepositoryRepositoryNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ContainerRecipeForProviderTargetRepositoryRepositoryNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ContainerRecipeForProviderTargetRepositoryRepositoryNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ContainerRecipeForProviderTargetRepositoryRepositoryNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ContainerRecipeForProviderTargetRepositoryRepositoryNameSelectorPolicyResolve>,
}
...
pub struct ContainerRecipeInitProviderComponentComponentArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ContainerRecipeInitProviderComponentComponentArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ContainerRecipeInitProviderInstanceConfiguration {
    /// Configuration block(s) with block device mappings for the container recipe. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blockDeviceMapping")]
    pub block_device_mapping: Option<Vec<ContainerRecipeInitProviderInstanceConfigurationBlockDeviceMapping>>,
    /// The AMI ID to use as the base image for a container build and test instance. If not specified, Image Builder will use the appropriate ECS-optimized AMI as a base image.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<String>,
}
...
pub struct ContainerRecipeInitProviderTargetRepository {
    ...
    /// Selector for a Repository in ecr to populate repositoryName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "repositoryNameSelector")]
    pub repository_name_selector: Option<ContainerRecipeInitProviderTargetRepositoryRepositoryNameSelector>,
    /// The service in which this image is registered. Valid values: ECR.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub service: Option<String>,
}
...
pub struct ContainerRecipeInitProviderTargetRepositoryRepositoryNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ContainerRecipeInitProviderTargetRepositoryRepositoryNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ContainerRecipeInitProviderTargetRepositoryRepositoryNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ContainerRecipeInitProviderTargetRepositoryRepositoryNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ContainerRecipeInitProviderTargetRepositoryRepositoryNameSelectorPolicyResolve>,
}
...
pub struct ContainerRecipeStatusAtProviderInstanceConfiguration {
    /// Configuration block(s) with block device mappings for the container recipe. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blockDeviceMapping")]
    pub block_device_mapping: Option<Vec<ContainerRecipeStatusAtProviderInstanceConfigurationBlockDeviceMapping>>,
    /// The AMI ID to use as the base image for a container build and test instance. If not specified, Image Builder will use the appropriate ECS-optimized AMI as a base image.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub image: Option<String>,
}
