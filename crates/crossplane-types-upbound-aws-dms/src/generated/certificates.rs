...
#[kube(group = "dms.aws.upbound.io", version = "v1beta1", kind = "Certificate", plural = "certificates")]
...
pub struct CertificateForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateWalletSecretRef")]
    pub certificate_wallet_secret_ref: Option<CertificateForProviderCertificateWalletSecretRef>,
...
/// The contents of the Oracle Wallet certificate for use with SSL, provided as a base64-encoded String. Either certificate_pem or certificate_wallet must be set.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct CertificateForProviderCertificateWalletSecretRef {
    /// The key to select.
    pub key: String,
    /// Name of the secret.
    pub name: String,
...
pub struct CertificateInitProvider {
    ...
    /// The contents of the Oracle Wallet certificate for use with SSL, provided as a base64-encoded String. Either certificate_pem or certificate_wallet must be set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateWalletSecretRef")]
    pub certificate_wallet_secret_ref: Option<CertificateInitProviderCertificateWalletSecretRef>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
}
...
/// The contents of the Oracle Wallet certificate for use with SSL, provided as a base64-encoded String. Either certificate_pem or certificate_wallet must be set.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct CertificateInitProviderCertificateWalletSecretRef {
    /// The key to select.
    pub key: String,
    /// Name of the secret.
    pub name: String,
