...
#[kube(group = "apigatewayv2.aws.upbound.io", version = "v1beta2", kind = "DomainName", plural = "domainnames")]
...
pub struct DomainNameForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainNameConfiguration")]
    pub domain_name_configuration: Option<DomainNameForProviderDomainNameConfiguration>,
...
/// Domain name configuration. See below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameForProviderDomainNameConfiguration {
    ...
    pub certificate_arn_ref: Option<DomainNameForProviderDomainNameConfigurationCertificateArnRef>,
    ...
    pub certificate_arn_selector: Option<DomainNameForProviderDomainNameConfigurationCertificateArnSelector>,
...
/// Reference to a Certificate in acm to populate certificateArn.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameForProviderDomainNameConfigurationCertificateArnRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameForProviderDomainNameConfigurationCertificateArnRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
/// Selector for a Certificate in acm to populate certificateArn.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameForProviderDomainNameConfigurationCertificateArnSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameForProviderDomainNameConfigurationCertificateArnSelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct DomainNameInitProvider {
    /// Domain name configuration. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainNameConfiguration")]
    pub domain_name_configuration: Option<DomainNameInitProviderDomainNameConfiguration>,
    /// Mutual TLS authentication configuration for the domain name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mutualTlsAuthentication")]
...
/// Domain name configuration. See below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameInitProviderDomainNameConfiguration {
    /// ARN of an AWS-managed certificate that will be used by the endpoint for the domain name. AWS Certificate Manager is the only supported source. Use the aws_acm_certificate resource to configure an ACM certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateArn")]
    pub certificate_arn: Option<String>,
    /// Reference to a Certificate in acm to populate certificateArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateArnRef")]
    pub certificate_arn_ref: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnRef>,
    /// Selector for a Certificate in acm to populate certificateArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateArnSelector")]
    pub certificate_arn_selector: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnSelector>,
    /// Endpoint type. Valid values: REGIONAL.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "endpointType")]
    pub endpoint_type: Option<String>,
    /// ARN of the AWS-issued certificate used to validate custom domain ownership (when certificate_arn is issued via an ACM Private CA or mutual_tls_authentication is configured with an ACM-imported certificate.)
...
/// Reference to a Certificate in acm to populate certificateArn.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameInitProviderDomainNameConfigurationCertificateArnRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameInitProviderDomainNameConfigurationCertificateArnRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
/// Selector for a Certificate in acm to populate certificateArn.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameInitProviderDomainNameConfigurationCertificateArnSelector {
    /// MatchControllerRef ensures an object with the same controller reference
    /// as the selecting object is selected.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchControllerRef")]
    pub match_controller_ref: Option<bool>,
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DomainNameInitProviderDomainNameConfigurationCertificateArnSelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct DomainNameStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apiMappingSelectionExpression")]
    ...
    /// Domain name configuration. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainNameConfiguration")]
    pub domain_name_configuration: Option<DomainNameStatusAtProviderDomainNameConfiguration>,
...
/// Domain name configuration. See below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DomainNameStatusAtProviderDomainNameConfiguration {
    /// ARN of an AWS-managed certificate that will be used by the endpoint for the domain name. AWS Certificate Manager is the only supported source. Use the aws_acm_certificate resource to configure an ACM certificate.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateArn")]
    pub certificate_arn: Option<String>,
    /// Endpoint type. Valid values: REGIONAL.
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetDomainName")]
