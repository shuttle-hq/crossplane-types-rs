...
#[kube(group = "guardduty.aws.upbound.io", version = "v1beta2", kind = "Detector", plural = "detectors")]
...
pub struct DetectorForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "findingPublishingFrequency")]
...
pub struct DetectorForProviderDatasources {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "malwareProtection")]
...
pub struct DetectorForProviderDatasourcesMalwareProtection {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scanEc2InstanceWithFindings")]
    pub scan_ec2_instance_with_findings: Option<DetectorForProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings>,
}
...
pub struct DetectorForProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ebsVolumes")]
    pub ebs_volumes: Option<DetectorForProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes>,
}
...
pub struct DetectorInitProviderDatasourcesMalwareProtection {
    ...
    /// See Scan EC2 instance with findings below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scanEc2InstanceWithFindings")]
    pub scan_ec2_instance_with_findings: Option<DetectorInitProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings>,
}
...
pub struct DetectorInitProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings {
    ...
    /// See EBS volumes below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ebsVolumes")]
    pub ebs_volumes: Option<DetectorInitProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes>,
}
...
pub struct DetectorStatusAtProviderDatasourcesMalwareProtection {
    ...
    /// See Scan EC2 instance with findings below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scanEc2InstanceWithFindings")]
    pub scan_ec2_instance_with_findings: Option<DetectorStatusAtProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings>,
}
...
pub struct DetectorStatusAtProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindings {
    ...
    /// See EBS volumes below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ebsVolumes")]
    pub ebs_volumes: Option<DetectorStatusAtProviderDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes>,
}
