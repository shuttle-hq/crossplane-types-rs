...
#[kube(group = "networkmanager.aws.upbound.io", version = "v1beta2", kind = "Device", plural = "devices")]
...
pub struct DeviceForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "awsLocation")]
