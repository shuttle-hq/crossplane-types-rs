...
#[kube(group = "networkmanager.aws.upbound.io", version = "v1beta1", kind = "Connection", plural = "connections")]
...
pub struct ConnectionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectedDeviceId")]
    pub connected_device_id: Option<String>,
    /// Reference to a Device in networkmanager to populate connectedDeviceId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectedDeviceIdRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectedDeviceIdSelector")]
    pub connected_device_id_selector: Option<ConnectionForProviderConnectedDeviceIdSelector>,
    /// The ID of the link for the second device.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectedLinkId")]
