...
#[kube(group = "transfer.aws.upbound.io", version = "v1beta2", kind = "Connector", plural = "connectors")]
...
pub struct ConnectorForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessRoleRef")]
    pub access_role_ref: Option<ConnectorForProviderAccessRoleRef>,
    /// Selector for a Role in iam to populate accessRole.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "accessRoleSelector")]
    ...
    /// Either SFTP or AS2 is configured.The parameters to configure for the connector object. Fields documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sftpConfig")]
...
pub struct ConnectorForProviderAs2Config {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "localProfileId")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mdnResponse")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mdnSigningAlgorithm")]
    pub mdn_signing_algorithm: Option<String>,
    /// Used as the subject HTTP header attribute in AS2 messages that are being sent with the connector.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "messageSubject")]
    pub message_subject: Option<String>,
    /// The unique identifier for the AS2 partner profile.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "partnerProfileId")]
...
pub struct ConnectorForProviderSftpConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trustedHostKeys")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userSecretId")]
    pub user_secret_id: Option<String>,
    /// Reference to a Secret in secretsmanager to populate userSecretId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userSecretIdRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "userSecretIdSelector")]
