...
#[kube(group = "transfer.aws.upbound.io", version = "v1beta2", kind = "User", plural = "users")]
...
pub struct UserForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "homeDirectory")]
    pub home_directory: Option<String>,
    /// Logical directory mappings that specify what S3 paths and keys should be visible to your user and how you want to make them visible. See Home Directory Mappings below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "homeDirectoryMappings")]
    pub home_directory_mappings: Option<Vec<UserForProviderHomeDirectoryMappings>>,
    /// The type of landing directory (folder) you mapped for your users' home directory. Valid values are PATH and LOGICAL.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "homeDirectoryType")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "posixProfile")]
