...
#[kube(group = "sesv2.aws.upbound.io", version = "v1beta2", kind = "ConfigurationSetEventDestination", plural = "configurationseteventdestinations")]
...
pub struct ConfigurationSetEventDestinationSpec {
    ...
    pub publish_connection_details_to: Option<ConfigurationSetEventDestinationPublishConnectionDetailsTo>,
    ...
    pub write_connection_secret_to_ref: Option<ConfigurationSetEventDestinationWriteConnectionSecretToRef>,
}
...
pub struct ConfigurationSetEventDestinationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetName")]
    pub configuration_set_name: Option<String>,
    /// Reference to a ConfigurationSet in sesv2 to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameRef")]
    pub configuration_set_name_ref: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameRef>,
    /// Selector for a ConfigurationSet in sesv2 to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameSelector")]
    pub configuration_set_name_selector: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameSelector>,
    /// A name that identifies the event destination within the configuration set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventDestination")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventDestinationName")]
...
pub struct ConfigurationSetEventDestinationForProviderConfigurationSetNameRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameRefPolicyResolve>,
}
...
pub struct ConfigurationSetEventDestinationForProviderConfigurationSetNameSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameSelectorPolicy>,
}
...
pub struct ConfigurationSetEventDestinationForProviderConfigurationSetNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConfigurationSetEventDestinationForProviderConfigurationSetNameSelectorPolicyResolve>,
}
...
pub struct ConfigurationSetEventDestinationForProviderEventDestination {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudWatchDestination")]
    pub cloud_watch_destination: Option<ConfigurationSetEventDestinationForProviderEventDestinationCloudWatchDestination>,
    /// When the event destination is enabled, the specified event types are sent to the destinations. Default: false.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventBridgeDestination")]
    pub event_bridge_destination: Option<ConfigurationSetEventDestinationForProviderEventDestinationEventBridgeDestination>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseDestination")]
    pub kinesis_firehose_destination: Option<ConfigurationSetEventDestinationForProviderEventDestinationKinesisFirehoseDestination>,
    /// - An array that specifies which events the Amazon SES API v2 should send to the destinations. Valid values: SEND, REJECT, BOUNCE, COMPLAINT, DELIVERY, OPEN, CLICK, RENDERING_FAILURE, DELIVERY_DELAY, SUBSCRIPTION.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchingEventTypes")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pinpointDestination")]
    pub pinpoint_destination: Option<ConfigurationSetEventDestinationForProviderEventDestinationPinpointDestination>,
    /// An object that defines an Amazon SNS destination for email events. See sns_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsDestination")]
    pub sns_destination: Option<ConfigurationSetEventDestinationForProviderEventDestinationSnsDestination>,
}
...
pub struct ConfigurationSetEventDestinationForProviderEventDestinationCloudWatchDestinationDimensionConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultDimensionValue")]
    pub default_dimension_value: Option<String>,
    /// The name of an Amazon CloudWatch dimension associated with an email sending metric.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dimensionName")]
    pub dimension_name: Option<String>,
    /// The location where the Amazon SES API v2 finds the value of a dimension to publish to Amazon CloudWatch. Valid values: MESSAGE_TAG, EMAIL_HEADER, LINK_TAG.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dimensionValueSource")]
...
pub struct ConfigurationSetEventDestinationForProviderEventDestinationSnsDestination {
    ...
    pub topic_arn_ref: Option<ConfigurationSetEventDestinationForProviderEventDestinationSnsDestinationTopicArnRef>,
    /// Selector for a Topic in sns to populate topicArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "topicArnSelector")]
    pub topic_arn_selector: Option<ConfigurationSetEventDestinationForProviderEventDestinationSnsDestinationTopicArnSelector>,
}
...
pub struct ConfigurationSetEventDestinationForProviderEventDestinationSnsDestinationTopicArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConfigurationSetEventDestinationForProviderEventDestinationSnsDestinationTopicArnRefPolicy>,
}
...
pub struct ConfigurationSetEventDestinationInitProvider {
    ...
    /// Reference to a ConfigurationSet in sesv2 to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameRef")]
    pub configuration_set_name_ref: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameRef>,
    /// Selector for a ConfigurationSet in sesv2 to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameSelector")]
    pub configuration_set_name_selector: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelector>,
    /// A name that identifies the event destination within the configuration set.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventDestination")]
...
pub struct ConfigurationSetEventDestinationInitProviderConfigurationSetNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameRefPolicyResolve>,
}
...
pub struct ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelectorPolicy>,
}
...
pub struct ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConfigurationSetEventDestinationInitProviderConfigurationSetNameSelectorPolicyResolve>,
}
...
pub struct ConfigurationSetEventDestinationInitProviderEventDestination {
    /// An object that defines an Amazon CloudWatch destination for email events. See cloud_watch_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudWatchDestination")]
    pub cloud_watch_destination: Option<ConfigurationSetEventDestinationInitProviderEventDestinationCloudWatchDestination>,
    /// When the event destination is enabled, the specified event types are sent to the destinations. Default: false.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventBridgeDestination")]
    pub event_bridge_destination: Option<ConfigurationSetEventDestinationInitProviderEventDestinationEventBridgeDestination>,
    /// An object that defines an Amazon Kinesis Data Firehose destination for email events. See kinesis_firehose_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseDestination")]
    pub kinesis_firehose_destination: Option<ConfigurationSetEventDestinationInitProviderEventDestinationKinesisFirehoseDestination>,
    /// - An array that specifies which events the Amazon SES API v2 should send to the destinations. Valid values: SEND, REJECT, BOUNCE, COMPLAINT, DELIVERY, OPEN, CLICK, RENDERING_FAILURE, DELIVERY_DELAY, SUBSCRIPTION.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchingEventTypes")]
    pub matching_event_types: Option<Vec<String>>,
    /// An object that defines an Amazon Pinpoint project destination for email events. See pinpoint_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pinpointDestination")]
    pub pinpoint_destination: Option<ConfigurationSetEventDestinationInitProviderEventDestinationPinpointDestination>,
    /// An object that defines an Amazon SNS destination for email events. See sns_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsDestination")]
    pub sns_destination: Option<ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestination>,
}
...
pub struct ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestination {
    ...
    /// Reference to a Topic in sns to populate topicArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "topicArnRef")]
    pub topic_arn_ref: Option<ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestinationTopicArnRef>,
    /// Selector for a Topic in sns to populate topicArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "topicArnSelector")]
    pub topic_arn_selector: Option<ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestinationTopicArnSelector>,
}
...
pub struct ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestinationTopicArnRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConfigurationSetEventDestinationInitProviderEventDestinationSnsDestinationTopicArnRefPolicy>,
}
...
pub struct ConfigurationSetEventDestinationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConfigurationSetEventDestinationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConfigurationSetEventDestinationPublishConnectionDetailsToConfigRefPolicyResolve>,
}
...
pub struct ConfigurationSetEventDestinationStatusAtProviderEventDestination {
    /// An object that defines an Amazon CloudWatch destination for email events. See cloud_watch_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudWatchDestination")]
    pub cloud_watch_destination: Option<ConfigurationSetEventDestinationStatusAtProviderEventDestinationCloudWatchDestination>,
    /// When the event destination is enabled, the specified event types are sent to the destinations. Default: false.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventBridgeDestination")]
    pub event_bridge_destination: Option<ConfigurationSetEventDestinationStatusAtProviderEventDestinationEventBridgeDestination>,
    /// An object that defines an Amazon Kinesis Data Firehose destination for email events. See kinesis_firehose_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisFirehoseDestination")]
    pub kinesis_firehose_destination: Option<ConfigurationSetEventDestinationStatusAtProviderEventDestinationKinesisFirehoseDestination>,
    /// - An array that specifies which events the Amazon SES API v2 should send to the destinations. Valid values: SEND, REJECT, BOUNCE, COMPLAINT, DELIVERY, OPEN, CLICK, RENDERING_FAILURE, DELIVERY_DELAY, SUBSCRIPTION.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchingEventTypes")]
    pub matching_event_types: Option<Vec<String>>,
    /// An object that defines an Amazon Pinpoint project destination for email events. See pinpoint_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pinpointDestination")]
    pub pinpoint_destination: Option<ConfigurationSetEventDestinationStatusAtProviderEventDestinationPinpointDestination>,
    /// An object that defines an Amazon SNS destination for email events. See sns_destination Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snsDestination")]
    pub sns_destination: Option<ConfigurationSetEventDestinationStatusAtProviderEventDestinationSnsDestination>,
}
