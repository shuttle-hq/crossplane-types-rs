...
#[kube(group = "sesv2.aws.upbound.io", version = "v1beta2", kind = "EmailIdentity", plural = "emailidentities")]
...
pub struct EmailIdentityForProvider {
    ...
    pub configuration_set_name_selector: Option<EmailIdentityForProviderConfigurationSetNameSelector>,
    /// The configuration of the DKIM authentication settings for an email domain identity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dkimSigningAttributes")]
...
pub struct EmailIdentityForProviderDkimSigningAttributes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainSigningPrivateKeySecretRef")]
    pub domain_signing_private_key_secret_ref: Option<EmailIdentityForProviderDkimSigningAttributesDomainSigningPrivateKeySecretRef>,
    /// [Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainSigningSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nextSigningKeyLength")]
...
pub struct EmailIdentityInitProvider {
    ...
    /// Selector for a ConfigurationSet in sesv2 to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameSelector")]
    pub configuration_set_name_selector: Option<EmailIdentityInitProviderConfigurationSetNameSelector>,
    /// The configuration of the DKIM authentication settings for an email domain identity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dkimSigningAttributes")]
...
pub struct EmailIdentityInitProviderDkimSigningAttributes {
    /// [Bring Your Own DKIM] A private key that's used to generate a DKIM signature. The private key must use 1024 or 2048-bit RSA encryption, and must be encoded using base64 encoding.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainSigningPrivateKeySecretRef")]
    pub domain_signing_private_key_secret_ref: Option<EmailIdentityInitProviderDkimSigningAttributesDomainSigningPrivateKeySecretRef>,
    /// [Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainSigningSelector")]
    pub domain_signing_selector: Option<String>,
    /// [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day. Valid values: RSA_1024_BIT, RSA_2048_BIT.
...
pub struct EmailIdentityStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "verifiedForSendingStatus")]
...
pub struct EmailIdentityStatusAtProviderDkimSigningAttributes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "currentSigningKeyLength")]
    pub current_signing_key_length: Option<String>,
    /// [Bring Your Own DKIM] A string that's used to identify a public key in the DNS configuration for a domain.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainSigningSelector")]
    pub domain_signing_selector: Option<String>,
    /// [Easy DKIM] The last time a key pair was generated for this identity.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lastKeyGenerationTimestamp")]
    pub last_key_generation_timestamp: Option<String>,
    /// [Easy DKIM] The key length of the future DKIM key pair to be generated. This can be changed at most once per day. Valid values: RSA_1024_BIT, RSA_2048_BIT.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nextSigningKeyLength")]
    pub next_signing_key_length: Option<String>,
    /// A string that indicates how DKIM was configured for the identity. AWS_SES indicates that DKIM was configured for the identity by using Easy DKIM. EXTERNAL indicates that DKIM was configured for the identity by using Bring Your Own DKIM (BYODKIM).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "signingAttributesOrigin")]
