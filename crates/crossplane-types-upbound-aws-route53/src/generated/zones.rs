...
#[kube(group = "route53.aws.upbound.io", version = "v1beta1", kind = "Zone", plural = "zones")]
...
pub struct ZoneForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "delegationSetIdRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "delegationSetIdSelector")]
...
pub struct ZoneStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "primaryNameServer")]
