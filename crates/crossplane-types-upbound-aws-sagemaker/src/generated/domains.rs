...
#[kube(group = "sagemaker.aws.upbound.io", version = "v1beta2", kind = "Domain", plural = "domains")]
...
pub struct DomainForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultUserSettings")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tagPropagation")]
...
pub struct DomainForProviderDefaultSpaceSettings {
    ...
    pub custom_file_system_config: Option<Vec<DomainForProviderDefaultSpaceSettingsCustomFileSystemConfig>>,
    ...
    pub custom_posix_user_config: Option<DomainForProviderDefaultSpaceSettingsCustomPosixUserConfig>,
    ...
    pub jupyter_lab_app_settings: Option<DomainForProviderDefaultSpaceSettingsJupyterLabAppSettings>,
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainForProviderDefaultSpaceSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainForProviderDefaultSpaceSettingsKernelGatewayAppSettings>,
...
pub struct DomainForProviderDefaultSpaceSettingsCustomFileSystemConfig {
    ...
    pub efs_file_system_config: Option<DomainForProviderDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainForProviderDefaultSpaceSettingsJupyterLabAppSettings {
    ...
    pub app_lifecycle_management: Option<DomainForProviderDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    ...
    pub code_repository: Option<Vec<DomainForProviderDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository>>,
    ...
    pub custom_image: Option<Vec<DomainForProviderDefaultSpaceSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec>,
...
pub struct DomainForProviderDefaultSpaceSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainForProviderDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainForProviderDefaultSpaceSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainForProviderDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainForProviderDefaultSpaceSettingsSpaceStorageSettings {
    ...
    pub default_ebs_storage_settings: Option<DomainForProviderDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainForProviderDefaultUserSettings {
    ...
    /// The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker Studio. See custom_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customFileSystemConfig")]
    pub custom_file_system_config: Option<Vec<DomainForProviderDefaultUserSettingsCustomFileSystemConfig>>,
    /// Details about the POSIX identity that is used for file system operations. See custom_posix_user_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPosixUserConfig")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executionRoleRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executionRoleSelector")]
    ...
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainForProviderDefaultUserSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainForProviderDefaultUserSettingsKernelGatewayAppSettings>,
    ...
    pub r_studio_server_pro_app_settings: Option<DomainForProviderDefaultUserSettingsRStudioServerProAppSettings>,
    ...
    pub studio_web_portal_settings: Option<DomainForProviderDefaultUserSettingsStudioWebPortalSettings>,
    ...
    pub tensor_board_app_settings: Option<DomainForProviderDefaultUserSettingsTensorBoardAppSettings>,
}
...
pub struct DomainForProviderDefaultUserSettingsCanvasAppSettings {
    ...
    pub direct_deploy_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsDirectDeploySettings>,
    ...
    pub emr_serverless_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "generativeAiSettings")]
    pub generative_ai_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings>,
    ...
    pub identity_provider_oauth_settings: Option<Vec<DomainForProviderDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSettings>>,
    ...
    pub kendra_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsKendraSettings>,
    ...
    pub model_register_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsModelRegisterSettings>,
    ...
    pub time_series_forecasting_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings>,
    ...
    pub workspace_settings: Option<DomainForProviderDefaultUserSettingsCanvasAppSettingsWorkspaceSettings>,
}
...
pub struct DomainForProviderDefaultUserSettingsCodeEditorAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainForProviderDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainForProviderDefaultUserSettingsCodeEditorAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainForProviderDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement {
    /// Settings related to idle shutdown of Studio applications. see idle_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "idleSettings")]
    pub idle_settings: Option<DomainForProviderDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagementIdleSettings>,
}
...
pub struct DomainForProviderDefaultUserSettingsCustomFileSystemConfig {
    /// The default EBS storage settings for a private space. See efs_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsFileSystemConfig")]
    pub efs_file_system_config: Option<DomainForProviderDefaultUserSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainForProviderDefaultUserSettingsExecutionRoleSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainForProviderDefaultUserSettingsExecutionRoleSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DomainForProviderDefaultUserSettingsJupyterLabAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainForProviderDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainForProviderDefaultUserSettingsJupyterLabAppSettingsCodeRepository>>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainForProviderDefaultUserSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec>,
    /// The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrSettings")]
...
pub struct DomainForProviderDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement {
    /// Settings related to idle shutdown of Studio applications. see idle_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "idleSettings")]
    pub idle_settings: Option<DomainForProviderDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings>,
}
...
pub struct DomainForProviderDefaultUserSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainForProviderDefaultUserSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainForProviderDefaultUserSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainForProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainForProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImageImageNameRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainForProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImageImageNameRefPolicy>,
}
...
pub struct DomainForProviderDefaultUserSettingsRSessionAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainForProviderDefaultUserSettingsRSessionAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainForProviderDefaultUserSettingsSpaceStorageSettings {
    /// The default EBS storage settings for a private space. See default_ebs_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultEbsStorageSettings")]
    pub default_ebs_storage_settings: Option<DomainForProviderDefaultUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainForProviderDefaultUserSettingsTensorBoardAppSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainForProviderDomainSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executionRoleIdentityConfig")]
    ...
    pub r_studio_server_pro_domain_settings: Option<DomainForProviderDomainSettingsRStudioServerProDomainSettings>,
...
pub struct DomainForProviderDomainSettingsRStudioServerProDomainSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainForProviderDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec>,
...
pub struct DomainForProviderRetentionPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "homeEfsFileSystem")]
...
pub struct DomainInitProviderDefaultSpaceSettings {
    /// The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker Studio. See custom_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customFileSystemConfig")]
    pub custom_file_system_config: Option<Vec<DomainInitProviderDefaultSpaceSettingsCustomFileSystemConfig>>,
    /// Details about the POSIX identity that is used for file system operations. See custom_posix_user_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPosixUserConfig")]
    pub custom_posix_user_config: Option<DomainInitProviderDefaultSpaceSettingsCustomPosixUserConfig>,
    /// The execution role for the space.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executionRole")]
    pub execution_role: Option<String>,
    /// The settings for the JupyterLab application. See jupyter_lab_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterLabAppSettings")]
    pub jupyter_lab_app_settings: Option<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettings>,
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainInitProviderDefaultSpaceSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainInitProviderDefaultSpaceSettingsKernelGatewayAppSettings>,
    /// The security groups for the Amazon Virtual Private Cloud that the space uses for communication.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    pub security_groups: Option<Vec<String>>,
    /// The storage settings for a private space. See space_storage_settings Block below.
...
pub struct DomainInitProviderDefaultSpaceSettingsCustomFileSystemConfig {
    /// The default EBS storage settings for a private space. See efs_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsFileSystemConfig")]
    pub efs_file_system_config: Option<DomainInitProviderDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository>>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec>,
    /// The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrSettings")]
    pub emr_settings: Option<DomainInitProviderDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultSpaceSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainInitProviderDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultSpaceSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultSpaceSettingsSpaceStorageSettings {
    /// The default EBS storage settings for a private space. See default_ebs_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultEbsStorageSettings")]
    pub default_ebs_storage_settings: Option<DomainInitProviderDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainInitProviderDefaultUserSettings {
    ...
    /// The Code Editor application settings. See code_editor_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeEditorAppSettings")]
    pub code_editor_app_settings: Option<DomainInitProviderDefaultUserSettingsCodeEditorAppSettings>,
    /// The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker Studio. See custom_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customFileSystemConfig")]
    pub custom_file_system_config: Option<Vec<DomainInitProviderDefaultUserSettingsCustomFileSystemConfig>>,
    /// Details about the POSIX identity that is used for file system operations. See custom_posix_user_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPosixUserConfig")]
    pub custom_posix_user_config: Option<DomainInitProviderDefaultUserSettingsCustomPosixUserConfig>,
    /// The default experience that the user is directed to when accessing the domain. The supported values are: studio::: Indicates that Studio is the default experience. This value can only be passed if StudioWebPortal is set to ENABLED. app:JupyterServer:: Indicates that Studio Classic is the default experience.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultLandingUri")]
    pub default_landing_uri: Option<String>,
    /// The execution role ARN for the user.
    ...
    /// The settings for the JupyterLab application. See jupyter_lab_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterLabAppSettings")]
    pub jupyter_lab_app_settings: Option<DomainInitProviderDefaultUserSettingsJupyterLabAppSettings>,
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainInitProviderDefaultUserSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainInitProviderDefaultUserSettingsKernelGatewayAppSettings>,
    /// The RSession app settings. See r_session_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rSessionAppSettings")]
    pub r_session_app_settings: Option<DomainInitProviderDefaultUserSettingsRSessionAppSettings>,
    /// A collection of settings that configure user interaction with the RStudioServerPro app. See r_studio_server_pro_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rStudioServerProAppSettings")]
    pub r_studio_server_pro_app_settings: Option<DomainInitProviderDefaultUserSettingsRStudioServerProAppSettings>,
    /// A list of security group IDs that will be attached to the user.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    pub security_groups: Option<Vec<String>>,
    /// The sharing settings. See sharing_settings Block below.
    ...
    /// The Studio Web Portal settings. See studio_web_portal_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "studioWebPortalSettings")]
    pub studio_web_portal_settings: Option<DomainInitProviderDefaultUserSettingsStudioWebPortalSettings>,
    /// The TensorBoard app settings. See tensor_board_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tensorBoardAppSettings")]
    pub tensor_board_app_settings: Option<DomainInitProviderDefaultUserSettingsTensorBoardAppSettings>,
}
...
pub struct DomainInitProviderDefaultUserSettingsCanvasAppSettings {
    /// The model deployment settings for the SageMaker Canvas application. See direct_deploy_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "directDeploySettings")]
    pub direct_deploy_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsDirectDeploySettings>,
    /// The settings for running Amazon EMR Serverless jobs in SageMaker Canvas. See emr_serverless_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrServerlessSettings")]
    pub emr_serverless_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "generativeAiSettings")]
    pub generative_ai_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings>,
    /// The settings for connecting to an external data source with OAuth. See identity_provider_oauth_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "identityProviderOauthSettings")]
    pub identity_provider_oauth_settings: Option<Vec<DomainInitProviderDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSettings>>,
    /// The settings for document querying. See kendra_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kendraSettings")]
    pub kendra_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsKendraSettings>,
    /// The model registry settings for the SageMaker Canvas application. See model_register_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelRegisterSettings")]
    pub model_register_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsModelRegisterSettings>,
    /// Time series forecast settings for the Canvas app. See time_series_forecasting_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeSeriesForecastingSettings")]
    pub time_series_forecasting_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings>,
    /// The workspace settings for the SageMaker Canvas application. See workspace_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workspaceSettings")]
    pub workspace_settings: Option<DomainInitProviderDefaultUserSettingsCanvasAppSettingsWorkspaceSettings>,
}
...
pub struct DomainInitProviderDefaultUserSettingsCodeEditorAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainInitProviderDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultUserSettingsCodeEditorAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultUserSettingsCustomFileSystemConfig {
    /// The default EBS storage settings for a private space. See efs_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsFileSystemConfig")]
    pub efs_file_system_config: Option<DomainInitProviderDefaultUserSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainInitProviderDefaultUserSettingsExecutionRoleSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DomainInitProviderDefaultUserSettingsExecutionRoleSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DomainInitProviderDefaultUserSettingsJupyterLabAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainInitProviderDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainInitProviderDefaultUserSettingsJupyterLabAppSettingsCodeRepository>>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultUserSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec>,
    /// The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrSettings")]
...
pub struct DomainInitProviderDefaultUserSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainInitProviderDefaultUserSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultUserSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImageImageNameRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DomainInitProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImageImageNameRefPolicy>,
}
...
pub struct DomainInitProviderDefaultUserSettingsRSessionAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainInitProviderDefaultUserSettingsRSessionAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainInitProviderDefaultUserSettingsSpaceStorageSettings {
    /// The default EBS storage settings for a private space. See default_ebs_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultEbsStorageSettings")]
    pub default_ebs_storage_settings: Option<DomainInitProviderDefaultUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainInitProviderDefaultUserSettingsTensorBoardAppSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainInitProviderDomainSettings {
    ...
    /// A collection of settings that configure the RStudioServerPro Domain-level app. see r_studio_server_pro_domain_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rStudioServerProDomainSettings")]
    pub r_studio_server_pro_domain_settings: Option<DomainInitProviderDomainSettingsRStudioServerProDomainSettings>,
    /// The security groups for the Amazon Virtual Private Cloud that the Domain uses for communication between Domain-level apps and user apps.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIds")]
    pub security_group_ids: Option<Vec<String>>,
}
...
pub struct DomainInitProviderDomainSettingsRStudioServerProDomainSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainInitProviderDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec>,
    /// The ARN of the execution role for the RStudioServerPro Domain-level app.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainExecutionRoleArn")]
    pub domain_execution_role_arn: Option<String>,
    /// A URL pointing to an RStudio Connect server.
...
pub struct DomainStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "homeEfsFileSystemId")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIdForDomainBoundary")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "singleSignOnManagedApplicationInstanceId")]
...
pub struct DomainStatusAtProviderDefaultSpaceSettings {
    /// The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker Studio. See custom_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customFileSystemConfig")]
    pub custom_file_system_config: Option<Vec<DomainStatusAtProviderDefaultSpaceSettingsCustomFileSystemConfig>>,
    /// Details about the POSIX identity that is used for file system operations. See custom_posix_user_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPosixUserConfig")]
    pub custom_posix_user_config: Option<DomainStatusAtProviderDefaultSpaceSettingsCustomPosixUserConfig>,
    /// The execution role for the space.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executionRole")]
    pub execution_role: Option<String>,
    /// The settings for the JupyterLab application. See jupyter_lab_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterLabAppSettings")]
    pub jupyter_lab_app_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettings>,
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsKernelGatewayAppSettings>,
    /// The security groups for the Amazon Virtual Private Cloud that the space uses for communication.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    pub security_groups: Option<Vec<String>>,
    /// The storage settings for a private space. See space_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spaceStorageSettings")]
    pub space_storage_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsSpaceStorageSettings>,
}
...
pub struct DomainStatusAtProviderDefaultSpaceSettingsCustomFileSystemConfig {
    /// The default EBS storage settings for a private space. See efs_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsFileSystemConfig")]
    pub efs_file_system_config: Option<DomainStatusAtProviderDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository>>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec>,
    /// The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrSettings")]
    pub emr_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultSpaceSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainStatusAtProviderDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultSpaceSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultSpaceSettingsSpaceStorageSettings {
    /// The default EBS storage settings for a private space. See default_ebs_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultEbsStorageSettings")]
    pub default_ebs_storage_settings: Option<DomainStatusAtProviderDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettings {
    ...
    /// The Code Editor application settings. See code_editor_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeEditorAppSettings")]
    pub code_editor_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsCodeEditorAppSettings>,
    /// The settings for assigning a custom file system to a user profile. Permitted users can access this file system in Amazon SageMaker Studio. See custom_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customFileSystemConfig")]
    pub custom_file_system_config: Option<Vec<DomainStatusAtProviderDefaultUserSettingsCustomFileSystemConfig>>,
    /// Details about the POSIX identity that is used for file system operations. See custom_posix_user_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPosixUserConfig")]
    pub custom_posix_user_config: Option<DomainStatusAtProviderDefaultUserSettingsCustomPosixUserConfig>,
    /// The default experience that the user is directed to when accessing the domain. The supported values are: studio::: Indicates that Studio is the default experience. This value can only be passed if StudioWebPortal is set to ENABLED. app:JupyterServer:: Indicates that Studio Classic is the default experience.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultLandingUri")]
    pub default_landing_uri: Option<String>,
    /// The execution role ARN for the user.
    ...
    /// The settings for the JupyterLab application. See jupyter_lab_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterLabAppSettings")]
    pub jupyter_lab_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettings>,
    /// The Jupyter server's app settings. See jupyter_server_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jupyterServerAppSettings")]
    pub jupyter_server_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsJupyterServerAppSettings>,
    /// The kernel gateway app settings. See kernel_gateway_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kernelGatewayAppSettings")]
    pub kernel_gateway_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsKernelGatewayAppSettings>,
    /// The RSession app settings. See r_session_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rSessionAppSettings")]
    pub r_session_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsRSessionAppSettings>,
    /// A collection of settings that configure user interaction with the RStudioServerPro app. See r_studio_server_pro_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rStudioServerProAppSettings")]
    pub r_studio_server_pro_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsRStudioServerProAppSettings>,
    /// A list of security group IDs that will be attached to the user.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    pub security_groups: Option<Vec<String>>,
    /// The sharing settings. See sharing_settings Block below.
    ...
    /// The storage settings for a private space. See space_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "spaceStorageSettings")]
    pub space_storage_settings: Option<DomainStatusAtProviderDefaultUserSettingsSpaceStorageSettings>,
    /// Whether the user can access Studio. If this value is set to DISABLED, the user cannot access Studio, even if that is the default experience for the domain. Valid values are ENABLED and DISABLED.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "studioWebPortal")]
    pub studio_web_portal: Option<String>,
    /// The Studio Web Portal settings. See studio_web_portal_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "studioWebPortalSettings")]
    pub studio_web_portal_settings: Option<DomainStatusAtProviderDefaultUserSettingsStudioWebPortalSettings>,
    /// The TensorBoard app settings. See tensor_board_app_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tensorBoardAppSettings")]
    pub tensor_board_app_settings: Option<DomainStatusAtProviderDefaultUserSettingsTensorBoardAppSettings>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsCanvasAppSettings {
    /// The model deployment settings for the SageMaker Canvas application. See direct_deploy_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "directDeploySettings")]
    pub direct_deploy_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsDirectDeploySettings>,
    /// The settings for running Amazon EMR Serverless jobs in SageMaker Canvas. See emr_serverless_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrServerlessSettings")]
    pub emr_serverless_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "generativeAiSettings")]
    pub generative_ai_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings>,
    /// The settings for connecting to an external data source with OAuth. See identity_provider_oauth_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "identityProviderOauthSettings")]
    pub identity_provider_oauth_settings: Option<Vec<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSettings>>,
    /// The settings for document querying. See kendra_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kendraSettings")]
    pub kendra_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsKendraSettings>,
    /// The model registry settings for the SageMaker Canvas application. See model_register_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelRegisterSettings")]
    pub model_register_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsModelRegisterSettings>,
    /// Time series forecast settings for the Canvas app. See time_series_forecasting_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timeSeriesForecastingSettings")]
    pub time_series_forecasting_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings>,
    /// The workspace settings for the SageMaker Canvas application. See workspace_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workspaceSettings")]
    pub workspace_settings: Option<DomainStatusAtProviderDefaultUserSettingsCanvasAppSettingsWorkspaceSettings>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsCodeEditorAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainStatusAtProviderDefaultUserSettingsCodeEditorAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultUserSettingsCodeEditorAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsCustomFileSystemConfig {
    /// The default EBS storage settings for a private space. See efs_file_system_config Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsFileSystemConfig")]
    pub efs_file_system_config: Option<DomainStatusAtProviderDefaultUserSettingsCustomFileSystemConfigEfsFileSystemConfig>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettings {
    /// Indicates whether idle shutdown is activated for JupyterLab applications. see app_lifecycle_management Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appLifecycleManagement")]
    pub app_lifecycle_management: Option<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement>,
    /// The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "builtInLifecycleConfigArn")]
    pub built_in_lifecycle_config_arn: Option<String>,
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettingsCodeRepository>>,
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec>,
    /// The configuration parameters that specify the IAM roles assumed by the execution role of SageMaker (assumable roles) and the cluster instances or job execution environments (execution roles or runtime roles) to manage and access resources required for running Amazon EMR clusters or Amazon EMR Serverless applications. see emr_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "emrSettings")]
    pub emr_settings: Option<DomainStatusAtProviderDefaultUserSettingsJupyterLabAppSettingsEmrSettings>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsJupyterServerAppSettings {
    /// A list of Git repositories that SageMaker automatically displays to users for cloning in the JupyterServer application. see code_repository Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codeRepository")]
    pub code_repository: Option<Vec<DomainStatusAtProviderDefaultUserSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsKernelGatewayAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultUserSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec>,
    /// The Amazon Resource Name (ARN) of the Lifecycle Configurations.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lifecycleConfigArns")]
    pub lifecycle_config_arns: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsRSessionAppSettings {
    /// A list of custom SageMaker images that are configured to run as a KernelGateway app. see custom_image Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customImage")]
    pub custom_image: Option<Vec<DomainStatusAtProviderDefaultUserSettingsRSessionAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsSpaceStorageSettings {
    /// The default EBS storage settings for a private space. See default_ebs_storage_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultEbsStorageSettings")]
    pub default_ebs_storage_settings: Option<DomainStatusAtProviderDefaultUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings>,
}
...
pub struct DomainStatusAtProviderDefaultUserSettingsTensorBoardAppSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec>,
}
...
pub struct DomainStatusAtProviderDomainSettings {
    ...
    /// A collection of settings that configure the RStudioServerPro Domain-level app. see r_studio_server_pro_domain_settings Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rStudioServerProDomainSettings")]
    pub r_studio_server_pro_domain_settings: Option<DomainStatusAtProviderDomainSettingsRStudioServerProDomainSettings>,
    /// The security groups for the Amazon Virtual Private Cloud that the Domain uses for communication between Domain-level apps and user apps.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupIds")]
    pub security_group_ids: Option<Vec<String>>,
}
...
pub struct DomainStatusAtProviderDomainSettingsRStudioServerProDomainSettings {
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see default_resource_spec Block below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "defaultResourceSpec")]
    pub default_resource_spec: Option<DomainStatusAtProviderDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec>,
    /// The ARN of the execution role for the RStudioServerPro Domain-level app.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "domainExecutionRoleArn")]
    pub domain_execution_role_arn: Option<String>,
    /// A URL pointing to an RStudio Connect server.
