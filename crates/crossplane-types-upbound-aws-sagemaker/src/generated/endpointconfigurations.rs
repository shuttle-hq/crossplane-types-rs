...
#[kube(group = "sagemaker.aws.upbound.io", version = "v1beta2", kind = "EndpointConfiguration", plural = "endpointconfigurations")]
...
pub struct EndpointConfigurationForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "shadowProductionVariants")]
    pub shadow_production_variants: Option<Vec<EndpointConfigurationForProviderShadowProductionVariants>>,
...
pub struct EndpointConfigurationForProviderAsyncInferenceConfigOutputConfig {
    ...
    pub notification_config: Option<EndpointConfigurationForProviderAsyncInferenceConfigOutputConfigNotificationConfig>,
...
pub struct EndpointConfigurationForProviderDataCaptureConfig {
    ...
    pub capture_content_type_header: Option<EndpointConfigurationForProviderDataCaptureConfigCaptureContentTypeHeader>,
    /// Specifies what data to capture. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureOptions")]
    pub capture_options: Option<Vec<EndpointConfigurationForProviderDataCaptureConfigCaptureOptions>>,
...
pub struct EndpointConfigurationForProviderProductionVariants {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inferenceAmiVersion")]
    ...
    pub managed_instance_scaling: Option<EndpointConfigurationForProviderProductionVariantsManagedInstanceScaling>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelNameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelNameSelector")]
    pub model_name_selector: Option<EndpointConfigurationForProviderProductionVariantsModelNameSelector>,
    ...
    pub routing_config: Option<Vec<EndpointConfigurationForProviderProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationForProviderProductionVariantsServerlessConfig>,
...
pub struct EndpointConfigurationForProviderProductionVariantsModelNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EndpointConfigurationForProviderProductionVariantsModelNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EndpointConfigurationForProviderProductionVariantsModelNameRefPolicyResolve>,
}
...
pub struct EndpointConfigurationForProviderProductionVariantsModelNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EndpointConfigurationForProviderProductionVariantsModelNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EndpointConfigurationForProviderProductionVariantsModelNameSelectorPolicyResolve>,
}
...
pub struct EndpointConfigurationForProviderShadowProductionVariants {
    ...
    /// Specifies configuration for a core dump from the model container when the process crashes. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreDumpConfig")]
    pub core_dump_config: Option<EndpointConfigurationForProviderShadowProductionVariantsCoreDumpConfig>,
    /// You can use this parameter to turn on native Amazon Web Services Systems Manager (SSM) access for a production variant behind an endpoint. By default, SSM access is disabled for all production variants behind an endpoints.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableSsmAccess")]
    pub enable_ssm_access: Option<bool>,
    /// Specifies an option from a collection of preconfigured Amazon Machine Image (AMI) images. Each image is configured by Amazon Web Services with a set of software and driver versions. Amazon Web Services optimizes these configurations for different machine learning workloads.
    ...
    /// Settings that control the range in the number of instances that the endpoint provisions as it scales up or down to accommodate traffic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedInstanceScaling")]
    pub managed_instance_scaling: Option<EndpointConfigurationForProviderShadowProductionVariantsManagedInstanceScaling>,
    /// The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between 60 and 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelDataDownloadTimeoutInSeconds")]
    pub model_data_download_timeout_in_seconds: Option<f64>,
    /// The name of the model to use.
    ...
    /// Sets how the endpoint routes incoming traffic. See routing_config below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingConfig")]
    pub routing_config: Option<Vec<EndpointConfigurationForProviderShadowProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationForProviderShadowProductionVariantsServerlessConfig>,
    /// The name of the variant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "variantName")]
    pub variant_name: Option<String>,
    /// The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between 1 and 512.
...
pub struct EndpointConfigurationInitProvider {
    ...
    /// Array of ProductionVariant objects. There is one for each model that you want to host at this endpoint in shadow mode with production traffic replicated from the model specified on ProductionVariants. If you use this field, you can only specify one variant for ProductionVariants and one variant for ShadowProductionVariants. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "shadowProductionVariants")]
    pub shadow_production_variants: Option<Vec<EndpointConfigurationInitProviderShadowProductionVariants>>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
}
...
pub struct EndpointConfigurationInitProviderAsyncInferenceConfigOutputConfig {
    ...
    /// Specifies the configuration for notifications of inference results for asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "notificationConfig")]
    pub notification_config: Option<EndpointConfigurationInitProviderAsyncInferenceConfigOutputConfigNotificationConfig>,
    /// The Amazon S3 location to upload failure inference responses to.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3FailurePath")]
    pub s3_failure_path: Option<String>,
    /// The Amazon S3 location to upload inference responses to.
...
pub struct EndpointConfigurationInitProviderDataCaptureConfig {
    /// The content type headers to capture. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureContentTypeHeader")]
    pub capture_content_type_header: Option<EndpointConfigurationInitProviderDataCaptureConfigCaptureContentTypeHeader>,
    /// Specifies what data to capture. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureOptions")]
    pub capture_options: Option<Vec<EndpointConfigurationInitProviderDataCaptureConfigCaptureOptions>>,
    /// The URL for S3 location where the captured data is stored.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationS3Uri")]
    pub destination_s3_uri: Option<String>,
    /// Flag to enable data capture. Defaults to false.
...
pub struct EndpointConfigurationInitProviderProductionVariants {
    ...
    /// Settings that control the range in the number of instances that the endpoint provisions as it scales up or down to accommodate traffic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedInstanceScaling")]
    pub managed_instance_scaling: Option<EndpointConfigurationInitProviderProductionVariantsManagedInstanceScaling>,
    /// The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between 60 and 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelDataDownloadTimeoutInSeconds")]
    pub model_data_download_timeout_in_seconds: Option<f64>,
    /// The name of the model to use.
    ...
    /// Selector for a Model in sagemaker to populate modelName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelNameSelector")]
    pub model_name_selector: Option<EndpointConfigurationInitProviderProductionVariantsModelNameSelector>,
    /// Sets how the endpoint routes incoming traffic. See routing_config below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingConfig")]
    pub routing_config: Option<Vec<EndpointConfigurationInitProviderProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationInitProviderProductionVariantsServerlessConfig>,
    /// The name of the variant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "variantName")]
    pub variant_name: Option<String>,
    /// The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between 1 and 512.
...
pub struct EndpointConfigurationInitProviderProductionVariantsModelNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EndpointConfigurationInitProviderProductionVariantsModelNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EndpointConfigurationInitProviderProductionVariantsModelNameRefPolicyResolve>,
}
...
pub struct EndpointConfigurationInitProviderProductionVariantsModelNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EndpointConfigurationInitProviderProductionVariantsModelNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EndpointConfigurationInitProviderProductionVariantsModelNameSelectorPolicyResolve>,
}
...
pub struct EndpointConfigurationInitProviderShadowProductionVariants {
    ...
    /// Specifies configuration for a core dump from the model container when the process crashes. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreDumpConfig")]
    pub core_dump_config: Option<EndpointConfigurationInitProviderShadowProductionVariantsCoreDumpConfig>,
    /// You can use this parameter to turn on native Amazon Web Services Systems Manager (SSM) access for a production variant behind an endpoint. By default, SSM access is disabled for all production variants behind an endpoints.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableSsmAccess")]
    pub enable_ssm_access: Option<bool>,
    /// Specifies an option from a collection of preconfigured Amazon Machine Image (AMI) images. Each image is configured by Amazon Web Services with a set of software and driver versions. Amazon Web Services optimizes these configurations for different machine learning workloads.
    ...
    /// Settings that control the range in the number of instances that the endpoint provisions as it scales up or down to accommodate traffic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedInstanceScaling")]
    pub managed_instance_scaling: Option<EndpointConfigurationInitProviderShadowProductionVariantsManagedInstanceScaling>,
    /// The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between 60 and 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelDataDownloadTimeoutInSeconds")]
    pub model_data_download_timeout_in_seconds: Option<f64>,
    /// The name of the model to use.
    ...
    /// Sets how the endpoint routes incoming traffic. See routing_config below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingConfig")]
    pub routing_config: Option<Vec<EndpointConfigurationInitProviderShadowProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationInitProviderShadowProductionVariantsServerlessConfig>,
    /// The name of the variant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "variantName")]
    pub variant_name: Option<String>,
    /// The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between 1 and 512.
...
pub struct EndpointConfigurationPublishConnectionDetailsToConfigRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EndpointConfigurationPublishConnectionDetailsToConfigRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EndpointConfigurationStatusAtProvider {
    ...
    /// Array of ProductionVariant objects. There is one for each model that you want to host at this endpoint in shadow mode with production traffic replicated from the model specified on ProductionVariants. If you use this field, you can only specify one variant for ProductionVariants and one variant for ShadowProductionVariants. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "shadowProductionVariants")]
    pub shadow_production_variants: Option<Vec<EndpointConfigurationStatusAtProviderShadowProductionVariants>>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
...
pub struct EndpointConfigurationStatusAtProviderAsyncInferenceConfig {
    /// Configures the behavior of the client used by Amazon SageMaker to interact with the model container during asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clientConfig")]
    pub client_config: Option<EndpointConfigurationStatusAtProviderAsyncInferenceConfigClientConfig>,
    /// Specifies the configuration for asynchronous inference invocation outputs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputConfig")]
    pub output_config: Option<EndpointConfigurationStatusAtProviderAsyncInferenceConfigOutputConfig>,
}
...
pub struct EndpointConfigurationStatusAtProviderAsyncInferenceConfigOutputConfig {
    ...
    /// Specifies the configuration for notifications of inference results for asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "notificationConfig")]
    pub notification_config: Option<EndpointConfigurationStatusAtProviderAsyncInferenceConfigOutputConfigNotificationConfig>,
    /// The Amazon S3 location to upload failure inference responses to.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3FailurePath")]
    pub s3_failure_path: Option<String>,
    /// The Amazon S3 location to upload inference responses to.
...
pub struct EndpointConfigurationStatusAtProviderDataCaptureConfig {
    /// The content type headers to capture. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureContentTypeHeader")]
    pub capture_content_type_header: Option<EndpointConfigurationStatusAtProviderDataCaptureConfigCaptureContentTypeHeader>,
    /// Specifies what data to capture. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureOptions")]
    pub capture_options: Option<Vec<EndpointConfigurationStatusAtProviderDataCaptureConfigCaptureOptions>>,
    /// The URL for S3 location where the captured data is stored.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationS3Uri")]
    pub destination_s3_uri: Option<String>,
    /// Flag to enable data capture. Defaults to false.
...
pub struct EndpointConfigurationStatusAtProviderProductionVariants {
    ...
    /// Specifies configuration for a core dump from the model container when the process crashes. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreDumpConfig")]
    pub core_dump_config: Option<EndpointConfigurationStatusAtProviderProductionVariantsCoreDumpConfig>,
    /// You can use this parameter to turn on native Amazon Web Services Systems Manager (SSM) access for a production variant behind an endpoint. By default, SSM access is disabled for all production variants behind an endpoints.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableSsmAccess")]
    pub enable_ssm_access: Option<bool>,
    /// Specifies an option from a collection of preconfigured Amazon Machine Image (AMI) images. Each image is configured by Amazon Web Services with a set of software and driver versions. Amazon Web Services optimizes these configurations for different machine learning workloads.
    ...
    /// Settings that control the range in the number of instances that the endpoint provisions as it scales up or down to accommodate traffic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedInstanceScaling")]
    pub managed_instance_scaling: Option<EndpointConfigurationStatusAtProviderProductionVariantsManagedInstanceScaling>,
    /// The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between 60 and 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelDataDownloadTimeoutInSeconds")]
    pub model_data_download_timeout_in_seconds: Option<f64>,
    /// The name of the model to use.
    ...
    /// Sets how the endpoint routes incoming traffic. See routing_config below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingConfig")]
    pub routing_config: Option<Vec<EndpointConfigurationStatusAtProviderProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationStatusAtProviderProductionVariantsServerlessConfig>,
    /// The name of the variant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "variantName")]
    pub variant_name: Option<String>,
    /// The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between 1 and 512.
...
pub struct EndpointConfigurationStatusAtProviderShadowProductionVariants {
    ...
    /// Specifies configuration for a core dump from the model container when the process crashes. Fields are documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "coreDumpConfig")]
    pub core_dump_config: Option<EndpointConfigurationStatusAtProviderShadowProductionVariantsCoreDumpConfig>,
    /// You can use this parameter to turn on native Amazon Web Services Systems Manager (SSM) access for a production variant behind an endpoint. By default, SSM access is disabled for all production variants behind an endpoints.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableSsmAccess")]
    pub enable_ssm_access: Option<bool>,
    /// Specifies an option from a collection of preconfigured Amazon Machine Image (AMI) images. Each image is configured by Amazon Web Services with a set of software and driver versions. Amazon Web Services optimizes these configurations for different machine learning workloads.
    ...
    /// Settings that control the range in the number of instances that the endpoint provisions as it scales up or down to accommodate traffic.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedInstanceScaling")]
    pub managed_instance_scaling: Option<EndpointConfigurationStatusAtProviderShadowProductionVariantsManagedInstanceScaling>,
    /// The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between 60 and 3600.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "modelDataDownloadTimeoutInSeconds")]
    pub model_data_download_timeout_in_seconds: Option<f64>,
    /// The name of the model to use.
    ...
    /// Sets how the endpoint routes incoming traffic. See routing_config below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "routingConfig")]
    pub routing_config: Option<Vec<EndpointConfigurationStatusAtProviderShadowProductionVariantsRoutingConfig>>,
    /// Specifies configuration for how an endpoint performs asynchronous inference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverlessConfig")]
    pub serverless_config: Option<EndpointConfigurationStatusAtProviderShadowProductionVariantsServerlessConfig>,
    /// The name of the variant.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "variantName")]
    pub variant_name: Option<String>,
    /// The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between 1 and 512.
