...
#[kube(group = "sagemaker.aws.upbound.io", version = "v1beta2", kind = "DeviceFleet", plural = "devicefleet")]
...
pub struct DeviceFleetForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableIotRoleAlias")]
...
pub struct DeviceFleetForProviderOutputConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3OutputLocation")]
...
pub struct DeviceFleetStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "iotRoleAlias")]
