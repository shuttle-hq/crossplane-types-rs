...
#[kube(group = "mq.aws.upbound.io", version = "v1alpha1", kind = "User", plural = "users")]
...
pub struct UserForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "brokerIdRef")]
    pub broker_id_ref: Option<UserForProviderBrokerIdRef>,
    /// Selector for a Broker in mq to populate brokerId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "brokerIdSelector")]
