...
#[kube(group = "lexmodels.aws.upbound.io", version = "v1beta2", kind = "BotAlias", plural = "botaliases")]
...
pub struct BotAliasForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "botVersion")]
    pub bot_version: Option<String>,
    /// The settings that determine how Amazon Lex uses conversation logs for the alias. Attributes are documented under conversation_logs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "conversationLogs")]
...
pub struct BotAliasForProviderConversationLogs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logSettings")]
...
pub struct BotAliasStatusAtProviderConversationLogsLogSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourcePrefix")]
