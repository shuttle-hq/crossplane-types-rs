...
#[kube(group = "lexmodels.aws.upbound.io", version = "v1beta2", kind = "Bot", plural = "bots")]
...
pub struct BotForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "abortStatement")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "childDirected")]
    pub child_directed: Option<bool>,
    /// The message that Amazon Lex uses when it doesn't understand the user's request. Attributes are documented under prompt.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "clarificationPrompt")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "detectSentiment")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableModelImprovements")]
    pub enable_model_improvements: Option<bool>,
    /// The maximum time in seconds that Amazon Lex retains the data gathered in a conversation. Default is 300. Must be a number between 60 and 86400 (inclusive).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "idleSessionTtlInSeconds")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nluIntentConfidenceThreshold")]
    pub nlu_intent_confidence_threshold: Option<f64>,
    /// If you set the process_behavior element to BUILD, Amazon Lex builds the bot so that it can be run. If you set the element to SAVE Amazon Lex saves the bot, but doesn't build it. Default is SAVE.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "processBehavior")]
...
pub struct BotForProviderIntent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "intentName")]
    pub intent_name: Option<String>,
    /// The version of the intent. Must be less than or equal to 64 characters in length.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "intentVersion")]
