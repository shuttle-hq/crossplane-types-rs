...
#[kube(group = "lightsail.aws.upbound.io", version = "v1beta2", kind = "ContainerService", plural = "containerservices")]
...
pub struct ContainerServiceForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "isDisabled")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateRegistryAccess")]
    ...
    /// Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicDomainNames")]
...
pub struct ContainerServiceForProviderPrivateRegistryAccess {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ecrImagePullerRole")]
    pub ecr_image_puller_role: Option<ContainerServiceForProviderPrivateRegistryAccessEcrImagePullerRole>,
}
...
pub struct ContainerServiceInitProviderPrivateRegistryAccess {
    /// Describes a request to configure an Amazon Lightsail container service to access private container image repositories, such as Amazon Elastic Container Registry (Amazon ECR) private repositories. See ECR Image Puller Role below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ecrImagePullerRole")]
    pub ecr_image_puller_role: Option<ContainerServiceInitProviderPrivateRegistryAccessEcrImagePullerRole>,
}
...
pub struct ContainerServiceStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "privateDomainName")]
...
pub struct ContainerServiceStatusAtProviderPrivateRegistryAccess {
    /// Describes a request to configure an Amazon Lightsail container service to access private container image repositories, such as Amazon Elastic Container Registry (Amazon ECR) private repositories. See ECR Image Puller Role below for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ecrImagePullerRole")]
    pub ecr_image_puller_role: Option<ContainerServiceStatusAtProviderPrivateRegistryAccessEcrImagePullerRole>,
}
