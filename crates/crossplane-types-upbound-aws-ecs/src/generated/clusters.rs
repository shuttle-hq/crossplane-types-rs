...
#[kube(group = "ecs.aws.upbound.io", version = "v1beta2", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceConnectDefaults")]
...
pub struct ClusterForProviderConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executeCommandConfiguration")]
    pub execute_command_configuration: Option<ClusterForProviderConfigurationExecuteCommandConfiguration>,
    /// Details of the managed storage configuration. See managed_storage_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedStorageConfiguration")]
    pub managed_storage_configuration: Option<ClusterForProviderConfigurationManagedStorageConfiguration>,
}
...
pub struct ClusterForProviderConfigurationExecuteCommandConfiguration {
    ...
    pub log_configuration: Option<ClusterForProviderConfigurationExecuteCommandConfigurationLogConfiguration>,
...
pub struct ClusterForProviderConfigurationExecuteCommandConfigurationLogConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudWatchEncryptionEnabled")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "s3BucketEncryptionEnabled")]
...
pub struct ClusterForProviderConfigurationManagedStorageConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fargateEphemeralStorageKmsKeyId")]
...
pub struct ClusterInitProviderConfiguration {
    /// Details of the execute command configuration. See execute_command_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executeCommandConfiguration")]
    pub execute_command_configuration: Option<ClusterInitProviderConfigurationExecuteCommandConfiguration>,
    /// Details of the managed storage configuration. See managed_storage_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedStorageConfiguration")]
    pub managed_storage_configuration: Option<ClusterInitProviderConfigurationManagedStorageConfiguration>,
}
...
pub struct ClusterInitProviderConfigurationExecuteCommandConfiguration {
    ...
    /// Log configuration for the results of the execute command actions. Required when logging is OVERRIDE. See log_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logConfiguration")]
    pub log_configuration: Option<ClusterInitProviderConfigurationExecuteCommandConfigurationLogConfiguration>,
    /// Log setting to use for redirecting logs for your execute command results. Valid values: NONE, DEFAULT, OVERRIDE.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub logging: Option<String>,
}
...
pub struct ClusterStatusAtProviderConfiguration {
    /// Details of the execute command configuration. See execute_command_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "executeCommandConfiguration")]
    pub execute_command_configuration: Option<ClusterStatusAtProviderConfigurationExecuteCommandConfiguration>,
    /// Details of the managed storage configuration. See managed_storage_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "managedStorageConfiguration")]
    pub managed_storage_configuration: Option<ClusterStatusAtProviderConfigurationManagedStorageConfiguration>,
}
...
pub struct ClusterStatusAtProviderConfigurationExecuteCommandConfiguration {
    ...
    /// Log configuration for the results of the execute command actions. Required when logging is OVERRIDE. See log_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logConfiguration")]
    pub log_configuration: Option<ClusterStatusAtProviderConfigurationExecuteCommandConfigurationLogConfiguration>,
    /// Log setting to use for redirecting logs for your execute command results. Valid values: NONE, DEFAULT, OVERRIDE.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub logging: Option<String>,
}
