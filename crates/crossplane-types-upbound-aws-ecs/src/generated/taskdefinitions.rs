...
#[kube(group = "ecs.aws.upbound.io", version = "v1beta2", kind = "TaskDefinition", plural = "taskdefinitions")]
...
pub struct TaskDefinitionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containerDefinitions")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inferenceAccelerator")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "requiresCompatibilities")]
    pub requires_compatibilities: Option<Vec<String>>,
    /// Configuration block for runtime_platform that containers in your task may use.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimePlatform")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trackLatest")]
...
pub struct TaskDefinitionForProviderRuntimePlatform {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuArchitecture")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "operatingSystemFamily")]
...
pub struct TaskDefinitionForProviderVolume {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configureAtLaunch")]
    pub configure_at_launch: Option<bool>,
    /// Configuration block to configure a docker volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dockerVolumeConfiguration")]
    pub docker_volume_configuration: Option<TaskDefinitionForProviderVolumeDockerVolumeConfiguration>,
    /// Configuration block for an EFS volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsVolumeConfiguration")]
    pub efs_volume_configuration: Option<TaskDefinitionForProviderVolumeEfsVolumeConfiguration>,
    /// Configuration block for an FSX Windows File Server volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fsxWindowsFileServerVolumeConfiguration")]
    pub fsx_windows_file_server_volume_configuration: Option<TaskDefinitionForProviderVolumeFsxWindowsFileServerVolumeConfiguration>,
...
pub struct TaskDefinitionForProviderVolumeDockerVolumeConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "driverOpts")]
...
pub struct TaskDefinitionForProviderVolumeEfsVolumeConfiguration {
    ...
    pub authorization_config: Option<TaskDefinitionForProviderVolumeEfsVolumeConfigurationAuthorizationConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitEncryption")]
    pub transit_encryption: Option<String>,
    /// Port to use for transit encryption. If you do not specify a transit encryption port, it will use the port selection strategy that the Amazon EFS mount helper uses.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "transitEncryptionPort")]
...
pub struct TaskDefinitionForProviderVolumeFsxWindowsFileServerVolumeConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizationConfig")]
    pub authorization_config: Option<TaskDefinitionForProviderVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfig>,
...
pub struct TaskDefinitionForProviderVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "credentialsParameter")]
...
pub struct TaskDefinitionInitProviderVolume {
    ...
    /// Configuration block to configure a docker volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dockerVolumeConfiguration")]
    pub docker_volume_configuration: Option<TaskDefinitionInitProviderVolumeDockerVolumeConfiguration>,
    /// Configuration block for an EFS volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsVolumeConfiguration")]
    pub efs_volume_configuration: Option<TaskDefinitionInitProviderVolumeEfsVolumeConfiguration>,
    /// Configuration block for an FSX Windows File Server volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fsxWindowsFileServerVolumeConfiguration")]
    pub fsx_windows_file_server_volume_configuration: Option<TaskDefinitionInitProviderVolumeFsxWindowsFileServerVolumeConfiguration>,
    /// Path on the host container instance that is presented to the container. If not set, ECS will create a nonpersistent data volume that starts empty and is deleted after the task has finished.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostPath")]
    pub host_path: Option<String>,
    /// Name of the volume. This name is referenced in the sourceVolume
...
pub struct TaskDefinitionInitProviderVolumeEfsVolumeConfiguration {
    /// Configuration block for authorization for the Amazon EFS file system. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizationConfig")]
    pub authorization_config: Option<TaskDefinitionInitProviderVolumeEfsVolumeConfigurationAuthorizationConfig>,
    /// ID of the EFS File System.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileSystemId")]
    pub file_system_id: Option<String>,
    /// Directory within the Amazon EFS file system to mount as the root directory inside the host. If this parameter is omitted, the root of the Amazon EFS volume will be used. Specifying / will have the same effect as omitting this parameter. This argument is ignored when using authorization_config.
...
pub struct TaskDefinitionInitProviderVolumeFsxWindowsFileServerVolumeConfiguration {
    /// Configuration block for authorization for the Amazon FSx for Windows File Server file system detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizationConfig")]
    pub authorization_config: Option<TaskDefinitionInitProviderVolumeFsxWindowsFileServerVolumeConfigurationAuthorizationConfig>,
    /// The Amazon FSx for Windows File Server file system ID to use.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileSystemId")]
    pub file_system_id: Option<String>,
    /// The directory within the Amazon FSx for Windows File Server file system to mount as the root directory inside the host.
...
pub struct TaskDefinitionStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "arnWithoutRevision")]
...
pub struct TaskDefinitionStatusAtProviderVolume {
    ...
    /// Configuration block to configure a docker volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dockerVolumeConfiguration")]
    pub docker_volume_configuration: Option<TaskDefinitionStatusAtProviderVolumeDockerVolumeConfiguration>,
    /// Configuration block for an EFS volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "efsVolumeConfiguration")]
    pub efs_volume_configuration: Option<TaskDefinitionStatusAtProviderVolumeEfsVolumeConfiguration>,
    /// Configuration block for an FSX Windows File Server volume. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fsxWindowsFileServerVolumeConfiguration")]
    pub fsx_windows_file_server_volume_configuration: Option<TaskDefinitionStatusAtProviderVolumeFsxWindowsFileServerVolumeConfiguration>,
    /// Path on the host container instance that is presented to the container. If not set, ECS will create a nonpersistent data volume that starts empty and is deleted after the task has finished.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostPath")]
    pub host_path: Option<String>,
    /// Name of the volume. This name is referenced in the sourceVolume
...
pub struct TaskDefinitionStatusAtProviderVolumeEfsVolumeConfiguration {
    /// Configuration block for authorization for the Amazon EFS file system. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizationConfig")]
    pub authorization_config: Option<TaskDefinitionStatusAtProviderVolumeEfsVolumeConfigurationAuthorizationConfig>,
    /// ID of the EFS File System.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fileSystemId")]
    pub file_system_id: Option<String>,
    /// Directory within the Amazon EFS file system to mount as the root directory inside the host. If this parameter is omitted, the root of the Amazon EFS volume will be used. Specifying / will have the same effect as omitting this parameter. This argument is ignored when using authorization_config.
