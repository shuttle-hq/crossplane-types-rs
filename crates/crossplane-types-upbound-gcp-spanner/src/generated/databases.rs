...
#[kube(group = "spanner.gcp.upbound.io", version = "v1beta2", kind = "Database", plural = "databases")]
...
pub struct DatabaseForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "databaseDialect")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableDropProtection")]
    ...
    pub encryption_config: Option<DatabaseForProviderEncryptionConfig>,
    ...
    pub instance_ref: Option<DatabaseForProviderInstanceRef>,
    ...
    pub instance_selector: Option<DatabaseForProviderInstanceSelector>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "versionRetentionPeriod")]
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseForProviderEncryptionConfig {
...
/// Reference to a Instance in spanner to populate instance.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseForProviderInstanceRef {
    /// Name of the referenced object.
    pub name: String,
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DatabaseForProviderInstanceRefPolicy>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseForProviderInstanceRefPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DatabaseForProviderInstanceRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DatabaseForProviderInstanceRefPolicyResolve>,
}

/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DatabaseForProviderInstanceRefPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for referencing.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DatabaseForProviderInstanceRefPolicyResolve {
    Always,
    IfNotPresent,
}
...
/// Selector for a Instance in spanner to populate instance.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseForProviderInstanceSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DatabaseForProviderInstanceSelectorPolicy>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseForProviderInstanceSelectorPolicy {
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is 'Required', which means the reconcile will fail if the
    /// reference cannot be resolved. 'Optional' means this reference will be
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DatabaseForProviderInstanceSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DatabaseForProviderInstanceSelectorPolicyResolve>,
}

/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DatabaseForProviderInstanceSelectorPolicyResolution {
    Required,
    Optional,
}
...
/// Policies for selection.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DatabaseForProviderInstanceSelectorPolicyResolve {
    Always,
    IfNotPresent,
}
...
pub struct DatabaseInitProvider {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<DatabaseInitProviderEncryptionConfig>,
    /// The ID of the project in which the resource belongs.
    /// If it is not provided, the provider project is used.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub project: Option<String>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseInitProviderEncryptionConfig {
    /// Fully qualified name of the KMS key to use to encrypt this database. This key must exist
    /// in the same location as the Spanner Database.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyName")]
    pub kms_key_name: Option<String>,
...
pub struct DatabaseStatusAtProvider {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encryptionConfig")]
    pub encryption_config: Option<DatabaseStatusAtProviderEncryptionConfig>,
...
/// Structure is documented below.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct DatabaseStatusAtProviderEncryptionConfig {
    /// Fully qualified name of the KMS key to use to encrypt this database. This key must exist
    /// in the same location as the Spanner Database.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kmsKeyName")]
    pub kms_key_name: Option<String>,
