...
#[kube(group = "lakeformation.aws.upbound.io", version = "v1beta1", kind = "DataLakeSettings", plural = "datalakesettings")]
...
pub struct DataLakeSettingsForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminsRefs")]
    pub admins_refs: Option<Vec<DataLakeSettingsForProviderAdminsRefs>>,
    /// Selector for a list of User in iam to populate admins.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "adminsSelector")]
    pub admins_selector: Option<DataLakeSettingsForProviderAdminsSelector>,
    /// Whether to allow Amazon EMR clusters to access data managed by Lake Formation.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowExternalDataFiltering")]
    pub allow_external_data_filtering: Option<bool>,
    /// Whether to allow a third-party query engine to get data access credentials without session tags when a caller has full data access permissions.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowFullTableExternalDataAccess")]
    pub allow_full_table_external_data_access: Option<bool>,
    /// Lake Formation relies on a privileged process secured by Amazon EMR or the third party integrator to tag the user's role while assuming it.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authorizedSessionTagValueList")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createDatabaseDefaultPermissions")]
    pub create_database_default_permissions: Option<Vec<DataLakeSettingsForProviderCreateDatabaseDefaultPermissions>>,
    /// Up to three configuration blocks of principal permissions for default create table permissions. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createTableDefaultPermissions")]
    pub create_table_default_permissions: Option<Vec<DataLakeSettingsForProviderCreateTableDefaultPermissions>>,
    /// A list of the account IDs of Amazon Web Services accounts with Amazon EMR clusters that are to perform data filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalDataFilteringAllowList")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "readOnlyAdmins")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "trustedResourceOwners")]
...
pub struct DataLakeSettingsInitProvider {
    ...
    /// Up to three configuration blocks of principal permissions for default create database permissions. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createDatabaseDefaultPermissions")]
    pub create_database_default_permissions: Option<Vec<DataLakeSettingsInitProviderCreateDatabaseDefaultPermissions>>,
    /// Up to three configuration blocks of principal permissions for default create table permissions. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createTableDefaultPermissions")]
    pub create_table_default_permissions: Option<Vec<DataLakeSettingsInitProviderCreateTableDefaultPermissions>>,
    /// A list of the account IDs of Amazon Web Services accounts with Amazon EMR clusters that are to perform data filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalDataFilteringAllowList")]
    pub external_data_filtering_allow_list: Option<Vec<String>>,
    /// Key-value map of additional configuration. Valid values for the CROSS_ACCOUNT_VERSION key are "1", "2", "3", or "4". SET_CONTEXT is also returned with a value of TRUE. In a fresh account, prior to configuring, CROSS_ACCOUNT_VERSION is "1". Destroying this resource sets the CROSS_ACCOUNT_VERSION to "1".
...
pub struct DataLakeSettingsStatusAtProvider {
    ...
    /// Up to three configuration blocks of principal permissions for default create database permissions. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createDatabaseDefaultPermissions")]
    pub create_database_default_permissions: Option<Vec<DataLakeSettingsStatusAtProviderCreateDatabaseDefaultPermissions>>,
    /// Up to three configuration blocks of principal permissions for default create table permissions. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createTableDefaultPermissions")]
    pub create_table_default_permissions: Option<Vec<DataLakeSettingsStatusAtProviderCreateTableDefaultPermissions>>,
    /// A list of the account IDs of Amazon Web Services accounts with Amazon EMR clusters that are to perform data filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "externalDataFilteringAllowList")]
    pub external_data_filtering_allow_list: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
