...
#[kube(group = "lakeformation.aws.upbound.io", version = "v1beta2", kind = "Permissions", plural = "permissions")]
...
pub struct PermissionsForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "catalogResource")]
    pub catalog_resource: Option<bool>,
    /// Configuration block for a data cells filter resource. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataCellsFilter")]
    pub data_cells_filter: Option<PermissionsForProviderDataCellsFilter>,
    /// Configuration block for a data location resource. Detailed below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dataLocation")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lfTagPolicy")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "permissionsWithGrantOption")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tableWithColumns")]
...
pub struct PermissionsForProviderDataCellsFilter {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tableCatalogId")]
...
pub struct PermissionsForProviderTableWithColumns {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "columnNames")]
    pub column_names: Option<Vec<String>>,
    /// –  Name of the database for the table with columns resource. Unique to the Data Catalog.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "databaseName")]
    pub database_name: Option<String>,
    /// Set of column names for the table to exclude.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "excludedColumnNames")]
