...
#[kube(group = "kinesis.aws.upbound.io", version = "v1beta2", kind = "Stream", plural = "streams")]
...
pub struct StreamForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enforceConsumerDeletion")]
