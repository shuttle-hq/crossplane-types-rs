...
#[kube(group = "kafkaconnect.aws.upbound.io", version = "v1beta2", kind = "Connector", plural = "connectors")]
...
pub struct ConnectorForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectorConfiguration")]
    pub connector_configuration: Option<HashMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterClientAuthentication")]
    pub kafka_cluster_client_authentication: Option<ConnectorForProviderKafkaClusterClientAuthentication>,
    /// Details of encryption in transit to the Apache Kafka cluster. See kafka_cluster_encryption_in_transit Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterEncryptionInTransit")]
    pub kafka_cluster_encryption_in_transit: Option<ConnectorForProviderKafkaClusterEncryptionInTransit>,
    /// The version of Kafka Connect. It has to be compatible with both the Apache Kafka cluster's version and the plugins.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaconnectVersion")]
    pub kafkaconnect_version: Option<String>,
    /// Details about log delivery. See log_delivery Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logDelivery")]
    ...
    pub service_execution_role_arn_selector: Option<ConnectorForProviderServiceExecutionRoleArnSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
    /// Specifies which worker configuration to use with the connector. See worker_configuration Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workerConfiguration")]
...
pub struct ConnectorForProviderCapacity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "provisionedCapacity")]
...
pub struct ConnectorForProviderCapacityAutoscaling {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxWorkerCount")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "minWorkerCount")]
    pub min_worker_count: Option<f64>,
    /// The scale-in policy for the connector. See scale_in_policy Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleInPolicy")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleOutPolicy")]
...
pub struct ConnectorForProviderCapacityAutoscalingScaleInPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cpuUtilizationPercentage")]
...
pub struct ConnectorForProviderCapacityProvisionedCapacity {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workerCount")]
...
pub struct ConnectorForProviderKafkaCluster {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "apacheKafkaCluster")]
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpc {
    ...
    pub security_group_refs: Option<Vec<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroups.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupSelector")]
    pub security_group_selector: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelector>,
    ...
    pub subnet_selector: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetSelector>,
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicy>,
}
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicyResolve>,
}
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicy>,
}
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicyResolve>,
}
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicyResolve>,
}
...
pub struct ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicyResolve>,
}
...
pub struct ConnectorForProviderLogDelivery {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "workerLogDelivery")]
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogs {
    ...
    pub log_group_ref: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRef>,
    ...
    pub log_group_selector: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelector>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicy>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicyResolve>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelectorPolicy>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehose {
    ...
    pub delivery_stream_ref: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRef>,
    ...
    pub delivery_stream_selector: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelector>,
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicy>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicyResolve>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelectorPolicy>,
}
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryS3BucketRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryS3BucketRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectorForProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorForProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicyResolve>,
}
...
pub struct ConnectorInitProvider {
    ...
    /// Details of the client authentication used by the Apache Kafka cluster. See kafka_cluster_client_authentication Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterClientAuthentication")]
    pub kafka_cluster_client_authentication: Option<ConnectorInitProviderKafkaClusterClientAuthentication>,
    /// Details of encryption in transit to the Apache Kafka cluster. See kafka_cluster_encryption_in_transit Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterEncryptionInTransit")]
    pub kafka_cluster_encryption_in_transit: Option<ConnectorInitProviderKafkaClusterEncryptionInTransit>,
    /// The version of Kafka Connect. It has to be compatible with both the Apache Kafka cluster's version and the plugins.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaconnectVersion")]
    pub kafkaconnect_version: Option<String>,
    /// Details about log delivery. See log_delivery Block for details.
    ...
    /// Selector for a Role in iam to populate serviceExecutionRoleArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceExecutionRoleArnSelector")]
    pub service_execution_role_arn_selector: Option<ConnectorInitProviderServiceExecutionRoleArnSelector>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
    /// Specifies which worker configuration to use with the connector. See worker_configuration Block for details.
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpc {
    /// References to SecurityGroup in ec2 to populate securityGroups.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupRefs")]
    pub security_group_refs: Option<Vec<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefs>>,
    /// Selector for a list of SecurityGroup in ec2 to populate securityGroups.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroupSelector")]
    pub security_group_selector: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelector>,
    /// The security groups for the connector.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "securityGroups")]
    pub security_groups: Option<Vec<String>>,
    /// References to Subnet in ec2 to populate subnets.
    ...
    /// Selector for a list of Subnet in ec2 to populate subnets.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "subnetSelector")]
    pub subnet_selector: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetSelector>,
    /// The subnets for the connector.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub subnets: Option<Vec<String>>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefs {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicy>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupRefsPolicyResolve>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicy>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSecurityGroupSelectorPolicyResolve>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetRefsPolicyResolve>,
}
...
pub struct ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderKafkaClusterApacheKafkaClusterVpcSubnetSelectorPolicyResolve>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogs {
    ...
    /// Reference to a Group in cloudwatchlogs to populate logGroup.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logGroupRef")]
    pub log_group_ref: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRef>,
    /// Selector for a Group in cloudwatchlogs to populate logGroup.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "logGroupSelector")]
    pub log_group_selector: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelector>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicy>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupRefPolicyResolve>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryCloudwatchLogsLogGroupSelectorPolicy>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehose {
    ...
    /// Reference to a DeliveryStream in firehose to populate deliveryStream.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliveryStreamRef")]
    pub delivery_stream_ref: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRef>,
    /// Selector for a DeliveryStream in firehose to populate deliveryStream.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deliveryStreamSelector")]
    pub delivery_stream_selector: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelector>,
    /// Specifies whether connector logs get sent to the specified Amazon S3 destination.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicy>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamRefPolicyResolve>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryFirehoseDeliveryStreamSelectorPolicy>,
}
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryS3BucketRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryS3BucketRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct ConnectorInitProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<ConnectorInitProviderLogDeliveryWorkerLogDeliveryS3BucketSelectorPolicyResolve>,
}
...
pub struct ConnectorStatusAtProvider {
    ...
    /// Details of the client authentication used by the Apache Kafka cluster. See kafka_cluster_client_authentication Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterClientAuthentication")]
    pub kafka_cluster_client_authentication: Option<ConnectorStatusAtProviderKafkaClusterClientAuthentication>,
    /// Details of encryption in transit to the Apache Kafka cluster. See kafka_cluster_encryption_in_transit Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaClusterEncryptionInTransit")]
    pub kafka_cluster_encryption_in_transit: Option<ConnectorStatusAtProviderKafkaClusterEncryptionInTransit>,
    /// The version of Kafka Connect. It has to be compatible with both the Apache Kafka cluster's version and the plugins.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kafkaconnectVersion")]
    pub kafkaconnect_version: Option<String>,
    /// Details about log delivery. See log_delivery Block for details.
...
pub struct ConnectorStatusAtProviderLogDeliveryWorkerLogDelivery {
    /// Details about delivering logs to Amazon CloudWatch Logs. See cloudwatch_logs Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cloudwatchLogs")]
    pub cloudwatch_logs: Option<ConnectorStatusAtProviderLogDeliveryWorkerLogDeliveryCloudwatchLogs>,
    /// Details about delivering logs to Amazon Kinesis Data Firehose. See firehose Block for details.
    #[serde(default, skip_serializing_if = "Option::is_none")]
