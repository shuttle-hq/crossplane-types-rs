...
#[kube(group = "pinpoint.aws.upbound.io", version = "v1beta2", kind = "App", plural = "apps")]
...
pub struct AppForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "campaignHook")]
...
pub struct AppForProviderLimits {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maximumDuration")]
    pub maximum_duration: Option<f64>,
    /// The number of messages that the campaign can send per second. The minimum value is 50, and the maximum is 20000.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "messagesPerSecond")]
