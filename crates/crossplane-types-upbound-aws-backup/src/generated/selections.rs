...
#[kube(group = "backup.aws.upbound.io", version = "v1beta1", kind = "Selection", plural = "selections")]
...
pub struct SelectionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "notResources")]
    pub not_resources: Option<Vec<String>>,
    /// References to Instance in rds to populate notResources.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "notResourcesRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "notResourcesSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "planIdSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourcesRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourcesSelector")]
    pub resources_selector: Option<SelectionForProviderResourcesSelector>,
    /// Tag-based conditions used to specify a set of resources to assign to a backup plan.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectionTag")]
    pub selection_tag: Option<Vec<SelectionForProviderSelectionTag>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct SelectionForProviderCondition {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stringEquals")]
    pub string_equals: Option<Vec<SelectionForProviderConditionStringEquals>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stringLike")]
    pub string_like: Option<Vec<SelectionForProviderConditionStringLike>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stringNotEquals")]
    pub string_not_equals: Option<Vec<SelectionForProviderConditionStringNotEquals>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stringNotLike")]
