...
#[kube(group = "backup.aws.upbound.io", version = "v1beta2", kind = "Framework", plural = "frameworks")]
...
pub struct FrameworkForProviderControlScope {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "complianceResourceIds")]
