...
#[kube(group = "dataproc.gcp.upbound.io", version = "v1beta2", kind = "AutoscalingPolicy", plural = "autoscalingpolicies")]
...
pub struct AutoscalingPolicyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "basicAlgorithm")]
...
pub struct AutoscalingPolicyForProviderBasicAlgorithm {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "yarnConfig")]
...
pub struct AutoscalingPolicyForProviderBasicAlgorithmYarnConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleDownMinWorkerFraction")]
    ...
    /// Bounds: [0.0, 1.0]. Default: 0.0.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleUpMinWorkerFraction")]
