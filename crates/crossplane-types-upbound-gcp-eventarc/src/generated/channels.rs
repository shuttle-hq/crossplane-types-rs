...
#[kube(group = "eventarc.gcp.upbound.io", version = "v1beta1", kind = "Channel", plural = "channels")]
...
pub struct ChannelForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "thirdPartyProvider")]
    pub third_party_provider: Option<String>,
}
...
pub struct ChannelStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "activationToken")]
