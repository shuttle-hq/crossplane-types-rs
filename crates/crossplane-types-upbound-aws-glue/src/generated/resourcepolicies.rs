...
#[kube(group = "glue.aws.upbound.io", version = "v1beta1", kind = "ResourcePolicy", plural = "resourcepolicies")]
...
pub struct ResourcePolicyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableHybrid")]
