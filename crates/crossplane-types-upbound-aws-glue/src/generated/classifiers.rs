...
#[kube(group = "glue.aws.upbound.io", version = "v1beta2", kind = "Classifier", plural = "classifiers")]
...
pub struct ClassifierForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "csvClassifier")]
    pub csv_classifier: Option<ClassifierForProviderCsvClassifier>,
    /// –  A classifier that uses grok patterns. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "grokClassifier")]
    pub grok_classifier: Option<ClassifierForProviderGrokClassifier>,
    /// –  A classifier for JSON content. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "jsonClassifier")]
    pub json_classifier: Option<ClassifierForProviderJsonClassifier>,
    /// Region is the region you'd like your resource to be created in.
    pub region: String,
    /// –  A classifier for XML content. Defined below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "xmlClassifier")]
...
pub struct ClassifierForProviderCsvClassifier {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "allowSingleColumn")]
    pub allow_single_column: Option<bool>,
    /// Indicates whether the CSV file contains a header. This can be one of "ABSENT", "PRESENT", or "UNKNOWN".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "containsHeader")]
    pub contains_header: Option<String>,
    /// Enables the custom datatype to be configured.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customDatatypeConfigured")]
    pub custom_datatype_configured: Option<bool>,
    /// A list of supported custom datatypes. Valid values are BINARY, BOOLEAN, DATE, DECIMAL, DOUBLE, FLOAT, INT, LONG, SHORT, STRING, TIMESTAMP.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customDatatypes")]
    pub custom_datatypes: Option<Vec<String>>,
    /// The delimiter used in the CSV to separate columns.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub delimiter: Option<String>,
    /// Specifies whether to trim column values.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableValueTrimming")]
    pub disable_value_trimming: Option<bool>,
    /// A list of strings representing column names.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub header: Option<Vec<String>>,
    /// A custom symbol to denote what combines content into a single column value. It must be different from the column delimiter.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "quoteSymbol")]
...
pub struct ClassifierForProviderGrokClassifier {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customPatterns")]
