...
#[kube(group = "glue.aws.upbound.io", version = "v1beta1", kind = "Schema", plural = "schemas")]
...
pub struct SchemaForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "registryArnRef")]
    pub registry_arn_ref: Option<SchemaForProviderRegistryArnRef>,
    /// Selector for a Registry in glue to populate registryArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "registryArnSelector")]
...
pub struct SchemaStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "latestSchemaVersion")]
    pub latest_schema_version: Option<f64>,
    /// The next version of the schema associated with the returned schema definition.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nextSchemaVersion")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "schemaCheckpoint")]
