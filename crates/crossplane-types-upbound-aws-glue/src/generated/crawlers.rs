...
#[kube(group = "glue.aws.upbound.io", version = "v1beta2", kind = "Crawler", plural = "crawlers")]
...
pub struct CrawlerForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "catalogTarget")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "schemaChangePolicy")]
...
pub struct CrawlerForProviderCatalogTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "dlqEventQueueArn")]
    pub dlq_event_queue_arn: Option<String>,
    /// The ARN of the SQS queue to receive S3 notifications from.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eventQueueArn")]
    pub event_queue_arn: Option<String>,
    /// A list of catalog tables to be synchronized.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tables: Option<Vec<String>>,
    /// References to CatalogTable in glue to populate tables.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tablesRefs")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "tablesSelector")]
...
pub struct CrawlerForProviderDeltaTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "createNativeDeltaTable")]
    pub create_native_delta_table: Option<bool>,
    /// A list of the Amazon S3 paths to the Delta tables.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deltaTables")]
    pub delta_tables: Option<Vec<String>>,
    /// Specifies whether to write the manifest files to the Delta table path.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "writeManifest")]
...
pub struct CrawlerForProviderHudiTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maximumTraversalDepth")]
...
pub struct CrawlerForProviderJdbcTarget {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionNameRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionNameSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "enableAdditionalMetadata")]
...
pub struct CrawlerForProviderLakeFormationConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "useLakeFormationCredentials")]
...
pub struct CrawlerForProviderLineageConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "crawlerLineageSettings")]
...
pub struct CrawlerForProviderRecrawlPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "recrawlBehavior")]
...
pub struct CrawlerForProviderS3Target {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sampleSize")]
...
pub struct CrawlerForProviderSchemaChangePolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deleteBehavior")]
    pub delete_behavior: Option<String>,
    /// The update behavior when the crawler finds a changed schema. Valid values: LOG or UPDATE_IN_DATABASE. Defaults to UPDATE_IN_DATABASE.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "updateBehavior")]
