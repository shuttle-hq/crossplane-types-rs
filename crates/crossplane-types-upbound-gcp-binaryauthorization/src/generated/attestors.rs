...
#[kube(group = "binaryauthorization.gcp.upbound.io", version = "v1beta2", kind = "Attestor", plural = "attestors")]
...
pub struct AttestorForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "attestationAuthorityNote")]
...
pub struct AttestorForProviderAttestationAuthorityNote {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noteReference")]
    pub note_reference: Option<String>,
    /// Reference to a Note in containeranalysis to populate noteReference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noteReferenceRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noteReferenceSelector")]
    pub note_reference_selector: Option<AttestorForProviderAttestationAuthorityNoteNoteReferenceSelector>,
...
pub struct AttestorForProviderAttestationAuthorityNoteNoteReferenceRefPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<AttestorForProviderAttestationAuthorityNoteNoteReferenceRefPolicyResolution>,
...
pub struct AttestorForProviderAttestationAuthorityNoteNoteReferenceSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<AttestorForProviderAttestationAuthorityNoteNoteReferenceSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<AttestorForProviderAttestationAuthorityNoteNoteReferenceSelectorPolicyResolve>,
}
...
pub struct AttestorForProviderAttestationAuthorityNotePublicKeys {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "asciiArmoredPgpPublicKey")]
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pkixPublicKey")]
...
pub struct AttestorForProviderAttestationAuthorityNotePublicKeysPkixPublicKey {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicKeyPem")]
...
pub struct AttestorInitProviderAttestationAuthorityNote {
    ...
    /// Selector for a Note in containeranalysis to populate noteReference.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "noteReferenceSelector")]
    pub note_reference_selector: Option<AttestorInitProviderAttestationAuthorityNoteNoteReferenceSelector>,
    /// Public keys that verify attestations signed by this attestor. This
    /// field may be updated.
    /// If this field is non-empty, one of the specified public keys must
    /// verify that an attestation was signed by this attestor for the
...
pub struct AttestorInitProviderAttestationAuthorityNoteNoteReferenceRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<AttestorInitProviderAttestationAuthorityNoteNoteReferenceRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct AttestorInitProviderAttestationAuthorityNoteNoteReferenceSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<AttestorInitProviderAttestationAuthorityNoteNoteReferenceSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<AttestorInitProviderAttestationAuthorityNoteNoteReferenceSelectorPolicyResolve>,
}
...
pub struct AttestorInitProviderAttestationAuthorityNotePublicKeys {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pkixPublicKey")]
    pub pkix_public_key: Option<AttestorInitProviderAttestationAuthorityNotePublicKeysPkixPublicKey>,
}
...
pub struct AttestorStatusAtProviderAttestationAuthorityNote {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "delegationServiceAccountEmail")]
...
pub struct AttestorStatusAtProviderAttestationAuthorityNotePublicKeys {
    ...
    /// Structure is documented below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "pkixPublicKey")]
    pub pkix_public_key: Option<AttestorStatusAtProviderAttestationAuthorityNotePublicKeysPkixPublicKey>,
}
