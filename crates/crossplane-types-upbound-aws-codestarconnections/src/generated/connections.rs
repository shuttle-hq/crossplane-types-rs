...
#[kube(group = "codestarconnections.aws.upbound.io", version = "v1beta1", kind = "Connection", plural = "connections")]
...
pub struct ConnectionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hostArn")]
...
pub struct ConnectionStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "connectionStatus")]
