...
#[kube(group = "appautoscaling.aws.upbound.io", version = "v1beta2", kind = "Policy", plural = "policies")]
...
pub struct PolicyForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scalableDimensionRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scalableDimensionSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceNamespaceRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceNamespaceSelector")]
    ...
    pub target_tracking_scaling_policy_configuration: Option<PolicyForProviderTargetTrackingScalingPolicyConfiguration>,
}
...
pub struct PolicyForProviderTargetTrackingScalingPolicyConfiguration {
    ...
    pub customized_metric_specification: Option<PolicyForProviderTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification>,
    ...
    pub predefined_metric_specification: Option<PolicyForProviderTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification>,
...
pub struct PolicyInitProvider {
    ...
    /// Target tracking policy, requires policy_type = "TargetTrackingScaling". See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetTrackingScalingPolicyConfiguration")]
    pub target_tracking_scaling_policy_configuration: Option<PolicyInitProviderTargetTrackingScalingPolicyConfiguration>,
}
...
pub struct PolicyInitProviderStepScalingPolicyConfiguration {
    ...
    /// Set of adjustments that manage scaling. These have the following structure:
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stepAdjustment")]
    pub step_adjustment: Option<Vec<PolicyInitProviderStepScalingPolicyConfigurationStepAdjustment>>,
}
...
pub struct PolicyInitProviderTargetTrackingScalingPolicyConfiguration {
    /// Custom CloudWatch metric. Documentation can be found  at: AWS Customized Metric Specification. See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customizedMetricSpecification")]
    pub customized_metric_specification: Option<PolicyInitProviderTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification>,
    /// Whether scale in by the target tracking policy is disabled. If the value is true, scale in is disabled and the target tracking policy won't remove capacity from the scalable resource. Otherwise, scale in is enabled and the target tracking policy can remove capacity from the scalable resource. The default value is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableScaleIn")]
    pub disable_scale_in: Option<bool>,
    /// Predefined metric. See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "predefinedMetricSpecification")]
    pub predefined_metric_specification: Option<PolicyInitProviderTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification>,
    /// Amount of time, in seconds, after a scale in activity completes before another scale in activity can start.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleInCooldown")]
    pub scale_in_cooldown: Option<f64>,
    /// Amount of time, in seconds, after a scale out activity completes before another scale out activity can start.
...
pub struct PolicyStatusAtProvider {
    ...
    /// Step scaling policy configuration, requires policy_type = "StepScaling" (default). See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stepScalingPolicyConfiguration")]
    pub step_scaling_policy_configuration: Option<PolicyStatusAtProviderStepScalingPolicyConfiguration>,
    /// Target tracking policy, requires policy_type = "TargetTrackingScaling". See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetTrackingScalingPolicyConfiguration")]
    pub target_tracking_scaling_policy_configuration: Option<PolicyStatusAtProviderTargetTrackingScalingPolicyConfiguration>,
}
...
pub struct PolicyStatusAtProviderStepScalingPolicyConfiguration {
    ...
    /// Set of adjustments that manage scaling. These have the following structure:
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stepAdjustment")]
    pub step_adjustment: Option<Vec<PolicyStatusAtProviderStepScalingPolicyConfigurationStepAdjustment>>,
}
...
pub struct PolicyStatusAtProviderTargetTrackingScalingPolicyConfiguration {
    /// Custom CloudWatch metric. Documentation can be found  at: AWS Customized Metric Specification. See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "customizedMetricSpecification")]
    pub customized_metric_specification: Option<PolicyStatusAtProviderTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification>,
    /// Whether scale in by the target tracking policy is disabled. If the value is true, scale in is disabled and the target tracking policy won't remove capacity from the scalable resource. Otherwise, scale in is enabled and the target tracking policy can remove capacity from the scalable resource. The default value is false.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "disableScaleIn")]
    pub disable_scale_in: Option<bool>,
    /// Predefined metric. See supported fields below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "predefinedMetricSpecification")]
    pub predefined_metric_specification: Option<PolicyStatusAtProviderTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification>,
    /// Amount of time, in seconds, after a scale in activity completes before another scale in activity can start.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scaleInCooldown")]
    pub scale_in_cooldown: Option<f64>,
    /// Amount of time, in seconds, after a scale out activity completes before another scale out activity can start.
