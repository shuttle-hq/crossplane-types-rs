...
#[kube(group = "appautoscaling.aws.upbound.io", version = "v1beta2", kind = "ScheduledAction", plural = "scheduledactions")]
...
pub struct ScheduledActionForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scalableTargetAction")]
