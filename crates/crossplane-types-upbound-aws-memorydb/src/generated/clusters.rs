...
#[kube(group = "memorydb.aws.upbound.io", version = "v1beta1", kind = "Cluster", plural = "clusters")]
...
pub struct ClusterForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "finalSnapshotName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiRegionClusterName")]
