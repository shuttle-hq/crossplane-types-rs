...
#[kube(group = "gamelift.aws.upbound.io", version = "v1beta2", kind = "Fleet", plural = "fleet")]
...
pub struct FleetForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "buildIdRef")]
    pub build_id_ref: Option<FleetForProviderBuildIdRef>,
    /// Selector for a Build in gamelift to populate buildId.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "buildIdSelector")]
    pub build_id_selector: Option<FleetForProviderBuildIdSelector>,
    /// Prompts GameLift to generate a TLS/SSL certificate for the fleet. See certificate_configuration.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateConfiguration")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ec2InboundPermission")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceRoleArnRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "instanceRoleArnSelector")]
    pub instance_role_arn_selector: Option<FleetForProviderInstanceRoleArnSelector>,
    /// List of names of metric groups to add this fleet to. A metric group tracks metrics across all fleets in the group. Defaults to default.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metricGroups")]
    pub metric_groups: Option<Vec<String>>,
    /// The name of the fleet.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Game session protection policy to apply to all instances in this fleetE.g., FullProtection. Defaults to NoProtection.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "newGameSessionProtectionPolicy")]
    pub new_game_session_protection_policy: Option<String>,
    /// Region is the region you'd like your resource to be created in.
    pub region: String,
    /// Policy that limits the number of game sessions an individual player can create over a span of time for this fleet. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "resourceCreationLimitPolicy")]
    pub resource_creation_limit_policy: Option<FleetForProviderResourceCreationLimitPolicy>,
    /// Instructions for launching server processes on each instance in the fleet. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "runtimeConfiguration")]
...
pub struct FleetForProviderCertificateConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "certificateType")]
...
pub struct FleetForProviderResourceCreationLimitPolicy {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "newGameSessionsPerCreator")]
    pub new_game_sessions_per_creator: Option<f64>,
    /// Time span used in evaluating the resource creation limit policy.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "policyPeriodInMinutes")]
...
pub struct FleetForProviderRuntimeConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "gameSessionActivationTimeoutSeconds")]
    pub game_session_activation_timeout_seconds: Option<f64>,
    /// Maximum number of game sessions with status ACTIVATING to allow on an instance simultaneously.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maxConcurrentGameSessionActivations")]
    pub max_concurrent_game_session_activations: Option<f64>,
    /// Collection of server process configurations that describe which server processes to run on each instance in a fleet. See below.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverProcess")]
...
pub struct FleetForProviderRuntimeConfigurationServerProcess {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "concurrentExecutions")]
    pub concurrent_executions: Option<f64>,
    /// Location of the server executable in a game build. All game builds are installed on instances at the root : for Windows instances C:\game, and for Linux instances /local/game.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "launchPath")]
