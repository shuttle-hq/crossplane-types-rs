...
#[kube(group = "deploy.aws.upbound.io", version = "v1beta2", kind = "DeploymentGroup", plural = "deploymentgroups")]
...
pub struct DeploymentGroupForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "alarmConfiguration")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appNameRef")]
    pub app_name_ref: Option<DeploymentGroupForProviderAppNameRef>,
    /// Selector for a App in deploy to populate appName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "appNameSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blueGreenDeploymentConfig")]
    pub blue_green_deployment_config: Option<DeploymentGroupForProviderBlueGreenDeploymentConfig>,
    /// The name of the group's deployment config. The default is "CodeDeployDefault.OneAtATime".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deploymentConfigName")]
    pub deployment_config_name: Option<String>,
    /// Configuration block of the type of deployment, either in-place or blue/green, you want to run and whether to route deployment traffic behind a load balancer (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deploymentStyle")]
    pub deployment_style: Option<DeploymentGroupForProviderDeploymentStyle>,
    /// Tag filters associated with the deployment group. See the AWS docs for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ec2TagFilter")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ecsService")]
    pub ecs_service: Option<DeploymentGroupForProviderEcsService>,
    /// Single configuration block of the load balancer to use in a blue/green deployment (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loadBalancerInfo")]
    pub load_balancer_info: Option<DeploymentGroupForProviderLoadBalancerInfo>,
    /// On premise tag filters associated with the group. See the AWS docs for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onPremisesInstanceTagFilter")]
    pub on_premises_instance_tag_filter: Option<Vec<DeploymentGroupForProviderOnPremisesInstanceTagFilter>>,
    /// Configuration block of Indicates what happens when new Amazon EC2 instances are launched mid-deployment and do not receive the deployed application revision. Valid values are UPDATE and IGNORE. Defaults to UPDATE.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outdatedInstancesStrategy")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "terminationHookEnabled")]
    pub termination_hook_enabled: Option<bool>,
    /// Configuration block(s) of the triggers for the deployment group (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerConfiguration")]
...
pub struct DeploymentGroupForProviderAlarmConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ignorePollAlarmFailure")]
...
pub struct DeploymentGroupForProviderBlueGreenDeploymentConfigDeploymentReadyOption {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "actionOnTimeout")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "waitTimeInMinutes")]
...
pub struct DeploymentGroupForProviderBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccess {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "terminationWaitTimeInMinutes")]
...
pub struct DeploymentGroupForProviderDeploymentStyle {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deploymentOption")]
...
pub struct DeploymentGroupForProviderLoadBalancerInfo {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroupInfo")]
    pub target_group_info: Option<Vec<DeploymentGroupForProviderLoadBalancerInfoTargetGroupInfo>>,
    /// The (Application/Network Load Balancer) target group pair to use in a deployment. Conflicts with elb_info and target_group_info.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroupPairInfo")]
    pub target_group_pair_info: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfo>,
}
...
pub struct DeploymentGroupForProviderLoadBalancerInfoElbInfoNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupForProviderLoadBalancerInfoElbInfoNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeploymentGroupForProviderLoadBalancerInfoElbInfoNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupForProviderLoadBalancerInfoElbInfoNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfo {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "prodTrafficRoute")]
    pub prod_traffic_route: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoProdTrafficRoute>,
    /// Configuration blocks for a target group within a target group pair (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroup")]
    pub target_group: Option<Vec<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroup>>,
    /// Configuration block for the test traffic route (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "testTrafficRoute")]
    pub test_traffic_route: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTestTrafficRoute>,
}
...
pub struct DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroup {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nameRef")]
    pub name_ref: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRef>,
    /// Selector for a LBTargetGroup in elbv2 to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nameSelector")]
    pub name_selector: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelector>,
}
...
pub struct DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRefPolicy>,
}
...
pub struct DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupForProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelectorPolicy>,
}
...
pub struct DeploymentGroupForProviderTriggerConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerEvents")]
    pub trigger_events: Option<Vec<String>>,
    /// The name of the notification trigger.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerName")]
    pub trigger_name: Option<String>,
    /// The ARN of the SNS topic through which notifications are sent.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerTargetArn")]
    pub trigger_target_arn: Option<String>,
    /// Reference to a Topic in sns to populate triggerTargetArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerTargetArnRef")]
    pub trigger_target_arn_ref: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnRef>,
    /// Selector for a Topic in sns to populate triggerTargetArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerTargetArnSelector")]
    pub trigger_target_arn_selector: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelector>,
}
...
pub struct DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnRefPolicyResolve>,
}
...
pub struct DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelectorPolicy>,
}
...
pub struct DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DeploymentGroupForProviderTriggerConfigurationTriggerTargetArnSelectorPolicyResolve>,
}
...
pub struct DeploymentGroupInitProvider {
    ...
    /// On premise tag filters associated with the group. See the AWS docs for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onPremisesInstanceTagFilter")]
    pub on_premises_instance_tag_filter: Option<Vec<DeploymentGroupInitProviderOnPremisesInstanceTagFilter>>,
    /// Configuration block of Indicates what happens when new Amazon EC2 instances are launched mid-deployment and do not receive the deployed application revision. Valid values are UPDATE and IGNORE. Defaults to UPDATE.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outdatedInstancesStrategy")]
    pub outdated_instances_strategy: Option<String>,
    /// The service role ARN that allows deployments.
...
pub struct DeploymentGroupInitProviderEcsServiceClusterNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderEcsServiceClusterNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeploymentGroupInitProviderEcsServiceServiceNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderEcsServiceServiceNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeploymentGroupInitProviderLoadBalancerInfo {
    ...
    /// The (Application/Network Load Balancer) target group pair to use in a deployment. Conflicts with elb_info and target_group_info.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroupPairInfo")]
    pub target_group_pair_info: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfo>,
}
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoElbInfoNameRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderLoadBalancerInfoElbInfoNameRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoElbInfoNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderLoadBalancerInfoElbInfoNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DeploymentGroupInitProviderLoadBalancerInfoElbInfoNameSelectorPolicyResolve>,
}
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfo {
    /// Configuration block for the production traffic route (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "prodTrafficRoute")]
    pub prod_traffic_route: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoProdTrafficRoute>,
    /// Configuration blocks for a target group within a target group pair (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroup")]
    pub target_group: Option<Vec<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroup>>,
    /// Configuration block for the test traffic route (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "testTrafficRoute")]
    pub test_traffic_route: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTestTrafficRoute>,
}
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroup {
    ...
    /// Reference to a LBTargetGroup in elbv2 to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nameRef")]
    pub name_ref: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRef>,
    /// Selector for a LBTargetGroup in elbv2 to populate name.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nameSelector")]
    pub name_selector: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelector>,
}
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRef {
    ...
    /// Policies for referencing.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameRefPolicy>,
}
...
pub struct DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupInitProviderLoadBalancerInfoTargetGroupPairInfoTargetGroupNameSelectorPolicy>,
}
...
pub struct DeploymentGroupInitProviderTriggerConfiguration {
    ...
    /// Reference to a Topic in sns to populate triggerTargetArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerTargetArnRef")]
    pub trigger_target_arn_ref: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnRef>,
    /// Selector for a Topic in sns to populate triggerTargetArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "triggerTargetArnSelector")]
    pub trigger_target_arn_selector: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelector>,
}
...
pub struct DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnRefPolicyResolve>,
}
...
pub struct DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelector {
    ...
    /// Policies for selection.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub policy: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelectorPolicy>,
}
...
pub struct DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<DeploymentGroupInitProviderTriggerConfigurationTriggerTargetArnSelectorPolicyResolve>,
}
...
pub struct DeploymentGroupStatusAtProvider {
    ...
    /// Configuration block of the automatic rollback configuration associated with the deployment group (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoRollbackConfiguration")]
    pub auto_rollback_configuration: Option<DeploymentGroupStatusAtProviderAutoRollbackConfiguration>,
    /// Autoscaling groups associated with the deployment group.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "autoscalingGroups")]
    pub autoscaling_groups: Option<Vec<String>>,
    /// Configuration block of the blue/green deployment options for a deployment group (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blueGreenDeploymentConfig")]
    pub blue_green_deployment_config: Option<DeploymentGroupStatusAtProviderBlueGreenDeploymentConfig>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deploymentGroupId")]
    ...
    /// On premise tag filters associated with the group. See the AWS docs for details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "onPremisesInstanceTagFilter")]
    pub on_premises_instance_tag_filter: Option<Vec<DeploymentGroupStatusAtProviderOnPremisesInstanceTagFilter>>,
    /// Configuration block of Indicates what happens when new Amazon EC2 instances are launched mid-deployment and do not receive the deployed application revision. Valid values are UPDATE and IGNORE. Defaults to UPDATE.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outdatedInstancesStrategy")]
    pub outdated_instances_strategy: Option<String>,
    /// The service role ARN that allows deployments.
...
pub struct DeploymentGroupStatusAtProviderLoadBalancerInfo {
    ...
    /// The (Application/Network Load Balancer) target group to use in a deployment. Conflicts with elb_info and target_group_pair_info.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroupInfo")]
    pub target_group_info: Option<Vec<DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupInfo>>,
    /// The (Application/Network Load Balancer) target group pair to use in a deployment. Conflicts with elb_info and target_group_info.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroupPairInfo")]
    pub target_group_pair_info: Option<DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupPairInfo>,
}
...
pub struct DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupPairInfo {
    /// Configuration block for the production traffic route (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "prodTrafficRoute")]
    pub prod_traffic_route: Option<DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupPairInfoProdTrafficRoute>,
    /// Configuration blocks for a target group within a target group pair (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetGroup")]
    pub target_group: Option<Vec<DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupPairInfoTargetGroup>>,
    /// Configuration block for the test traffic route (documented below).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "testTrafficRoute")]
    pub test_traffic_route: Option<DeploymentGroupStatusAtProviderLoadBalancerInfoTargetGroupPairInfoTestTrafficRoute>,
}
