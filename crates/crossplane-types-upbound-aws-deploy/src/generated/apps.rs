...
#[kube(group = "deploy.aws.upbound.io", version = "v1beta1", kind = "App", plural = "apps")]
...
pub struct AppStatusAtProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "githubAccountName")]
    pub github_account_name: Option<String>,
    /// Amazon's assigned ID for the application.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// Whether the user has authenticated with GitHub for the specified application.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "linkedToGithub")]
    pub linked_to_github: Option<bool>,
    /// Key-value map of resource tags.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<HashMap<String, String>>,
