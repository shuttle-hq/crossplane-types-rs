...
#[kube(group = "medialive.aws.upbound.io", version = "v1beta2", kind = "Channel", plural = "channels")]
...
pub struct ChannelForProvider {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cdiInputSpecification")]
    pub cdi_input_specification: Option<ChannelForProviderCdiInputSpecification>,
    /// Concise argument description.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelClass")]
    pub channel_class: Option<String>,
    /// Destinations for channel. See Destinations for more details.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub destinations: Option<Vec<ChannelForProviderDestinations>>,
    /// Encoder settings. See Encoder Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "encoderSettings")]
    pub encoder_settings: Option<ChannelForProviderEncoderSettings>,
    /// Input attachments for the channel. See Input Attachments for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputAttachments")]
    pub input_attachments: Option<Vec<ChannelForProviderInputAttachments>>,
    /// Specification of network and file inputs for the channel.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputSpecification")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "startChannel")]
...
pub struct ChannelForProviderDestinations {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mediaPackageSettings")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiplexSettings")]
...
pub struct ChannelForProviderDestinationsMultiplexSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiplexId")]
    pub multiplex_id: Option<String>,
    /// The program name of the Multiplex program that the encoder is providing output to.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "programName")]
...
pub struct ChannelForProviderEncoderSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioDescriptions")]
    pub audio_descriptions: Option<Vec<ChannelForProviderEncoderSettingsAudioDescriptions>>,
    /// Settings for ad avail blanking. See Avail Blanking for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availBlanking")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionDescriptions")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalConfiguration")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsConfiguration")]
    pub motion_graphics_configuration: Option<ChannelForProviderEncoderSettingsMotionGraphicsConfiguration>,
    /// Nielsen configuration settings. See Nielsen Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nielsenConfiguration")]
    pub nielsen_configuration: Option<ChannelForProviderEncoderSettingsNielsenConfiguration>,
    /// Output groups for the channel. See Output Groups for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputGroups")]
    pub output_groups: Option<Vec<ChannelForProviderEncoderSettingsOutputGroups>>,
    /// Contains settings used to acquire and adjust timecode information from inputs. See Timecode Config for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timecodeConfig")]
    pub timecode_config: Option<ChannelForProviderEncoderSettingsTimecodeConfig>,
    /// Video Descriptions. See Video Descriptions for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoDescriptions")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioNormalizationSettings")]
    pub audio_normalization_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings>,
    /// The name of the audio selector in the input that MediaLive should monitor to detect silence. Select your most important rendition. If you didn't create an audio selector in this input, leave blank.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSelectorName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioTypeControl")]
    pub audio_type_control: Option<String>,
    /// Settings to configure one or more solutions that insert audio watermarks in the audio encode. See Audio Watermark Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioWatermarkSettings")]
    pub audio_watermark_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings>,
    /// Audio codec settings. See Audio Codec Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codecSettings")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCodeControl")]
    pub language_code_control: Option<String>,
    /// Name of the Channel.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "remixSettings")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "algorithmControl")]
    pub algorithm_control: Option<String>,
    /// Target LKFS (loudness) to adjust volume to.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "targetLkfs")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cbetCheckDigitString")]
    pub cbet_check_digit_string: Option<String>,
    /// Determines the method of CBET insertion mode when prior encoding is detected on the same layer.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cbetStepaside")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettingsNielsenWatermarksSettingsNielsenNaesIiNwSettings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "checkDigitString")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "aacSettings")]
    pub aac_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings>,
    /// Ac3 Settings. See AC3 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ac3Settings")]
    pub ac3_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings>,
    /// - Eac3 Atmos Settings. See EAC3 Atmos Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3AtmosSettings")]
    pub eac3_atmos_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings>,
    /// - Eac3 Settings. See EAC3 Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3Settings")]
    pub eac3_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mp2Settings")]
    pub mp2_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passThroughSettings")]
    pub pass_through_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "wavSettings")]
    pub wav_settings: Option<ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsWavSettings>,
}
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codingMode")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "vbrQuality")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bitstreamMode")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "drcProfile")]
    ...
    /// Metadata control.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metadataControl")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "heightTrim")]
    pub height_trim: Option<f64>,
    /// Surround dimensional trim.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "surroundTrim")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "attenuationControl")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "drcRf")]
    pub drc_rf: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lfeControl")]
    pub lfe_control: Option<String>,
    /// When set to enabled, applies a 120Hz lowpass filter to the LFE channel prior to encoding.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "lfeFilter")]
    pub lfe_filter: Option<String>,
    /// H264 level.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loRoCenterMixLevel")]
    pub lo_ro_center_mix_level: Option<f64>,
    /// H264 level.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "loRoSurroundMixLevel")]
    pub lo_ro_surround_mix_level: Option<f64>,
    /// H264 level.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ltRtCenterMixLevel")]
    pub lt_rt_center_mix_level: Option<f64>,
    /// H264 level.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ltRtSurroundMixLevel")]
    pub lt_rt_surround_mix_level: Option<f64>,
    /// Metadata control.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "metadataControl")]
    pub metadata_control: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passthroughControl")]
    pub passthrough_control: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "phaseControl")]
    pub phase_control: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stereoDownmix")]
    pub stereo_downmix: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "surroundExMode")]
    pub surround_ex_mode: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "surroundMode")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsRemixSettings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelMappings")]
    pub channel_mappings: Option<Vec<ChannelForProviderEncoderSettingsAudioDescriptionsRemixSettingsChannelMappings>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsIn")]
    pub channels_in: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsOut")]
...
pub struct ChannelForProviderEncoderSettingsAudioDescriptionsRemixSettingsChannelMappingsInputChannelLevels {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub gain: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputChannel")]
...
pub struct ChannelForProviderEncoderSettingsAvailBlanking {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availBlankingImage")]
    pub avail_blanking_image: Option<ChannelForProviderEncoderSettingsAvailBlankingAvailBlankingImage>,
...
pub struct ChannelForProviderEncoderSettingsCaptionDescriptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionSelectorName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationSettings")]
    pub destination_settings: Option<ChannelForProviderEncoderSettingsCaptionDescriptionsDestinationSettings>,
    /// Selects a specific three-letter language code from within an audio source.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCode")]
    pub language_code: Option<String>,
    /// Human readable information to indicate captions available for players (eg. English, or Spanish).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageDescription")]
...
pub struct ChannelForProviderEncoderSettingsCaptionDescriptionsDestinationSettingsEbuTtDDestinationSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "copyrightHolder")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fillLineGap")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fontFamily")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "styleControl")]
...
pub struct ChannelForProviderEncoderSettingsGlobalConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "initialAudioGain")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputEndAction")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossBehavior")]
    pub input_loss_behavior: Option<ChannelForProviderEncoderSettingsGlobalConfigurationInputLossBehavior>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputLockingMode")]
    pub output_locking_mode: Option<String>,
    /// –  Indicates whether the rate of frames emitted by the Live encoder should be paced by its system clock (which optionally may be locked to another source via NTP) or should be locked to the clock of the source that is providing the input stream.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputTimingSource")]
    pub output_timing_source: Option<String>,
    /// –  Adjusts video input buffer for streams with very low video framerates. This is commonly set to enabled for music channels with less than one video frame per second.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "supportLowFramerateInputs")]
...
pub struct ChannelForProviderEncoderSettingsGlobalConfigurationInputLossBehavior {
    ...
    pub input_loss_image_slate: Option<ChannelForProviderEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate>,
...
pub struct ChannelForProviderEncoderSettingsMotionGraphicsConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsInsertion")]
    pub motion_graphics_insertion: Option<String>,
    /// –  Motion Graphics Settings. See Motion Graphics Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsSettings")]
    pub motion_graphics_settings: Option<ChannelForProviderEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings>,
}
...
pub struct ChannelForProviderEncoderSettingsNielsenConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "distributorId")]
    pub distributor_id: Option<String>,
    /// –  Enables Nielsen PCM to ID3 tagging.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nielsenPcmToId3Tagging")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroups {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputGroupSettings")]
    pub output_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettings>,
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettings {
    ...
    pub archive_group_settings: Option<Vec<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettings>>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameCaptureGroupSettings")]
    pub frame_capture_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsGroupSettings")]
    pub hls_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings>,
    ...
    pub media_package_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMediaPackageGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "msSmoothGroupSettings")]
    pub ms_smooth_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiplexGroupSettings")]
    pub multiplex_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsMultiplexGroupSettings>,
    /// RTMP group settings. See RTMP Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rtmpGroupSettings")]
    pub rtmp_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "udpGroupSettings")]
    pub udp_group_settings: Option<ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsUdpGroupSettings>,
}
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettingsDestination {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationRefId")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsCaptionLanguageMappings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionChannel")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsAkamaiSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "httpTransferMode")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettingsHlsCdnSettingsHlsMediaStoreSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filecacheDuration")]
    pub filecache_duration: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mediaStoreStorageClass")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "authenticationScheme")]
    pub authentication_scheme: Option<String>,
    /// Controls behavior when content cache fills up.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cacheFullBehavior")]
    pub cache_full_behavior: Option<String>,
    /// Cache length in seconds, is used to calculate buffer size.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "cacheLength")]
    pub cache_length: Option<f64>,
    /// Controls the types of data that passes to onCaptionInfo outputs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionData")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputs {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioDescriptionNames")]
    pub audio_description_names: Option<Vec<String>>,
    /// The names of the caption descriptions used as caption sources for the output.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionDescriptionNames")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputSettings")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoDescriptionName")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbNitSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "repInterval")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsArchiveOutputSettingsContainerSettingsM2tsSettingsDvbSdtSettings {
    ...
    /// Name of the Channel.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serviceProviderName")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettingsM3u8Settings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "programNum")]
    pub program_num: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte35Behavior")]
...
pub struct ChannelForProviderEncoderSettingsOutputGroupsOutputsOutputSettingsUdpOutputSettingsFecOutputSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "columnDepth")]
    pub column_depth: Option<f64>,
    /// Enables column only or column and row based FEC.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "includeFec")]
...
pub struct ChannelForProviderEncoderSettingsTimecodeConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "syncThreshold")]
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "respondToAfd")]
    pub respond_to_afd: Option<String>,
    /// Behavior on how to scale.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scalingBehavior")]
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameCaptureSettings")]
    pub frame_capture_settings: Option<ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings>,
    /// H264 settings. See H264 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h264Settings")]
    pub h264_settings: Option<ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h265Settings")]
    pub h265_settings: Option<ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings>,
}
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureInterval")]
    pub capture_interval: Option<f64>,
    /// Unit for the frame capture interval.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captureIntervalUnits")]
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings {
    ...
    pub filter_settings: Option<ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettings>,
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettingsTemporalFilterSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "postFilterSharpening")]
...
pub struct ChannelForProviderEncoderSettingsVideoDescriptionsCodecSettingsH265SettingsTimecodeBurninSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timecodeBurninFontSize")]
    pub timecode_burnin_font_size: Option<String>,
    /// Sets the position of the burned in timecode.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "timecodeBurninPosition")]
...
pub struct ChannelForProviderInputAttachments {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "automaticInputFailoverSettings")]
    pub automatic_input_failover_settings: Option<ChannelForProviderInputAttachmentsAutomaticInputFailoverSettings>,
    /// User-specified name for the attachment.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputAttachmentName")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputIdRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputIdSelector")]
    pub input_id_selector: Option<ChannelForProviderInputAttachmentsInputIdSelector>,
    /// Settings of an input. See Input Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputSettings")]
...
pub struct ChannelForProviderInputAttachmentsAutomaticInputFailoverSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "errorClearTimeMsec")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failoverCondition")]
    pub failover_condition: Option<Vec<ChannelForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverCondition>>,
    /// Input preference when deciding which input to make active when a previously failed input has recovered.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputPreference")]
    pub input_preference: Option<String>,
    /// The input ID of the secondary input in the automatic input failover pair.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "secondaryInputId")]
...
pub struct ChannelForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsAudioSilenceSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSilenceThresholdMsec")]
...
pub struct ChannelForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsInputLossSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossThresholdMsec")]
...
pub struct ChannelForProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverConditionFailoverConditionSettingsVideoBlackSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "blackDetectThreshold")]
    pub black_detect_threshold: Option<f64>,
    /// The amount of time (in milliseconds) that the active input must be black before automatic input failover occurs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoBlackThresholdMsec")]
...
pub struct ChannelForProviderInputAttachmentsInputSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSelector")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionSelector")]
    pub caption_selector: Option<Vec<ChannelForProviderInputAttachmentsInputSettingsCaptionSelector>>,
    /// Enable or disable the deblock filter when filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deblockFilter")]
    pub deblock_filter: Option<String>,
    /// Enable or disable the denoise filter when filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "denoiseFilter")]
    pub denoise_filter: Option<String>,
    /// Adjusts the magnitude of filtering from 1 (minimal) to 5 (strongest).
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filterStrength")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInputSettings")]
    pub network_input_settings: Option<ChannelForProviderInputAttachmentsInputSettingsNetworkInputSettings>,
    /// PID from which to read SCTE-35 messages.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte35Pid")]
    pub scte35_pid: Option<f64>,
    /// Specifies whether to extract applicable ancillary data from a SMPTE-2038 source in the input.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "smpte2038DataPreference")]
    pub smpte2038_data_preference: Option<String>,
    /// Loop input if it is a file.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceEndBehavior")]
    pub source_end_behavior: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoSelector")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsAudioSelector {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings>,
}
...
pub struct ChannelForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioLanguageSelection {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageSelectionPolicy")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionDolbyEDecode {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "programSelection")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsCaptionSelector {
    ...
    /// The audio selector settings. See Audio Selector Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings>,
}
...
pub struct ChannelForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsAncillarySourceSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "sourceAncillaryChannelNumber")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsDvbSubSourceSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ocrLanguage")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "convert608To708")]
    pub convert608_to708: Option<String>,
    /// Set to “auto” to handle streams with intermittent and/or non-aligned SCTE-20 and Embedded captions.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte20Detection")]
    pub scte20_detection: Option<String>,
    /// Specifies the 608/708 channel number within the video track from which to extract captions. Unused for passthrough.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "source608ChannelNumber")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettingsTeletextSourceSettingsOutputRectangle {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "leftOffset")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsNetworkInputSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsInputSettings")]
    pub hls_input_settings: Option<ChannelForProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings>,
    /// Check HTTPS server certificates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverValidation")]
...
pub struct ChannelForProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings {
    ...
    /// Buffer segments.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "bufferSegments")]
    ...
    /// The source for the timecode that will be associated with the events outputs.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte35Source")]
    pub scte35_source: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct ChannelForProviderInputAttachmentsInputSettingsVideoSelector {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "colorSpace")]
    pub color_space: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "colorSpaceUsage")]
...
pub struct ChannelForProviderInputSpecification {
    ...
    /// - Maximum CDI input resolution.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputResolution")]
    pub input_resolution: Option<String>,
    /// Average bitrate in bits/second.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maximumBitrate")]
...
pub struct ChannelForProviderMaintenance {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maintenanceDay")]
    pub maintenance_day: Option<String>,
    /// The hour maintenance will start.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "maintenanceStartTime")]
...
pub struct ChannelForProviderVpc {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "publicAddressAllocationIds")]
...
pub struct ChannelInitProviderEncoderSettings {
    ...
    /// Settings for motion graphics. See Motion Graphics Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsConfiguration")]
    pub motion_graphics_configuration: Option<ChannelInitProviderEncoderSettingsMotionGraphicsConfiguration>,
    /// Nielsen configuration settings. See Nielsen Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nielsenConfiguration")]
...
pub struct ChannelInitProviderEncoderSettingsAudioDescriptions {
    /// Advanced audio normalization settings. See Audio Normalization Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioNormalizationSettings")]
    pub audio_normalization_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings>,
    /// The name of the audio selector in the input that MediaLive should monitor to detect silence. Select your most important rendition. If you didn't create an audio selector in this input, leave blank.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSelectorName")]
    pub audio_selector_name: Option<String>,
    /// Applies only if audioTypeControl is useConfigured. The values for audioType are defined in ISO-IEC 13818-1.
    ...
    /// Settings to configure one or more solutions that insert audio watermarks in the audio encode. See Audio Watermark Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioWatermarkSettings")]
    pub audio_watermark_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings>,
    /// Audio codec settings. See Audio Codec Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codecSettings")]
...
pub struct ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettings {
    /// Aac Settings. See AAC Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "aacSettings")]
    pub aac_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings>,
    /// Ac3 Settings. See AC3 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ac3Settings")]
    pub ac3_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings>,
    /// - Eac3 Atmos Settings. See EAC3 Atmos Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3AtmosSettings")]
    pub eac3_atmos_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings>,
    /// - Eac3 Settings. See EAC3 Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3Settings")]
    pub eac3_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mp2Settings")]
    pub mp2_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passThroughSettings")]
    pub pass_through_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "wavSettings")]
    pub wav_settings: Option<ChannelInitProviderEncoderSettingsAudioDescriptionsCodecSettingsWavSettings>,
}
...
pub struct ChannelInitProviderEncoderSettingsAudioDescriptionsRemixSettings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelMappings")]
    pub channel_mappings: Option<Vec<ChannelInitProviderEncoderSettingsAudioDescriptionsRemixSettingsChannelMappings>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsIn")]
    pub channels_in: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsOut")]
    pub channels_out: Option<f64>,
...
pub struct ChannelInitProviderEncoderSettingsAvailBlanking {
    /// Blanking image to be used. See Avail Blanking Image for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availBlankingImage")]
    pub avail_blanking_image: Option<ChannelInitProviderEncoderSettingsAvailBlankingAvailBlankingImage>,
    /// When set to enabled, causes video, audio and captions to be blanked when insertion metadata is added.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
}
...
pub struct ChannelInitProviderEncoderSettingsCaptionDescriptions {
    ...
    /// Additional settings for captions destination that depend on the destination type. See Destination Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationSettings")]
    pub destination_settings: Option<ChannelInitProviderEncoderSettingsCaptionDescriptionsDestinationSettings>,
    /// Selects a specific three-letter language code from within an audio source.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCode")]
    pub language_code: Option<String>,
    /// Human readable information to indicate captions available for players (eg. English, or Spanish).
...
pub struct ChannelInitProviderEncoderSettingsGlobalConfiguration {
    ...
    /// Settings for system actions when input is lost. See Input Loss Behavior for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossBehavior")]
    pub input_loss_behavior: Option<ChannelInitProviderEncoderSettingsGlobalConfigurationInputLossBehavior>,
    /// MediaLive will attempt to synchronize the output of each pipeline to the other. EPOCH_LOCKING - MediaLive will attempt to synchronize the output of each pipeline to the Unix epoch.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputLockingMode")]
    pub output_locking_mode: Option<String>,
    /// –  Indicates whether the rate of frames emitted by the Live encoder should be paced by its system clock (which optionally may be locked to another source via NTP) or should be locked to the clock of the source that is providing the input stream.
...
pub struct ChannelInitProviderEncoderSettingsGlobalConfigurationInputLossBehavior {
    ...
    pub input_loss_image_color: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossImageSlate")]
    pub input_loss_image_slate: Option<ChannelInitProviderEncoderSettingsGlobalConfigurationInputLossBehaviorInputLossImageSlate>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossImageType")]
    pub input_loss_image_type: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "repeatFrameMsec")]
    pub repeat_frame_msec: Option<f64>,
...
pub struct ChannelInitProviderEncoderSettingsMotionGraphicsConfiguration {
    ...
    /// –  Motion Graphics Settings. See Motion Graphics Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsSettings")]
    pub motion_graphics_settings: Option<ChannelInitProviderEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings>,
}
...
pub struct ChannelInitProviderEncoderSettingsOutputGroups {
    ...
    /// Settings associated with the output group. See Output Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputGroupSettings")]
    pub output_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettings>,
    /// List of outputs. See Outputs for more details.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettings {
    /// Archive group settings. See Archive Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "archiveGroupSettings")]
    pub archive_group_settings: Option<Vec<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsArchiveGroupSettings>>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameCaptureGroupSettings")]
    pub frame_capture_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsFrameCaptureGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsGroupSettings")]
    pub hls_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsHlsGroupSettings>,
    /// Media package group settings. See Media Package Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mediaPackageGroupSettings")]
    pub media_package_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMediaPackageGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "msSmoothGroupSettings")]
    pub ms_smooth_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMsSmoothGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiplexGroupSettings")]
    pub multiplex_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsMultiplexGroupSettings>,
    /// RTMP group settings. See RTMP Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rtmpGroupSettings")]
    pub rtmp_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsRtmpGroupSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "udpGroupSettings")]
    pub udp_group_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputGroupSettingsUdpGroupSettings>,
}
...
pub struct ChannelInitProviderEncoderSettingsOutputGroupsOutputs {
    ...
    /// Settings for output. See Output Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputSettings")]
    pub output_settings: Option<ChannelInitProviderEncoderSettingsOutputGroupsOutputsOutputSettings>,
    /// The name of the video description used as video source for the output.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoDescriptionName")]
    pub video_description_name: Option<String>,
}
...
pub struct ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettings {
    /// Frame capture settings. See Frame Capture Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameCaptureSettings")]
    pub frame_capture_settings: Option<ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings>,
    /// H264 settings. See H264 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h264Settings")]
    pub h264_settings: Option<ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h265Settings")]
    pub h265_settings: Option<ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings>,
}
...
pub struct ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings {
    ...
    /// Filters to apply to an encode. See H264 Filter Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "filterSettings")]
    pub filter_settings: Option<ChannelInitProviderEncoderSettingsVideoDescriptionsCodecSettingsH264SettingsFilterSettings>,
    /// Four bit AFD value to write on all frames of video in the output stream.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "fixedAfd")]
    pub fixed_afd: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "flickerAq")]
...
pub struct ChannelInitProviderInputAttachments {
    /// User-specified settings for defining what the conditions are for declaring the input unhealthy and failing over to a different input. See Automatic Input Failover Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "automaticInputFailoverSettings")]
    pub automatic_input_failover_settings: Option<ChannelInitProviderInputAttachmentsAutomaticInputFailoverSettings>,
    /// User-specified name for the attachment.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputAttachmentName")]
    pub input_attachment_name: Option<String>,
    /// The ID of the input.
...
pub struct ChannelInitProviderInputAttachmentsAutomaticInputFailoverSettings {
    ...
    /// A list of failover conditions. If any of these conditions occur, MediaLive will perform a failover to the other input. See Failover Condition Block for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failoverCondition")]
    pub failover_condition: Option<Vec<ChannelInitProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverCondition>>,
    /// Input preference when deciding which input to make active when a previously failed input has recovered.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputPreference")]
    pub input_preference: Option<String>,
    /// The input ID of the secondary input in the automatic input failover pair.
...
pub struct ChannelInitProviderInputAttachmentsInputSettings {
    ...
    /// Used to select the caption input to use for inputs that have multiple available. See Caption Selectors for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionSelector")]
    pub caption_selector: Option<Vec<ChannelInitProviderInputAttachmentsInputSettingsCaptionSelector>>,
    /// Enable or disable the deblock filter when filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deblockFilter")]
    pub deblock_filter: Option<String>,
    /// Enable or disable the denoise filter when filtering.
    ...
    /// Input settings. See Network Input Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInputSettings")]
    pub network_input_settings: Option<ChannelInitProviderInputAttachmentsInputSettingsNetworkInputSettings>,
    /// PID from which to read SCTE-35 messages.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte35Pid")]
    pub scte35_pid: Option<f64>,
    /// Specifies whether to extract applicable ancillary data from a SMPTE-2038 source in the input.
...
pub struct ChannelInitProviderInputAttachmentsInputSettingsAudioSelector {
    ...
    /// The audio selector settings. See Audio Selector Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelInitProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings>,
}
...
pub struct ChannelInitProviderInputAttachmentsInputSettingsCaptionSelector {
    ...
    /// The audio selector settings. See Audio Selector Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelInitProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings>,
}
...
pub struct ChannelInitProviderInputAttachmentsInputSettingsNetworkInputSettings {
    /// Specifies HLS input settings when the uri is for a HLS manifest. See HLS Input Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsInputSettings")]
    pub hls_input_settings: Option<ChannelInitProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings>,
    /// Check HTTPS server certificates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverValidation")]
    pub server_validation: Option<String>,
}
...
pub struct ChannelStatusAtProviderDestinations {
    ...
    /// Destination settings for a MediaPackage output; one destination for both encoders. See Media Package Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mediaPackageSettings")]
    pub media_package_settings: Option<Vec<ChannelStatusAtProviderDestinationsMediaPackageSettings>>,
    /// Destination settings for a Multiplex output; one destination for both encoders. See Multiplex Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "multiplexSettings")]
...
pub struct ChannelStatusAtProviderEncoderSettings {
    ...
    /// Caption Descriptions. See Caption Descriptions for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionDescriptions")]
    pub caption_descriptions: Option<Vec<ChannelStatusAtProviderEncoderSettingsCaptionDescriptions>>,
    /// Configuration settings that apply to the event as a whole. See Global Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "globalConfiguration")]
    pub global_configuration: Option<ChannelStatusAtProviderEncoderSettingsGlobalConfiguration>,
    /// Settings for motion graphics. See Motion Graphics Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsConfiguration")]
    pub motion_graphics_configuration: Option<ChannelStatusAtProviderEncoderSettingsMotionGraphicsConfiguration>,
    /// Nielsen configuration settings. See Nielsen Configuration for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "nielsenConfiguration")]
...
pub struct ChannelStatusAtProviderEncoderSettingsAudioDescriptions {
    /// Advanced audio normalization settings. See Audio Normalization Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioNormalizationSettings")]
    pub audio_normalization_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioNormalizationSettings>,
    /// The name of the audio selector in the input that MediaLive should monitor to detect silence. Select your most important rendition. If you didn't create an audio selector in this input, leave blank.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSelectorName")]
    pub audio_selector_name: Option<String>,
    /// Applies only if audioTypeControl is useConfigured. The values for audioType are defined in ISO-IEC 13818-1.
    ...
    /// Settings to configure one or more solutions that insert audio watermarks in the audio encode. See Audio Watermark Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioWatermarkSettings")]
    pub audio_watermark_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsAudioWatermarkSettings>,
    /// Audio codec settings. See Audio Codec Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codecSettings")]
    pub codec_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettings>,
    /// Selects a specific three-letter language code from within an audio source.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCode")]
    pub language_code: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCodeControl")]
    ...
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "remixSettings")]
    pub remix_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsRemixSettings>,
    /// Stream name RTMP destinations (URLs of type rtmp://)
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "streamName")]
    pub stream_name: Option<String>,
}
...
pub struct ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettings {
    /// Aac Settings. See AAC Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "aacSettings")]
    pub aac_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsAacSettings>,
    /// Ac3 Settings. See AC3 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "ac3Settings")]
    pub ac3_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsAc3Settings>,
    /// - Eac3 Atmos Settings. See EAC3 Atmos Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3AtmosSettings")]
    pub eac3_atmos_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3AtmosSettings>,
    /// - Eac3 Settings. See EAC3 Settings
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "eac3Settings")]
    pub eac3_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsEac3Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mp2Settings")]
    pub mp2_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsMp2Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "passThroughSettings")]
    pub pass_through_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsPassThroughSettings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "wavSettings")]
    pub wav_settings: Option<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsCodecSettingsWavSettings>,
}
...
pub struct ChannelStatusAtProviderEncoderSettingsAudioDescriptionsRemixSettings {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelMappings")]
    pub channel_mappings: Option<Vec<ChannelStatusAtProviderEncoderSettingsAudioDescriptionsRemixSettingsChannelMappings>>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsIn")]
    pub channels_in: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "channelsOut")]
    pub channels_out: Option<f64>,
...
pub struct ChannelStatusAtProviderEncoderSettingsAvailBlanking {
    /// Blanking image to be used. See Avail Blanking Image for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "availBlankingImage")]
    pub avail_blanking_image: Option<ChannelStatusAtProviderEncoderSettingsAvailBlankingAvailBlankingImage>,
    /// When set to enabled, causes video, audio and captions to be blanked when insertion metadata is added.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
}
...
pub struct ChannelStatusAtProviderEncoderSettingsCaptionDescriptions {
    ...
    /// Additional settings for captions destination that depend on the destination type. See Destination Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "destinationSettings")]
    pub destination_settings: Option<ChannelStatusAtProviderEncoderSettingsCaptionDescriptionsDestinationSettings>,
    /// Selects a specific three-letter language code from within an audio source.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "languageCode")]
    pub language_code: Option<String>,
    /// Human readable information to indicate captions available for players (eg. English, or Spanish).
...
pub struct ChannelStatusAtProviderEncoderSettingsGlobalConfiguration {
    ...
    /// Settings for system actions when input is lost. See Input Loss Behavior for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputLossBehavior")]
    pub input_loss_behavior: Option<ChannelStatusAtProviderEncoderSettingsGlobalConfigurationInputLossBehavior>,
    /// MediaLive will attempt to synchronize the output of each pipeline to the other. EPOCH_LOCKING - MediaLive will attempt to synchronize the output of each pipeline to the Unix epoch.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputLockingMode")]
    pub output_locking_mode: Option<String>,
    /// –  Indicates whether the rate of frames emitted by the Live encoder should be paced by its system clock (which optionally may be locked to another source via NTP) or should be locked to the clock of the source that is providing the input stream.
...
pub struct ChannelStatusAtProviderEncoderSettingsMotionGraphicsConfiguration {
    ...
    /// –  Motion Graphics Settings. See Motion Graphics Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "motionGraphicsSettings")]
    pub motion_graphics_settings: Option<ChannelStatusAtProviderEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings>,
}
...
pub struct ChannelStatusAtProviderEncoderSettingsOutputGroups {
    ...
    /// Settings associated with the output group. See Output Group Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputGroupSettings")]
    pub output_group_settings: Option<ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputGroupSettings>,
    /// List of outputs. See Outputs for more details.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputs {
    ...
    /// Settings for output. See Output Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "outputSettings")]
    pub output_settings: Option<ChannelStatusAtProviderEncoderSettingsOutputGroupsOutputsOutputSettings>,
    /// The name of the video description used as video source for the output.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "videoDescriptionName")]
    pub video_description_name: Option<String>,
}
...
pub struct ChannelStatusAtProviderEncoderSettingsVideoDescriptions {
    /// Audio codec settings. See Audio Codec Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "codecSettings")]
    pub codec_settings: Option<ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettings>,
    /// See the description in left_offset. For height, specify the entire height of the rectangle as a percentage of the underlying frame height. For example, "80" means the rectangle height is 80% of the underlying frame height. The top_offset and rectangle_height must add up to 100% or less. This field corresponds to tts:extent - Y in the TTML standard.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub height: Option<f64>,
    /// Name of the Channel.
...
pub struct ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettings {
    /// Frame capture settings. See Frame Capture Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "frameCaptureSettings")]
    pub frame_capture_settings: Option<ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsFrameCaptureSettings>,
    /// H264 settings. See H264 Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h264Settings")]
    pub h264_settings: Option<ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH264Settings>,
    /// Destination settings for a standard output; one destination for each redundant encoder. See Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "h265Settings")]
    pub h265_settings: Option<ChannelStatusAtProviderEncoderSettingsVideoDescriptionsCodecSettingsH265Settings>,
}
...
pub struct ChannelStatusAtProviderInputAttachments {
    /// User-specified settings for defining what the conditions are for declaring the input unhealthy and failing over to a different input. See Automatic Input Failover Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "automaticInputFailoverSettings")]
    pub automatic_input_failover_settings: Option<ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettings>,
    /// User-specified name for the attachment.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputAttachmentName")]
    pub input_attachment_name: Option<String>,
    /// The ID of the input.
...
pub struct ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettings {
    ...
    /// A list of failover conditions. If any of these conditions occur, MediaLive will perform a failover to the other input. See Failover Condition Block for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "failoverCondition")]
    pub failover_condition: Option<Vec<ChannelStatusAtProviderInputAttachmentsAutomaticInputFailoverSettingsFailoverCondition>>,
    /// Input preference when deciding which input to make active when a previously failed input has recovered.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "inputPreference")]
    pub input_preference: Option<String>,
    /// The input ID of the secondary input in the automatic input failover pair.
...
pub struct ChannelStatusAtProviderInputAttachmentsInputSettings {
    /// Used to select the audio stream to decode for inputs that have multiple. See Audio Selectors for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "audioSelector")]
    pub audio_selector: Option<Vec<ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelector>>,
    /// Used to select the caption input to use for inputs that have multiple available. See Caption Selectors for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "captionSelector")]
    pub caption_selector: Option<Vec<ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelector>>,
    /// Enable or disable the deblock filter when filtering.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "deblockFilter")]
    pub deblock_filter: Option<String>,
    /// Enable or disable the denoise filter when filtering.
    ...
    /// Input settings. See Network Input Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkInputSettings")]
    pub network_input_settings: Option<ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettings>,
    /// PID from which to read SCTE-35 messages.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "scte35Pid")]
    pub scte35_pid: Option<f64>,
    /// Specifies whether to extract applicable ancillary data from a SMPTE-2038 source in the input.
...
pub struct ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelector {
    ...
    /// The audio selector settings. See Audio Selector Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelStatusAtProviderInputAttachmentsInputSettingsAudioSelectorSelectorSettings>,
}
...
pub struct ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelector {
    ...
    /// The audio selector settings. See Audio Selector Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "selectorSettings")]
    pub selector_settings: Option<ChannelStatusAtProviderInputAttachmentsInputSettingsCaptionSelectorSelectorSettings>,
}
...
pub struct ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettings {
    /// Specifies HLS input settings when the uri is for a HLS manifest. See HLS Input Settings for more details.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "hlsInputSettings")]
    pub hls_input_settings: Option<ChannelStatusAtProviderInputAttachmentsInputSettingsNetworkInputSettingsHlsInputSettings>,
    /// Check HTTPS server certificates.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "serverValidation")]
    pub server_validation: Option<String>,
}
