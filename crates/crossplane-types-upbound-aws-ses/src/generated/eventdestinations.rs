...
#[kube(group = "ses.aws.upbound.io", version = "v1beta2", kind = "EventDestination", plural = "eventdestinations")]
...
pub struct EventDestinationForProvider {
    ...
    pub configuration_set_name_selector: Option<EventDestinationForProviderConfigurationSetNameSelector>,
    /// If true, the event destination will be enabled
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Send the events to a kinesis firehose destination
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "kinesisDestination")]
    pub kinesis_destination: Option<EventDestinationForProviderKinesisDestination>,
    /// A list of matching types. May be any of "send", "reject", "bounce", "complaint", "delivery", "open", "click", or "renderingFailure".
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchingTypes")]
...
pub struct EventDestinationForProviderKinesisDestinationRoleArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationForProviderKinesisDestinationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationForProviderKinesisDestinationStreamArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationForProviderKinesisDestinationStreamArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationForProviderKinesisDestinationStreamArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationForProviderKinesisDestinationStreamArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EventDestinationForProviderKinesisDestinationStreamArnSelectorPolicyResolve>,
}
...
pub struct EventDestinationForProviderSnsDestinationTopicArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationForProviderSnsDestinationTopicArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationInitProvider {
    ...
    /// Selector for a ConfigurationSet in ses to populate configurationSetName.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "configurationSetNameSelector")]
    pub configuration_set_name_selector: Option<EventDestinationInitProviderConfigurationSetNameSelector>,
    /// If true, the event destination will be enabled
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    /// Send the events to a kinesis firehose destination
...
pub struct EventDestinationInitProviderConfigurationSetNameSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderConfigurationSetNameSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationInitProviderKinesisDestination {
    ...
    /// Selector for a DeliveryStream in firehose to populate streamArn.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "streamArnSelector")]
    pub stream_arn_selector: Option<EventDestinationInitProviderKinesisDestinationStreamArnSelector>,
}
...
pub struct EventDestinationInitProviderKinesisDestinationRoleArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderKinesisDestinationRoleArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationInitProviderKinesisDestinationRoleArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderKinesisDestinationRoleArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationInitProviderKinesisDestinationStreamArnRefPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderKinesisDestinationStreamArnRefPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
...
pub struct EventDestinationInitProviderKinesisDestinationStreamArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderKinesisDestinationStreamArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolve: Option<EventDestinationInitProviderKinesisDestinationStreamArnSelectorPolicyResolve>,
}
...
pub struct EventDestinationInitProviderSnsDestinationTopicArnSelectorPolicy {
    ...
    /// a no-op if it cannot be resolved.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resolution: Option<EventDestinationInitProviderSnsDestinationTopicArnSelectorPolicyResolution>,
    /// Resolve specifies when this reference should be resolved. The default
    /// is 'IfNotPresent', which will attempt to resolve the reference only when
    /// the corresponding field is not present. Use 'Always' to resolve the
    /// reference on every reconcile.
